...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/whopsdk/helpers/` and `examples/` directory.
...
```ruby
gem "whopsdk", git: "https://www.github.com/stainless-sdks/whopsdk-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/whopsdk-ruby' '<path-to-repo>'
```

```ruby
gem "whopsdk", path: "<path-to-repo>"
```
