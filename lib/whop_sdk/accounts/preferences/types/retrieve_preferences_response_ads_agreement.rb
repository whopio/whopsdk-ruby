  ...
  module Accounts
    module Preferences
      module Types
        ...
        class RetrievePreferencesResponseAdsAgreement < Internal::Types::Model
          ...
          field :status, -> { Whop_sdk::Accounts::Preferences::Types::RetrievePreferencesResponseAdsAgreementStatus }, optional: false, nullable: false
        end
      end
    end
  end
