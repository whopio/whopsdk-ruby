...
module Whop_sdk
  module Accounts
    module Preferences
      module Types
        class RetrievePreferencesResponseAdsPaymentMethodsBackup < Internal::Types::Model
          ...
          field :type, -> { Whop_sdk::Accounts::Preferences::Types::RetrievePreferencesResponseAdsPaymentMethodsBackupType }, optional: false, nullable: false
        end
      end
    end
  end
