...
module Whop_sdk
  module Accounts
    module Preferences
      module Types
        class RetrievePreferencesResponseAdsPaymentMethodsPrimary < Internal::Types::Model
          ...
          field :type, -> { Whop_sdk::Accounts::Preferences::Types::RetrievePreferencesResponseAdsPaymentMethodsPrimaryType }, optional: false, nullable: false
        end
      end
    end
  end
