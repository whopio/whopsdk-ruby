...
module Whop_sdk
  module Accounts
    module Preferences
      module Types
        class UpdatePreferencesResponseAdsPaymentMethodsBackup < Internal::Types::Model
          ...
          field :type, -> { Whop_sdk::Accounts::Preferences::Types::UpdatePreferencesResponseAdsPaymentMethodsBackupType }, optional: false, nullable: false
        end
      end
    end
  end
