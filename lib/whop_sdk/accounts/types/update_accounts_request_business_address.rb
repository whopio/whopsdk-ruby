...
module Whop_sdk
  module Accounts
    module Types
      # Account business address used to calculate tax. A complete address in a supported country is required when
      # `tax_remitted_by` is `self`.
      class UpdateAccountsRequestBusinessAddress < Internal::Types::Model
