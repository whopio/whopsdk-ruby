...
module Whop_sdk
  module AdGroups
    module Types
      ...
      # - `whatsapp`: `status`
      class UpdateAdGroupsRequestPlacements < Internal::Types::Model
        extend Whop_sdk::Internal::Types::Union

        member -> { Whop_sdk::AdGroups::Types::UpdateAdGroupsRequestPlacementsZero }

        member -> { Internal::Types::Array[Whop_sdk::AdGroups::Types::UpdateAdGroupsRequestPlacementsOneItem] }
      end
    end
  end
end
