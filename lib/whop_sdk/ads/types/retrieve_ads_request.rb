...
module Whop_sdk
  module Ads
    module Types
      class RetrieveAdsRequest < Internal::Types::Model
        ...
        field :attribution_model, -> { Whop_sdk::Ads::Types::RetrieveAdsRequestAttributionModel }, optional: true, nullable: false
      end
    end
  end
end
