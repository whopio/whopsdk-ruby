...
module Whop_sdk
  module Ads
    module Types
      ...
      class UpdateAdsRequestLeadFormCompletion < Internal::Types::Model
        field :button_text, -> { String }, optional: true, nullable: false

        field :button_type, -> { Whop_sdk::Ads::Types::UpdateAdsRequestLeadFormCompletionButtonType }, optional: true, nullable: false
