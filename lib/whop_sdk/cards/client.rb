...
module Whop_sdk
  module Cards
    class Client
      ...
      #   client.cards.list
      #
      # @return [Whop_sdk::Cards::Types::ListCardsResponse]
      ...
      #   client.cards.create
      #
      # @return [Whop_sdk::Cards::Types::CreateCardsResponse]
      ...
      #
      # @return [Whop_sdk::Cards::Types::RetrieveCardsResponse]
      ...
      #
      # @param request_options [Hash]
      # @param params [Whop_sdk::Cards::Types::UpdateCardsRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [Whop_sdk::Cards::Types::UpdateCardsResponse]
      def update(request_options: {}, **params)
        params = Whop_sdk::Internal::Types::Utils.normalize_keys(params)
        request_data = Whop_sdk::Cards::Types::UpdateCardsRequest.new(params).to_h
