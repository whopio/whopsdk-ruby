...
module Whop_sdk
  class Client
    ...
    #
    # @return [void]
    def initialize(token:, base_url: nil, api_version_date: "2026-09-11-1", idempotency_key: nil, max_retries: 2)
      headers = {
    ...
    def experiments
      @experiments ||= Whop_sdk::Experiments::Client.new(client: @raw_client)
    end
