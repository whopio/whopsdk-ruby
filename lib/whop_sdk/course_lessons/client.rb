...
module Whop_sdk
  module CourseLessons
    class Client
      ...
      # @option params [String, nil] :course_id
      # @option params [String, nil] :chapter_id
      #
      # @example
      ...
      #   )
      #
      # @return [Whop_sdk::CourseLessons::Types::ListCourseLessonsResponse]
      def list(request_options: {}, **params)
        ...
        query_params["chapter_id"] = params[:chapter_id] if params.key?(:chapter_id)
      ...
      #
      # @param request_options [Hash]
      # @param params [Whop_sdk::CourseLessons::Types::CreateCourseLessonsRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [Whop_sdk::Types::CourseLesson]
      def create(request_options: {}, **params)
        ...
        request = Whop_sdk::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "course_lessons",
          body: Whop_sdk::CourseLessons::Types::CreateCourseLessonsRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def retrieve(request_options: {}, **params)
        ...
        request = Whop_sdk::Internal::JSON::Request.new(
          base_url: request_options[:base_url] || @base_url || @environment&.dig(:api),
          method: "GET",
          path: "course_lessons/#{URI.encode_uri_component(params[:id].to_s)}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @param request_options [Hash]
      # @param params [Whop_sdk::CourseLessons::Types::UpdateCourseLessonsRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def update(request_options: {}, **params)
        params = Whop_sdk::Internal::Types::Utils.normalize_keys(params)
        request_data = Whop_sdk::CourseLessons::Types::UpdateCourseLessonsRequest.new(params).to_h
      ...
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      # @option params [String] :lesson_id
      #
      # @example
      #   client.course_lessons.mark_as_completed(lesson_id: "lesson_id")
      #
      # @return [Boolean]
      def mark_as_completed(request_options: {}, **params)
        params = Whop_sdk::Internal::Types::Utils.normalize_keys(params)
        request = Whop_sdk::Internal::JSON::Request.new(
          base_url: request_options[:base_url] || @base_url || @environment&.dig(:api),
          method: "POST",
          path: "course_lessons/#{URI.encode_uri_component(params[:lesson_id].to_s)}/mark_as_completed",
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def start(request_options: {}, **params)
        ...
        request = Whop_sdk::Internal::JSON::Request.new(
          base_url: request_options[:base_url] || @base_url || @environment&.dig(:api),
          method: "POST",
          path: "course_lessons/#{URI.encode_uri_component(params[:lesson_id].to_s)}/start",
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @param request_options [Hash]
      # @param params [Whop_sdk::CourseLessons::Types::SubmitAssessmentCourseLessonsRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [Whop_sdk::CourseLessons::Types::SubmitAssessmentCourseLessonsResponse]
      def submit_assessment(request_options: {}, **params)
        params = Whop_sdk::Internal::Types::Utils.normalize_keys(params)
        request_data = Whop_sdk::CourseLessons::Types::SubmitAssessmentCourseLessonsRequest.new(params).to_h
        non_body_param_names = %w[lesson_id]
        body = request_data.except(*non_body_param_names)

        request = Whop_sdk::Internal::JSON::Request.new(
          base_url: request_options[:base_url] || @base_url || @environment&.dig(:api),
          method: "POST",
          path: "course_lessons/#{URI.encode_uri_component(params[:lesson_id].to_s)}/submit_assessment",
          body: body,
          request_options: request_options
        )
        begin
