...
module Whop_sdk
  module Ledgers
    class Client
      ...
      # @option params [Whop_sdk::Ledgers::Types::GetFinancialReportRequestReportType] :report_type
      ...
      # @option params [Whop_sdk::Ledgers::Types::GetFinancialReportRequestGroupBy, nil] :group_by
      ...
      #   )
      #
      # @return [Whop_sdk::Ledgers::Types::GetFinancialReportResponse]
      def get_financial_report(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          Whop_sdk::Ledgers::Types::GetFinancialReportResponse.load(response.body)
        else
