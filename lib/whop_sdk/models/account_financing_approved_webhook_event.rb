  ...
  module Models
    class AccountFinancingApprovedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   one.
        #
        #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy, nil]
        required :cancellation_policy,
                 -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy },
                 nil?: true
        ...
        #   one.
        #
        #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy, nil]
        required :shipping_policy,
                 -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy },
                 nil?: true
        ...
        #   other responses.
        #
        #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner, nil]
        optional :partner, -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Partner }, nil?: true

        # @!attribute rewards
        #
        #   @return [Array<WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward>, nil]
        optional :rewards,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Reward] }
        ...
        #
        #   @param cancellation_policy [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy, nil] The account's cancellation policy document, or `null` if they have not published
        #
        ...
        #
        #   @param cards [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Cards, nil] Whop Cards application details for the account. Returned on `list`, `retrieve`,
        #
        ...
        #
        #   @param shipping_policy [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy, nil] The account's shipping policy document, or `null` if they have not published one
        #
        ...
        #
        #   @param three_ds_level [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ThreeDSLevel, nil] 3D Secure behavior for supported on-session card payments. `mandate_challenge` r
        #
        ...
        #
        #   @param partner [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner, nil] The account's active first-tier partner. Present on retrieve responses; null whe
        #
        #   @param rewards [Array<WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward>]
        ...
        # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data#cancellation_policy
        class CancellationPolicy < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::UploadStatus]
          required :upload_status,
                   enum: -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::UploadStatus }
          ...
          #   expiring URL.
          #
          #   @return [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::Visibility]
          required :visibility,
                   enum: -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::Visibility }
          ...
          #
          #   @return [Array<WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL>, nil]
          optional :multipart_upload_urls,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL]
                   },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy}
          #   for more details.
          #
          #   The account's cancellation policy document, or `null` if they have not published
          #   one.
          ...
          #
          #   @param upload_status [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::UploadStatus] Where the file is in its upload lifecycle.
          #
          #   @param url [String, nil] A URL to download the file: a permanent CDN URL for public files, a signed expir
          #
          #   @param visibility [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::Visibility] `public` files are served via an unsigned CDN URL; `private` files via a signed,
          #
          ...
          #
          #   @param multipart_upload_urls [Array<WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL>, nil]
          #
          ...
          # Where the file is in its upload lifecycle.
          #
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy#upload_status
          module UploadStatus
          ...
          # expiring URL.
          #
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy#visibility
          module Visibility
            extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data#shipping_policy
        class ShippingPolicy < WhopSDK::Internal::Type::BaseModel
          ...
          #   Where the file is in its upload lifecycle.
          #
          #   @return [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::UploadStatus]
          required :upload_status,
                   enum: -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::UploadStatus }
          ...
          #   expiring URL.
          #
          #   @return [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::Visibility]
          required :visibility,
                   enum: -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::Visibility }
          ...
          # @!attribute multipart_upload_urls
          #
          #   @return [Array<WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL>, nil]
          optional :multipart_upload_urls,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL]
                   },
                   nil?: true
          ...
          # @!method initialize(id:, content_type:, created_at:, filename:, object:, size:, upload_status:, url:, visibility:, multipart_chunk_size: nil, multipart_upload_id: nil, multipart_upload_urls: nil, upload_headers: nil, upload_url: nil)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy}
          #   for more details.
          #
          #   The account's shipping policy document, or `null` if they have not published
          #   one.
          ...
          #   @param size [Integer, nil] The file size in bytes. `null` until the upload has finished.
          #
          #   @param upload_status [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::UploadStatus] Where the file is in its upload lifecycle.
          #
          #   @param url [String, nil] A URL to download the file: a permanent CDN URL for public files, a signed expir
          #
          #   @param visibility [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::Visibility] `public` files are served via an unsigned CDN URL; `private` files via a signed,
          #
          #   @param multipart_chunk_size [Integer, nil] The byte size each part (except the last) must be. Present only on create, and o
          #
          #   @param multipart_upload_id [String, nil] The ID of the multipart upload, passed back to `complete`. Present only on creat
          #
          #   @param multipart_upload_urls [Array<WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL>, nil]
          #
          #   @param upload_headers [Object] Headers to send with the upload PUT. Present only on create.
          #
          #   @param upload_url [String, nil] Presigned URL to PUT the file's bytes to. Present only on create, and only for s
          ...
          # Where the file is in its upload lifecycle.
          #
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy#upload_status
          module UploadStatus
            extend WhopSDK::Internal::Type::Enum
          ...
          # expiring URL.
          #
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy#visibility
          module Visibility
            extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data#partner
        class Partner < WhopSDK::Internal::Type::BaseModel
          ...
          #   the user set no picture.
          #
          #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner::ProfilePicture]
          required :profile_picture,
                   -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Partner::ProfilePicture }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner} for more
          #   details.
          #
          #   The account's active first-tier partner. Present on retrieve responses; null
          #   when no active first-tier partner is attributed to the account. Omitted from
          ...
          #   @param name [String, nil] Display name.
          #
          #   @param profile_picture [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner::ProfilePicture] Avatar wrapper; its `url` is always present, using a generated placeholder when
          #
          #   @param username [String] Public username.

          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner#profile_picture
          class ProfilePicture < WhopSDK::Internal::Type::BaseModel
            # @!attribute url
            #   Avatar image URL. Always present — a generated placeholder when the user set no
            #   picture.
            ...
            # @!method initialize(url:)
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Partner::ProfilePicture}
            #   for more details.
            #
            #   Avatar wrapper; its `url` is always present, using a generated placeholder when
            #   the user set no picture.
        ...
        class Reward < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationAmount]
          ...
          #
          #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationProgress]
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationType]
          required :qualification_type,
                   enum: -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationType }

          # @!attribute reward_amount
          #   USD balance credit for this reward. Uses the saved grant amount once fulfillment
          #   has started.
          #
          #   @return [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::RewardAmount]
          required :reward_amount, -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Reward::RewardAmount }
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::Status]
          required :status, enum: -> { WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Reward::Status }

          # @!method initialize(id:, qualification_amount:, qualification_progress:, qualification_type:, reward_amount:, status:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward} for more
          #   details.
          #
          ...
          #
          #   @param qualification_amount [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationAmount] Qualifying USD volume required to earn this reward.
          #
          #   @param qualification_progress [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationProgress] Qualifying USD volume for the reward’s activity accumulated by this account sinc
          #
          #   @param qualification_type [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationType] Activity that qualifies this account for the reward.
          #
          #   @param reward_amount [WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::RewardAmount] USD balance credit for this reward. Uses the saved grant amount once fulfillment
          #
          #   @param status [Symbol, WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::Status] This account's reward state. Credited requires a posted ledger entry; processing

          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward#qualification_amount
          class QualificationAmount < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationAmount}
            #   for more details.
            #
            #   Qualifying USD volume required to earn this reward.
            #
          ...
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward#qualification_progress
          class QualificationProgress < WhopSDK::Internal::Type::BaseModel
            ...
            # @!method initialize(amount:, currency:, decimals:, display_decimals:)
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::QualificationProgress}
            #   for more details.
            #
            #   Qualifying USD volume for the reward’s activity accumulated by this account
            #   since attribution, calculated using the fulfillment rules.
          ...
          # Activity that qualifies this account for the reward.
          #
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward#qualification_type
          ...
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward#reward_amount
          class RewardAmount < WhopSDK::Internal::Type::BaseModel
            ...
            # @!method initialize(amount:, currency:, decimals:, display_decimals:)
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward::RewardAmount}
            #   for more details.
            #
            #   USD balance credit for this reward. Uses the saved grant amount once fulfillment
            #   has started.
          ...
          # a subsequent reward reversal.
          #
          # @see WhopSDK::Models::AccountFinancingApprovedWebhookEvent::Data::Reward#status
          module Status
            extend WhopSDK::Internal::Type::Enum
