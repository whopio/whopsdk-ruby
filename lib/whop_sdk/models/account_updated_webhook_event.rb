  ...
  module Models
    class AccountUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   one.
        #
        #   @return [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy, nil]
        ...
        #   one.
        #
        #   @return [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy, nil]
        ...
        #
        #   @param cancellation_policy [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy, nil] The account's cancellation policy document, or `null` if they have not published
        #
        ...
        #
        #   @param cards [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::Cards, nil] Whop Cards application details for the account. Returned on `list`, `retrieve`,
        #
        ...
        #
        #   @param shipping_policy [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy, nil] The account's shipping policy document, or `null` if they have not published one
        #
        ...
        #
        #   @param three_ds_level [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ThreeDSLevel, nil] 3D Secure behavior for supported on-session card payments. `mandate_challenge` r
        #
        ...
        # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data#cancellation_policy
        class CancellationPolicy < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy::UploadStatus]
          required :upload_status,
                   enum: -> { WhopSDK::AccountUpdatedWebhookEvent::Data::CancellationPolicy::UploadStatus }
          ...
          #   expiring URL.
          #
          #   @return [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy::Visibility]
          required :visibility,
                   enum: -> { WhopSDK::AccountUpdatedWebhookEvent::Data::CancellationPolicy::Visibility }
          ...
          #
          #   @return [Array<WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL>, nil]
          optional :multipart_upload_urls,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AccountUpdatedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL]
                   },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy} for more
          #   details.
          #
          #   The account's cancellation policy document, or `null` if they have not published
          #   one.
          ...
          #
          #   @param upload_status [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy::UploadStatus] Where the file is in its upload lifecycle.
          #
          #   @param url [String, nil] A URL to download the file: a permanent CDN URL for public files, a signed expir
          #
          #   @param visibility [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy::Visibility] `public` files are served via an unsigned CDN URL; `private` files via a signed,
          #
          ...
          #
          #   @param multipart_upload_urls [Array<WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL>, nil]
          #
          ...
          # Where the file is in its upload lifecycle.
          #
          # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy#upload_status
          module UploadStatus
          ...
          # expiring URL.
          #
          # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data::CancellationPolicy#visibility
          module Visibility
            extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data#shipping_policy
        class ShippingPolicy < WhopSDK::Internal::Type::BaseModel
          ...
          #   Where the file is in its upload lifecycle.
          #
          #   @return [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy::UploadStatus]
          required :upload_status,
                   enum: -> { WhopSDK::AccountUpdatedWebhookEvent::Data::ShippingPolicy::UploadStatus }
          ...
          #   expiring URL.
          #
          #   @return [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy::Visibility]
          required :visibility, enum: -> { WhopSDK::AccountUpdatedWebhookEvent::Data::ShippingPolicy::Visibility }
          ...
          # @!attribute multipart_upload_urls
          #
          #   @return [Array<WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL>, nil]
          optional :multipart_upload_urls,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AccountUpdatedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL]
                   },
                   nil?: true
          ...
          # @!method initialize(id:, content_type:, created_at:, filename:, object:, size:, upload_status:, url:, visibility:, multipart_chunk_size: nil, multipart_upload_id: nil, multipart_upload_urls: nil, upload_headers: nil, upload_url: nil)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy} for more
          #   details.
          #
          #   The account's shipping policy document, or `null` if they have not published
          #   one.
          ...
          #   @param size [Integer, nil] The file size in bytes. `null` until the upload has finished.
          #
          #   @param upload_status [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy::UploadStatus] Where the file is in its upload lifecycle.
          #
          #   @param url [String, nil] A URL to download the file: a permanent CDN URL for public files, a signed expir
          #
          #   @param visibility [Symbol, WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy::Visibility] `public` files are served via an unsigned CDN URL; `private` files via a signed,
          #
          #   @param multipart_chunk_size [Integer, nil] The byte size each part (except the last) must be. Present only on create, and o
          #
          #   @param multipart_upload_id [String, nil] The ID of the multipart upload, passed back to `complete`. Present only on creat
          #
          #   @param multipart_upload_urls [Array<WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL>, nil]
          #
          #   @param upload_headers [Object] Headers to send with the upload PUT. Present only on create.
          #
          #   @param upload_url [String, nil] Presigned URL to PUT the file's bytes to. Present only on create, and only for s
          ...
          # Where the file is in its upload lifecycle.
          #
          # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy#upload_status
          module UploadStatus
            extend WhopSDK::Internal::Type::Enum
          ...
          # expiring URL.
          #
          # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data::ShippingPolicy#visibility
          module Visibility
            extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data#partner
        class Partner < WhopSDK::Internal::Type::BaseModel
          ...
          #   the user set no picture.
          #
          #   @return [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::Partner::ProfilePicture]
          required :profile_picture, -> { WhopSDK::AccountUpdatedWebhookEvent::Data::Partner::ProfilePicture }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AccountUpdatedWebhookEvent::Data::Partner} for more details.
          #
          #   The account's active first-tier partner. Present on retrieve responses; null
          #   when no active first-tier partner is attributed to the account. Omitted from
          #   other responses.
          ...
          #   @param name [String, nil] Display name.
          #
          #   @param profile_picture [WhopSDK::Models::AccountUpdatedWebhookEvent::Data::Partner::ProfilePicture] Avatar wrapper; its `url` is always present, using a generated placeholder when
          #
          #   @param username [String] Public username.

          # @see WhopSDK::Models::AccountUpdatedWebhookEvent::Data::Partner#profile_picture
          class ProfilePicture < WhopSDK::Internal::Type::BaseModel
            # @!attribute url
            #   Avatar image URL. Always present — a generated placeholder when the user set no
            #   picture.
            ...
            # @!method initialize(url:)
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AccountUpdatedWebhookEvent::Data::Partner::ProfilePicture} for
            #   more details.
            #
            #   Avatar wrapper; its `url` is always present, using a generated placeholder when
            #   the user set no picture.
