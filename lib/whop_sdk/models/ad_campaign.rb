...
module WhopSDK
  module Models
    ...
    class AdCampaign < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, budget:, budget_type:, clicks:, cost_per_lead:, cost_per_purchase:, cost_per_result:, cpc:, cpm:, created_at:, ctr:, frequency:, impressions:, issues:, leads:, platform:, purchase_value:, purchases:, reach:, roas:, spend:, spend_currency:, status:, title:, unique_ctr:, updated_at:)
