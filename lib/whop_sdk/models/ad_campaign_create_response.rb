...
module WhopSDK
  module Models
    ...
    class AdCampaignCreateResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #   card)
      #
      #   @return [WhopSDK::Models::AdCampaignCreateResponse::BillingLedgerAccount, nil]
      required :billing_ledger_account,
               -> { WhopSDK::Models::AdCampaignCreateResponse::BillingLedgerAccount },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignCreateResponse::Config, nil]
      required :config, -> { WhopSDK::Models::AdCampaignCreateResponse::Config }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser]
      required :created_by_user, -> { WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser }
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Status]
      required :status, enum: -> { WhopSDK::Models::AdCampaignCreateResponse::Status }
      ...
      #   {WhopSDK::Models::AdCampaignCreateResponse} for more details.
      #
      ...
      #
      #   @param billing_ledger_account [WhopSDK::Models::AdCampaignCreateResponse::BillingLedgerAccount, nil] The ledger account being charged for platform balance billing (null if using car
      #
      #   @param clicks_count [Integer] Number of clicks
      #
      #   @param config [WhopSDK::Models::AdCampaignCreateResponse::Config, nil] Meta campaign configuration (objective, budget, bidding, etc.). Null for non-Met
      #
      #   @param created_at [Time] The datetime the ad campaign was created.
      #
      #   @param created_by_user [WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser] The user who created the campaign
      #
      ...
      #
      #   @param platform [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Platform, nil] The platforms where an ad campaign can run.
      #
      #   @param product [WhopSDK::Models::AdCampaignCreateResponse::Product, nil] The access pass being promoted. Null for campaigns that don't target a specific
      #
      ...
      #
      #   @param status [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Status] Current status of the campaign (active, paused, or inactive)
      #
      ...
      # @see WhopSDK::Models::AdCampaignCreateResponse#config
      class Config < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Config::BidStrategy, nil]
        required :bid_strategy,
                 enum: -> { WhopSDK::Models::AdCampaignCreateResponse::Config::BidStrategy },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Config::Objective, nil]
        required :objective, enum: -> { WhopSDK::Models::AdCampaignCreateResponse::Config::Objective }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Config::Status, nil]
        required :status, enum: -> { WhopSDK::Models::AdCampaignCreateResponse::Config::Status }, nil?: true

        # @!method initialize(bid_amount:, bid_strategy:, budget_optimization:, end_time:, objective:, special_categories:, start_time:, status:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignCreateResponse::Config} for more details.
        #
        #   Meta campaign configuration (objective, budget, bidding, etc.). Null for
        #   non-Meta campaigns — use `tiktokConfig` for TikTok.
        #
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Config::BidStrategy, nil] The bidding strategy used to optimize spend for this campaign.
        #
        ...
        #
        #   @param objective [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Config::Objective, nil] The campaign objective that determines how Meta optimizes delivery.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdCampaignCreateResponse::Config::Status, nil] The campaign status as set by the advertiser (active or paused).

        # The bidding strategy used to optimize spend for this campaign.
        #
        # @see WhopSDK::Models::AdCampaignCreateResponse::Config#bid_strategy
        module BidStrategy
        ...
        # The campaign objective that determines how Meta optimizes delivery.
        #
        # @see WhopSDK::Models::AdCampaignCreateResponse::Config#objective
        module Objective
          extend WhopSDK::Internal::Type::Enum
        ...
        # The campaign status as set by the advertiser (active or paused).
        #
        # @see WhopSDK::Models::AdCampaignCreateResponse::Config#status
        module Status
          extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::AdCampaignCreateResponse#created_by_user
      ...
      # The payment method used for daily billing (null if using platform balance)
      #
      # @see WhopSDK::Models::AdCampaignCreateResponse#payment_method
      module PaymentMethod
        ...
        variant :BasePaymentMethod,
                -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::BasePaymentMethod }

        # A saved card payment method, including brand, last four digits, and expiration details.
        variant :CardPaymentMethod,
                -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod }
        ...
        variant :UsBankAccountPaymentMethod,
                -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod }

        # A saved Cash App payment method, including the buyer's cashtag and unique identifier.
        variant :CashappPaymentMethod,
                -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod }

        # A saved iDEAL payment method, including the customer's bank name and BIC code.
        variant :IdealPaymentMethod,
                -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod }
        ...
        variant :SepaDebitPaymentMethod,
                -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod }
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod::Card]
          required :card, -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod::Card }
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param card [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod::Card] The card-specific details for this payment method, including brand, last four di
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod#card
          class Card < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod::Card}
            #   for more details.
            #
            #   The card-specific details for this payment method, including brand, last four
            #   digits, and expiration.
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount]
          required :us_bank_account,
                   -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount }
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param us_bank_account [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount] The bank account-specific details for this payment method, including bank name a
          #
          #   @param typename [Symbol, :UsBankAccountPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod#us_bank_account
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #   buyer ID.
          #
          #   @return [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod::Cashapp]
          required :cashapp,
                   -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod::Cashapp }
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param cashapp [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod::Cashapp] The Cash App-specific details for this payment method, including cashtag and buy
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod#cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod::Ideal]
          required :ideal,
                   -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod::Ideal }
          ...
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param ideal [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod::Ideal] The iDEAL-specific details for this payment method, including bank name and BIC.
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param typename [Symbol, :IdealPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod#ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit]
          required :sepa_debit,
                   -> { WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit }
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param sepa_debit [WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit] The SEPA Direct Debit-specific details for this payment method, including bank c
          #
          #   @param typename [Symbol, :SepaDebitPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod#sepa_debit
        ...
        #   @return [Array(WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::BasePaymentMethod, WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod, WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod, WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod, WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod, WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod)]
      end

      # The platforms where an ad campaign can run.
      #
      # @see WhopSDK::Models::AdCampaignCreateResponse#platform
      module Platform
        extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::AdCampaignCreateResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignCreateResponse::Product} for more details.
        #
        #   The access pass being promoted. Null for campaigns that don't target a specific
        #   product.
        #
      ...
      # Current status of the campaign (active, paused, or inactive)
      #
      # @see WhopSDK::Models::AdCampaignCreateResponse#status
      module Status
        extend WhopSDK::Internal::Type::Enum
