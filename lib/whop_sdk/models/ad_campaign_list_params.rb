...
module WhopSDK
  module Models
    ...
    class AdCampaignListParams < WhopSDK::Internal::Type::BaseModel
      ...
      #   otherwise.
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignListParams::AttributionModel, nil]
      ...
      # @!method initialize(account_id: nil, after: nil, attribution_model: nil, before: nil, created_after: nil, created_before: nil, direction: nil, first: nil, last: nil, order: nil, query: nil, stats_from: nil, stats_to: nil, status: nil, time_zone: nil, api_version_date: nil, request_options: {})
