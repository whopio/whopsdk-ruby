...
module WhopSDK
  module Models
    ...
    class AdCampaignListParams < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(after: nil, before: nil, company_id: nil, created_after: nil, created_before: nil, first: nil, include_paused: nil, last: nil, query: nil, status: nil, request_options: {})
