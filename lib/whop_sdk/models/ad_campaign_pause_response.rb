...
module WhopSDK
  module Models
    ...
    class AdCampaignPauseResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   card)
      #
      #   @return [WhopSDK::Models::AdCampaignPauseResponse::BillingLedgerAccount, nil]
      required :billing_ledger_account,
               -> { WhopSDK::Models::AdCampaignPauseResponse::BillingLedgerAccount },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignPauseResponse::Config, nil]
      required :config, -> { WhopSDK::Models::AdCampaignPauseResponse::Config }, nil?: true
      ...
      required :payment_method, union: -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod }

      # @!attribute platform
      #   The platforms where an ad campaign can run.
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Platform, nil]
      required :platform, enum: -> { WhopSDK::Models::AdCampaignPauseResponse::Platform }, nil?: true

      # @!attribute product
      #   The access pass being promoted. Null for campaigns that don't target a specific
      #   product.
      #
      #   @return [WhopSDK::Models::AdCampaignPauseResponse::Product, nil]
      required :product, -> { WhopSDK::Models::AdCampaignPauseResponse::Product }, nil?: true
      ...
      #
      #   @param billing_ledger_account [WhopSDK::Models::AdCampaignPauseResponse::BillingLedgerAccount, nil] The ledger account being charged for platform balance billing (null if using car
      #
      #   @param clicks_count [Integer] Number of clicks
      #
      #   @param config [WhopSDK::Models::AdCampaignPauseResponse::Config, nil] Meta campaign configuration (objective, budget, bidding, etc.). Null for non-Met
      #
      #   @param created_at [Time] The datetime the ad campaign was created.
      #
      #   @param created_by_user [WhopSDK::Models::AdCampaignPauseResponse::CreatedByUser] The user who created the campaign
      #
      ...
      #
      #   @param platform [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Platform, nil] The platforms where an ad campaign can run.
      #
      #   @param product [WhopSDK::Models::AdCampaignPauseResponse::Product, nil] The access pass being promoted. Null for campaigns that don't target a specific
      #
      ...
      # @see WhopSDK::Models::AdCampaignPauseResponse#billing_ledger_account
      ...
      # @see WhopSDK::Models::AdCampaignPauseResponse#config
      class Config < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Config::BidStrategy, nil]
        required :bid_strategy,
                 enum: -> { WhopSDK::Models::AdCampaignPauseResponse::Config::BidStrategy },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Config::Objective, nil]
        required :objective, enum: -> { WhopSDK::Models::AdCampaignPauseResponse::Config::Objective }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Config::Status, nil]
        required :status, enum: -> { WhopSDK::Models::AdCampaignPauseResponse::Config::Status }, nil?: true

        # @!method initialize(bid_amount:, bid_strategy:, budget_optimization:, end_time:, objective:, special_categories:, start_time:, status:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignPauseResponse::Config} for more details.
        #
        #   Meta campaign configuration (objective, budget, bidding, etc.). Null for
        #   non-Meta campaigns — use `tiktokConfig` for TikTok.
        #
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Config::BidStrategy, nil] The bidding strategy used to optimize spend for this campaign.
        #
        ...
        #
        #   @param objective [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Config::Objective, nil] The campaign objective that determines how Meta optimizes delivery.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdCampaignPauseResponse::Config::Status, nil] The campaign status as set by the advertiser (active or paused).

        # The bidding strategy used to optimize spend for this campaign.
        #
        # @see WhopSDK::Models::AdCampaignPauseResponse::Config#bid_strategy
        module BidStrategy
        ...
        # The campaign objective that determines how Meta optimizes delivery.
        #
        # @see WhopSDK::Models::AdCampaignPauseResponse::Config#objective
        module Objective
          extend WhopSDK::Internal::Type::Enum
        ...
        # The campaign status as set by the advertiser (active or paused).
        #
        # @see WhopSDK::Models::AdCampaignPauseResponse::Config#status
        module Status
          extend WhopSDK::Internal::Type::Enum
      ...
      # The payment method used for daily billing (null if using platform balance)
      #
      # @see WhopSDK::Models::AdCampaignPauseResponse#payment_method
      module PaymentMethod
        ...
        variant :BasePaymentMethod,
                -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::BasePaymentMethod }

        # A saved card payment method, including brand, last four digits, and expiration details.
        variant :CardPaymentMethod,
                -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod }
        ...
        variant :UsBankAccountPaymentMethod,
                -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod }

        # A saved Cash App payment method, including the buyer's cashtag and unique identifier.
        variant :CashappPaymentMethod,
                -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod }

        # A saved iDEAL payment method, including the customer's bank name and BIC code.
        variant :IdealPaymentMethod,
                -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod }
        ...
        variant :SepaDebitPaymentMethod,
                -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod }
        ...
        class BasePaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::BasePaymentMethod} for
          #   more details.
          #
          #   A saved payment method with no type-specific details available.
          #
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod::Card]
          required :card, -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod::Card }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod} for
          #   more details.
          #
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param card [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod::Card] The card-specific details for this payment method, including brand, last four di
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod#card
          class Card < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod::Card}
            #   for more details.
            #
            #   The card-specific details for this payment method, including brand, last four
            #   digits, and expiration.
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount]
          required :us_bank_account,
                   -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount }
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param us_bank_account [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount] The bank account-specific details for this payment method, including bank name a
          #
          #   @param typename [Symbol, :UsBankAccountPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod#us_bank_account
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #   buyer ID.
          #
          #   @return [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod::Cashapp]
          required :cashapp,
                   -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod::Cashapp }
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param cashapp [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod::Cashapp] The Cash App-specific details for this payment method, including cashtag and buy
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod#cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod::Ideal]
          required :ideal, -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod::Ideal }
          ...
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param ideal [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod::Ideal] The iDEAL-specific details for this payment method, including bank name and BIC.
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param typename [Symbol, :IdealPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod#ideal
          class Ideal < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod::Ideal}
            #   for more details.
            #
            #   The iDEAL-specific details for this payment method, including bank name and BIC.
            #
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit]
          required :sepa_debit,
                   -> { WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit }
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param sepa_debit [WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit] The SEPA Direct Debit-specific details for this payment method, including bank c
          #
          #   @param typename [Symbol, :SepaDebitPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod#sepa_debit
        ...
        #   @return [Array(WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::BasePaymentMethod, WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod, WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod, WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod, WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod, WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod)]
      end
      ...
      # @see WhopSDK::Models::AdCampaignPauseResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignPauseResponse::Product} for more details.
        #
        #   The access pass being promoted. Null for campaigns that don't target a specific
        #   product.
        #
