...
module WhopSDK
  module Models
    ...
    class AdCampaignRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   card)
      #
      #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::BillingLedgerAccount, nil]
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::Config, nil]
      required :config, -> { WhopSDK::Models::AdCampaignRetrieveResponse::Config }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::CreatedByUser]
      required :created_by_user, -> { WhopSDK::Models::AdCampaignRetrieveResponse::CreatedByUser }
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::BasePaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CardPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::UsBankAccountPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CashappPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::IdealPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::SepaDebitPaymentMethod, nil]
      required :payment_method, union: -> { WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod }

      # @!attribute platform
      #   The platforms where an ad campaign can run.
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Platform, nil]
      required :platform, enum: -> { WhopSDK::Models::AdCampaignRetrieveResponse::Platform }, nil?: true

      # @!attribute product
      #   The access pass being promoted. Null for campaigns that don't target a specific
      #   product.
      #
      #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::Product, nil]
      required :product, -> { WhopSDK::Models::AdCampaignRetrieveResponse::Product }, nil?: true
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Status]
      required :status, enum: -> { WhopSDK::Models::AdCampaignRetrieveResponse::Status }
      ...
      #   {WhopSDK::Models::AdCampaignRetrieveResponse} for more details.
      #
      ...
      #
      #   @param billing_ledger_account [WhopSDK::Models::AdCampaignRetrieveResponse::BillingLedgerAccount, nil] The ledger account being charged for platform balance billing (null if using car
      #
      #   @param clicks_count [Integer] Number of clicks
      #
      #   @param config [WhopSDK::Models::AdCampaignRetrieveResponse::Config, nil] Meta campaign configuration (objective, budget, bidding, etc.). Null for non-Met
      #
      #   @param created_at [Time] The datetime the ad campaign was created.
      #
      #   @param created_by_user [WhopSDK::Models::AdCampaignRetrieveResponse::CreatedByUser] The user who created the campaign
      #
      ...
      #
      #   @param platform [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Platform, nil] The platforms where an ad campaign can run.
      #
      #   @param product [WhopSDK::Models::AdCampaignRetrieveResponse::Product, nil] The access pass being promoted. Null for campaigns that don't target a specific
      #
      ...
      #
      #   @param status [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Status] Current status of the campaign (active, paused, or inactive)
      #
      ...
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#billing_ledger_account
      ...
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#config
      class Config < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Config::BidStrategy, nil]
        required :bid_strategy,
                 enum: -> { WhopSDK::Models::AdCampaignRetrieveResponse::Config::BidStrategy },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Config::Objective, nil]
        required :objective,
                 enum: -> { WhopSDK::Models::AdCampaignRetrieveResponse::Config::Objective },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Config::Status, nil]
        required :status, enum: -> { WhopSDK::Models::AdCampaignRetrieveResponse::Config::Status }, nil?: true

        # @!method initialize(bid_amount:, bid_strategy:, budget_optimization:, end_time:, objective:, special_categories:, start_time:, status:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignRetrieveResponse::Config} for more details.
        #
        #   Meta campaign configuration (objective, budget, bidding, etc.). Null for
        #   non-Meta campaigns — use `tiktokConfig` for TikTok.
        #
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Config::BidStrategy, nil] The bidding strategy used to optimize spend for this campaign.
        #
        ...
        #
        #   @param objective [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Config::Objective, nil] The campaign objective that determines how Meta optimizes delivery.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdCampaignRetrieveResponse::Config::Status, nil] The campaign status as set by the advertiser (active or paused).

        # The bidding strategy used to optimize spend for this campaign.
        #
        # @see WhopSDK::Models::AdCampaignRetrieveResponse::Config#bid_strategy
        module BidStrategy
        ...
        # The campaign objective that determines how Meta optimizes delivery.
        #
        # @see WhopSDK::Models::AdCampaignRetrieveResponse::Config#objective
        module Objective
          extend WhopSDK::Internal::Type::Enum
        ...
        # The campaign status as set by the advertiser (active or paused).
        #
        # @see WhopSDK::Models::AdCampaignRetrieveResponse::Config#status
        module Status
          extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#created_by_user
      ...
      # The payment method used for daily billing (null if using platform balance)
      #
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#payment_method
      module PaymentMethod
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CardPaymentMethod::Card]
          required :card, -> { WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CardPaymentMethod::Card }
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param card [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CardPaymentMethod::Card] The card-specific details for this payment method, including brand, last four di
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CardPaymentMethod#card
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount]
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param us_bank_account [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount] The bank account-specific details for this payment method, including bank name a
          #
          #   @param typename [Symbol, :UsBankAccountPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::UsBankAccountPaymentMethod#us_bank_account
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #   buyer ID.
          #
          #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CashappPaymentMethod::Cashapp]
          required :cashapp,
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param cashapp [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CashappPaymentMethod::Cashapp] The Cash App-specific details for this payment method, including cashtag and buy
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CashappPaymentMethod#cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::IdealPaymentMethod::Ideal]
          required :ideal,
          ...
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param ideal [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::IdealPaymentMethod::Ideal] The iDEAL-specific details for this payment method, including bank name and BIC.
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param typename [Symbol, :IdealPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::IdealPaymentMethod#ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit]
          required :sepa_debit,
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param sepa_debit [WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit] The SEPA Direct Debit-specific details for this payment method, including bank c
          #
          #   @param typename [Symbol, :SepaDebitPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::SepaDebitPaymentMethod#sepa_debit
        ...
        #   @return [Array(WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::BasePaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CardPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::UsBankAccountPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::CashappPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::IdealPaymentMethod, WhopSDK::Models::AdCampaignRetrieveResponse::PaymentMethod::SepaDebitPaymentMethod)]
      end

      # The platforms where an ad campaign can run.
      #
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#platform
      module Platform
        extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignRetrieveResponse::Product} for more details.
        #
        #   The access pass being promoted. Null for campaigns that don't target a specific
        #   product.
        #
      ...
      # Current status of the campaign (active, paused, or inactive)
      #
      # @see WhopSDK::Models::AdCampaignRetrieveResponse#status
      module Status
        extend WhopSDK::Internal::Type::Enum
