...
module WhopSDK
  module Models
    ...
    class AdCampaignUnpauseResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::BudgetType, nil]
      required :budget_type, enum: -> { WhopSDK::Models::AdCampaignUnpauseResponse::BudgetType }, nil?: true
      ...
      #   non-Meta campaigns.
      #
      #   @return [WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig, nil]
      required :meta_config, -> { WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig }, nil?: true

      # @!attribute platform
      #   The external ad platform this campaign is running on (e.g., meta, tiktok).
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::Platform]
      ...
      #
      #   @param budget_type [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::BudgetType, nil] The budget type for an ad campaign or ad group.
      #
      #   @param created_at [Time] When the ad campaign was created.
      #
      #   @param created_by_user [WhopSDK::Models::AdCampaignUnpauseResponse::CreatedByUser] The user who created this ad campaign.
      #
      #   @param meta_config [WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig, nil] Meta-specific campaign configuration (objective, budget mode, etc.). Null for no
      #
      #   @param platform [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::Platform] The external ad platform this campaign is running on (e.g., meta, tiktok).
      #
      ...
      # The budget type for an ad campaign or ad group.
      #
      # @see WhopSDK::Models::AdCampaignUnpauseResponse#budget_type
      module BudgetType
      ...
      # @see WhopSDK::Models::AdCampaignUnpauseResponse#meta_config
      class MetaConfig < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::BidStrategy, nil]
        required :bid_strategy,
                 enum: -> { WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::BidStrategy },
                 nil?: true
        ...
        #   rejected).
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::EffectiveStatus, nil]
        required :effective_status,
                 enum: -> { WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::EffectiveStatus },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::Objective, nil]
        required :objective,
                 enum: -> { WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::Objective },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::Status, nil]
        required :status, enum: -> { WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::Status }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig} for more details.
        #
        #   Meta-specific campaign configuration (objective, budget mode, etc.). Null for
        #   non-Meta campaigns.
        #
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::BidStrategy, nil] The bidding strategy used to optimize spend for this campaign.
        #
        #   @param budget_optimization [Boolean, nil] Whether campaign budget optimization (CBO) is enabled, allowing the platform to
        #
        #   @param effective_status [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::EffectiveStatus, nil] The actual delivery status, accounting for platform overrides (e.g., in_review,
        #
        #   @param end_time [String, nil] The scheduled end time of the campaign (ISO8601).
        #
        #   @param objective [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::Objective, nil] The campaign objective that determines how Meta optimizes delivery.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig::Status, nil] The campaign status as set by the advertiser (active or paused).

        # The bidding strategy used to optimize spend for this campaign.
        #
        # @see WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig#bid_strategy
        module BidStrategy
          extend WhopSDK::Internal::Type::Enum
        ...
        # rejected).
        #
        # @see WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig#effective_status
        ...
        # The campaign objective that determines how Meta optimizes delivery.
        #
        # @see WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig#objective
        module Objective
          extend WhopSDK::Internal::Type::Enum
        ...
        # The campaign status as set by the advertiser (active or paused).
        #
        # @see WhopSDK::Models::AdCampaignUnpauseResponse::MetaConfig#status
        module Status
          extend WhopSDK::Internal::Type::Enum
