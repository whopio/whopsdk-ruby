...
module WhopSDK
  module Models
    ...
    class AdCampaignUpdateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   card)
      #
      #   @return [WhopSDK::Models::AdCampaignUpdateResponse::BillingLedgerAccount, nil]
      required :billing_ledger_account,
               -> { WhopSDK::Models::AdCampaignUpdateResponse::BillingLedgerAccount },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignUpdateResponse::Config, nil]
      required :config, -> { WhopSDK::Models::AdCampaignUpdateResponse::Config }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::BasePaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod, nil]
      required :payment_method, union: -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod }

      # @!attribute platform
      #   The platforms where an ad campaign can run.
      #
      #   @return [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Platform, nil]
      required :platform, enum: -> { WhopSDK::Models::AdCampaignUpdateResponse::Platform }, nil?: true

      # @!attribute product
      #   The access pass being promoted. Null for campaigns that don't target a specific
      #   product.
      #
      #   @return [WhopSDK::Models::AdCampaignUpdateResponse::Product, nil]
      required :product, -> { WhopSDK::Models::AdCampaignUpdateResponse::Product }, nil?: true
      ...
      #
      #   @param billing_ledger_account [WhopSDK::Models::AdCampaignUpdateResponse::BillingLedgerAccount, nil] The ledger account being charged for platform balance billing (null if using car
      #
      #   @param clicks_count [Integer] Number of clicks
      #
      #   @param config [WhopSDK::Models::AdCampaignUpdateResponse::Config, nil] Meta campaign configuration (objective, budget, bidding, etc.). Null for non-Met
      #
      #   @param created_at [Time] The datetime the ad campaign was created.
      #
      #   @param created_by_user [WhopSDK::Models::AdCampaignUpdateResponse::CreatedByUser] The user who created the campaign
      #
      ...
      #
      #   @param platform [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Platform, nil] The platforms where an ad campaign can run.
      #
      #   @param product [WhopSDK::Models::AdCampaignUpdateResponse::Product, nil] The access pass being promoted. Null for campaigns that don't target a specific
      #
      ...
      # @see WhopSDK::Models::AdCampaignUpdateResponse#billing_ledger_account
      ...
      # @see WhopSDK::Models::AdCampaignUpdateResponse#config
      class Config < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Config::BidStrategy, nil]
        required :bid_strategy,
                 enum: -> { WhopSDK::Models::AdCampaignUpdateResponse::Config::BidStrategy },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Config::Objective, nil]
        required :objective, enum: -> { WhopSDK::Models::AdCampaignUpdateResponse::Config::Objective }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Config::Status, nil]
        required :status, enum: -> { WhopSDK::Models::AdCampaignUpdateResponse::Config::Status }, nil?: true

        # @!method initialize(bid_amount:, bid_strategy:, budget_optimization:, end_time:, objective:, special_categories:, start_time:, status:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignUpdateResponse::Config} for more details.
        #
        #   Meta campaign configuration (objective, budget, bidding, etc.). Null for
        #   non-Meta campaigns — use `tiktokConfig` for TikTok.
        #
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Config::BidStrategy, nil] The bidding strategy used to optimize spend for this campaign.
        #
        ...
        #
        #   @param objective [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Config::Objective, nil] The campaign objective that determines how Meta optimizes delivery.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Config::Status, nil] The campaign status as set by the advertiser (active or paused).

        # The bidding strategy used to optimize spend for this campaign.
        #
        # @see WhopSDK::Models::AdCampaignUpdateResponse::Config#bid_strategy
        module BidStrategy
        ...
        # The campaign objective that determines how Meta optimizes delivery.
        #
        # @see WhopSDK::Models::AdCampaignUpdateResponse::Config#objective
        module Objective
          extend WhopSDK::Internal::Type::Enum
        ...
        # The campaign status as set by the advertiser (active or paused).
        #
        # @see WhopSDK::Models::AdCampaignUpdateResponse::Config#status
        module Status
          extend WhopSDK::Internal::Type::Enum
      ...
      # The payment method used for daily billing (null if using platform balance)
      #
      # @see WhopSDK::Models::AdCampaignUpdateResponse#payment_method
      module PaymentMethod
        ...
        variant :BasePaymentMethod,
                -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::BasePaymentMethod }

        # A saved card payment method, including brand, last four digits, and expiration details.
        variant :CardPaymentMethod,
                -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod }
        ...
        variant :UsBankAccountPaymentMethod,
                -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod }
        ...
        variant :IdealPaymentMethod,
                -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod }
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod::Card]
          required :card, -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod::Card }
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param card [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod::Card] The card-specific details for this payment method, including brand, last four di
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod#card
          class Card < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod::Card}
            #   for more details.
            #
            #   The card-specific details for this payment method, including brand, last four
            #   digits, and expiration.
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount]
          required :us_bank_account,
                   -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount }
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param us_bank_account [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount] The bank account-specific details for this payment method, including bank name a
          #
          #   @param typename [Symbol, :UsBankAccountPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod#us_bank_account
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #   buyer ID.
          #
          #   @return [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod::Cashapp]
          required :cashapp,
                   -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod::Cashapp }
          ...
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param cashapp [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod::Cashapp] The Cash App-specific details for this payment method, including cashtag and buy
          #
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          ...
          # @see WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod#cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod::Ideal]
          required :ideal,
                   -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod::Ideal }
          ...
          #   @param created_at [Time] The time of the event in ISO 8601 UTC format with millisecond precision
          #
          #   @param ideal [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod::Ideal] The iDEAL-specific details for this payment method, including bank name and BIC.
          #
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param typename [Symbol, :IdealPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod#ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit]
          required :sepa_debit,
                   -> { WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit }
          ...
          #   @param payment_method_type [Symbol, WhopSDK::Models::PaymentMethodTypes] The type of payment instrument stored on file (e.g., card, us_bank_account, cash
          #
          #   @param sepa_debit [WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit] The SEPA Direct Debit-specific details for this payment method, including bank c
          #
          #   @param typename [Symbol, :SepaDebitPaymentMethod] The typename of this object

          # @see WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod#sepa_debit
        ...
        #   @return [Array(WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::BasePaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod, WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod)]
      end
      ...
      # @see WhopSDK::Models::AdCampaignUpdateResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCampaignUpdateResponse::Product} for more details.
        #
        #   The access pass being promoted. Null for campaigns that don't target a specific
        #   product.
        #
