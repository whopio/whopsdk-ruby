...
module WhopSDK
  module Models
    ...
    class AdCreateParams < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdCreateParams::CallToAction, nil]
      ...
      #
      #   @return [Array<WhopSDK::Models::AdCreateParams::Creative>, nil]
      ...
      #   lead_form_id.
      #
      #   @return [WhopSDK::Models::AdCreateParams::LeadForm, nil]
      ...
      #   (keyword).
      #
      #   @return [WhopSDK::Models::AdCreateParams::MessagingConfig, nil]
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdCreateParams::PostSource, nil]
      ...
      #
      #   @return [Array<WhopSDK::Models::AdCreateParams::SocialAccount>, nil]
      ...
      class Creative < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::AdCreateParams::Creative::Crop, nil]
        optional :crop, -> { WhopSDK::AdCreateParams::Creative::Crop }

        # @!attribute format_
        #
        #   @return [Symbol, WhopSDK::Models::AdCreateParams::Creative::Format, nil]
        optional :format_, enum: -> { WhopSDK::AdCreateParams::Creative::Format }, api_name: :format

        # @!method initialize(id: nil, crop: nil, format_: nil)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCreateParams::Creative} for more details.
        #
        #   @param id [String]
        #
        #   @param crop [WhopSDK::Models::AdCreateParams::Creative::Crop] The saved crop window for this creative, in source image pixels. Omit it for the
        #
        #   @param format_ [Symbol, WhopSDK::Models::AdCreateParams::Creative::Format]

        # @see WhopSDK::Models::AdCreateParams::Creative#crop
        ...
        # @see WhopSDK::Models::AdCreateParams::Creative#format_
        module Format
          extend WhopSDK::Internal::Type::Enum
      ...
      class LeadForm < WhopSDK::Internal::Type::BaseModel
        ...
        #   website button.
        #
        #   @return [WhopSDK::Models::AdCreateParams::LeadForm::Completion, nil]
        ...
        #
        #   @return [WhopSDK::Models::AdCreateParams::LeadForm::Disclaimer, nil]
        ...
        #   step.
        #
        #   @return [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::FormType, nil]
        optional :form_type, enum: -> { WhopSDK::AdCreateParams::LeadForm::FormType }

        # @!attribute intro
        #   Optional intro screen shown before the questions.
        #
        #   @return [WhopSDK::Models::AdCreateParams::LeadForm::Intro, nil]
        ...
        #
        #   @return [WhopSDK::Models::AdCreateParams::LeadForm::PrivacyPolicy, nil]
        ...
        #
        #   @return [Array<WhopSDK::Models::AdCreateParams::LeadForm::Question>, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdCreateParams::LeadForm} for more details.
        #
        #   Instant lead form for the ad. Only allowed when the ad group's
        #   conversion_location is an instant-form destination (instant_forms,
        #   instant_forms_and_messenger, website_and_instant_forms). Mutually exclusive with
        #   lead_form_id.
        #
        #   @param completion [WhopSDK::Models::AdCreateParams::LeadForm::Completion] Optional completion screen shown after submission; url sets the follow-up websit
        #
        #   @param disclaimer [WhopSDK::Models::AdCreateParams::LeadForm::Disclaimer] Optional custom consent disclaimer with checkboxes.
        #
        #   @param form_type [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::FormType] more_volume (default) is quickest to submit; higher_intent adds a confirmation s
        #
        #   @param intro [WhopSDK::Models::AdCreateParams::LeadForm::Intro] Optional intro screen shown before the questions.
        #
        ...
        #
        #   @param privacy_policy [WhopSDK::Models::AdCreateParams::LeadForm::PrivacyPolicy] Your privacy policy. url is required by Meta.
        #
        #   @param questions [Array<WhopSDK::Models::AdCreateParams::LeadForm::Question>] The questions on the form. Standard prefill types need only a type; a custom que

        # @see WhopSDK::Models::AdCreateParams::LeadForm#completion
        ...
        # @see WhopSDK::Models::AdCreateParams::LeadForm#disclaimer
        class Disclaimer < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<WhopSDK::Models::AdCreateParams::LeadForm::Disclaimer::Checkbox>, nil]
          optional :checkboxes,
                   -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdCreateParams::LeadForm::Disclaimer::Checkbox] }
          ...
          #
          #   @param body [String]
          #   @param checkboxes [Array<WhopSDK::Models::AdCreateParams::LeadForm::Disclaimer::Checkbox>]
          #   @param title [String]
        ...
        # step.
        #
        # @see WhopSDK::Models::AdCreateParams::LeadForm#form_type
        module FormType
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AdCreateParams::LeadForm#intro
        ...
        # @see WhopSDK::Models::AdCreateParams::LeadForm#privacy_policy
        ...
        class Question < WhopSDK::Internal::Type::BaseModel
          # @!attribute format_
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::Question::Format, nil]
          optional :format_,
                   enum: -> {
          ...
          # @!attribute options
          #
          #   @return [Array<WhopSDK::Models::AdCreateParams::LeadForm::Question::Option>, nil]
          optional :options,
                   -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdCreateParams::LeadForm::Question::Option] }

          # @!attribute type
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::Question::Type, nil]
          ...
          #   @param format_ [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::Question::Format]
          #   @param label [String]
          #   @param options [Array<WhopSDK::Models::AdCreateParams::LeadForm::Question::Option>]
          #   @param type [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::Question::Type]

          # @see WhopSDK::Models::AdCreateParams::LeadForm::Question#format_
          module Format
            extend WhopSDK::Internal::Type::Enum
          ...
          class Option < WhopSDK::Internal::Type::BaseModel
            ...
            # @!attribute logic
            #
            #   @return [WhopSDK::Models::AdCreateParams::LeadForm::Question::Option::Logic, nil]
            optional :logic, -> { WhopSDK::AdCreateParams::LeadForm::Question::Option::Logic }
            ...
            #   @param key [String]
            #   @param logic [WhopSDK::Models::AdCreateParams::LeadForm::Question::Option::Logic]
            #   @param value [String]

            # @see WhopSDK::Models::AdCreateParams::LeadForm::Question::Option#logic
            class Logic < WhopSDK::Internal::Type::BaseModel
              # @!attribute action
              #
              #   @return [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::Question::Option::Logic::Action, nil]
              optional :action, enum: -> { WhopSDK::AdCreateParams::LeadForm::Question::Option::Logic::Action }
              ...
              #   @param action [Symbol, WhopSDK::Models::AdCreateParams::LeadForm::Question::Option::Logic::Action]
              #   @param target_end_page_index [Integer]
              #   @param target_question_index [Integer]

              # @see WhopSDK::Models::AdCreateParams::LeadForm::Question::Option::Logic#action
              module Action
                extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdCreateParams::LeadForm::Question#type
          module Type
            extend WhopSDK::Internal::Type::Enum
