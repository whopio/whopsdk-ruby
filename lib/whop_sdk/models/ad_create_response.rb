...
module WhopSDK
  module Models
    ...
    class AdCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::AdCreateResponse::ExternalAdCreativeSet, nil]
      ...
      #   The parent ad group.
      #
      #   @return [WhopSDK::Models::AdCreateResponse::ExternalAdGroup]
      required :external_ad_group, -> { WhopSDK::Models::AdCreateResponse::ExternalAdGroup }

      # @!attribute platform_config
      #   Typed platform-specific configuration.
      #
      #   @return [WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType, nil]
      required :platform_config, union: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig }
      ...
      #
      #   @param external_ad_creative_set [WhopSDK::Models::AdCreateResponse::ExternalAdCreativeSet, nil] The creative set used by this ad.
      #
      #   @param external_ad_group [WhopSDK::Models::AdCreateResponse::ExternalAdGroup] The parent ad group.
      #
      #   @param platform_config [WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType, nil] Typed platform-specific configuration.
      #
      #   @param status [Symbol, WhopSDK::Models::AdCreateResponse::Status] Current status of the ad.
      #
      #   @param updated_at [Time] When the ad was last updated.

      # @see WhopSDK::Models::AdCreateResponse#external_ad_creative_set
      ...
      # @see WhopSDK::Models::AdCreateResponse#external_ad_group
      class ExternalAdGroup < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdCreateResponse::ExternalAdGroup::Status]
        required :status, enum: -> { WhopSDK::Models::AdCreateResponse::ExternalAdGroup::Status }
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdCreateResponse::ExternalAdGroup::Status] Current operational status of the ad group

        # Current operational status of the ad group
        #
        # @see WhopSDK::Models::AdCreateResponse::ExternalAdGroup#status
        module Status
      ...
      # Typed platform-specific configuration.
      #
      # @see WhopSDK::Models::AdCreateResponse#platform_config
      module PlatformConfig
        ...
        class MetaAdPlatformConfigType < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType::CallToActionType, nil]
          required :call_to_action_type,
                   enum: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType::CallToActionType },
                   nil?: true
          ...
          #   The ad platform.
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType::Platform]
          required :platform,
                   enum: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType::Platform }
          ...
          #   Meta (Facebook/Instagram) ad configuration.
          #
          #   @param call_to_action_type [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType::CallToActionType, nil]
          #
          ...
          #
          #   @param platform [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType::Platform] The ad platform.
          #
          ...
          # @see WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType#call_to_action_type
          ...
          # The ad platform.
          #
          # @see WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType#platform
          module Platform
            extend WhopSDK::Internal::Type::Enum
        ...
        class TiktokAdPlatformConfigType < WhopSDK::Internal::Type::BaseModel
          # @!attribute ad_format
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::AdFormat, nil]
          required :ad_format,
                   enum: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::AdFormat },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::CallToAction, nil]
          required :call_to_action,
                   enum: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::CallToAction },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::IdentityType, nil]
          required :identity_type,
                   enum: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::IdentityType },
                   nil?: true
          ...
          #   The ad platform.
          #
          #   @return [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::Platform]
          required :platform,
                   enum: -> { WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::Platform }
          ...
          #   TikTok ad configuration.
          #
          #   @param ad_format [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::AdFormat, nil]
          #
          ...
          #
          #   @param call_to_action [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::CallToAction, nil] TikTok call-to-action button text. See docs/tiktok_api/ad.md § call_to_action.
          #
          ...
          #
          #   @param identity_type [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::IdentityType, nil]
          #
          ...
          #
          #   @param platform [Symbol, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType::Platform] The ad platform.
          #
          ...
          # @see WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType#ad_format
          module AdFormat
            extend WhopSDK::Internal::Type::Enum
          ...
          # TikTok call-to-action button text. See docs/tiktok_api/ad.md § call_to_action.
          #
          # @see WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType#call_to_action
          module CallToAction
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType#identity_type
          module IdentityType
            extend WhopSDK::Internal::Type::Enum
          ...
          # The ad platform.
          #
          # @see WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType#platform
          module Platform
            extend WhopSDK::Internal::Type::Enum
        ...
        #   @return [Array(WhopSDK::Models::AdCreateResponse::PlatformConfig::MetaAdPlatformConfigType, WhopSDK::Models::AdCreateResponse::PlatformConfig::TiktokAdPlatformConfigType)]
      end
