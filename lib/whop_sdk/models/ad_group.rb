  ...
  module Models
    ...
    class AdGroup < WhopSDK::Internal::Type::BaseModel
      ...
      class Issue < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroup::Issue::Category, nil]
        required :category, enum: -> { WhopSDK::AdGroup::Issue::Category }, nil?: true
        ...
        #
        #   @param category [Symbol, WhopSDK::Models::AdGroup::Issue::Category, nil] Whop's canonical category that a raw platform issue is bucketed into.
        #
        ...
        # Whop's canonical category that a raw platform issue is bucketed into.
        #
        # @see WhopSDK::Models::AdGroup::Issue#category
        module Category
