...
module WhopSDK
  module Models
    ...
    class AdGroup < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, ad_campaign:, budget:, budget_type:, clicks:, cost_per_result:, cpc:, cpm:, created_at:, ctr:, frequency:, impressions:, issues:, platform:, purchase_value:, purchases:, reach:, results:, roas:, spend:, spend_currency:, status:, title:, unique_ctr:, updated_at:)
