...
module WhopSDK
  module Models
    ...
    class AdGroupCreateParams < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::BudgetType, nil]
      optional :budget_type, enum: -> { WhopSDK::AdGroupCreateParams::BudgetType }, nil?: true

      # @!attribute config
      #   Unified ad group configuration (bidding, optimization, targeting).
      #
      #   @return [WhopSDK::Models::AdGroupCreateParams::Config, nil]
      optional :config, -> { WhopSDK::AdGroupCreateParams::Config }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig, nil]
      optional :platform_config, -> { WhopSDK::AdGroupCreateParams::PlatformConfig }, nil?: true

      # @!attribute status
      #   The status of an external ad group.
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::Status, nil]
      optional :status, enum: -> { WhopSDK::AdGroupCreateParams::Status }, nil?: true

      # @!method initialize(campaign_id:, budget: nil, budget_type: nil, config: nil, daily_budget: nil, name: nil, platform_config: nil, status: nil, request_options: {})
      ...
      class Config < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::BidStrategy, nil]
        optional :bid_strategy, enum: -> { WhopSDK::AdGroupCreateParams::Config::BidStrategy }, nil?: true

        # @!attribute billing_event
        #   How you are billed (e.g., impressions, clicks).
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::BillingEvent, nil]
        optional :billing_event, enum: -> { WhopSDK::AdGroupCreateParams::Config::BillingEvent }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::OptimizationGoal, nil]
        optional :optimization_goal,
                 enum: -> { WhopSDK::AdGroupCreateParams::Config::OptimizationGoal },
                 nil?: true

        # @!attribute pacing
        #   Budget pacing: standard (even) or accelerated (fast).
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Pacing, nil]
        optional :pacing, enum: -> { WhopSDK::AdGroupCreateParams::Config::Pacing }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::AdGroupCreateParams::Config::Targeting, nil]
        optional :targeting, -> { WhopSDK::AdGroupCreateParams::Config::Targeting }, nil?: true
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::BidStrategy, nil] Bid strategy: lowest_cost, bid_cap, or cost_cap.
        #
        #   @param billing_event [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::BillingEvent, nil] How you are billed (e.g., impressions, clicks).
        #
        ...
        #
        #   @param optimization_goal [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::OptimizationGoal, nil] What the ad group optimizes for (e.g., conversions, link_clicks, reach).
        #
        #   @param pacing [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Pacing, nil] Budget pacing: standard (even) or accelerated (fast).
        #
        #   @param start_time [String, nil] Scheduled start time (ISO8601).
        #
        #   @param targeting [WhopSDK::Models::AdGroupCreateParams::Config::Targeting, nil] Audience targeting settings (demographics, geo, interests, audiences, devices).

        # Bid strategy: lowest_cost, bid_cap, or cost_cap.
        #
        # @see WhopSDK::Models::AdGroupCreateParams::Config#bid_strategy
        module BidStrategy
          extend WhopSDK::Internal::Type::Enum
        ...
        # How you are billed (e.g., impressions, clicks).
        #
        # @see WhopSDK::Models::AdGroupCreateParams::Config#billing_event
        module BillingEvent
          extend WhopSDK::Internal::Type::Enum
        ...
        # What the ad group optimizes for (e.g., conversions, link_clicks, reach).
        #
        # @see WhopSDK::Models::AdGroupCreateParams::Config#optimization_goal
        ...
        # Budget pacing: standard (even) or accelerated (fast).
        #
        # @see WhopSDK::Models::AdGroupCreateParams::Config#pacing
        module Pacing
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AdGroupCreateParams::Config#targeting
        class Targeting < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Targeting::DevicePlatform>, nil]
          optional :device_platforms,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::AdGroupCreateParams::Config::Targeting::DevicePlatform]
                   },
                   nil?: true
          ...
          #   Genders to target.
          #
          #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Targeting::Gender>, nil]
          optional :genders,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::AdGroupCreateParams::Config::Targeting::Gender]
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Targeting::PlacementType, nil]
          optional :placement_type,
                   enum: -> { WhopSDK::AdGroupCreateParams::Config::Targeting::PlacementType },
                   nil?: true
          ...
          #
          #   @param device_platforms [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Targeting::DevicePlatform>, nil] Device platforms to target.
          #
          #   @param exclude_audience_ids [Array<String>, nil] Platform audience IDs to exclude.
          #
          #   @param genders [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Targeting::Gender>, nil] Genders to target.
          #
          ...
          #
          #   @param placement_type [Symbol, WhopSDK::Models::AdGroupCreateParams::Config::Targeting::PlacementType, nil] Placement strategy for ad delivery.
          ...
          # Placement strategy for ad delivery.
          #
          # @see WhopSDK::Models::AdGroupCreateParams::Config::Targeting#placement_type
      ...
      class PlatformConfig < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta, nil]
        optional :meta, -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta }, nil?: true

        # @!attribute tiktok
        #   TikTok ad group configuration.
        #
        #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok, nil]
        optional :tiktok, -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok }, nil?: true

        # @!method initialize(meta: nil, tiktok: nil)
        #   Platform-specific ad group configuration.
        #
        #   @param meta [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta, nil] Meta (Facebook/Instagram) ad set configuration.
        #
        #   @param tiktok [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok, nil] TikTok ad group configuration.

        # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig#meta
        class Meta < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::AttributionSpec>, nil]
          optional :attribution_spec,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::AttributionSpec]
                   },
                   nil?: true
          ...
          #   Meta bid strategy.
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::BidStrategy, nil]
          optional :bid_strategy,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BidStrategy },
                   nil?: true

          # @!attribute billing_event
          #   How you are billed on Meta.
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::BillingEvent, nil]
          optional :billing_event,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BillingEvent },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::DestinationType, nil]
          optional :destination_type,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::DestinationType },
                   nil?: true
          ...
          #
          #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations, nil]
          optional :excluded_geo_locations,
                   -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations },
                   nil?: true
          ...
          #
          #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoCity>, nil]
          optional :geo_cities,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoCity]
                   },
                   nil?: true
          ...
          #
          #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations, nil]
          optional :geo_locations,
                   -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations },
                   nil?: true

          # @!attribute geo_regions
          #
          #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoRegion>, nil]
          optional :geo_regions,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoRegion]
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadConversionLocation, nil]
          optional :lead_conversion_location,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadConversionLocation },
                   nil?: true

          # @!attribute lead_form_config
          #   Configuration for a Meta lead gen instant form.
          #
          #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig, nil]
          optional :lead_form_config,
                   -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::OptimizationGoal, nil]
          optional :optimization_goal,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::OptimizationGoal },
                   nil?: true
          ...
          #
          #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::PromotedObject, nil]
          optional :promoted_object,
                   -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::PromotedObject },
                   nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::Status, nil]
          optional :status,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::Status
                   },
                   nil?: true
          ...
          #
          #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::TargetingAutomation, nil]
          ...
          #   {WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta} for more details.
          #
          #   Meta (Facebook/Instagram) ad set configuration.
          #
          ...
          #
          #   @param attribution_spec [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::AttributionSpec>, nil] Conversion attribution windows.
          #
          ...
          #
          #   @param bid_strategy [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::BidStrategy, nil] Meta bid strategy.
          #
          #   @param billing_event [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::BillingEvent, nil] How you are billed on Meta.
          #
          ...
          #
          #   @param destination_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::DestinationType, nil] Where ads in this ad set direct people.
          #
          ...
          #
          #   @param excluded_geo_locations [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations, nil] Geo locations to exclude.
          #
          ...
          #
          #   @param geo_cities [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoCity>, nil]
          #
          #   @param geo_locations [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations, nil] Geo targeting (countries, regions, cities, zips).
          #
          #   @param geo_regions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoRegion>, nil]
          #
          ...
          #
          #   @param lead_conversion_location [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadConversionLocation, nil]
          #
          #   @param lead_form_config [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig, nil] Configuration for a Meta lead gen instant form.
          #
          ...
          #
          #   @param optimization_goal [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::OptimizationGoal, nil] What this ad set optimizes for on Meta.
          #
          ...
          #
          #   @param promoted_object [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::PromotedObject, nil] The object this ad set promotes (pixel, page, etc.).
          #
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::Status, nil]
          #
          #   @param targeting_automation [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::TargetingAutomation, nil] Advantage+ audience expansion settings.
          #
          ...
          # Meta bid strategy.
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#bid_strategy
          module BidStrategy
            extend WhopSDK::Internal::Type::Enum
          ...
          # How you are billed on Meta.
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#billing_event
          module BillingEvent
            extend WhopSDK::Internal::Type::Enum
          ...
          # Where ads in this ad set direct people.
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#destination_type
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#excluded_geo_locations
          class ExcludedGeoLocations < WhopSDK::Internal::Type::BaseModel
            # @!attribute cities
            #   City targets.
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::City>, nil]
            optional :cities,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::City]
                     },
                     nil?: true
            ...
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Region>, nil]
            optional :regions,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Region]
                     },
                     nil?: true
            ...
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Zip>, nil]
            optional :zips,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Zip]
                     },
                     nil?: true
            ...
            #   Geo locations to exclude.
            #
            #   @param cities [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::City>, nil] City targets.
            #
            ...
            #
            #   @param regions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Region>, nil] Region/state targets.
            #
            #   @param zips [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Zip>, nil] Zip/postal code targets.
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#geo_locations
          class GeoLocations < WhopSDK::Internal::Type::BaseModel
            # @!attribute cities
            #   City targets.
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::City>, nil]
            optional :cities,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::City]
                     },
                     nil?: true
            ...
            #   Region/state targets.
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Region>, nil]
            optional :regions,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Region]
                     },
                     nil?: true
            ...
            #   Zip/postal code targets.
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Zip>, nil]
            optional :zips,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Zip]
                     },
                     nil?: true
            ...
            #   Geo targeting (countries, regions, cities, zips).
            #
            #   @param cities [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::City>, nil] City targets.
            #
            #   @param countries [Array<String>, nil] ISO 3166-1 alpha-2 country codes.
            #
            #   @param location_types [Array<String>, nil] Location types (home, recent, travel_in).
            #
            #   @param regions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Region>, nil] Region/state targets.
            #
            #   @param zips [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Zip>, nil] Zip/postal code targets.
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#lead_conversion_location
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#lead_form_config
          class LeadFormConfig < WhopSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question>]
            required :questions,
                     -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question] }
            ...
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::CustomDisclaimerCheckbox>, nil]
            optional :custom_disclaimer_checkboxes,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::CustomDisclaimerCheckbox]
                     },
                     nil?: true
            ...
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::ThankYouPage>, nil]
            optional :thank_you_pages,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::ThankYouPage]
                     },
                     nil?: true
            ...
            #
            #   @param questions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question>] Questions to ask on the form.
            #
            ...
            #
            #   @param custom_disclaimer_checkboxes [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::CustomDisclaimerCheckbox>, nil] Consent checkboxes for the custom disclaimer.
            #
            ...
            #
            #   @param thank_you_pages [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::ThankYouPage>, nil] Thank you / ending pages (supports multiple for conditional routing).
            ...
            class Question < WhopSDK::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion>, nil]
              optional :dependent_conditional_questions,
                       -> {
                         WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion]
                       },
                       nil?: true
              ...
              #
              #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option>, nil]
              optional :options,
                       -> {
                         WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option]
                       },
                       nil?: true
              ...
              #
              #   @param dependent_conditional_questions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion>, nil] Questions shown conditionally based on this question's answer.
              #
              ...
              #
              #   @param options [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option>, nil] Answer options for multiple choice CUSTOM questions.
              #
              ...
              class DependentConditionalQuestion < WhopSDK::Internal::Type::BaseModel
                ...
                #
                #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option>, nil]
                optional :options,
                         -> do
                           WhopSDK::Internal::Type::ArrayOf[
                             WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option
                           ]
                         end,
                         nil?: true
                ...
                #   @param label [String, nil] Custom label for CUSTOM questions.
                #
                #   @param options [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option>, nil] Answer options for multiple choice questions.
                ...
                class Option < WhopSDK::Internal::Type::BaseModel
                  ...
                  #
                  #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option::Logic, nil]
                  optional :logic,
                           -> {
                             WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option::Logic
                           },
                           nil?: true
                  ...
                  #
                  #   @param logic [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option::Logic, nil] Conditional logic routing for this answer option.

                  # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option#logic
              ...
              class Option < WhopSDK::Internal::Type::BaseModel
                ...
                #   Conditional logic routing for this answer option.
                #
                #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option::Logic, nil]
                optional :logic,
                         -> {
                           WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option::Logic
                         },
                         nil?: true
                ...
                #   @param value [String] Display text for this option.
                #
                #   @param logic [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option::Logic, nil] Conditional logic routing for this answer option.

                # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option#logic
                class Logic < WhopSDK::Internal::Type::BaseModel
                  # @!attribute type
                  #   Logic type: go_to_question, submit_form, or close_form.
                  #
          ...
          # What this ad set optimizes for on Meta.
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#optimization_goal
          module OptimizationGoal
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#promoted_object
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#status
          module Status
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Meta#targeting_automation
        ...
        # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig#tiktok
        class Tiktok < WhopSDK::Internal::Type::BaseModel
          # @!attribute actions
          #
          #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action>, nil]
          optional :actions,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action]
                   },
                   nil?: true

          # @!attribute age_groups
          #
          #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::AgeGroup>, nil]
          optional :age_groups,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AgeGroup]
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::AttributionEventCount, nil]
          optional :attribution_event_count,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AttributionEventCount },
                   nil?: true
          ...
          # @!attribute audience_type
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::AudienceType, nil]
          optional :audience_type,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AudienceType },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BidType, nil]
          optional :bid_type,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BidType
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BillingEvent, nil]
          optional :billing_event,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BillingEvent },
                   nil?: true

          # @!attribute brand_safety_type
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BrandSafetyType, nil]
          optional :brand_safety_type,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BrandSafetyType },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BudgetMode, nil]
          optional :budget_mode,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BudgetMode },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ClickAttributionWindow, nil]
          optional :click_attribution_window,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ClickAttributionWindow },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::DeepFunnelOptimizationStatus, nil]
          optional :deep_funnel_optimization_status,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::DeepFunnelOptimizationStatus
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::EngagedViewAttributionWindow, nil]
          optional :engaged_view_attribution_window,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::EngagedViewAttributionWindow
                   },
                   nil?: true
          ...
          # @!attribute gender
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Gender, nil]
          optional :gender,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Gender
                   },
                   nil?: true
          ...
          #
          #   @return [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig, nil]
          optional :instant_form_config,
                   -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Ios14Targeting, nil]
          optional :ios14_targeting,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Ios14Targeting },
                   nil?: true
          ...
          #
          #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::OperatingSystem>, nil]
          optional :operating_systems,
                   -> {
                     WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperatingSystem]
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::OperationStatus, nil]
          optional :operation_status,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperationStatus },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::OptimizationGoal, nil]
          optional :optimization_goal,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OptimizationGoal },
                   nil?: true

          # @!attribute pacing
          #   Budget pacing (PACING_MODE_SMOOTH, PACING_MODE_FAST).
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Pacing, nil]
          optional :pacing,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Pacing
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::PlacementType, nil]
          optional :placement_type,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::PlacementType },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ProductSource, nil]
          optional :product_source,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ProductSource },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ScheduleType, nil]
          optional :schedule_type,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ScheduleType },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ShoppingAdsRetargetingType, nil]
          optional :shopping_ads_retargeting_type,
                   enum: -> {
                     WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ShoppingAdsRetargetingType
                   },
                   nil?: true

          # @!attribute spending_power
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::SpendingPower, nil]
          optional :spending_power,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::SpendingPower },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ViewAttributionWindow, nil]
          optional :view_attribution_window,
                   enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ViewAttributionWindow },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok} for more details.
          #
          #   TikTok ad group configuration.
          #
          #   @param actions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action>, nil]
          #
          #   @param age_groups [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::AgeGroup>, nil]
          #
          #   @param app_id [String, nil] App ID for app promotion campaigns.
          #
          #   @param attribution_event_count [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::AttributionEventCount, nil]
          #
          #   @param audience_ids [Array<String>, nil]
          #
          #   @param audience_rule [Hash{Symbol=>Object}, nil] Represents untyped JSON
          #
          #   @param audience_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::AudienceType, nil]
          #
          #   @param bid_price [Float, nil] Bid price (cost per result for Cost Cap).
          #
          #   @param bid_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BidType, nil] Bidding strategy (BID_TYPE_NO_BID, BID_TYPE_CUSTOM).
          #
          #   @param billing_event [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BillingEvent, nil] How you are billed on TikTok (CPC, CPM, OCPM, CPV).
          #
          #   @param brand_safety_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BrandSafetyType, nil]
          #
          #   @param budget_mode [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::BudgetMode, nil] Budget mode (BUDGET_MODE_DAY, BUDGET_MODE_TOTAL, BUDGET_MODE_DYNAMIC_DAILY_BUDGE
          #
          #   @param carrier_ids [Array<String>, nil]
          #
          #   @param category_exclusion_ids [Array<String>, nil]
          #
          #   @param click_attribution_window [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ClickAttributionWindow, nil]
          #
          ...
          #
          #   @param deep_funnel_optimization_status [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::DeepFunnelOptimizationStatus, nil]
          #
          #   @param device_model_ids [Array<String>, nil]
          #
          #   @param device_price_ranges [Array<String>, nil]
          #
          #   @param engaged_view_attribution_window [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::EngagedViewAttributionWindow, nil]
          #
          ...
          #
          #   @param gender [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Gender, nil]
          #
          ...
          #
          #   @param instant_form_config [WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig, nil] Instant form configuration for lead generation campaigns.
          #
          ...
          #
          #   @param ios14_targeting [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Ios14Targeting, nil]
          #
          ...
          #
          #   @param operating_systems [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::OperatingSystem>, nil]
          #
          #   @param operation_status [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::OperationStatus, nil] Initial status (ENABLE, DISABLE).
          #
          #   @param optimization_event [String, nil] Conversion event (e.g., COMPLETE_PAYMENT).
          #
          #   @param optimization_goal [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::OptimizationGoal, nil] What this ad group optimizes for on TikTok.
          #
          #   @param pacing [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Pacing, nil] Budget pacing (PACING_MODE_SMOOTH, PACING_MODE_FAST).
          #
          ...
          #
          #   @param placement_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::PlacementType, nil] Placement strategy (PLACEMENT_TYPE_AUTOMATIC, PLACEMENT_TYPE_NORMAL).
          #
          ...
          #
          #   @param product_source [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ProductSource, nil]
          #
          ...
          #
          #   @param schedule_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ScheduleType, nil] Schedule type (SCHEDULE_START_END, SCHEDULE_FROM_NOW).
          #
          ...
          #
          #   @param shopping_ads_retargeting_type [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ShoppingAdsRetargetingType, nil]
          #
          #   @param spending_power [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::SpendingPower, nil]
          #
          ...
          #
          #   @param view_attribution_window [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::ViewAttributionWindow, nil]
          ...
          class Action < WhopSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action::ActionScene, nil]
            optional :action_scene,
                     enum: -> { WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::ActionScene },
                     nil?: true
            ...
            #   PROFILE_VISITED).
            #
            #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action::VideoUserAction>, nil]
            optional :video_user_actions,
                     -> {
                       WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::VideoUserAction]
                     },
                     nil?: true

            # @!method initialize(action_category_ids: nil, action_period: nil, action_scene: nil, video_user_actions: nil)
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action} for more
            #   details.
            #
            ...
            #
            #   @param action_scene [Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action::ActionScene, nil] The category of TikTok content a behavioral targeting rule applies to. See docs/
            #
            #   @param video_user_actions [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action::VideoUserAction>, nil] Specific video interactions (WATCHED_TO_END, LIKED, COMMENTED, SHARED, FOLLOWED,

            # The category of TikTok content a behavioral targeting rule applies to. See
            # docs/tiktok_api/ad_group.md § actions.
            #
            # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::Action#action_scene
            module ActionScene
              extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#attribution_event_count
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#audience_type
          module AudienceType
            extend WhopSDK::Internal::Type::Enum
          ...
          # Bidding strategy (BID_TYPE_NO_BID, BID_TYPE_CUSTOM).
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#bid_type
          module BidType
            extend WhopSDK::Internal::Type::Enum
          ...
          # How you are billed on TikTok (CPC, CPM, OCPM, CPV).
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#billing_event
          module BillingEvent
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#brand_safety_type
          ...
          # BUDGET_MODE_DYNAMIC_DAILY_BUDGET).
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#budget_mode
          module BudgetMode
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#click_attribution_window
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#deep_funnel_optimization_status
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#engaged_view_attribution_window
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#gender
          module Gender
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#instant_form_config
          class InstantFormConfig < WhopSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig::Question>]
            required :questions,
                     -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig::Question] }
            ...
            #
            #   @param questions [Array<WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig::Question>] Form questions (at least one required).
            #
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#ios14_targeting
          ...
          # Initial status (ENABLE, DISABLE).
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#operation_status
          ...
          # What this ad group optimizes for on TikTok.
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#optimization_goal
          module OptimizationGoal
            extend WhopSDK::Internal::Type::Enum
          ...
          # Budget pacing (PACING_MODE_SMOOTH, PACING_MODE_FAST).
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#pacing
          module Pacing
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#product_source
          ...
          # Schedule type (SCHEDULE_START_END, SCHEDULE_FROM_NOW).
          #
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#schedule_type
          module ScheduleType
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#shopping_ads_retargeting_type
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#spending_power
          ...
          # @see WhopSDK::Models::AdGroupCreateParams::PlatformConfig::Tiktok#view_attribution_window
