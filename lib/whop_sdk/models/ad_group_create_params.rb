...
module WhopSDK
  module Models
    ...
    class AdGroupCreateParams < WhopSDK::Internal::Type::BaseModel
      ...
      #   Bid strategy.
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::BidType, nil]
      ...
      #
      #   @return [Symbol, String, WhopSDK::Models::AdGroupCreateParams::ConversionEvent, nil]
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupCreateParams::ConversionLocation, nil]
      ...
      #
      #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateParams::MessageApp>, nil]
      ...
      module ConversionEvent
        ...
        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::PURCHASE }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::ADD_TO_CART }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::INITIATED_CHECKOUT }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::ADD_PAYMENT_INFO }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::COMPLETE_REGISTRATION }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::LEAD }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::CONTENT_VIEW }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::SEARCH }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::CONTACT }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::CUSTOMIZE_PRODUCT }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::DONATE }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::FIND_LOCATION }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::SCHEDULE }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::START_TRIAL }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::SUBMIT_APPLICATION }

        variant const: -> { WhopSDK::Models::AdGroupCreateParams::ConversionEvent::SUBSCRIBE }
        ...
        define_sorbet_constant!(:Variants) do
          T.type_alias { T.any(WhopSDK::AdGroupCreateParams::ConversionEvent::TaggedSymbol, String) }
        end
