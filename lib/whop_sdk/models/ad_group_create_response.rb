...
module WhopSDK
  module Models
    ...
    class AdGroupCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::AdGroupCreateResponse::Config, nil]
      required :config, -> { WhopSDK::Models::AdGroupCreateResponse::Config }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType, nil]
      required :platform_config, union: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig }
      ...
      #   {WhopSDK::Models::AdGroupCreateResponse} for more details.
      #
      #   An external ad group (ad set) belonging to an ad campaign
      #
      #   @param id [String] The unique identifier for the external ad group.
      #
      #   @param ad_campaign [WhopSDK::Models::AdGroupCreateResponse::AdCampaign] The parent ad campaign
      #
      #   @param config [WhopSDK::Models::AdGroupCreateResponse::Config, nil] Unified ad group configuration (platform-agnostic)
      #
      ...
      #
      #   @param platform_config [WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType, nil] Typed platform-specific configuration. Use inline fragments (... on MetaAdGroupP
      #
      ...
      class AdCampaign < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::AdCampaign::Platform, nil]
        required :platform, enum: -> { WhopSDK::Models::AdGroupCreateResponse::AdCampaign::Platform }, nil?: true

        # @!attribute status
        #   Current status of the campaign (active, paused, or inactive)
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::AdCampaign::Status]
        required :status, enum: -> { WhopSDK::Models::AdGroupCreateResponse::AdCampaign::Status }
        ...
        #
        #   @param platform [Symbol, WhopSDK::Models::AdGroupCreateResponse::AdCampaign::Platform, nil] The platforms where an ad campaign can run.
        #
        #   @param status [Symbol, WhopSDK::Models::AdGroupCreateResponse::AdCampaign::Status] Current status of the campaign (active, paused, or inactive)
        #
        #   @param title [String] The title of the ad campaign

        # The platforms where an ad campaign can run.
        #
        # @see WhopSDK::Models::AdGroupCreateResponse::AdCampaign#platform
        module Platform
        ...
        # Current status of the campaign (active, paused, or inactive)
        #
        # @see WhopSDK::Models::AdGroupCreateResponse::AdCampaign#status
        module Status
          extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::AdGroupCreateResponse#config
      class Config < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::BidStrategy, nil]
        required :bid_strategy,
                 enum: -> { WhopSDK::Models::AdGroupCreateResponse::Config::BidStrategy },
                 nil?: true

        # @!attribute billing_event
        #   How you are billed (e.g., impressions, clicks).
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::BillingEvent, nil]
        required :billing_event,
                 enum: -> { WhopSDK::Models::AdGroupCreateResponse::Config::BillingEvent },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::OptimizationGoal, nil]
        required :optimization_goal,
                 enum: -> { WhopSDK::Models::AdGroupCreateResponse::Config::OptimizationGoal },
                 nil?: true

        # @!attribute pacing
        #   Budget pacing: standard (even) or accelerated (fast).
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Pacing, nil]
        required :pacing, enum: -> { WhopSDK::Models::AdGroupCreateResponse::Config::Pacing }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::AdGroupCreateResponse::Config::Targeting, nil]
        required :targeting, -> { WhopSDK::Models::AdGroupCreateResponse::Config::Targeting }, nil?: true
        ...
        #
        #   @param bid_strategy [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::BidStrategy, nil] Bid strategy: lowest_cost, bid_cap, or cost_cap.
        #
        #   @param billing_event [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::BillingEvent, nil] How you are billed (e.g., impressions, clicks).
        #
        ...
        #
        #   @param optimization_goal [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::OptimizationGoal, nil] What the ad group optimizes for (e.g., conversions, link_clicks, reach).
        #
        #   @param pacing [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Pacing, nil] Budget pacing: standard (even) or accelerated (fast).
        #
        #   @param start_time [String, nil] Scheduled start time (ISO8601).
        #
        #   @param targeting [WhopSDK::Models::AdGroupCreateResponse::Config::Targeting, nil] Audience targeting settings (demographics, geo, interests, audiences, devices).

        # Bid strategy: lowest_cost, bid_cap, or cost_cap.
        #
        # @see WhopSDK::Models::AdGroupCreateResponse::Config#bid_strategy
        module BidStrategy
          extend WhopSDK::Internal::Type::Enum
        ...
        # How you are billed (e.g., impressions, clicks).
        #
        # @see WhopSDK::Models::AdGroupCreateResponse::Config#billing_event
        module BillingEvent
          extend WhopSDK::Internal::Type::Enum
        ...
        # What the ad group optimizes for (e.g., conversions, link_clicks, reach).
        #
        # @see WhopSDK::Models::AdGroupCreateResponse::Config#optimization_goal
        ...
        # Budget pacing: standard (even) or accelerated (fast).
        #
        # @see WhopSDK::Models::AdGroupCreateResponse::Config#pacing
        module Pacing
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::AdGroupCreateResponse::Config#targeting
        class Targeting < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::DevicePlatform>, nil]
          required :device_platforms,
                   -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::DevicePlatform] },
                   nil?: true
          ...
          #   Genders targeted.
          #
          #   @return [Array<Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::Gender>, nil]
          required :genders,
                   -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::Gender] },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::PlacementType, nil]
          required :placement_type,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::PlacementType },
                   nil?: true
          ...
          #
          #   @param device_platforms [Array<Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::DevicePlatform>, nil] Device platforms targeted.
          #
          #   @param exclude_audience_ids [Array<String>, nil] Platform audience IDs excluded.
          #
          #   @param genders [Array<Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::Gender>, nil] Genders targeted.
          #
          ...
          #
          #   @param placement_type [Symbol, WhopSDK::Models::AdGroupCreateResponse::Config::Targeting::PlacementType, nil] Placement strategy for ad delivery.
          ...
          # Placement strategy for ad delivery.
          #
          # @see WhopSDK::Models::AdGroupCreateResponse::Config::Targeting#placement_type
      ...
      # MetaAdGroupPlatformConfigType).
      #
      # @see WhopSDK::Models::AdGroupCreateResponse#platform_config
      module PlatformConfig
        ...
        class MetaAdGroupPlatformConfigType < WhopSDK::Internal::Type::BaseModel
          ...
          # @!attribute bid_strategy
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::BidStrategy, nil]
          required :bid_strategy,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::BidStrategy },
                   nil?: true

          # @!attribute billing_event
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::BillingEvent, nil]
          required :billing_event,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::BillingEvent },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::DestinationType, nil]
          required :destination_type,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::DestinationType },
                   nil?: true
          ...
          # @!attribute optimization_goal
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::OptimizationGoal, nil]
          required :optimization_goal,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::OptimizationGoal },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::Platform]
          required :platform,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::Platform }
          ...
          # @!attribute status
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::Status, nil]
          required :status,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::Status },
                   nil?: true
          ...
          #
          #   @param bid_strategy [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::BidStrategy, nil]
          #
          #   @param billing_event [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::BillingEvent, nil]
          #
          #   @param daily_budget [Integer, nil] Represents non-fractional signed whole numeric values. Int can represent values
          #
          #   @param destination_type [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::DestinationType, nil]
          #
          ...
          #
          #   @param optimization_goal [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::OptimizationGoal, nil]
          #
          #   @param page_id [String, nil] Represents textual data as UTF-8 character sequences. This type is most often us
          #
          #   @param platform [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::Platform] The ad platform (meta, tiktok).
          #
          #   @param promoted_object [Hash{Symbol=>Object}, nil] Represents untyped JSON
          #
          #   @param publisher_platforms [Array<String>, nil]
          #
          #   @param status [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType::Status, nil]
          #
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType#bid_strategy
          module BidStrategy
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType#billing_event
          module BillingEvent
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType#destination_type
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType#optimization_goal
          module OptimizationGoal
            extend WhopSDK::Internal::Type::Enum
          ...
          # The ad platform (meta, tiktok).
          #
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType#platform
          module Platform
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType#status
          module Status
            extend WhopSDK::Internal::Type::Enum
        ...
        class TiktokAdGroupPlatformConfigType < WhopSDK::Internal::Type::BaseModel
          ...
          # @!attribute bid_type
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BidType, nil]
          required :bid_type,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BidType },
                   nil?: true

          # @!attribute billing_event
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BillingEvent, nil]
          required :billing_event,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BillingEvent },
                   nil?: true

          # @!attribute budget_mode
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BudgetMode, nil]
          required :budget_mode,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BudgetMode },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::OperationStatus, nil]
          required :operation_status,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::OperationStatus },
                   nil?: true
          ...
          # @!attribute optimization_goal
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::OptimizationGoal, nil]
          required :optimization_goal,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::OptimizationGoal },
                   nil?: true

          # @!attribute pacing
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::Pacing, nil]
          required :pacing,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::Pacing },
                   nil?: true
          ...
          # @!attribute placement_type
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::PlacementType, nil]
          required :placement_type,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::PlacementType },
                   nil?: true
          ...
          #   The ad platform (meta, tiktok).
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::Platform]
          required :platform,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::Platform }
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::ScheduleType, nil]
          required :schedule_type,
                   enum: -> { WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::ScheduleType },
                   nil?: true
          ...
          #
          #   @param bid_type [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BidType, nil]
          #
          #   @param billing_event [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BillingEvent, nil]
          #
          #   @param budget_mode [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::BudgetMode, nil]
          #
          ...
          #
          #   @param operation_status [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::OperationStatus, nil]
          #
          #   @param optimization_event [String, nil] Represents textual data as UTF-8 character sequences. This type is most often us
          #
          #   @param optimization_goal [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::OptimizationGoal, nil]
          #
          #   @param pacing [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::Pacing, nil]
          #
          #   @param pixel_id [String, nil] Represents textual data as UTF-8 character sequences. This type is most often us
          #
          #   @param placement_type [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::PlacementType, nil]
          #
          #   @param placements [Array<String>, nil]
          #
          #   @param platform [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::Platform] The ad platform (meta, tiktok).
          #
          ...
          #
          #   @param schedule_type [Symbol, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType::ScheduleType, nil]
          #
          #   @param typename [Symbol, :TiktokAdGroupPlatformConfigType] The typename of this object

          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#bid_type
          module BidType
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#billing_event
          module BillingEvent
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#budget_mode
          module BudgetMode
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#operation_status
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#optimization_goal
          module OptimizationGoal
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#pacing
          module Pacing
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#placement_type
          module PlacementType
            extend WhopSDK::Internal::Type::Enum
          ...
          # The ad platform (meta, tiktok).
          #
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#platform
          module Platform
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType#schedule_type
          module ScheduleType
            extend WhopSDK::Internal::Type::Enum
        ...
        #   @return [Array(WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::MetaAdGroupPlatformConfigType, WhopSDK::Models::AdGroupCreateResponse::PlatformConfig::TiktokAdGroupPlatformConfigType)]
      end
