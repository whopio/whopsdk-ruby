...
module WhopSDK
  module Models
    ...
    class AdGroupListParams < WhopSDK::Internal::Type::BaseModel
      ...
      #   otherwise.
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupListParams::AttributionModel, nil]
      ...
      optional :status, enum: -> { WhopSDK::AdGroupListParams::Status }
      ...
      # @!method initialize(account_id: nil, ad_campaign_id: nil, ad_campaign_ids: nil, after: nil, attribution_model: nil, before: nil, created_after: nil, created_before: nil, direction: nil, first: nil, last: nil, order: nil, query: nil, stats_from: nil, stats_to: nil, status: nil, time_zone: nil, api_version_date: nil, request_options: {})
      ...
      #
      #   @param status [Symbol, WhopSDK::Models::AdGroupListParams::Status] Filter to ad groups with this status.
      #
