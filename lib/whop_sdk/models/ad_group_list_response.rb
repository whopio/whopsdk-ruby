  ...
  module Models
    ...
    class AdGroupListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      class Issue < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdGroupListResponse::Issue::Category, nil]
        required :category, enum: -> { WhopSDK::Models::AdGroupListResponse::Issue::Category }, nil?: true
        ...
        #
        #   @param category [Symbol, WhopSDK::Models::AdGroupListResponse::Issue::Category, nil] Whop's canonical category that a raw platform issue is bucketed into.
        #
        ...
        # Whop's canonical category that a raw platform issue is bucketed into.
        #
        # @see WhopSDK::Models::AdGroupListResponse::Issue#category
        module Category
