...
module WhopSDK
  module Models
    ...
    class AdGroupRetrieveParams < WhopSDK::Internal::Type::BaseModel
      ...
      #   otherwise.
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupRetrieveParams::AttributionModel, nil]
      optional :attribution_model, enum: -> { WhopSDK::AdGroupRetrieveParams::AttributionModel }
      ...
      #   @param id [String]
      #
      #   @param attribution_model [Symbol, WhopSDK::Models::AdGroupRetrieveParams::AttributionModel] Attribution model the conversion stats count under (defaults to last_touch). Und
      #
