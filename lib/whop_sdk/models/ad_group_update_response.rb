...
module WhopSDK
  module Models
    ...
    class AdGroupUpdateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupUpdateResponse::BudgetType, nil]
      required :budget_type, enum: -> { WhopSDK::Models::AdGroupUpdateResponse::BudgetType }, nil?: true
      ...
      #
      #   @return [Symbol, WhopSDK::Models::AdGroupUpdateResponse::Platform]
      required :platform, enum: -> { WhopSDK::Models::AdGroupUpdateResponse::Platform }
      ...
      #
      #   @param ad_campaign [WhopSDK::Models::AdGroupUpdateResponse::AdCampaign] The ad campaign this ad group belongs to.
      #
      #   @param budget [Float, nil] Budget amount in dollars.
      #
      #   @param budget_type [Symbol, WhopSDK::Models::AdGroupUpdateResponse::BudgetType, nil] The budget type for an ad campaign or ad group.
      #
      #   @param created_at [Time] When the ad group was created.
      #
      #   @param platform [Symbol, WhopSDK::Models::AdGroupUpdateResponse::Platform] The external ad platform this ad group is running on (e.g., meta, tiktok).
      #
      ...
      # The budget type for an ad campaign or ad group.
      #
      # @see WhopSDK::Models::AdGroupUpdateResponse#budget_type
      module BudgetType
      ...
      # The external ad platform this ad group is running on (e.g., meta, tiktok).
      #
      # @see WhopSDK::Models::AdGroupUpdateResponse#platform
      module Platform
        extend WhopSDK::Internal::Type::Enum
