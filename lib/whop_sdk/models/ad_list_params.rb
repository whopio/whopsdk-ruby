...
module WhopSDK
  module Models
    ...
    class AdListParams < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(ad_group_id: nil, after: nil, before: nil, campaign_id: nil, company_id: nil, created_after: nil, created_before: nil, first: nil, last: nil, order_by: nil, order_direction: nil, query: nil, stats_from: nil, stats_to: nil, status: nil, request_options: {})
