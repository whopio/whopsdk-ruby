...
module WhopSDK
  module Models
    ...
    class AdListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   there are none.
      #
      #   @return [Array<WhopSDK::Models::AdListResponse::Issue>]
      required :issues, -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::AdListResponse::Issue] }
      ...
      # @!method initialize(id:, ad_campaign:, ad_group:, click_through_rate:, clicks:, cost_per_click:, cost_per_lead:, cost_per_mille:, cost_per_purchase:, cost_per_result:, created_at:, frequency:, impressions:, issues:, leads:, platform:, purchase_value:, purchases:, reach:, return_on_ad_spend:, spend:, spend_currency:, status:, title:, unique_click_through_rate:, unique_clicks:, updated_at:)
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::AdListResponse} for more details.
      #
      ...
      #
      #   @param issues [Array<WhopSDK::Models::AdListResponse::Issue>] Open platform issues affecting this ad, deduplicated per object. Empty when ther
      #
      ...
      class Issue < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdListResponse::Issue::Category, nil]
        required :category, enum: -> { WhopSDK::Models::AdListResponse::Issue::Category }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdListResponse::Issue::ResolutionStatus]
        required :resolution_status, enum: -> { WhopSDK::Models::AdListResponse::Issue::ResolutionStatus }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::AdListResponse::Issue} for more details.
        #
        #   A platform-reported issue on an ad object (rejection, policy flag, etc.).
        #
        #   @param category [Symbol, WhopSDK::Models::AdListResponse::Issue::Category, nil] Whop's canonical category that a raw platform issue is bucketed into.
        #
        #   @param created_at [Time] When the issue was first reported.
        #
        #   @param resolution_status [Symbol, WhopSDK::Models::AdListResponse::Issue::ResolutionStatus] Current resolution status.
        #
        ...
        # Whop's canonical category that a raw platform issue is bucketed into.
        #
        # @see WhopSDK::Models::AdListResponse::Issue#category
        module Category
        ...
        # Current resolution status.
        #
        # @see WhopSDK::Models::AdListResponse::Issue#resolution_status
