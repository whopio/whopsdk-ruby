...
module WhopSDK
  module Models
    ...
    class AdRetrieveParams < WhopSDK::Internal::Type::BaseModel
      ...
      #   otherwise.
      #
      #   @return [Symbol, WhopSDK::Models::AdRetrieveParams::AttributionModel, nil]
      optional :attribution_model, enum: -> { WhopSDK::AdRetrieveParams::AttributionModel }
      ...
      #   @param id [String]
      #
      #   @param attribution_model [Symbol, WhopSDK::Models::AdRetrieveParams::AttributionModel] Attribution model the conversion stats count under (defaults to last_touch). Und
      #
