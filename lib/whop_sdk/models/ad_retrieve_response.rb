...
module WhopSDK
  module Models
    ...
    class AdRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      # @!attribute external_ad_creative_set
      #   The creative set used by this ad.
      #
      #   @return [WhopSDK::Models::AdRetrieveResponse::ExternalAdCreativeSet, nil]
      required :external_ad_creative_set,
               -> { WhopSDK::Models::AdRetrieveResponse::ExternalAdCreativeSet },
               nil?: true

      # @!attribute external_ad_group
      #   The parent ad group.
      #
      #   @return [WhopSDK::Models::AdRetrieveResponse::ExternalAdGroup]
      ...
      #
      #   @return [WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType, nil]
      required :platform_config, union: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig }
      ...
      # @!method initialize(id:, created_at:, external_ad_creative_set:, external_ad_group:, platform_config:, status:, updated_at:)
      ...
      #
      #   @param external_ad_creative_set [WhopSDK::Models::AdRetrieveResponse::ExternalAdCreativeSet, nil] The creative set used by this ad.
      #
      #   @param external_ad_group [WhopSDK::Models::AdRetrieveResponse::ExternalAdGroup] The parent ad group.
      #
      #   @param platform_config [WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType, nil] Typed platform-specific configuration.
      #
      #   @param status [Symbol, WhopSDK::Models::AdRetrieveResponse::Status] Current status of the ad.
      #
      ...
      class ExternalAdCreativeSet < WhopSDK::Internal::Type::BaseModel
        ...
        #   The creative set used by this ad.
        #
        #   @param id [String] The unique identifier for the external ad creative set.
      end

      # @see WhopSDK::Models::AdRetrieveResponse#external_ad_group
      class ExternalAdGroup < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::ExternalAdGroup::Status]
        required :status, enum: -> { WhopSDK::Models::AdRetrieveResponse::ExternalAdGroup::Status }

        # @!method initialize(id:, name:, status:)
        #   The parent ad group.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::AdRetrieveResponse::ExternalAdGroup::Status] Current operational status of the ad group

        # Current operational status of the ad group
        #
        # @see WhopSDK::Models::AdRetrieveResponse::ExternalAdGroup#status
        module Status
      ...
      # Typed platform-specific configuration.
      #
      # @see WhopSDK::Models::AdRetrieveResponse#platform_config
      module PlatformConfig
        ...
        variant :MetaAdPlatformConfigType,
                -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType }

        # TikTok ad configuration.
        variant :TiktokAdPlatformConfigType,
                -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType }

        class MetaAdPlatformConfigType < WhopSDK::Internal::Type::BaseModel
          # @!attribute call_to_action_type
          #
          #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType::CallToActionType, nil]
          required :call_to_action_type,
                   enum: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType::CallToActionType },
                   nil?: true
          ...
          #   The ad platform.
          #
          #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType::Platform]
          required :platform,
                   enum: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType::Platform }
          ...
          #   Meta (Facebook/Instagram) ad configuration.
          #
          #   @param call_to_action_type [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType::CallToActionType, nil]
          #
          ...
          #
          #   @param platform [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType::Platform] The ad platform.
          #
          ...
          # @see WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType#call_to_action_type
          ...
          # The ad platform.
          #
          # @see WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType#platform
          module Platform
            extend WhopSDK::Internal::Type::Enum
        ...
        class TiktokAdPlatformConfigType < WhopSDK::Internal::Type::BaseModel
          # @!attribute ad_format
          #
          #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::AdFormat, nil]
          required :ad_format,
                   enum: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::AdFormat },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::CallToAction, nil]
          required :call_to_action,
                   enum: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::CallToAction },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::IdentityType, nil]
          required :identity_type,
                   enum: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::IdentityType },
                   nil?: true
          ...
          #   The ad platform.
          #
          #   @return [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::Platform]
          required :platform,
                   enum: -> { WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::Platform }
          ...
          #   TikTok ad configuration.
          #
          #   @param ad_format [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::AdFormat, nil]
          #
          ...
          #
          #   @param call_to_action [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::CallToAction, nil] TikTok call-to-action button text. See docs/tiktok_api/ad.md § call_to_action.
          #
          ...
          #
          #   @param identity_type [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::IdentityType, nil]
          #
          ...
          #
          #   @param platform [Symbol, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType::Platform] The ad platform.
          #
          ...
          # @see WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType#ad_format
          module AdFormat
            extend WhopSDK::Internal::Type::Enum
          ...
          # TikTok call-to-action button text. See docs/tiktok_api/ad.md § call_to_action.
          #
          # @see WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType#call_to_action
          module CallToAction
            extend WhopSDK::Internal::Type::Enum
          ...
          # @see WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType#identity_type
          module IdentityType
            extend WhopSDK::Internal::Type::Enum
          ...
          # The ad platform.
          #
          # @see WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType#platform
          module Platform
            extend WhopSDK::Internal::Type::Enum
        ...
        #   @return [Array(WhopSDK::Models::AdRetrieveResponse::PlatformConfig::MetaAdPlatformConfigType, WhopSDK::Models::AdRetrieveResponse::PlatformConfig::TiktokAdPlatformConfigType)]
      end
