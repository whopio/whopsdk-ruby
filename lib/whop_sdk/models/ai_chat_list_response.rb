...
module WhopSDK
  module Models
    ...
    class AIChatListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   its lifetime.
      #
      #   @return [Symbol, WhopSDK::Models::AIChatListResponse::AgentIdentifier]
      required :agent_identifier, enum: -> { WhopSDK::Models::AIChatListResponse::AgentIdentifier }
      ...
      #
      #   @param agent_identifier [Symbol, WhopSDK::Models::AIChatListResponse::AgentIdentifier] The AI agent that handles this chat. Set when the chat is created and fixed for
      #
      ...
      # its lifetime.
      #
      # @see WhopSDK::Models::AIChatListResponse#agent_identifier
