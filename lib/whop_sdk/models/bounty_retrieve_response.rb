...
module WhopSDK
  module Models
    ...
    class BountyRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, WhopSDK::Models::BountyRetrieveResponse::AcceptedDeliverableType>]
      required :accepted_deliverable_types,
               -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::Models::BountyRetrieveResponse::AcceptedDeliverableType] }
      ...
      #
      #   @return [Array<WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed>]
      required :active_proof_livestream_feeds,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed] }
      ...
      #
      #   @return [Symbol, WhopSDK::Models::BountyRetrieveResponse::BusinessGoalType, nil]
      required :business_goal_type,
               enum: -> { WhopSDK::Models::BountyRetrieveResponse::BusinessGoalType },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::BountyRetrieveResponse::CaptureSpec, nil]
      required :capture_spec, -> { WhopSDK::Models::BountyRetrieveResponse::CaptureSpec }, nil?: true
      ...
      #
      #   @return [Symbol, WhopSDK::Models::BountyRetrieveResponse::Currency]
      required :currency, enum: -> { WhopSDK::Models::BountyRetrieveResponse::Currency }
      ...
      #
      #   @return [WhopSDK::Models::BountyRetrieveResponse::FundingAccount, nil]
      required :funding_account, -> { WhopSDK::Models::BountyRetrieveResponse::FundingAccount }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::BountyRetrieveResponse::HostingAccount, nil]
      required :hosting_account, -> { WhopSDK::Models::BountyRetrieveResponse::HostingAccount }, nil?: true
      ...
      #   key.
      #
      #   @return [WhopSDK::Models::BountyRetrieveResponse::Poster]
      required :poster, -> { WhopSDK::Models::BountyRetrieveResponse::Poster }
      ...
      #
      #   @return [Symbol, WhopSDK::Models::BountyRetrieveResponse::ScheduledFrequency, nil]
      required :scheduled_frequency,
               enum: -> { WhopSDK::Models::BountyRetrieveResponse::ScheduledFrequency },
               nil?: true
      ...
      #   {WhopSDK::Models::BountyRetrieveResponse} for more details.
      #
      #   @param id [String] Bounty ID, prefixed `bnty_`.
      #
      #   @param accepted_deliverable_types [Array<Symbol, WhopSDK::Models::BountyRetrieveResponse::AcceptedDeliverableType>]
      #
      ...
      #
      #   @param active_proof_livestream_feeds [Array<WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed>]
      #
      ...
      #
      #   @param business_goal_type [Symbol, WhopSDK::Models::BountyRetrieveResponse::BusinessGoalType, nil] What the poster wants the work to achieve, declared once at create. `null` for b
      #
      #   @param cancel_requested_at [String, nil] When cancellation was requested, as an ISO 8601 timestamp. On a `closed` bounty
      #
      #   @param capture_spec [WhopSDK::Models::BountyRetrieveResponse::CaptureSpec, nil] The technical contract footage must be recorded against. Present only on `data_c
      #
      #   @param created_at [String] When the bounty was created, as an ISO 8601 timestamp.
      #
      #   @param currency [Symbol, WhopSDK::Models::BountyRetrieveResponse::Currency] Currency for all amounts on the bounty, as a lowercase ISO 4217 code.
      #
      ...
      #
      #   @param funding_account [WhopSDK::Models::BountyRetrieveResponse::FundingAccount, nil] Account whose balance funds the bounty pool, or `null` when a user funds it pers
      #
      ...
      #
      #   @param hosting_account [WhopSDK::Models::BountyRetrieveResponse::HostingAccount, nil] Account hosting the bounty's forum — the one whose `route` and `experience_id` a
      #
      ...
      #
      #   @param poster [WhopSDK::Models::BountyRetrieveResponse::Poster] User who posted the bounty — the account owner when created with an account API
      #
      #   @param scheduled_frequency [Symbol, WhopSDK::Models::BountyRetrieveResponse::ScheduledFrequency, nil] How often the schedule creates a new bounty. Each occurrence is a separate bount
      #
      ...
      #
      #   @param status [Symbol, WhopSDK::Models::BountyRetrieveResponse::Status] Lifecycle state. `scheduled` bounties are unpublished drafts, visible to their p
      #
      ...
      class ActiveProofLivestreamFeed < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host, nil]
        required :host,
                 -> { WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host },
                 nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed} for more
        #   details.
        #
        ...
        #
        #   @param host [WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host, nil] User hosting the proof livestream — the worker streaming their attempt. `null` i
        #
        #   @param title [String] Display title for the proof livestream.

        # @see WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed#host
        class Host < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host::ProfilePicture]
          required :profile_picture,
                   -> { WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host::ProfilePicture }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host} for
          #   more details.
          #
          #   User hosting the proof livestream — the worker streaming their attempt. `null`
          #   if the host account no longer exists.
          ...
          #
          #   @param profile_picture [WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host::ProfilePicture] Avatar wrapper; its `url` is always present, using a generated placeholder when
          #
          #   @param username [String] Public username.

          # @see WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host#profile_picture
      ...
      # bounties created before the taxonomy rolled out.
      #
      # @see WhopSDK::Models::BountyRetrieveResponse#business_goal_type
      ...
      # @see WhopSDK::Models::BountyRetrieveResponse#capture_spec
      class CaptureSpec < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu]
        required :imu, -> { WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu }
        ...
        #
        #   @return [WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video]
        required :video, -> { WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::BountyRetrieveResponse::CaptureSpec} for more details.
        #
        #   The technical contract footage must be recorded against. Present only on
        #   `data_capture` bounties; `null` for every other goal type.
        #
        ...
        #
        #   @param imu [WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu] Inertial measurement unit (IMU) recording requirements.
        #
        ...
        #
        #   @param video [WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video] Video recording requirements.

        # @see WhopSDK::Models::BountyRetrieveResponse::CaptureSpec#imu
        ...
        # @see WhopSDK::Models::BountyRetrieveResponse::CaptureSpec#video
        class Video < WhopSDK::Internal::Type::BaseModel
          ...
          #   device default.
          #
          #   @return [Symbol, WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::StabilizationMode]
          required :stabilization_mode,
                   enum: -> { WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::StabilizationMode }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video} for more details.
          #
          #   Video recording requirements.
          #
          ...
          #
          #   @param stabilization_mode [Symbol, WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::StabilizationMode] How the client must configure video stabilization: `off` disables EIS so raw mot
          #
          ...
          # device default.
          #
          # @see WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video#stabilization_mode
      ...
      # Currency for all amounts on the bounty, as a lowercase ISO 4217 code.
      #
      # @see WhopSDK::Models::BountyRetrieveResponse#currency
      module Currency
        extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::BountyRetrieveResponse#funding_account
      ...
      # @see WhopSDK::Models::BountyRetrieveResponse#hosting_account
      ...
      # @see WhopSDK::Models::BountyRetrieveResponse#poster
      class Poster < WhopSDK::Internal::Type::BaseModel
        ...
        #   the user set no picture.
        #
        #   @return [WhopSDK::Models::BountyRetrieveResponse::Poster::ProfilePicture]
        required :profile_picture, -> { WhopSDK::Models::BountyRetrieveResponse::Poster::ProfilePicture }
        ...
        # @!method initialize(id:, name:, profile_picture:, username:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::BountyRetrieveResponse::Poster} for more details.
        #
        #   User who posted the bounty — the account owner when created with an account API
        #   key.
        #
        ...
        #   @param name [String, nil] Display name.
        #
        #   @param profile_picture [WhopSDK::Models::BountyRetrieveResponse::Poster::ProfilePicture] Avatar wrapper; its `url` is always present, using a generated placeholder when
        #
        #   @param username [String] Public username.

        # @see WhopSDK::Models::BountyRetrieveResponse::Poster#profile_picture
        class ProfilePicture < WhopSDK::Internal::Type::BaseModel
          # @!attribute url
          #   Avatar image URL. Always present — a generated placeholder when the user set no
          #   picture.
          ...
          # @!method initialize(url:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::BountyRetrieveResponse::Poster::ProfilePicture} for more
          #   details.
          #
          #   Avatar wrapper; its `url` is always present, using a generated placeholder when
          #   the user set no picture.
      ...
      # bounty; the original is not republished.
      #
      # @see WhopSDK::Models::BountyRetrieveResponse#scheduled_frequency
