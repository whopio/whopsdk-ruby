...
module WhopSDK
  module Models
    class CardCanceledWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::CardCanceledWebhookEvent::Data]
      required :data, -> { WhopSDK::CardCanceledWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"card.canceled"]
      required :type, const: :"card.canceled"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"card.canceled")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::CardCanceledWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::CardCanceledWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"card.canceled"] The webhook event type

      # @see WhopSDK::Models::CardCanceledWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   The billing address.
        #
        #   @return [WhopSDK::Models::CardCanceledWebhookEvent::Data::Billing, nil]
        required :billing, -> { WhopSDK::CardCanceledWebhookEvent::Data::Billing }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::CardCanceledWebhookEvent::Data::Limit, nil]
        required :limit, -> { WhopSDK::CardCanceledWebhookEvent::Data::Limit }, nil?: true
        ...
        # @!attribute object
        #
        #   @return [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Object]
        required :object, enum: -> { WhopSDK::CardCanceledWebhookEvent::Data::Object }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Status, nil]
        required :status, enum: -> { WhopSDK::CardCanceledWebhookEvent::Data::Status }, nil?: true

        # @!attribute type
        #   The card type.
        #
        #   @return [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Type, nil]
        required :type, enum: -> { WhopSDK::CardCanceledWebhookEvent::Data::Type }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::CardCanceledWebhookEvent::Data::Secrets, nil]
        optional :secrets, -> { WhopSDK::CardCanceledWebhookEvent::Data::Secrets }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::CardCanceledWebhookEvent::Data} for more details.
        #
        #   @param id [String] Card ID, prefixed `icrd_`.
        #
        #   @param billing [WhopSDK::Models::CardCanceledWebhookEvent::Data::Billing, nil] The billing address.
        #
        ...
        #
        #   @param limit [WhopSDK::Models::CardCanceledWebhookEvent::Data::Limit, nil] The spending limit configuration.
        #
        #   @param name [String, nil] Card display name.
        #
        #   @param object [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Object]
        #
        #   @param spent_last_month [Integer, nil] Total spend in the last 30 days, in cents.
        #
        #   @param status [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Status, nil] The card status. `denied` means the issuer declined the cardholder, so the card
        #
        #   @param type [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Type, nil] The card type.
        #
        #   @param user_id [String, nil] Cardholder user ID, prefixed `user_`, when assigned.
        #
        #   @param secrets [WhopSDK::Models::CardCanceledWebhookEvent::Data::Secrets, nil] Sensitive card details. Present only on `GET /cards/:id` for active cards; `null

        # @see WhopSDK::Models::CardCanceledWebhookEvent::Data#billing
        ...
        # @see WhopSDK::Models::CardCanceledWebhookEvent::Data#limit
        class Limit < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Limit::Frequency]
          required :frequency, enum: -> { WhopSDK::CardCanceledWebhookEvent::Data::Limit::Frequency }

          # @!method initialize(amount:, frequency:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::CardCanceledWebhookEvent::Data::Limit} for more details.
          #
          #   The spending limit configuration.
          #
          #   @param amount [Float] The limit amount in dollars.
          #
          #   @param frequency [Symbol, WhopSDK::Models::CardCanceledWebhookEvent::Data::Limit::Frequency] The window the limit amount applies to. `per_transaction` caps each individual a

          # The window the limit amount applies to. `per_transaction` caps each individual
          # authorization and is what a limit set with `transaction_limit` reports.
          #
          # @see WhopSDK::Models::CardCanceledWebhookEvent::Data::Limit#frequency
          module Frequency
        ...
        # @see WhopSDK::Models::CardCanceledWebhookEvent::Data#object
        module Object
          extend WhopSDK::Internal::Type::Enum
        ...
        # will never be issued.
        #
        # @see WhopSDK::Models::CardCanceledWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
        ...
        # The card type.
        #
        # @see WhopSDK::Models::CardCanceledWebhookEvent::Data#type
        module Type
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::CardCanceledWebhookEvent::Data#secrets
        class Secrets < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::CardCanceledWebhookEvent::Data::Secrets} for more details.
          #
          #   Sensitive card details. Present only on `GET /cards/:id` for active cards;
          #   `null` when the card is inactive or details cannot be retrieved.
          #
