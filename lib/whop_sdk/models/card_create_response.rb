...
module WhopSDK
  module Models
    ...
    class CardCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   The billing address.
      #
      #   @return [WhopSDK::Models::CardCreateResponse::Billing, nil]
      required :billing, -> { WhopSDK::Models::CardCreateResponse::Billing }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::CardCreateResponse::Limit, nil]
      required :limit, -> { WhopSDK::Models::CardCreateResponse::Limit }, nil?: true
      ...
      # @!attribute object
      #
      #   @return [Symbol, WhopSDK::Models::CardCreateResponse::Object]
      required :object, enum: -> { WhopSDK::Models::CardCreateResponse::Object }
      ...
      #   The card status.
      #
      #   @return [Symbol, WhopSDK::Models::CardCreateResponse::Status, nil]
      required :status, enum: -> { WhopSDK::Models::CardCreateResponse::Status }, nil?: true

      # @!attribute type
      #   The card type.
      #
      #   @return [Symbol, WhopSDK::Models::CardCreateResponse::Type, nil]
      required :type, enum: -> { WhopSDK::Models::CardCreateResponse::Type }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::CardCreateResponse::Secrets, nil]
      optional :secrets, -> { WhopSDK::Models::CardCreateResponse::Secrets }, nil?: true
      ...
      #   {WhopSDK::Models::CardCreateResponse} for more details.
      #
      #   @param id [String] Card ID, prefixed `icrd_`.
      #
      #   @param billing [WhopSDK::Models::CardCreateResponse::Billing, nil] The billing address.
      #
      ...
      #
      #   @param limit [WhopSDK::Models::CardCreateResponse::Limit, nil] The spending limit configuration.
      #
      #   @param name [String, nil] Card display name.
      #
      #   @param object [Symbol, WhopSDK::Models::CardCreateResponse::Object]
      #
      #   @param spent_last_month [Integer, nil] Total spend in the last 30 days, in cents.
      #
      #   @param status [Symbol, WhopSDK::Models::CardCreateResponse::Status, nil] The card status.
      #
      #   @param type [Symbol, WhopSDK::Models::CardCreateResponse::Type, nil] The card type.
      #
      #   @param user_id [String, nil] Cardholder user ID, prefixed `user_`, when assigned.
      #
      #   @param secrets [WhopSDK::Models::CardCreateResponse::Secrets, nil] Sensitive card details. Present only on `GET /cards/:card_id` for active cards;

      # @see WhopSDK::Models::CardCreateResponse#billing
      ...
      # @see WhopSDK::Models::CardCreateResponse#limit
      ...
      # @see WhopSDK::Models::CardCreateResponse#object
      module Object
      ...
      # The card status.
      #
      # @see WhopSDK::Models::CardCreateResponse#status
      module Status
        extend WhopSDK::Internal::Type::Enum
      ...
      # The card type.
      #
      # @see WhopSDK::Models::CardCreateResponse#type
      module Type
        extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::CardCreateResponse#secrets
