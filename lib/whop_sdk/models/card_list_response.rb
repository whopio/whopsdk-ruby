...
module WhopSDK
  module Models
    ...
    class CardListResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<WhopSDK::Models::CardListResponse::Data>]
      required :data, -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::CardListResponse::Data] }

      # @!method initialize(data:)
      #   @param data [Array<WhopSDK::Models::CardListResponse::Data>]
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   The billing address.
        #
        #   @return [WhopSDK::Models::CardListResponse::Data::Billing, nil]
        required :billing, -> { WhopSDK::Models::CardListResponse::Data::Billing }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::CardListResponse::Data::Limit, nil]
        required :limit, -> { WhopSDK::Models::CardListResponse::Data::Limit }, nil?: true
        ...
        # @!attribute object
        #
        #   @return [Symbol, WhopSDK::Models::CardListResponse::Data::Object]
        required :object, enum: -> { WhopSDK::Models::CardListResponse::Data::Object }
        ...
        #   The card status.
        #
        #   @return [Symbol, WhopSDK::Models::CardListResponse::Data::Status, nil]
        required :status, enum: -> { WhopSDK::Models::CardListResponse::Data::Status }, nil?: true

        # @!attribute type
        #   The card type.
        #
        #   @return [Symbol, WhopSDK::Models::CardListResponse::Data::Type, nil]
        required :type, enum: -> { WhopSDK::Models::CardListResponse::Data::Type }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::CardListResponse::Data::Secrets, nil]
        optional :secrets, -> { WhopSDK::Models::CardListResponse::Data::Secrets }, nil?: true
        ...
        #   {WhopSDK::Models::CardListResponse::Data} for more details.
        #
        #   @param id [String] Card ID, prefixed `icrd_`.
        #
        #   @param billing [WhopSDK::Models::CardListResponse::Data::Billing, nil] The billing address.
        #
        ...
        #
        #   @param limit [WhopSDK::Models::CardListResponse::Data::Limit, nil] The spending limit configuration.
        #
        #   @param name [String, nil] Card display name.
        #
        #   @param object [Symbol, WhopSDK::Models::CardListResponse::Data::Object]
        #
        #   @param spent_last_month [Integer, nil] Total spend in the last 30 days, in cents.
        #
        #   @param status [Symbol, WhopSDK::Models::CardListResponse::Data::Status, nil] The card status.
        #
        #   @param type [Symbol, WhopSDK::Models::CardListResponse::Data::Type, nil] The card type.
        #
        #   @param user_id [String, nil] Cardholder user ID, prefixed `user_`, when assigned.
        #
        #   @param secrets [WhopSDK::Models::CardListResponse::Data::Secrets, nil] Sensitive card details. Present only on `GET /cards/:card_id` for active cards;

        # @see WhopSDK::Models::CardListResponse::Data#billing
        ...
        # @see WhopSDK::Models::CardListResponse::Data#limit
        ...
        # @see WhopSDK::Models::CardListResponse::Data#object
        module Object
        ...
        # The card status.
        #
        # @see WhopSDK::Models::CardListResponse::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
        ...
        # The card type.
        #
        # @see WhopSDK::Models::CardListResponse::Data#type
        module Type
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::CardListResponse::Data#secrets
