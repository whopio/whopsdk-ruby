...
module WhopSDK
  module Models
    class CardTransactionCompletedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data]
      required :data, -> { WhopSDK::CardTransactionCompletedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"card_transaction.completed"]
      required :type, const: :"card_transaction.completed"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.completed")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::CardTransactionCompletedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"card_transaction.completed"] The webhook event type

      # @see WhopSDK::Models::CardTransactionCompletedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::CardTransactionCompletedWebhookEvent::Data::Status }

        # @!attribute transaction_type
        #   The kind of card transaction. Always `spend` today.
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data::TransactionType]
        required :transaction_type,
                 enum: -> { WhopSDK::CardTransactionCompletedWebhookEvent::Data::TransactionType }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data} for more details.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data::Status] Current status of the transaction.
        #
        #   @param transaction_type [Symbol, WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data::TransactionType] The kind of card transaction. Always `spend` today.
        #
        #   @param usd_amount [Float, nil] Amount charged in USD. Negative when the merchant refunded the card.

        # Current status of the transaction.
        #
        # @see WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data#status
        module Status
        ...
        # The kind of card transaction. Always `spend` today.
        #
        # @see WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data#transaction_type
