...
module WhopSDK
  module Models
    class CardTransactionCompletedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param data [WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data] A card transaction record.
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionCompletedWebhookEvent::Data::Status] The current lifecycle status of the transaction.
        #
