...
module WhopSDK
  module Models
    class CardTransactionCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data]
      required :data, -> { WhopSDK::CardTransactionCreatedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"card_transaction.created"]
      required :type, const: :"card_transaction.created"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::CardTransactionCreatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"card_transaction.created"] The webhook event type

      # @see WhopSDK::Models::CardTransactionCreatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::CardTransactionCreatedWebhookEvent::Data::Status }

        # @!attribute transaction_type
        #   The kind of card transaction. Always `spend` today.
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data::TransactionType]
        required :transaction_type,
                 enum: -> { WhopSDK::CardTransactionCreatedWebhookEvent::Data::TransactionType }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data} for more details.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data::Status] Current status of the transaction.
        #
        #   @param transaction_type [Symbol, WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data::TransactionType] The kind of card transaction. Always `spend` today.
        #
        #   @param usd_amount [Float, nil] Amount charged in USD. Negative when the merchant refunded the card.

        # Current status of the transaction.
        #
        # @see WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data#status
        module Status
        ...
        # The kind of card transaction. Always `spend` today.
        #
        # @see WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data#transaction_type
