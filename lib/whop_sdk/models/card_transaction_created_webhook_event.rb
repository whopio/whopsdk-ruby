...
module WhopSDK
  module Models
    class CardTransactionCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.created")
      ...
      #
      #   @param data [WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data] A card transaction record.
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionCreatedWebhookEvent::Data::Status] The current lifecycle status of the transaction.
        #
