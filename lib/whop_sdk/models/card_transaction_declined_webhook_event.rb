...
module WhopSDK
  module Models
    class CardTransactionDeclinedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.declined")
      ...
      #
      #   @param data [WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data] A card transaction record.
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data::Status] The current lifecycle status of the transaction.
        #
