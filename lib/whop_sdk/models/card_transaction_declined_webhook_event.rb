...
module WhopSDK
  module Models
    class CardTransactionDeclinedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data]
      required :data, -> { WhopSDK::CardTransactionDeclinedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"card_transaction.declined"]
      required :type, const: :"card_transaction.declined"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.declined")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::CardTransactionDeclinedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"card_transaction.declined"] The webhook event type

      # @see WhopSDK::Models::CardTransactionDeclinedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::CardTransactionDeclinedWebhookEvent::Data::Status }

        # @!attribute transaction_type
        #   The kind of card transaction. Always `spend` today.
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data::TransactionType]
        required :transaction_type,
                 enum: -> { WhopSDK::CardTransactionDeclinedWebhookEvent::Data::TransactionType }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data} for more details.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data::Status] Current status of the transaction.
        #
        #   @param transaction_type [Symbol, WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data::TransactionType] The kind of card transaction. Always `spend` today.
        #
        #   @param usd_amount [Float, nil] Amount charged in USD. Negative when the merchant refunded the card.

        # Current status of the transaction.
        #
        # @see WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data#status
        module Status
        ...
        # The kind of card transaction. Always `spend` today.
        #
        # @see WhopSDK::Models::CardTransactionDeclinedWebhookEvent::Data#transaction_type
