...
module WhopSDK
  module Models
    class CardTransactionReversedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.reversed")
      ...
      #
      #   @param data [WhopSDK::Models::CardTransactionReversedWebhookEvent::Data] A card transaction record.
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionReversedWebhookEvent::Data::Status] The current lifecycle status of the transaction.
        #
