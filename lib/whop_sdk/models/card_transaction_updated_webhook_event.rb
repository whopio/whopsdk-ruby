...
module WhopSDK
  module Models
    class CardTransactionUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.updated")
      ...
      #
      #   @param data [WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data] A card transaction record.
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data::Status] The current lifecycle status of the transaction.
        #
