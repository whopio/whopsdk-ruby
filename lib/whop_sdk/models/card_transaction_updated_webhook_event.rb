...
module WhopSDK
  module Models
    class CardTransactionUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data]
      required :data, -> { WhopSDK::CardTransactionUpdatedWebhookEvent::Data }
      ...
      required :type, const: :"card_transaction.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"card_transaction.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::CardTransactionUpdatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"card_transaction.updated"] The webhook event type

      # @see WhopSDK::Models::CardTransactionUpdatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::CardTransactionUpdatedWebhookEvent::Data::Status }

        # @!attribute transaction_type
        #   The kind of card transaction. Always `spend` today.
        #
        #   @return [Symbol, WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data::TransactionType]
        required :transaction_type,
                 enum: -> { WhopSDK::CardTransactionUpdatedWebhookEvent::Data::TransactionType }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data} for more details.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data::Status] Current status of the transaction.
        #
        #   @param transaction_type [Symbol, WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data::TransactionType] The kind of card transaction. Always `spend` today.
        #
        #   @param usd_amount [Float, nil] Amount charged in USD. Negative when the merchant refunded the card.

        # Current status of the transaction.
        #
        # @see WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data#status
        module Status
        ...
        # The kind of card transaction. Always `spend` today.
        #
        # @see WhopSDK::Models::CardTransactionUpdatedWebhookEvent::Data#transaction_type
