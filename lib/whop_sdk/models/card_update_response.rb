...
module WhopSDK
  module Models
    ...
    class CardUpdateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   The billing address.
      #
      #   @return [WhopSDK::Models::CardUpdateResponse::Billing, nil]
      ...
      #
      #   @return [WhopSDK::Models::CardUpdateResponse::Limit, nil]
      ...
      # @!attribute object
      #
      #   @return [Symbol, WhopSDK::Models::CardUpdateResponse::Object]
      ...
      #   The card status.
      #
      #   @return [Symbol, WhopSDK::Models::CardUpdateResponse::Status, nil]
      required :status, enum: -> { WhopSDK::Models::CardUpdateResponse::Status }, nil?: true

      # @!attribute type
      #   The card type.
      #
      #   @return [Symbol, WhopSDK::Models::CardUpdateResponse::Type, nil]
      ...
      #
      #   @return [WhopSDK::Models::CardUpdateResponse::Secrets, nil]
      ...
      #   {WhopSDK::Models::CardUpdateResponse} for more details.
      #
      #   @param id [String] Card ID, prefixed `icrd_`.
      #
      #   @param billing [WhopSDK::Models::CardUpdateResponse::Billing, nil] The billing address.
      #
      ...
      #
      #   @param limit [WhopSDK::Models::CardUpdateResponse::Limit, nil] The spending limit configuration.
      #
      #   @param name [String, nil] Card display name.
      #
      #   @param object [Symbol, WhopSDK::Models::CardUpdateResponse::Object]
      #
      #   @param spent_last_month [Integer, nil] Total spend in the last 30 days, in cents.
      #
      #   @param status [Symbol, WhopSDK::Models::CardUpdateResponse::Status, nil] The card status.
      #
      #   @param type [Symbol, WhopSDK::Models::CardUpdateResponse::Type, nil] The card type.
      #
      #   @param user_id [String, nil] Cardholder user ID, prefixed `user_`, when assigned.
      #
      #   @param secrets [WhopSDK::Models::CardUpdateResponse::Secrets, nil] Sensitive card details. Present only on `GET /cards/:card_id` for active cards;

      # @see WhopSDK::Models::CardUpdateResponse#billing
      ...
      # @see WhopSDK::Models::CardUpdateResponse#limit
      ...
      # @see WhopSDK::Models::CardUpdateResponse#object
      module Object
      ...
      # The card status.
      #
      # @see WhopSDK::Models::CardUpdateResponse#status
      module Status
        extend WhopSDK::Internal::Type::Enum
      ...
      # The card type.
      #
      # @see WhopSDK::Models::CardUpdateResponse#type
      module Type
        extend WhopSDK::Internal::Type::Enum
      ...
      # @see WhopSDK::Models::CardUpdateResponse#secrets
