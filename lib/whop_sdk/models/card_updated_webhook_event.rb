...
module WhopSDK
  module Models
    class CardUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::CardUpdatedWebhookEvent::Data]
      required :data, -> { WhopSDK::CardUpdatedWebhookEvent::Data }
      ...
      required :type, const: :"card.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"card.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::CardUpdatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::CardUpdatedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"card.updated"] The webhook event type

      # @see WhopSDK::Models::CardUpdatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   The billing address.
        #
        #   @return [WhopSDK::Models::CardUpdatedWebhookEvent::Data::Billing, nil]
        required :billing, -> { WhopSDK::CardUpdatedWebhookEvent::Data::Billing }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::CardUpdatedWebhookEvent::Data::Limit, nil]
        required :limit, -> { WhopSDK::CardUpdatedWebhookEvent::Data::Limit }, nil?: true
        ...
        # @!attribute object
        #
        #   @return [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Object]
        required :object, enum: -> { WhopSDK::CardUpdatedWebhookEvent::Data::Object }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Status, nil]
        required :status, enum: -> { WhopSDK::CardUpdatedWebhookEvent::Data::Status }, nil?: true

        # @!attribute type
        #   The card type.
        #
        #   @return [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Type, nil]
        required :type, enum: -> { WhopSDK::CardUpdatedWebhookEvent::Data::Type }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::CardUpdatedWebhookEvent::Data::Secrets, nil]
        optional :secrets, -> { WhopSDK::CardUpdatedWebhookEvent::Data::Secrets }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::CardUpdatedWebhookEvent::Data} for more details.
        #
        #   @param id [String] Card ID, prefixed `icrd_`.
        #
        #   @param billing [WhopSDK::Models::CardUpdatedWebhookEvent::Data::Billing, nil] The billing address.
        #
        ...
        #
        #   @param limit [WhopSDK::Models::CardUpdatedWebhookEvent::Data::Limit, nil] The spending limit configuration.
        #
        #   @param name [String, nil] Card display name.
        #
        #   @param object [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Object]
        #
        #   @param spent_last_month [Integer, nil] Total spend in the last 30 days, in cents.
        #
        #   @param status [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Status, nil] The card status. `denied` means the issuer declined the cardholder, so the card
        #
        #   @param type [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Type, nil] The card type.
        #
        #   @param user_id [String, nil] Cardholder user ID, prefixed `user_`, when assigned.
        #
        #   @param secrets [WhopSDK::Models::CardUpdatedWebhookEvent::Data::Secrets, nil] Sensitive card details. Present only on `GET /cards/:id` for active cards; `null

        # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data#billing
        ...
        # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data#limit
        class Limit < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Limit::Frequency]
          required :frequency, enum: -> { WhopSDK::CardUpdatedWebhookEvent::Data::Limit::Frequency }

          # @!method initialize(amount:, frequency:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::CardUpdatedWebhookEvent::Data::Limit} for more details.
          #
          #   The spending limit configuration.
          #
          #   @param amount [Float] The limit amount in dollars.
          #
          #   @param frequency [Symbol, WhopSDK::Models::CardUpdatedWebhookEvent::Data::Limit::Frequency] The window the limit amount applies to. `per_transaction` caps each individual a

          # The window the limit amount applies to. `per_transaction` caps each individual
          # authorization and is what a limit set with `transaction_limit` reports.
          #
          # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data::Limit#frequency
          module Frequency
        ...
        # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data#object
        module Object
          extend WhopSDK::Internal::Type::Enum
        ...
        # will never be issued.
        #
        # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
        ...
        # The card type.
        #
        # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data#type
        module Type
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::CardUpdatedWebhookEvent::Data#secrets
        class Secrets < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::CardUpdatedWebhookEvent::Data::Secrets} for more details.
          #
          #   Sensitive card details. Present only on `GET /cards/:id` for active cards;
          #   `null` when the card is inactive or details cannot be retrieved.
          #
