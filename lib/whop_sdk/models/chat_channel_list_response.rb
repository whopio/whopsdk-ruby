...
module WhopSDK
  module Models
    ...
    class ChatChannelListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   {WhopSDK::Models::ChatChannelListResponse} for more details.
      #
      ...
      #
      #   @param experience [WhopSDK::Models::ChatChannelListResponse::Experience] The experience this chat feed is attached to.
      #
      ...
      class Experience < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::ChatChannelListResponse::Experience} for more details.
        #
        #   The experience this chat feed is attached to.
        #
