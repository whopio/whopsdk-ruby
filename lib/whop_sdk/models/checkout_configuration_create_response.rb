...
module WhopSDK
  module Models
    ...
    class CheckoutConfigurationCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   override.
      #
      #   @return [WhopSDK::Models::CheckoutConfigurationCreateResponse::EffectivePaymentMethodConfiguration, nil]
      ...
      #   policy.
      #
      #   @return [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::ThreeDSLevel, nil]
      optional :three_ds_level,
               enum: -> { WhopSDK::Models::CheckoutConfigurationCreateResponse::ThreeDSLevel },
               nil?: true
      ...
      #
      #   @param mode [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Mode] Controls whether checkout charges the buyer immediately or saves payment details
      #
      ...
      #
      #   @param effective_payment_method_configuration [WhopSDK::Models::CheckoutConfigurationCreateResponse::EffectivePaymentMethodConfiguration, nil] The configuration governing a checkout mounted from this configuration, resolved
      #
      ...
      #
      #   @param three_ds_level [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::ThreeDSLevel, nil] 3D Secure behavior for supported on-session card payments. `mandate_challenge` r
      ...
      # @see WhopSDK::Models::CheckoutConfigurationCreateResponse#effective_payment_method_configuration
      ...
      class Plan < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::PlanType]
        required :plan_type, enum: -> { WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::PlanType }

        # @!attribute release_method
        #   Sales method for the plan.
        #
        #   @return [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::ReleaseMethod]
        required :release_method,
                 enum: -> { WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::ReleaseMethod }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::ThreeDSLevel, nil]
        required :three_ds_level,
                 enum: -> { WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::ThreeDSLevel },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::Visibility]
        required :visibility, enum: -> { WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::Visibility }
        ...
        #
        #   @param plan_type [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::PlanType] Billing model for the plan.
        #
        #   @param release_method [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::ReleaseMethod] Sales method for the plan.
        #
        #   @param renewal_price [Float] Recurring price charged each billing period.
        #
        #   @param three_ds_level [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::ThreeDSLevel, nil] 3D Secure behavior for supported on-session card payments. `mandate_challenge` r
        #
        #   @param trial_period_days [Integer, nil] Free trial days before the first renewal charge.
        #
        #   @param visibility [Symbol, WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan::Visibility] Whether the plan is visible to customers or hidden from public view.

        # Billing model for the plan.
        #
        # @see WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan#plan_type
        module PlanType
          extend WhopSDK::Internal::Type::Enum
        ...
        # Sales method for the plan.
        #
        # @see WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan#release_method
        ...
        # `null` inherits the account default.
        #
        # @see WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan#three_ds_level
        module ThreeDSLevel
          extend WhopSDK::Internal::Type::Enum
        ...
        # Whether the plan is visible to customers or hidden from public view.
        #
        # @see WhopSDK::Models::CheckoutConfigurationCreateResponse::Plan#visibility
        module Visibility
          extend WhopSDK::Internal::Type::Enum
      ...
      # policy.
      #
      # @see WhopSDK::Models::CheckoutConfigurationCreateResponse#three_ds_level
      module ThreeDSLevel
        extend WhopSDK::Internal::Type::Enum
