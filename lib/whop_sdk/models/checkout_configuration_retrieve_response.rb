...
module WhopSDK
  module Models
    ...
    class CheckoutConfigurationRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param mode [Symbol, WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Mode] Checkout mode: `payment` collects payment now; `setup` saves payment details for
      #
