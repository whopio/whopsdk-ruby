...
module WhopSDK
  module Models
    ...
    class Course < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::Course::ResumeLesson, nil]
      required :resume_lesson, -> { WhopSDK::Course::ResumeLesson }, nil?: true
      ...
      # @!method initialize(id:, certificate_after_completion_enabled:, chapters:, chapters_count:, completed_lessons_count:, cover_image:, created_at:, description:, language:, latest_lesson_created_at:, lesson_unlock_days:, order:, require_completing_lessons_in_order:, resume_lesson:, started_at:, tagline:, thumbnail:, title:, total_duration_seconds:, total_lessons_count:, updated_at:, visibility:)
      ...
      #
      #   @param resume_lesson [WhopSDK::Models::Course::ResumeLesson, nil] The lesson the current user should continue from: their first incomplete lesson,
      #
      ...
      # @see WhopSDK::Models::Course#resume_lesson
