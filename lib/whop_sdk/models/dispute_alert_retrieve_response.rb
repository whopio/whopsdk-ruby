...
module WhopSDK
  module Models
    # @see WhopSDK::Resources::DisputeAlerts#retrieve
    class DisputeAlertRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::DisputeAlertRetrieveResponse::Dispute, nil]
      ...
      #
      #   @return [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment, nil]
      ...
      #
      #   @param dispute [WhopSDK::Models::DisputeAlertRetrieveResponse::Dispute, nil] The dispute associated with the dispute alert.
      #
      #   @param payment [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment, nil] The payment associated with the dispute alert.
      #
      #   @param transaction_date [Time, nil] The date of the original transaction.

      # @see WhopSDK::Models::DisputeAlertRetrieveResponse#dispute
      class Dispute < WhopSDK::Internal::Type::BaseModel
        ...
        #   {WhopSDK::Models::DisputeAlertRetrieveResponse::Dispute} for more details.
        #
        #   The dispute associated with the dispute alert.
        #
      ...
      # @see WhopSDK::Models::DisputeAlertRetrieveResponse#payment
      class Payment < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::Member, nil]
        required :member, -> { WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::Member }, nil?: true

        # @!attribute membership
        #   The membership attached to this payment.
        #
        #   @return [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::Membership, nil]
        required :membership,
        ...
        #
        #   @return [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::User, nil]
        required :user, -> { WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::User }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::DisputeAlertRetrieveResponse::Payment} for more details.
        #
        #   The payment associated with the dispute alert.
        #
        ...
        #
        #   @param member [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::Member, nil] The member attached to this payment.
        #
        #   @param membership [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::Membership, nil] The membership attached to this payment.
        #
        ...
        #
        #   @param user [WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::User, nil] The user that made this payment.

        # @see WhopSDK::Models::DisputeAlertRetrieveResponse::Payment#member
        ...
        # @see WhopSDK::Models::DisputeAlertRetrieveResponse::Payment#membership
        ...
        # @see WhopSDK::Models::DisputeAlertRetrieveResponse::Payment#user
        class User < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeAlertRetrieveResponse::Payment::User} for more details.
          #
          #   The user that made this payment.
          #
