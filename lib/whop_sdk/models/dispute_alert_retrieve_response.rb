...
module WhopSDK
  module Models
    ...
    class DisputeAlertRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   `actionable` is true.
      #
      #   @return [Symbol, WhopSDK::Models::DisputeAlertRetrieveResponse::NotActionableReason, nil]
      required :not_actionable_reason,
               enum: -> { WhopSDK::Models::DisputeAlertRetrieveResponse::NotActionableReason },
               nil?: true
      ...
      #
      #   @return [Symbol, WhopSDK::Models::DisputeAlertRetrieveResponse::Type]
      required :type, enum: -> { WhopSDK::Models::DisputeAlertRetrieveResponse::Type }
      ...
      #   {WhopSDK::Models::DisputeAlertRetrieveResponse} for more details.
      #
      ...
      #
      #   @param not_actionable_reason [Symbol, WhopSDK::Models::DisputeAlertRetrieveResponse::NotActionableReason, nil] Why refunding can no longer avoid a chargeback. `network_resolved` when a Visa R
      #
      ...
      #
      #   @param type [Symbol, WhopSDK::Models::DisputeAlertRetrieveResponse::Type] What the issuer sent. `early_fraud_warning` is a fraud report on a settled payme
      #
      ...
      # `actionable` is true.
      #
      # @see WhopSDK::Models::DisputeAlertRetrieveResponse#not_actionable_reason
      ...
      # refunding the payment — nothing is left to act on.
      #
      # @see WhopSDK::Models::DisputeAlertRetrieveResponse#type
      module Type
        extend WhopSDK::Internal::Type::Enum
