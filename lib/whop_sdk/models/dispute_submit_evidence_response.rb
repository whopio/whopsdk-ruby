...
module WhopSDK
  module Models
    ...
    class DisputeSubmitEvidenceResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::CancellationPolicyAttachment, nil]
      required :cancellation_policy_attachment,
               -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::CancellationPolicyAttachment },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Company, nil]
      required :company, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Company }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::CustomerCommunicationAttachment, nil]
      required :customer_communication_attachment,
               -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::CustomerCommunicationAttachment },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment, nil]
      required :payment, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment }, nil?: true

      # @!attribute plan
      #   The plan associated with the disputed payment. Null if the dispute is not linked
      #   to a specific plan.
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan, nil]
      required :plan, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan }, nil?: true

      # @!attribute product
      #   The product associated with the disputed payment. Null if the dispute is not
      #   linked to a specific product.
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Product, nil]
      required :product, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Product }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::RefundPolicyAttachment, nil]
      required :refund_policy_attachment,
               -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::RefundPolicyAttachment },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::UncategorizedAttachment, nil]
      required :uncategorized_attachment,
               -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::UncategorizedAttachment },
               nil?: true
      ...
      #   {WhopSDK::Models::DisputeSubmitEvidenceResponse} for more details.
      #
      ...
      #
      #   @param cancellation_policy_attachment [WhopSDK::Models::DisputeSubmitEvidenceResponse::CancellationPolicyAttachment, nil] The cancellation policy document uploaded as dispute evidence. Null if no cancel
      #
      ...
      #
      #   @param company [WhopSDK::Models::DisputeSubmitEvidenceResponse::Company, nil] The company that the dispute was filed against.
      #
      ...
      #
      #   @param customer_communication_attachment [WhopSDK::Models::DisputeSubmitEvidenceResponse::CustomerCommunicationAttachment, nil] Evidence of customer communication or product usage, uploaded as a dispute attac
      #
      ...
      #
      #   @param payment [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment, nil] The original payment that was disputed.
      #
      #   @param plan [WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan, nil] The plan associated with the disputed payment. Null if the dispute is not linked
      #
      #   @param product [WhopSDK::Models::DisputeSubmitEvidenceResponse::Product, nil] The product associated with the disputed payment. Null if the dispute is not lin
      #
      ...
      #
      #   @param refund_policy_attachment [WhopSDK::Models::DisputeSubmitEvidenceResponse::RefundPolicyAttachment, nil] The refund policy document uploaded as dispute evidence. Null if no refund polic
      #
      ...
      #
      #   @param uncategorized_attachment [WhopSDK::Models::DisputeSubmitEvidenceResponse::UncategorizedAttachment, nil] An additional attachment that does not fit into the standard evidence categories
      #
      #   @param visa_rdr [Boolean] Whether the dispute was automatically resolved through Visa Rapid Dispute Resolu

      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#cancellation_policy_attachment
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#company
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#customer_communication_attachment
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#payment
      class Payment < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Member, nil]
        required :member, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Member }, nil?: true

        # @!attribute membership
        #   The membership attached to this payment.
        #
        #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Membership, nil]
        required :membership,
                 -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Membership },
                 nil?: true
        ...
        #
        #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument, nil]
        required :payment_instrument,
                 -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument },
                 nil?: true
        ...
        #
        #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::User, nil]
        required :user, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::User }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment} for more details.
        #
        #   The original payment that was disputed.
        #
        ...
        #
        #   @param member [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Member, nil] The member attached to this payment.
        #
        #   @param membership [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Membership, nil] The membership attached to this payment.
        #
        #   @param paid_at [Time, nil] The time at which this payment was successfully collected. Null if the payment h
        #
        #   @param payment_instrument [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument, nil] The instrument this payment was made with, shaped for display: the method type,
        #
        ...
        #
        #   @param user [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::User, nil] The user that made this payment.

        # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment#member
        ...
        # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment#membership
        ...
        # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment#payment_instrument
        class PaymentInstrument < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons]
          required :icons, -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument} for
          #   more details.
          #
          #   The instrument this payment was made with, shaped for display: the method type,
          #   a buyer-facing name, the standard icon set, and the card facts when it was a
          ...
          #
          #   @param icons [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons] The standard icon set: square and card shapes, each in light and dark colorways.
          #
          ...
          # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument#icons
          class Icons < WhopSDK::Internal::Type::BaseModel
            # @!attribute square
            #   The square tile (32x32).
            #
            #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square]
            required :square,
                     -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square }

            # @!method initialize(square:)
            #   The standard icon set: square and card shapes, each in light and dark colorways.
            #
            #   @param square [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square] The square tile (32x32).

            # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons#square
            class Square < WhopSDK::Internal::Type::BaseModel
              # @!attribute dark
              #   The colorway for dark surfaces.
              #
              #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Dark]
              required :dark,
                       -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Dark }

              # @!attribute light
              #   The colorway for light surfaces.
              #
              #   @return [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Light]
              required :light,
                       -> { WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Light }

              # @!method initialize(dark:, light:)
              #   The square tile (32x32).
              #
              #   @param dark [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Dark] The colorway for dark surfaces.
              #
              #   @param light [WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Light] The colorway for light surfaces.

              # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square#dark
              ...
              # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square#light
        ...
        # @see WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment#user
        class User < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::User} for more
          #   details.
          #
          #   The user that made this payment.
          #
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#plan
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, title:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::DisputeSubmitEvidenceResponse::Product} for more details.
        #
        #   The product associated with the disputed payment. Null if the dispute is not
        #   linked to a specific product.
        #
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#refund_policy_attachment
      class RefundPolicyAttachment < WhopSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, content_type:, filename:, url:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::DisputeSubmitEvidenceResponse::RefundPolicyAttachment} for
        #   more details.
        #
        #   The refund policy document uploaded as dispute evidence. Null if no refund
        #   policy has been provided.
      ...
      # @see WhopSDK::Models::DisputeSubmitEvidenceResponse#uncategorized_attachment
      class UncategorizedAttachment < WhopSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, content_type:, filename:, url:)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::DisputeSubmitEvidenceResponse::UncategorizedAttachment} for
        #   more details.
        #
        #   An additional attachment that does not fit into the standard evidence
        #   categories. Null if not provided.
