...
module WhopSDK
  module Models
    class DisputeUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data]
      required :data, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data }
      ...
      #
      #   @param data [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data] An object representing a dispute against a company.
      #
      ...
      # @see WhopSDK::Models::DisputeUpdatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::CancellationPolicyAttachment, nil]
        required :cancellation_policy_attachment,
                 -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::CancellationPolicyAttachment },
                 nil?: true
        ...
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Company, nil]
        required :company, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Company }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::CustomerCommunicationAttachment, nil]
        required :customer_communication_attachment,
                 -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::CustomerCommunicationAttachment },
                 nil?: true
        ...
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment, nil]
        required :payment, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment }, nil?: true

        # @!attribute plan
        #   The plan that got disputed
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Plan, nil]
        required :plan, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Plan }, nil?: true

        # @!attribute product
        #   The product that got disputed
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Product, nil]
        required :product, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Product }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::RefundPolicyAttachment, nil]
        required :refund_policy_attachment,
                 -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::RefundPolicyAttachment },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Status }

        # @!attribute uncategorized_attachment
        #   An attachment that did not fit into the other categories
        #
        #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::UncategorizedAttachment, nil]
        required :uncategorized_attachment,
                 -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::UncategorizedAttachment },
                 nil?: true
        ...
        #   {WhopSDK::Models::DisputeUpdatedWebhookEvent::Data} for more details.
        #
        #   An object representing a dispute against a company.
        #
        ...
        #
        #   @param cancellation_policy_attachment [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::CancellationPolicyAttachment, nil] The cancellation policy for this dispute
        #
        #   @param cancellation_policy_disclosure [String, nil] A cancellation policy disclosure from the company.
        #
        #   @param company [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Company, nil] The company the dispute is against.
        #
        #   @param created_at [Time, nil] When it was made.
        #
        #   @param currency [Symbol, WhopSDK::Models::Currency] The currency of the dispute.
        #
        #   @param customer_communication_attachment [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::CustomerCommunicationAttachment, nil] The customer communication for this dispute
        #
        ...
        #
        #   @param payment [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment, nil] The payment that got disputed
        #
        #   @param plan [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Plan, nil] The plan that got disputed
        #
        #   @param product [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Product, nil] The product that got disputed
        #
        ...
        #
        #   @param refund_policy_attachment [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::RefundPolicyAttachment, nil] The refund policy for this dispute
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Status] The status of the dispute (mimics stripe's dispute status).
        #
        #   @param uncategorized_attachment [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::UncategorizedAttachment, nil] An attachment that did not fit into the other categories
        #
        #   @param visa_rdr [Boolean] Whether or not the dispute is a Visa Rapid Dispute Resolution.

        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#cancellation_policy_attachment
        class CancellationPolicyAttachment < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::CancellationPolicyAttachment}
          #   for more details.
          #
          #   The cancellation policy for this dispute
          #
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#company
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#customer_communication_attachment
        class CustomerCommunicationAttachment < WhopSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(id:, content_type:, filename:, url:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::CustomerCommunicationAttachment}
          #   for more details.
          #
          #   The customer communication for this dispute
          #
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#payment
        class Payment < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment::Member, nil]
          required :member, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::Member }, nil?: true

          # @!attribute membership
          #   The membership attached to this payment.
          #
          #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment::Membership, nil]
          required :membership,
                   -> {
                     WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::Membership
                   },
                   nil?: true
          ...
          #
          #   @return [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment::User, nil]
          required :user, -> { WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::User }, nil?: true
          ...
          #
          #   @param member [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment::Member, nil] The member attached to this payment.
          #
          #   @param membership [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment::Membership, nil] The membership attached to this payment.
          #
          ...
          #
          #   @param user [WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment::User, nil] The user that made this payment.

          # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment#member
          ...
          # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment#membership
          ...
          # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::Payment#user
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#plan
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#product
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#refund_policy_attachment
        class RefundPolicyAttachment < WhopSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(id:, content_type:, filename:, url:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::RefundPolicyAttachment} for
          #   more details.
          #
          #   The refund policy for this dispute
          #
        ...
        # The status of the dispute (mimics stripe's dispute status).
        #
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#status
        module Status
        ...
        # @see WhopSDK::Models::DisputeUpdatedWebhookEvent::Data#uncategorized_attachment
        class UncategorizedAttachment < WhopSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(id:, content_type:, filename:, url:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::DisputeUpdatedWebhookEvent::Data::UncategorizedAttachment} for
          #   more details.
          #
          #   An attachment that did not fit into the other categories
          #
