...
module WhopSDK
  module Models
    class EntryApprovedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"entry.approved")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::EntryApprovedWebhookEvent} for more details.
      #
