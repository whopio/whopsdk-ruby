...
module WhopSDK
  module Models
    class EntryCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"entry.created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::EntryCreatedWebhookEvent} for more details.
      #
