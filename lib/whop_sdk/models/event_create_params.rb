...
module WhopSDK
  module Models
    ...
    class EventCreateParams < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::EventCreateParams::User, nil]
      ...
      # @!method initialize(account_id:, event_name:, action_source: nil, context: nil, currency: nil, custom_name: nil, duration: nil, event_id: nil, event_time: nil, plan_id: nil, product_id: nil, referrer_url: nil, resumed: nil, source: nil, title: nil, url: nil, user: nil, value: nil, request_options: {})
      ...
      class User < WhopSDK::Internal::Type::BaseModel
        ...
        #   Gender
        #
        #   @return [Symbol, WhopSDK::Models::EventCreateParams::User::Gender, nil]
        optional :gender, enum: -> { WhopSDK::EventCreateParams::User::Gender }, nil?: true
        ...
        #
        #   @param gender [Symbol, WhopSDK::Models::EventCreateParams::User::Gender, nil] Gender
        #
        ...
        # Gender
        #
        # @see WhopSDK::Models::EventCreateParams::User#gender
        module Gender
          extend WhopSDK::Internal::Type::Enum
