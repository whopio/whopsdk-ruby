...
module WhopSDK
  module Models
    class ExportCompletedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::ExportCompletedWebhookEvent::Data]
      required :data, -> { WhopSDK::ExportCompletedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"export.completed"]
      required :type, const: :"export.completed"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"export.completed")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ExportCompletedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::ExportCompletedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"export.completed"] The webhook event type

      # @see WhopSDK::Models::ExportCompletedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::ExportCompletedWebhookEvent::Data::Resource]
        required :resource, enum: -> { WhopSDK::ExportCompletedWebhookEvent::Data::Resource }
        ...
        #   deleted.
        #
        #   @return [Symbol, WhopSDK::Models::ExportCompletedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::ExportCompletedWebhookEvent::Data::Status }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::ExportCompletedWebhookEvent::Data} for more details.
        #
        ...
        #
        #   @param resource [Symbol, WhopSDK::Models::ExportCompletedWebhookEvent::Data::Resource] The resource that was exported, e.g. `receipts`, `members`, or `payouts`.
        #
        #   @param status [Symbol, WhopSDK::Models::ExportCompletedWebhookEvent::Data::Status] `pending` or `processing` while the file is generated, `completed` when the down
        #
        #   @param updated_at [String] When the export last changed, as an ISO 8601 timestamp.

        # The resource that was exported, e.g. `receipts`, `members`, or `payouts`.
        #
        # @see WhopSDK::Models::ExportCompletedWebhookEvent::Data#resource
        module Resource
        ...
        # deleted.
        #
        # @see WhopSDK::Models::ExportCompletedWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
