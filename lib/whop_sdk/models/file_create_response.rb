...
module WhopSDK
  module Models
    ...
    class FileCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<WhopSDK::Models::FileCreateResponse::MultipartUploadURL>, nil]
      optional :multipart_upload_urls,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::FileCreateResponse::MultipartUploadURL] },
               nil?: true
      ...
      #
      #   @param upload_status [Symbol, WhopSDK::Models::FileCreateResponse::UploadStatus] Where the file is in its upload lifecycle.
      #
      #   @param url [String, nil] A URL to download the file: a permanent CDN URL for public files, a signed expir
      #
      #   @param visibility [Symbol, WhopSDK::Models::FileCreateResponse::Visibility] `public` files are served via an unsigned CDN URL; `private` files via a signed,
      #
      ...
      #
      #   @param multipart_upload_urls [Array<WhopSDK::Models::FileCreateResponse::MultipartUploadURL>, nil]
      #
