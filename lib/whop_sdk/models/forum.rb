...
module WhopSDK
  module Models
    class Forum < WhopSDK::Internal::Type::BaseModel
      ...
      #   Some parameter documentations has been truncated, see {WhopSDK::Models::Forum}
      #   for more details.
      #
      ...
      #
      #   @param experience [WhopSDK::Models::Forum::Experience] The parent experience that this forum belongs to.
      #
