...
module WhopSDK
  module Models
    ...
    class ForumListParams < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(account_id:, after: nil, before: nil, first: nil, last: nil, product_id: nil, request_options: {})
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ForumListParams} for more details.
      #
      #   @param account_id [String] The unique identifier of the company to list forums for.
      #
      ...
      #
      #   @param product_id [String] The unique identifier of a product to filter by. When set, only forums connected
      #
