...
module WhopSDK
  module Models
    ...
    class ForumPostCreateParams < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(experience_id:, account_id: nil, attachments: nil, content: nil, is_mention: nil, parent_id: nil, paywall_amount: nil, paywall_currency: nil, pinned: nil, poll: nil, rich_content: nil, title: nil, visibility: nil, request_options: {})
