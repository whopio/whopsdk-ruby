...
module WhopSDK
  module Models
    ...
    class ForumPostListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<WhopSDK::Models::ForumPostListResponse::Attachment>]
      ...
      #
      #   @param attachments [Array<WhopSDK::Models::ForumPostListResponse::Attachment>] All file attachments on this post, such as images, documents, and videos.
      #
      ...
      class Attachment < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::ForumPostListResponse::Attachment} for more details.
        #
