...
module WhopSDK
  module Models
    # @see WhopSDK::Resources::IdentityProfiles#retrieve
    class IdentityProfile < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #   `business` profiles.
      #
      #   @return [WhopSDK::Models::IdentityProfile::BusinessAddress, nil]
      required :business_address, -> { WhopSDK::IdentityProfile::BusinessAddress }, nil?: true
      ...
      #
      #   @return [Array<WhopSDK::Models::IdentityProfile::LinkedCompany>]
      required :linked_companies,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::IdentityProfile::LinkedCompany] }

      # @!attribute personal_address
      #   Residential address reported by the identity provider. Present on `individual`
      #   profiles.
      #
      #   @return [WhopSDK::Models::IdentityProfile::PersonalAddress, nil]
      required :personal_address, -> { WhopSDK::IdentityProfile::PersonalAddress }, nil?: true
      ...
      #   first.
      #
      #   @return [Array<WhopSDK::Models::IdentityProfile::Verification>]
      required :verifications, -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::IdentityProfile::Verification] }
      ...
      #   {WhopSDK::Models::IdentityProfile} for more details.
      #
      ...
      #
      #   @param business_address [WhopSDK::Models::IdentityProfile::BusinessAddress, nil] Registered business address reported by the identity provider. Present on `busin
      #
      ...
      #
      #   @param linked_companies [Array<WhopSDK::Models::IdentityProfile::LinkedCompany>] The companies this identity profile is currently linked to. Only populated for d
      #
      #   @param personal_address [WhopSDK::Models::IdentityProfile::PersonalAddress, nil] Residential address reported by the identity provider. Present on `individual` p
      #
      ...
      #
      #   @param verifications [Array<WhopSDK::Models::IdentityProfile::Verification>] All verification attempts attached to this identity profile, ordered most-recent

      # @see WhopSDK::Models::IdentityProfile#business_address
      ...
      # @see WhopSDK::Models::IdentityProfile#personal_address
      ...
      class Verification < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::IdentityProfile::Verification} for more details.
        #
