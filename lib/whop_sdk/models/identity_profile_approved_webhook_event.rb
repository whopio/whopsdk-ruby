...
module WhopSDK
  module Models
    class IdentityProfileApprovedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, api_version: :v1, type: :"identity_profile.approved")
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Status] Derived verification status across all linked verifications. Returns `action_req
        #
