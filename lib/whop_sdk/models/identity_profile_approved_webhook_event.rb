...
module WhopSDK
  module Models
    class IdentityProfileApprovedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #   data.
      #
      #   @return [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data]
      required :data, -> { WhopSDK::IdentityProfileApprovedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"identity_profile.approved"]
      required :type, const: :"identity_profile.approved"
      ...
      # @!method initialize(id:, data:, timestamp:, company_id: nil, api_version: :v1, type: :"identity_profile.approved")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::IdentityProfileApprovedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param data [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data] A consolidated identity or business profile synced from verification provider da
      #
      ...
      #
      #   @param type [Symbol, :"identity_profile.approved"] The webhook event type

      # @see WhopSDK::Models::IdentityProfileApprovedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   `business` profiles.
        #
        #   @return [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::BusinessAddress, nil]
        required :business_address,
                 -> { WhopSDK::IdentityProfileApprovedWebhookEvent::Data::BusinessAddress },
                 nil?: true
        ...
        #
        #   @return [Array<WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::LinkedCompany>]
        required :linked_companies,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::IdentityProfileApprovedWebhookEvent::Data::LinkedCompany] }

        # @!attribute personal_address
        #   Residential address reported by the identity provider. Present on `individual`
        #   profiles.
        #
        #   @return [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::PersonalAddress, nil]
        required :personal_address,
                 -> { WhopSDK::IdentityProfileApprovedWebhookEvent::Data::PersonalAddress },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Status }
        ...
        #   first.
        #
        #   @return [Array<WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification>]
        required :verifications,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data} for more details.
        #
        #   A consolidated identity or business profile synced from verification provider
        #   data.
        #
        ...
        #
        #   @param business_address [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::BusinessAddress, nil] Registered business address reported by the identity provider. Present on `busin
        #
        ...
        #
        #   @param linked_companies [Array<WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::LinkedCompany>] The companies this identity profile is currently linked to. Only populated for d
        #
        #   @param personal_address [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::PersonalAddress, nil] Residential address reported by the identity provider. Present on `individual` p
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Status] Derived verification status across all linked verifications.
        #
        #   @param updated_at [Time] When the identity profile was last synced from a verification.
        #
        #   @param verifications [Array<WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification>] All verification attempts attached to this identity profile, ordered most-recent

        # @see WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data#business_address
        ...
        # @see WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data#personal_address
        ...
        # Derived verification status across all linked verifications.
        #
        # @see WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data#status
        module Status
        ...
        class Verification < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification::LastErrorCode, nil]
          required :last_error_code,
                   enum: -> {
                     WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::LastErrorCode
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification::Status]
          required :status, enum: -> { WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::Status }

          # @!method initialize(id:, created_at:, last_error_code:, last_error_reason:, session_url:, status:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification} for
          #   more details.
          #
          ...
          #
          #   @param last_error_code [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification::LastErrorCode, nil] An error code for a verification attempt.
          #
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification::Status] The current status of this verification session.

          # An error code for a verification attempt.
          #
          # @see WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification#last_error_code
          ...
          # The current status of this verification session.
          #
          # @see WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data::Verification#status
          module Status
            extend WhopSDK::Internal::Type::Enum
