...
module WhopSDK
  module Models
    class IdentityProfileApprovedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param data [WhopSDK::Models::IdentityProfileApprovedWebhookEvent::Data] An IdentityProfile is the object you create to KYC (for individuals) or KYB (for
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        class Verification < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @param id [String] The identifier of the verification (verf_xxx).
          #
          ...
          #
          #   @param session_url [String, nil] A URL the user can visit to complete or resume this verification. Null if the se
          #
