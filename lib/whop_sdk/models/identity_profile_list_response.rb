...
module WhopSDK
  module Models
    ...
    class IdentityProfileListResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #   `business` profiles.
      #
      #   @return [WhopSDK::Models::IdentityProfileListResponse::BusinessAddress, nil]
      required :business_address,
               -> { WhopSDK::Models::IdentityProfileListResponse::BusinessAddress },
               nil?: true
      ...
      #
      #   @return [Array<WhopSDK::Models::IdentityProfileListResponse::LinkedCompany>]
      required :linked_companies,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::IdentityProfileListResponse::LinkedCompany] }

      # @!attribute personal_address
      #   Residential address reported by the identity provider. Present on `individual`
      #   profiles.
      #
      #   @return [WhopSDK::Models::IdentityProfileListResponse::PersonalAddress, nil]
      required :personal_address,
               -> { WhopSDK::Models::IdentityProfileListResponse::PersonalAddress },
               nil?: true
      ...
      #
      #   @return [Symbol, WhopSDK::Models::IdentityProfileStatus]
      required :status, enum: -> { WhopSDK::IdentityProfileStatus }
      ...
      #   first.
      #
      #   @return [Array<WhopSDK::Models::IdentityProfileListResponse::Verification>]
      required :verifications,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::IdentityProfileListResponse::Verification] }
      ...
      #   {WhopSDK::Models::IdentityProfileListResponse} for more details.
      #
      ...
      #
      #   @param business_address [WhopSDK::Models::IdentityProfileListResponse::BusinessAddress, nil] Registered business address reported by the identity provider. Present on `busin
      #
      ...
      #
      #   @param linked_companies [Array<WhopSDK::Models::IdentityProfileListResponse::LinkedCompany>] The companies this identity profile is currently linked to. Only populated for d
      #
      #   @param personal_address [WhopSDK::Models::IdentityProfileListResponse::PersonalAddress, nil] Residential address reported by the identity provider. Present on `individual` p
      #
      ...
      #
      #   @param status [Symbol, WhopSDK::Models::IdentityProfileStatus] Derived verification status across all linked verifications.
      #
      #   @param updated_at [Time] When the identity profile was last synced from a verification.
      #
      #   @param verifications [Array<WhopSDK::Models::IdentityProfileListResponse::Verification>] All verification attempts attached to this identity profile, ordered most-recent

      # @see WhopSDK::Models::IdentityProfileListResponse#business_address
      ...
      # @see WhopSDK::Models::IdentityProfileListResponse#personal_address
      ...
      class Verification < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::IdentityProfileListResponse::Verification} for more details.
        #
