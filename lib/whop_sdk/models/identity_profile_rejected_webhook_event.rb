...
module WhopSDK
  module Models
    class IdentityProfileRejectedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #   data.
      #
      #   @return [WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data]
      required :data, -> { WhopSDK::IdentityProfileRejectedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"identity_profile.rejected"]
      required :type, const: :"identity_profile.rejected"
      ...
      # @!method initialize(id:, data:, timestamp:, company_id: nil, api_version: :v1, type: :"identity_profile.rejected")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::IdentityProfileRejectedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param data [WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data] A consolidated identity or business profile synced from verification provider da
      #
      ...
      #
      #   @param type [Symbol, :"identity_profile.rejected"] The webhook event type

      # @see WhopSDK::Models::IdentityProfileRejectedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   `business` profiles.
        #
        #   @return [WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::BusinessAddress, nil]
        required :business_address,
                 -> { WhopSDK::IdentityProfileRejectedWebhookEvent::Data::BusinessAddress },
                 nil?: true
        ...
        #
        #   @return [Array<WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::LinkedCompany>]
        ...
        #   profiles.
        #
        #   @return [WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::PersonalAddress, nil]
        required :personal_address,
                 -> { WhopSDK::IdentityProfileRejectedWebhookEvent::Data::PersonalAddress },
                 nil?: true
        ...
        #   first.
        #
        #   @return [Array<WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification>]
        ...
        #
        #   @param business_address [WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::BusinessAddress, nil] Registered business address reported by the identity provider. Present on `busin
        #
        ...
        #
        #   @param verifications [Array<WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification>] All verification attempts attached to this identity profile, ordered most-recent

        # @see WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data#business_address
        ...
        # @see WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data#personal_address
        ...
        class Verification < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification::LastErrorCode, nil]
          required :last_error_code,
                   enum: -> {
                     WhopSDK::IdentityProfileRejectedWebhookEvent::Data::Verification::LastErrorCode
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification::Status]
          required :status, enum: -> { WhopSDK::IdentityProfileRejectedWebhookEvent::Data::Verification::Status }

          # @!method initialize(id:, created_at:, last_error_code:, last_error_reason:, session_url:, status:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification} for
          #   more details.
          #
          ...
          #
          #   @param last_error_code [Symbol, WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification::LastErrorCode, nil] An error code for a verification attempt.
          #
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification::Status] The current status of this verification session.

          # An error code for a verification attempt.
          #
          # @see WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification#last_error_code
          ...
          # The current status of this verification session.
          #
          # @see WhopSDK::Models::IdentityProfileRejectedWebhookEvent::Data::Verification#status
          module Status
            extend WhopSDK::Internal::Type::Enum
