    ...
    class IdentityProfileUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        class Verification < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Verification::LastErrorCode, nil]
          ...
          #
          #   @return [Symbol, WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Verification::Status]
          required :status, enum: -> { WhopSDK::IdentityProfileUpdatedWebhookEvent::Data::Verification::Status }
          ...
          #
          #   @param last_error_code [Symbol, WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Verification::LastErrorCode, nil] An error code for a verification attempt.
          #
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Verification::Status] The current status of this verification session.

          # An error code for a verification attempt.
          #
          # @see WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Verification#last_error_code
          ...
          # The current status of this verification session.
          #
          # @see WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Verification#status
          module Status
            extend WhopSDK::Internal::Type::Enum
