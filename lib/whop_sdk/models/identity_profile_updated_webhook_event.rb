  ...
  module Models
    class IdentityProfileUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::IdentityProfileUpdatedWebhookEvent::Data::Status] Derived verification status across all linked verifications. Returns `action_req
        #
