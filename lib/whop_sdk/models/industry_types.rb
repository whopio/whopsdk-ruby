...
module WhopSDK
  module Models
    ...
    module IndustryTypes
      ...
      DARK_PATTERN_SUBSCRIPTIONS = :dark_pattern_subscriptions
      INCOME_GUARANTEE_SCHEME = :income_guarantee_scheme
      LIFETIME_ACCESS_OFFERS = :lifetime_access_offers
      MLM_PYRAMID_SCHEME = :mlm_pyramid_scheme
      NEGATIVE_OPTION_BILLING = :negative_option_billing
      ...
      KINDLE_PUBLISHING = :kindle_publishing
      ...
      PODCAST_PRODUCTION_AGENCY = :podcast_production_agency
      ...
      NFT_DIGITAL_MARKETPLACE = :nft_digital_marketplace
      ...
      TRAMPOLINE_PARK_ENTERTAINMENT = :trampoline_park_entertainment
      CONCERT_VENUE = :concert_venue
      DRIVE_IN_THEATER = :drive_in_theater
      BILLIARDS_HALL = :billiards_hall
      DART_BAR = :dart_bar
      BATTING_CAGE_ENTERTAINMENT = :batting_cage_entertainment
