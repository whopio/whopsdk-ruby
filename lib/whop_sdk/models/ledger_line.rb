...
module WhopSDK
  module Models
    ...
    class LedgerLine < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param line_category [String, nil] The semantic transaction category of the line (e.g. 'payment_payout', 'refund').
      #
      #   @param posted_at [Time, nil] The timestamp when the ledger line was posted.
      #
      #   @param source_id [String, nil] The tag of the resource this line originated from (e.g. a receipt or transfer),
