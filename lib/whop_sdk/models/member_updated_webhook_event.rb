...
module WhopSDK
  module Models
    class MemberUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::MemberUpdatedWebhookEvent::Data]
      required :data, -> { WhopSDK::MemberUpdatedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"member.updated"]
      required :type, const: :"member.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"member.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::MemberUpdatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::MemberUpdatedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"member.updated"] The webhook event type

      # @see WhopSDK::Models::MemberUpdatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::MemberUpdatedWebhookEvent::Data::AccessLevel]
        required :access_level, enum: -> { WhopSDK::MemberUpdatedWebhookEvent::Data::AccessLevel }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::MemberUpdatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::MemberUpdatedWebhookEvent::Data::Status }
        ...
        #   than a person.
        #
        #   @return [WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User, nil]
        required :user, -> { WhopSDK::MemberUpdatedWebhookEvent::Data::User }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MemberUpdatedWebhookEvent::Data} for more details.
        #
        #   @param id [String] Member ID, prefixed `mber_`.
        #
        #   @param access_level [Symbol, WhopSDK::Models::MemberUpdatedWebhookEvent::Data::AccessLevel] What the member can reach on the account: `customer` for paying members, `admin`
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::MemberUpdatedWebhookEvent::Data::Status] `joined` while the member is part of the account, `left` after they leave.
        #
        #   @param token_balance [Float] The member's current token balance for this account, computed from token transac
        #
        #   @param user [WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User, nil] The user behind this member. `null` when the buyer is another business rather th

        # What the member can reach on the account: `customer` for paying members, `admin`
        # for team members, `no_access` once every grant has lapsed.
        #
        # @see WhopSDK::Models::MemberUpdatedWebhookEvent::Data#access_level
        module AccessLevel
        ...
        # `joined` while the member is part of the account, `left` after they leave.
        #
        # @see WhopSDK::Models::MemberUpdatedWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::MemberUpdatedWebhookEvent::Data#user
        class User < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User::ProfilePicture]
          required :profile_picture, -> { WhopSDK::MemberUpdatedWebhookEvent::Data::User::ProfilePicture }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User} for more details.
          #
          #   The user behind this member. `null` when the buyer is another business rather
          #   than a person.
          #
          ...
          #
          #   @param profile_picture [WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User::ProfilePicture] Avatar wrapper; its `url` is always present, using a generated placeholder when
          #
          #   @param username [String] Public username.

          # @see WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User#profile_picture
          class ProfilePicture < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::MemberUpdatedWebhookEvent::Data::User::ProfilePicture} for
            #   more details.
            #
            #   Avatar wrapper; its `url` is always present, using a generated placeholder when
            #   the user set no picture.
