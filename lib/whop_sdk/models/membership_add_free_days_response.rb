...
module WhopSDK
  module Models
    ...
    class MembershipAddFreeDaysResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, WhopSDK::Models::MembershipAddFreeDaysResponse::CancelationStatus, nil]
      required :cancelation_status,
               enum: -> { WhopSDK::Models::MembershipAddFreeDaysResponse::CancelationStatus },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::MembershipAddFreeDaysResponse::Company]
      required :company, -> { WhopSDK::Models::MembershipAddFreeDaysResponse::Company }
      ...
      #
      #   @return [Array<WhopSDK::Models::MembershipAddFreeDaysResponse::CustomFieldResponse>]
      required :custom_field_responses,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::MembershipAddFreeDaysResponse::CustomFieldResponse] }
      ...
      #
      #   @return [WhopSDK::Models::MembershipAddFreeDaysResponse::Member, nil]
      required :member, -> { WhopSDK::Models::MembershipAddFreeDaysResponse::Member }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::MembershipAddFreeDaysResponse::Plan]
      required :plan, -> { WhopSDK::Models::MembershipAddFreeDaysResponse::Plan }

      # @!attribute product
      #   The product this membership grants access to.
      #
      #   @return [WhopSDK::Models::MembershipAddFreeDaysResponse::Product]
      required :product, -> { WhopSDK::Models::MembershipAddFreeDaysResponse::Product }

      # @!attribute promo_code
      #   The promotional code currently applied to this membership's billing. Null if no
      #   promo code is active.
      #
      #   @return [WhopSDK::Models::MembershipAddFreeDaysResponse::PromoCode, nil]
      required :promo_code, -> { WhopSDK::Models::MembershipAddFreeDaysResponse::PromoCode }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::MembershipAddFreeDaysResponse::User, nil]
      required :user, -> { WhopSDK::Models::MembershipAddFreeDaysResponse::User }, nil?: true
      ...
      #   {WhopSDK::Models::MembershipAddFreeDaysResponse} for more details.
      #
      ...
      #
      #   @param cancelation_status [Symbol, WhopSDK::Models::MembershipAddFreeDaysResponse::CancelationStatus, nil] The state of a membership after a customer provides a cancelation reason.
      #
      ...
      #
      #   @param company [WhopSDK::Models::MembershipAddFreeDaysResponse::Company] The company this membership belongs to.
      #
      #   @param created_at [Time] The datetime the membership was created.
      #
      #   @param currency [Symbol, WhopSDK::Models::Currency, nil] The available currencies on the platform
      #
      #   @param custom_field_responses [Array<WhopSDK::Models::MembershipAddFreeDaysResponse::CustomFieldResponse>] The customer's responses to custom checkout questions configured on the product
      #
      ...
      #
      #   @param member [WhopSDK::Models::MembershipAddFreeDaysResponse::Member, nil] The member record linking the user to the company for this membership. Null if t
      #
      ...
      #
      #   @param plan [WhopSDK::Models::MembershipAddFreeDaysResponse::Plan] The plan the customer purchased to create this membership.
      #
      #   @param product [WhopSDK::Models::MembershipAddFreeDaysResponse::Product] The product this membership grants access to.
      #
      #   @param promo_code [WhopSDK::Models::MembershipAddFreeDaysResponse::PromoCode, nil] The promotional code currently applied to this membership's billing. Null if no
      #
      ...
      #
      #   @param user [WhopSDK::Models::MembershipAddFreeDaysResponse::User, nil] The user who owns this membership. Null if the user account has been deleted.

      # The state of a membership after a customer provides a cancelation reason.
      #
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#cancelation_status
      ...
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#company
      ...
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#member
      ...
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#plan
      class Plan < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MembershipAddFreeDaysResponse::Plan} for more details.
        #
        #   The plan the customer purchased to create this membership.
        #
      ...
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MembershipAddFreeDaysResponse::Product} for more details.
        #
        #   The product this membership grants access to.
        #
      ...
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#promo_code
      ...
      # @see WhopSDK::Models::MembershipAddFreeDaysResponse#user
      class User < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MembershipAddFreeDaysResponse::User} for more details.
        #
        #   The user who owns this membership. Null if the user account has been deleted.
        #
