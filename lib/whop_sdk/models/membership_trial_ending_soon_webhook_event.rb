...
module WhopSDK
  module Models
    class MembershipTrialEndingSoonWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"membership.trial_ending_soon"]
      required :type, const: :"membership.trial_ending_soon"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"membership.trial_ending_soon")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::MembershipTrialEndingSoonWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"membership.trial_ending_soon"] The webhook event type
    end
  end
end
