...
module WhopSDK
  module Models
    ...
    class MembershipUncancelResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, WhopSDK::Models::MembershipUncancelResponse::CancelationStatus, nil]
      required :cancelation_status,
               enum: -> { WhopSDK::Models::MembershipUncancelResponse::CancelationStatus },
               nil?: true
      ...
      #
      #   @return [WhopSDK::Models::MembershipUncancelResponse::Company]
      required :company, -> { WhopSDK::Models::MembershipUncancelResponse::Company }
      ...
      #
      #   @return [Array<WhopSDK::Models::MembershipUncancelResponse::CustomFieldResponse>]
      required :custom_field_responses,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::MembershipUncancelResponse::CustomFieldResponse] }
      ...
      #
      #   @return [WhopSDK::Models::MembershipUncancelResponse::Member, nil]
      required :member, -> { WhopSDK::Models::MembershipUncancelResponse::Member }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::MembershipUncancelResponse::Plan]
      required :plan, -> { WhopSDK::Models::MembershipUncancelResponse::Plan }

      # @!attribute product
      #   The product this membership grants access to.
      #
      #   @return [WhopSDK::Models::MembershipUncancelResponse::Product]
      required :product, -> { WhopSDK::Models::MembershipUncancelResponse::Product }

      # @!attribute promo_code
      #   The promotional code currently applied to this membership's billing. Null if no
      #   promo code is active.
      #
      #   @return [WhopSDK::Models::MembershipUncancelResponse::PromoCode, nil]
      required :promo_code, -> { WhopSDK::Models::MembershipUncancelResponse::PromoCode }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::MembershipUncancelResponse::User, nil]
      required :user, -> { WhopSDK::Models::MembershipUncancelResponse::User }, nil?: true
      ...
      #   {WhopSDK::Models::MembershipUncancelResponse} for more details.
      #
      ...
      #
      #   @param cancelation_status [Symbol, WhopSDK::Models::MembershipUncancelResponse::CancelationStatus, nil] The state of a membership after a customer provides a cancelation reason.
      #
      ...
      #
      #   @param company [WhopSDK::Models::MembershipUncancelResponse::Company] The company this membership belongs to.
      #
      #   @param created_at [Time] The datetime the membership was created.
      #
      #   @param currency [Symbol, WhopSDK::Models::Currency, nil] The available currencies on the platform
      #
      #   @param custom_field_responses [Array<WhopSDK::Models::MembershipUncancelResponse::CustomFieldResponse>] The customer's responses to custom checkout questions configured on the product
      #
      ...
      #
      #   @param member [WhopSDK::Models::MembershipUncancelResponse::Member, nil] The member record linking the user to the company for this membership. Null if t
      #
      ...
      #
      #   @param plan [WhopSDK::Models::MembershipUncancelResponse::Plan] The plan the customer purchased to create this membership.
      #
      #   @param product [WhopSDK::Models::MembershipUncancelResponse::Product] The product this membership grants access to.
      #
      #   @param promo_code [WhopSDK::Models::MembershipUncancelResponse::PromoCode, nil] The promotional code currently applied to this membership's billing. Null if no
      #
      ...
      #
      #   @param user [WhopSDK::Models::MembershipUncancelResponse::User, nil] The user who owns this membership. Null if the user account has been deleted.

      # The state of a membership after a customer provides a cancelation reason.
      #
      # @see WhopSDK::Models::MembershipUncancelResponse#cancelation_status
      ...
      # @see WhopSDK::Models::MembershipUncancelResponse#company
      ...
      # @see WhopSDK::Models::MembershipUncancelResponse#member
      ...
      # @see WhopSDK::Models::MembershipUncancelResponse#plan
      class Plan < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MembershipUncancelResponse::Plan} for more details.
        #
        #   The plan the customer purchased to create this membership.
        #
      ...
      # @see WhopSDK::Models::MembershipUncancelResponse#product
      class Product < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MembershipUncancelResponse::Product} for more details.
        #
        #   The product this membership grants access to.
        #
      ...
      # @see WhopSDK::Models::MembershipUncancelResponse#promo_code
      ...
      # @see WhopSDK::Models::MembershipUncancelResponse#user
      class User < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::MembershipUncancelResponse::User} for more details.
        #
        #   The user who owns this membership. Null if the user account has been deleted.
        #
