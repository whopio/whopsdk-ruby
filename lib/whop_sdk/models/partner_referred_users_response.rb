...
module WhopSDK
  module Models
    # @see WhopSDK::Resources::Partners#referred_users
    class PartnerReferredUsersResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<WhopSDK::Models::PartnerReferredUsersResponse::Data>]
      required :data,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::PartnerReferredUsersResponse::Data] }

      # @!attribute page_info
      #
      #   @return [WhopSDK::Models::PartnerReferredUsersResponse::PageInfo]
      required :page_info, -> { WhopSDK::Models::PartnerReferredUsersResponse::PageInfo }

      # @!method initialize(data:, page_info:)
      #   @param data [Array<WhopSDK::Models::PartnerReferredUsersResponse::Data>]
      #   @param page_info [WhopSDK::Models::PartnerReferredUsersResponse::PageInfo]
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        # @!attribute user
        #
        #   @return [WhopSDK::Models::PartnerReferredUsersResponse::Data::User]
        required :user, -> { WhopSDK::Models::PartnerReferredUsersResponse::Data::User }

        # @!method initialize(total_earnings_usd:, total_volume_usd:, user:)
        #   @param total_earnings_usd [String]
        #   @param total_volume_usd [String]
        #   @param user [WhopSDK::Models::PartnerReferredUsersResponse::Data::User]

        # @see WhopSDK::Models::PartnerReferredUsersResponse::Data#user
        class User < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::PartnerReferredUsersResponse::Data::User::ProfilePicture, nil]
          ...
          # @see WhopSDK::Models::PartnerReferredUsersResponse::Data::User#profile_picture
      ...
      # @see WhopSDK::Models::PartnerReferredUsersResponse#page_info
