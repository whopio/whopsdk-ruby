...
module WhopSDK
  module Models
    class PaymentCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data]
      required :data, -> { WhopSDK::PaymentCreatedWebhookEvent::Data }
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"payment.created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PaymentCreatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::PaymentCreatedWebhookEvent::Data] A payment represents a completed or attempted charge. Payments track the amount,
      #
      ...
      # @see WhopSDK::Models::PaymentCreatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::ApplicationFee, nil]
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::BillingAddress, nil]
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Company, nil]
        required :company, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Company }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::DeclineCode, nil]
        ...
        #
        #   @return [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Dispute>, nil]
        required :disputes,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::PaymentCreatedWebhookEvent::Data::Dispute] },
                 nil?: true
        ...
        #
        #   @return [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Fee>]
        required :fees, -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::PaymentCreatedWebhookEvent::Data::Fee] }
        ...
        #
        #   @return [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction>]
        required :financing_transactions,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::PaymentCreatedWebhookEvent::Data::FinancingTransaction] }
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Member, nil]
        required :member, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Member }, nil?: true

        # @!attribute membership
        #   The membership attached to this payment.
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Membership, nil]
        required :membership, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Membership }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument, nil]
        ...
        #   was used.
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod, nil]
        required :payment_method, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentMethod }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Plan, nil]
        required :plan, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Plan }, nil?: true

        # @!attribute product
        #   The product this payment was made for
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Product, nil]
        required :product, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Product }, nil?: true

        # @!attribute promo_code
        #   The promo code used for this payment.
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PromoCode, nil]
        required :promo_code, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PromoCode }, nil?: true
        ...
        #
        #   @return [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Refund>]
        required :refunds,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::PaymentCreatedWebhookEvent::Data::Refund] }
        ...
        #   permission.
        #
        #   @return [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Resolution>, nil]
        required :resolutions,
                 -> {
                   WhopSDK::Internal::Type::ArrayOf[WhopSDK::PaymentCreatedWebhookEvent::Data::Resolution]
                 },
                 nil?: true
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Shipment, nil]
        required :shipment, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Shipment }, nil?: true

        # @!attribute shipping_address
        #   The shipping address provided by the customer for physical goods. Null if no
        #   shipping address was collected.
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::ShippingAddress, nil]
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::User, nil]
        required :user, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::User }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::VerificationChecks, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data} for more details.
        #
        #   A payment represents a completed or attempted charge. Payments track the amount,
        #   status, currency, and payment method used.
        #
        ...
        #
        #   @param application_fee [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::ApplicationFee, nil] The application fee charged on this payment.
        #
        #   @param auto_refunded [Boolean] Whether this payment was auto refunded or not
        #
        #   @param billing_address [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::BillingAddress, nil] The address of the user who made the payment.
        #
        ...
        #
        #   @param company [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Company, nil] The company for the payment.
        #
        ...
        #
        #   @param decline_code [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::DeclineCode, nil] The reason a payment was declined.
        #
        #   @param dispute_alerted_at [Time, nil] When an alert came in that this transaction will be disputed
        #
        #   @param disputes [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Dispute>, nil] The disputes attached to this payment. Null if the actor in context does not hav
        #
        #   @param failure_message [String, nil] If the payment failed, the reason for the failure.
        #
        #   @param fees [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Fee>] The fees associated with this specific payment.
        #
        ...
        #
        #   @param financing_transactions [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction>] The financing transactions attached to this payment. Present if the payment is a
        #
        #   @param last_payment_attempt [Time, nil] The time of the last payment attempt.
        #
        #   @param member [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Member, nil] The member attached to this payment.
        #
        #   @param membership [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Membership, nil] The membership attached to this payment.
        #
        ...
        #
        #   @param payment_instrument [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument, nil] The instrument this payment was made with, shaped for display: the method type,
        #
        #   @param payment_method [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod, nil] The tokenized payment method reference used for this payment. Null if no token w
        #
        ...
        #
        #   @param plan [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Plan, nil] The plan attached to this payment.
        #
        #   @param product [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Product, nil] The product this payment was made for
        #
        #   @param promo_code [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PromoCode, nil] The promo code used for this payment.
        #
        ...
        #
        #   @param refunds [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Refund>] The refunds issued against this payment, newest first, including failed and canc
        #
        #   @param resolutions [Array<WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Resolution>, nil] The resolution center cases opened by the customer on this payment. Null if the
        #
        ...
        #
        #   @param shipment [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Shipment, nil] The shipment attached to this payment.
        #
        #   @param shipping_address [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::ShippingAddress, nil] The shipping address provided by the customer for physical goods. Null if no shi
        #
        ...
        #
        #   @param user [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::User, nil] The user that made this payment.
        #
        #   @param verification_checks [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::VerificationChecks, nil] The issuer's address and card security code check results for this payment. Null
        #
        #   @param voidable [Boolean] True when the payment is tied to a membership in `past_due`, the payment status

        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#application_fee
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#billing_address
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#company
        ...
        # The reason a payment was declined.
        #
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#decline_code
        module DeclineCode
        ...
        class Dispute < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Dispute} for more details.
          #
        ...
        class Fee < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Fee::Type]
          required :type, enum: -> { WhopSDK::PaymentCreatedWebhookEvent::Data::Fee::Type }
          ...
          #
          #   @param type [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Fee::Type] The specific origin of the fee, if applicable.

          # The specific origin of the fee, if applicable.
          #
          # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Fee#type
          module Type
            extend WhopSDK::Internal::Type::Enum
        ...
        class FinancingTransaction < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction::Status]
          required :status, enum: -> { WhopSDK::PaymentCreatedWebhookEvent::Data::FinancingTransaction::Status }

          # @!attribute transaction_type
          #   The type of the payment transaction.
          #
          #   @return [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction::TransactionType]
          required :transaction_type,
                   enum: -> { WhopSDK::PaymentCreatedWebhookEvent::Data::FinancingTransaction::TransactionType }
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction::Status] The status of the payment transaction.
          #
          #   @param transaction_type [Symbol, WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction::TransactionType] The type of the payment transaction.

          # The status of the payment transaction.
          #
          # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction#status
          module Status
            extend WhopSDK::Internal::Type::Enum
          ...
          # The type of the payment transaction.
          #
          # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::FinancingTransaction#transaction_type
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#member
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#membership
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#payment_instrument
        class PaymentInstrument < WhopSDK::Internal::Type::BaseModel
          # @!attribute card
          #   Card payments only: the card's network and last four.
          #
          #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Card, nil]
          required :card,
                   -> {
          ...
          #
          #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons]
          required :icons, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument} for more
          #   details.
          #
          #   The instrument this payment was made with, shaped for display: the method type,
          #   a buyer-facing name, the standard icon set, and the card facts when it was a
          #   card. Null when the receipt names no payment method.
          #
          #   @param card [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Card, nil] Card payments only: the card's network and last four.
          #
          #   @param display_name [String] Buyer-facing instrument name — "Visa •••• 4242" when the card surfaced, else the
          #
          #   @param icons [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons] The standard icon set: square and card shapes, each in light and dark colorways.
          #
          ...
          # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument#card
          class Card < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Card} for
            #   more details.
            #
            #   Card payments only: the card's network and last four.
            #
          ...
          # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument#icons
          class Icons < WhopSDK::Internal::Type::BaseModel
            # @!attribute card
            #   The credit-card-proportioned tile (48x30).
            #
            #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card]
            required :card, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card }

            # @!attribute square
            #   The square tile (32x32).
            #
            #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square]
            required :square, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square }

            # @!method initialize(card:, square:)
            #   The standard icon set: square and card shapes, each in light and dark colorways.
            #
            #   @param card [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card] The credit-card-proportioned tile (48x30).
            #
            #   @param square [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square] The square tile (32x32).

            # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons#card
            class Card < WhopSDK::Internal::Type::BaseModel
              # @!attribute dark
              #   The colorway for dark surfaces.
              #
              #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card::Dark]
              required :dark, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card::Dark }

              # @!attribute light
              #   The colorway for light surfaces.
              #
              #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card::Light]
              required :light, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card::Light }

              # @!method initialize(dark:, light:)
              #   The credit-card-proportioned tile (48x30).
              #
              #   @param dark [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card::Dark] The colorway for dark surfaces.
              #
              #   @param light [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card::Light] The colorway for light surfaces.

              # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card#dark
              ...
              # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Card#light
            ...
            # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons#square
            class Square < WhopSDK::Internal::Type::BaseModel
              # @!attribute dark
              #   The colorway for dark surfaces.
              #
              #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square::Dark]
              required :dark, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square::Dark }

              # @!attribute light
              #   The colorway for light surfaces.
              #
              #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square::Light]
              required :light, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square::Light }

              # @!method initialize(dark:, light:)
              #   The square tile (32x32).
              #
              #   @param dark [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square::Dark] The colorway for dark surfaces.
              #
              #   @param light [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square::Light] The colorway for light surfaces.

              # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square#dark
              class Dark < WhopSDK::Internal::Type::BaseModel
                # @!attribute png_1x
                #   Raster fallback at the shape's native size.
                #
              ...
              # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentInstrument::Icons::Square#light
              class Light < WhopSDK::Internal::Type::BaseModel
                # @!attribute png_1x
                #   Raster fallback at the shape's native size.
                #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#payment_method
        class PaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod::Card, nil]
          required :card, -> { WhopSDK::PaymentCreatedWebhookEvent::Data::PaymentMethod::Card }, nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod} for more
          #   details.
          #
          #   The tokenized payment method reference used for this payment. Null if no token
          #   was used.
          ...
          #
          #   @param card [WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod::Card, nil] The card data associated with the payment method, if its a debit or credit card.
          #
          ...
          # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod#card
          class Card < WhopSDK::Internal::Type::BaseModel
            # @!attribute brand
            #   Possible card brands that a payment token can have
            #
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PaymentMethod::Card} for
            #   more details.
            #
            #   The card data associated with the payment method, if its a debit or credit card.
            #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#plan
        class Plan < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Plan} for more details.
          #
          #   The plan attached to this payment.
          #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#product
        class Product < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Product} for more details.
          #
          #   The product this payment was made for
          #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#promo_code
        class PromoCode < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::PromoCode} for more details.
          #
          #   The promo code used for this payment.
          #
        ...
        class Refund < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Refund} for more details.
          #
        ...
        class Resolution < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Resolution} for more
          #   details.
          #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#shipment
        class Shipment < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::Shipment} for more details.
          #
          #   The shipment attached to this payment.
          #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#shipping_address
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#user
        class User < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::User} for more details.
          #
          #   The user that made this payment.
          #
        ...
        # @see WhopSDK::Models::PaymentCreatedWebhookEvent::Data#verification_checks
        class VerificationChecks < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PaymentCreatedWebhookEvent::Data::VerificationChecks} for more
          #   details.
          #
          #   The issuer's address and card security code check results for this payment. Null
          #   when the processor returned none.
