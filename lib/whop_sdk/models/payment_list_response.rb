...
module WhopSDK
  module Models
    ...
    class PaymentListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, WhopSDK::Models::PaymentListResponse::DeclineCode, nil]
      required :decline_code, enum: -> { WhopSDK::Models::PaymentListResponse::DeclineCode }, nil?: true
      ...
      #
      #   @param decline_code [Symbol, WhopSDK::Models::PaymentListResponse::DeclineCode, nil] The reason a payment was declined.
      #
      ...
      # The reason a payment was declined.
      #
      # @see WhopSDK::Models::PaymentListResponse#decline_code
      module DeclineCode
