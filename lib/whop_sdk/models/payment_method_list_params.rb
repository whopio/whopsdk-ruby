...
module WhopSDK
  module Models
    ...
    class PaymentMethodListParams < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :broken, WhopSDK::Internal::Type::Boolean
      ...
      optional :card_brands, -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::CardBrands] }
      ...
      #
      #   @return [Boolean, nil]
      optional :expired, WhopSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :has_payer_document, WhopSDK::Internal::Type::Boolean
