...
module WhopSDK
  module Models
    class PaymentRequiresActionWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"payment.requires_action"]
      required :type, const: :"payment.requires_action"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"payment.requires_action")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PaymentRequiresActionWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::Payment]
      #
      ...
      #
      #   @param type [Symbol, :"payment.requires_action"] The webhook event type
    end
  end
end
