  ...
  module Models
    ...
    class PayoutAccountRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      class LatestVerification < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification::LastErrorCode, nil]
        required :last_error_code,
                 enum: -> { WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification::LastErrorCode },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification::Status]
        required :status, enum: -> { WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification::Status }
        ...
        #
        #   @param last_error_code [Symbol, WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification::LastErrorCode, nil] An error code for a verification attempt.
        #
        #   @param last_error_reason [String, nil] A human-readable explanation of the most recent verification error. Null if no e
        #
        #   @param status [Symbol, WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification::Status] The current status of this verification session.

        # An error code for a verification attempt.
        #
        # @see WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification#last_error_code
        ...
        # The current status of this verification session.
        #
        # @see WhopSDK::Models::PayoutAccountRetrieveResponse::LatestVerification#status
        module Status
          extend WhopSDK::Internal::Type::Enum
