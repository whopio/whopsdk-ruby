...
module WhopSDK
  module Models
    class PayoutAccountStatusUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"payout_account.status_updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent} for more details.
      #
