    ...
    class PayoutAccountStatusUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        class LatestVerification < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification::LastErrorCode, nil]
          ...
          #
          #   @return [Symbol, WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification::Status]
          required :status,
                   enum: -> { WhopSDK::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification::Status }
          ...
          #
          #   @param last_error_code [Symbol, WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification::LastErrorCode, nil] An error code for a verification attempt.
          #
          #   @param last_error_reason [String, nil] A human-readable explanation of the most recent verification error. Null if no e
          #
          #   @param status [Symbol, WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification::Status] The current status of this verification session.

          # An error code for a verification attempt.
          #
          # @see WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification#last_error_code
          ...
          # The current status of this verification session.
          #
          # @see WhopSDK::Models::PayoutAccountStatusUpdatedWebhookEvent::Data::LatestVerification#status
          module Status
            extend WhopSDK::Internal::Type::Enum
