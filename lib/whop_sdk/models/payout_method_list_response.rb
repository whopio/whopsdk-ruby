...
module WhopSDK
  module Models
    ...
    class PayoutMethodListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param company [WhopSDK::Models::PayoutMethodListResponse::Company, nil] The company associated with this payout destination. Null if not linked to a spe
      #
      ...
      #
      #   @param destination [WhopSDK::Models::PayoutMethodListResponse::Destination, nil] The payout destination configuration linked to this token. Null if not yet confi
      #
