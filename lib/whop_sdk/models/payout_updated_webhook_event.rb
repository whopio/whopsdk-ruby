...
module WhopSDK
  module Models
    class PayoutUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data]
      required :data, -> { WhopSDK::PayoutUpdatedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"payout.updated"]
      required :type, const: :"payout.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"payout.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PayoutUpdatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"payout.updated"] The webhook event type

      # @see WhopSDK::Models::PayoutUpdatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Failure, nil]
        required :failure, -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::Failure }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::FeePaidBy]
        required :fee_paid_by, enum: -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::FeePaidBy }
        ...
        # @!attribute object
        #
        #   @return [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Object]
        required :object, enum: -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::Object }
        ...
        #
        #   @return [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod, nil]
        required :payout_method, -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Source, nil]
        required :source, enum: -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::Source }, nil?: true

        # @!attribute speed
        #   Payout delivery speed.
        #
        #   @return [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Speed]
        required :speed, enum: -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::Speed }

        # @!attribute status
        #   Current payout status.
        #
        #   @return [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::Status }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::PayoutUpdatedWebhookEvent::Data} for more details.
        #
        ...
        #
        #   @param failure [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Failure, nil] Why the payout ended without paying, or why it reversed after settlement. Presen
        #
        #   @param fee_amount [String] The fee charged for the payout, in the payout currency, as a decimal string.
        #
        #   @param fee_paid_by [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::FeePaidBy] Who bore the payout fee: the account itself, or its parent platform.
        #
        ...
        #
        #   @param object [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Object]
        #
        #   @param payer_name [String, nil] Name of the entity processing the payout.
        #
        #   @param payout_method [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod, nil] The saved payout method used. Requires payout:destination:read; null without it.
        #
        #   @param payout_request_id [String, nil] Payout request ID, prefixed `cofr_`, returned by `POST /payouts`. Match it to th
        #
        #   @param source [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Source, nil] How the payout was created. `automatic` means a scheduled auto-payout; `null` on
        #
        #   @param speed [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Speed] Payout delivery speed.
        #
        #   @param status [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Status] Current payout status.
        #
        ...
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#failure
        class Failure < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::Failure} for more details.
          #
          #   Why the payout ended without paying, or why it reversed after settlement.
          #   Present on failed, canceled, denied, and reversed payouts; `null` otherwise.
          #
        ...
        # Who bore the payout fee: the account itself, or its parent platform.
        #
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#fee_paid_by
        module FeePaidBy
        ...
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#object
        module Object
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#payout_method
        class PayoutMethod < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod, nil]
          required :supported_payout_method,
                   -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod },
                   nil?: true
          ...
          #
          #   @param supported_payout_method [WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod, nil] Supported payout method display details.

          # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod#supported_payout_method
          class SupportedPayoutMethod < WhopSDK::Internal::Type::BaseModel
            # @!attribute delivery_type
            #   How the funds are delivered to the recipient.
            #
            #   @return [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType]
            required :delivery_type,
                     enum: -> { WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType }
            ...
            #   Supported payout method display details.
            #
            #   @param delivery_type [Symbol, WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType] How the funds are delivered to the recipient.
            #
            ...
            # How the funds are delivered to the recipient.
            #
            # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod#delivery_type
            module DeliveryType
              extend WhopSDK::Internal::Type::Enum
        ...
        # payouts created before source tracking or through internal tooling.
        #
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#source
        module Source
          extend WhopSDK::Internal::Type::Enum
        ...
        # Payout delivery speed.
        #
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#speed
        module Speed
          extend WhopSDK::Internal::Type::Enum
        ...
        # Current payout status.
        #
        # @see WhopSDK::Models::PayoutUpdatedWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
