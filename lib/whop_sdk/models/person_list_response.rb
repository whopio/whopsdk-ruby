...
module WhopSDK
  module Models
    ...
    class PersonListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      # @!attribute ad_sets
      #
      #   @return [Array<WhopSDK::Models::PersonListResponse::AdSet>, nil]
      optional :ad_sets, -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::PersonListResponse::AdSet] }

      # @!attribute ads
      #
      #   @return [Array<WhopSDK::Models::PersonListResponse::Ad>, nil]
      ...
      # @!attribute campaigns
      #
      #   @return [Array<WhopSDK::Models::PersonListResponse::Campaign>, nil]
      optional :campaigns,
      ...
      #   @param ad_sets [Array<WhopSDK::Models::PersonListResponse::AdSet>]
      #   @param ads [Array<WhopSDK::Models::PersonListResponse::Ad>]
      #   @param aov [Float]
      #   @param campaigns [Array<WhopSDK::Models::PersonListResponse::Campaign>]
