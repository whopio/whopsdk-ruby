...
module WhopSDK
  module Models
    class PlanCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"plan.created"]
      required :type, const: :"plan.created"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"plan.created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PlanCreatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::Plan]
      #
      ...
      #
      #   @param type [Symbol, :"plan.created"] The webhook event type
    end
  end
end
