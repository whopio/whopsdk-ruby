...
module WhopSDK
  module Models
    class PlanDeletedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"plan.deleted"]
      required :type, const: :"plan.deleted"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"plan.deleted")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PlanDeletedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"plan.deleted"] The webhook event type
    end
  end
end
