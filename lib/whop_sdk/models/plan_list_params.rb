...
module WhopSDK
  module Models
    ...
    class PlanListParams < WhopSDK::Internal::Type::BaseModel
      ...
      #   Filter to only plans belonging to these product identifiers. When `account_id`
      ...
      # @!method initialize(account_id: nil, after: nil, before: nil, created_after: nil, created_before: nil, direction: nil, first: nil, last: nil, order: nil, plan_types: nil, product_ids: nil, release_methods: nil, visibilities: nil, api_version_date: nil, request_options: {})
      ...
      #
      #   @param product_ids [Array<String>] Filter to only plans belonging to these product identifiers. When `account_id` i
      #
