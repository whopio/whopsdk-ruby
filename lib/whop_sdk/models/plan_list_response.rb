...
module WhopSDK
  module Models
    ...
    class PlanListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::PlanListResponse::InitialPriceDue]
      required :initial_price_due, -> { WhopSDK::Models::PlanListResponse::InitialPriceDue }
      ...
      # @!method initialize(id:, account:, adaptive_pricing_enabled:, billing_period:, cancel_discount_intervals:, cancel_discount_percentage:, checkout_styling:, created_at:, currency:, custom_fields:, description:, expiration_days:, formatted_price:, image:, initial_price:, initial_price_due:, internal_notes:, invoice:, member_count:, metadata:, offer_cancel_discount:, payment_method_configuration:, plan_type:, product:, purchase_url:, release_method:, renewal_price:, split_pay_required_payments:, stock:, strike_through_initial_price:, strike_through_renewal_price:, three_ds_level:, title:, trial_period_days:, unlimited_stock:, updated_at:, visibility:)
      ...
      #
      #   @param initial_price_due [WhopSDK::Models::PlanListResponse::InitialPriceDue] Total charged at checkout for one unit, before promo codes and tax: `initial_pri
      #
      ...
      #
      #   @param three_ds_level [Symbol, WhopSDK::Models::PlanListResponse::ThreeDSLevel, nil] 3D Secure behavior for supported on-session card payments. `mandate_challenge` r
      #
      ...
      # @see WhopSDK::Models::PlanListResponse#initial_price_due
      class InitialPriceDue < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::PlanListResponse::InitialPriceDue} for more details.
        #
        #   Total charged at checkout for one unit, before promo codes and tax:
        #   `initial_price` plus the first `renewal_price` for recurring plans, or
        #   `initial_price` alone while a free trial applies. The trial does not apply when
