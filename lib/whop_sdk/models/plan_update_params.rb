...
module WhopSDK
  module Models
    ...
    class PlanUpdateParams < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param three_ds_level [Symbol, WhopSDK::Models::PlanUpdateParams::ThreeDSLevel, nil] 3D Secure behavior for supported on-session card payments. `mandate_challenge` r
      #
