...
module WhopSDK
  module Models
    class PlanUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"plan.updated"]
      required :type, const: :"plan.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"plan.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::PlanUpdatedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"plan.updated"] The webhook event type
    end
  end
end
