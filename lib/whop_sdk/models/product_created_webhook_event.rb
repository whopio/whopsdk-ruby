...
module WhopSDK
  module Models
    class ProductCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"product.created"]
      required :type, const: :"product.created"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"product.created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ProductCreatedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"product.created"] The webhook event type
    end
  end
end
