...
module WhopSDK
  module Models
    class ProductDeletedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"product.deleted"]
      required :type, const: :"product.deleted"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"product.deleted")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ProductDeletedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"product.deleted"] The webhook event type
    end
  end
end
