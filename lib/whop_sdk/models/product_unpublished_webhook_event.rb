...
module WhopSDK
  module Models
    class ProductUnpublishedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"product.unpublished"]
      required :type, const: :"product.unpublished"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"product.unpublished")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ProductUnpublishedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"product.unpublished"] The webhook event type
    end
  end
end
