...
module WhopSDK
  module Models
    class ProductUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"product.updated"]
      required :type, const: :"product.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"product.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ProductUpdatedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"product.updated"] The webhook event type
    end
  end
end
