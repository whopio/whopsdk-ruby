  ...
  module Models
    module Referrals
      ...
      class BusinessListParams < WhopSDK::Internal::Type::BaseModel
        ...
        #   Sort direction.
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Direction, nil]
        optional :direction, enum: -> { WhopSDK::Referrals::BusinessListParams::Direction }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Order, nil]
        optional :order, enum: -> { WhopSDK::Referrals::BusinessListParams::Order }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Status, nil]
        optional :status, enum: -> { WhopSDK::Referrals::BusinessListParams::Status }

        # @!attribute tier
        #   Filter to only first-tier referrals or only second-tier referrals.
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Tier, nil]
        optional :tier, enum: -> { WhopSDK::Referrals::BusinessListParams::Tier }
