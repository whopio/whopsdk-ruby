...
module WhopSDK
  module Models
    module Referrals
      # @see WhopSDK::Resources::Referrals::Businesses#list
      class BusinessListResponse < WhopSDK::Internal::Type::BaseModel
        ...
        #   Referred account.
        #
        #   @return [WhopSDK::Models::Referrals::BusinessListResponse::Account, nil]
        required :account, -> { WhopSDK::Models::Referrals::BusinessListResponse::Account }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::Referrals::BusinessListResponse::EarningsUsd]
        required :earnings_usd, -> { WhopSDK::Models::Referrals::BusinessListResponse::EarningsUsd }
        ...
        #
        #   @return [WhopSDK::Models::Referrals::BusinessListResponse::FirstTierPartner, nil]
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListResponse::MyPartnerTier]
        required :my_partner_tier, enum: -> { WhopSDK::Models::Referrals::BusinessListResponse::MyPartnerTier }

        # @!attribute object
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListResponse::Object]
        required :object, enum: -> { WhopSDK::Models::Referrals::BusinessListResponse::Object }

        # @!attribute owner
        #   The owner of the referred business.
        #
        #   @return [WhopSDK::Models::Referrals::BusinessListResponse::Owner, nil]
        required :owner, -> { WhopSDK::Models::Referrals::BusinessListResponse::Owner }, nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Referrals::BusinessListResponse::Status]
        required :status, enum: -> { WhopSDK::Models::Referrals::BusinessListResponse::Status }

        # @!attribute volume_usd
        #
        #   @return [WhopSDK::Models::Referrals::BusinessListResponse::VolumeUsd]
        required :volume_usd, -> { WhopSDK::Models::Referrals::BusinessListResponse::VolumeUsd }
        ...
        #   {WhopSDK::Models::Referrals::BusinessListResponse} for more details.
        #
        #   @param id [String] Business referral ID.
        #
        #   @param account [WhopSDK::Models::Referrals::BusinessListResponse::Account, nil] Referred account.
        #
        #   @param created_at [Time] When the business referral was created.
        #
        #   @param earnings_usd [WhopSDK::Models::Referrals::BusinessListResponse::EarningsUsd]
        #
        #   @param first_tier_partner [WhopSDK::Models::Referrals::BusinessListResponse::FirstTierPartner, nil] The partner who referred the business owner onto Whop (first tier). Null if ther
        #
        #   @param my_partner_tier [Symbol, WhopSDK::Models::Referrals::BusinessListResponse::MyPartnerTier] Which tier the caller earns on for this business: `first` (they referred the own
        #
        #   @param object [Symbol, WhopSDK::Models::Referrals::BusinessListResponse::Object]
        #
        #   @param owner [WhopSDK::Models::Referrals::BusinessListResponse::Owner, nil] The owner of the referred business.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::Referrals::BusinessListResponse::Status] Current referral status.
        #
        #   @param volume_usd [WhopSDK::Models::Referrals::BusinessListResponse::VolumeUsd]

        # @see WhopSDK::Models::Referrals::BusinessListResponse#account
        ...
        # @see WhopSDK::Models::Referrals::BusinessListResponse#earnings_usd
        ...
        # @see WhopSDK::Models::Referrals::BusinessListResponse#first_tier_partner
        class FirstTierPartner < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::Referrals::BusinessListResponse::FirstTierPartner::ProfilePicture]
          ...
          #
          #   @param profile_picture [WhopSDK::Models::Referrals::BusinessListResponse::FirstTierPartner::ProfilePicture] The user's profile picture.
          #
          #   @param username [String] The user's unique username.

          # @see WhopSDK::Models::Referrals::BusinessListResponse::FirstTierPartner#profile_picture
        ...
        # owner) or `second` (they referred the first-tier partner).
        #
        # @see WhopSDK::Models::Referrals::BusinessListResponse#my_partner_tier
        ...
        # @see WhopSDK::Models::Referrals::BusinessListResponse#object
        module Object
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::Referrals::BusinessListResponse#owner
        class Owner < WhopSDK::Internal::Type::BaseModel
          ...
          #   The user's profile picture.
          #
          #   @return [WhopSDK::Models::Referrals::BusinessListResponse::Owner::ProfilePicture]
          required :profile_picture, -> { WhopSDK::Models::Referrals::BusinessListResponse::Owner::ProfilePicture }
          ...
          #   @param name [String, nil] The user's display name.
          #
          #   @param profile_picture [WhopSDK::Models::Referrals::BusinessListResponse::Owner::ProfilePicture] The user's profile picture.
          #
          #   @param username [String] The user's unique username.

          # @see WhopSDK::Models::Referrals::BusinessListResponse::Owner#profile_picture
          class ProfilePicture < WhopSDK::Internal::Type::BaseModel
            # @!attribute url
            #   The user's profile picture URL.
            #
        ...
        # Current referral status.
        #
        # @see WhopSDK::Models::Referrals::BusinessListResponse#status
        module Status
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::Referrals::BusinessListResponse#volume_usd
        class VolumeUsd < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::Referrals::BusinessListResponse::VolumeUsd} for more details.
          #
