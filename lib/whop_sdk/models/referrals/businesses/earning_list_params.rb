    ...
    module Referrals
      module Businesses
        ...
        class EarningListParams < WhopSDK::Internal::Type::BaseModel
          ...
          #   Sort direction.
          #
          #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListParams::Direction, nil]
          ...
          #
          #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListParams::Order, nil]
          optional :order, enum: -> { WhopSDK::Referrals::Businesses::EarningListParams::Order }

          # @!attribute status
          #   Filter by earning status.
          #
          #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListParams::Status, nil]
