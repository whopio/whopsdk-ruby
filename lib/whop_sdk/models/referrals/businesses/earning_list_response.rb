...
module WhopSDK
  module Models
    module Referrals
      module Businesses
        # @see WhopSDK::Resources::Referrals::Businesses::Earnings#list
        class EarningListResponse < WhopSDK::Internal::Type::BaseModel
          ...
          #   Referred account.
          #
          #   @return [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Account, nil]
          required :account, -> { WhopSDK::Models::Referrals::Businesses::EarningListResponse::Account }, nil?: true
          ...
          #
          #   @return [Array<WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity>, nil]
          required :financial_activity,
                   -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity] },
                   nil?: true

          # @!attribute object
          #
          #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::Object]
          required :object, enum: -> { WhopSDK::Models::Referrals::Businesses::EarningListResponse::Object }
          ...
          # @!attribute product
          #
          #   @return [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Product, nil]
          required :product, -> { WhopSDK::Models::Referrals::Businesses::EarningListResponse::Product }, nil?: true

          # @!attribute resource
          #   The resource that generated the affiliate earning.
          #
          #   @return [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource, nil]
          required :resource,
                   -> { WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::Status]
          ...
          #   {WhopSDK::Models::Referrals::Businesses::EarningListResponse} for more details.
          #
          #   @param id [String, nil]
          #
          #   @param account [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Account, nil] Referred account.
          #
          ...
          #
          #   @param financial_activity [Array<WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity>, nil] Income and cost lines behind this earning's commission. Null for earnings settle
          #
          #   @param object [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::Object]
          #
          ...
          #
          #   @param product [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Product, nil]
          #
          #   @param resource [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource, nil] The resource that generated the affiliate earning.
          #
          #   @param second_tier [Boolean] Whether this earning is a second-tier (grandparent) commission.
          #
          #   @param status [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::Status] Current status of the earning.
          #
          #   @param transaction_amount_usd [String] The sale amount the commission is calculated from, in USD.

          # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse#account
          ...
          class FinancialActivity < WhopSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity::Type]
            required :type,
            ...
            #
            #   @param type [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity::Type] Whether the line is income Whop collected or a cost Whop paid.

            # Whether the line is income Whop collected or a cost Whop paid.
            #
            # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity#type
            module Type
          ...
          # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse#object
          module Object
            extend WhopSDK::Internal::Type::Enum

            BUSINESS_REFERRAL_EARNING = :business_referral_earning

            # @!method self.values
            #   @return [Array<Symbol>]
          end

          # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse#product
          ...
          # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse#resource
          class Resource < WhopSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::AlternativePaymentMethod, nil]
            required :alternative_payment_method,
                     -> { WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::AlternativePaymentMethod },
                     nil?: true
            ...
            # @!attribute object
            #
            #   @return [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::Object]
            required :object,
                     enum: -> { WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::Object }
            ...
            #
            #   @param id [String]
            #   @param alternative_payment_method [WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::AlternativePaymentMethod, nil]
            #   @param brand [String, nil]
            #   @param created_at [Time]
            #   @param currency [String]
            #   @param last4 [String, nil]
            #   @param object [Symbol, WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::Object]
            #   @param payment_method_type [String, nil]
            #   @param processor [String, nil]

            # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource#alternative_payment_method
            ...
            # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource#object
            module Object
              extend WhopSDK::Internal::Type::Enum
          ...
          # Current status of the earning.
          #
          # @see WhopSDK::Models::Referrals::Businesses::EarningListResponse#status
          module Status
            extend WhopSDK::Internal::Type::Enum
