...
module WhopSDK
  module Models
    class RefundUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"refund.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::RefundUpdatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::RefundUpdatedWebhookEvent::Data] A refund represents a full or partial reversal of a payment, including the amoun
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::RefundUpdatedWebhookEvent::Data} for more details.
        #
        #   A refund represents a full or partial reversal of a payment, including the
        #   amount, status, and payment provider.
        #
