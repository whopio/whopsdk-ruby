...
module WhopSDK
  module Models
    class ResolutionCenterCaseCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"resolution_center_case.created")
      ...
      #
      #   @param data [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data]
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Account, nil]
        required :account, -> { WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Account }, nil?: true
        ...
        #
        #   @return [Array<Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::AvailableAction>]
        required :available_actions,
                 -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::AvailableAction] }

        # @!attribute buyer
        #   The customer who opened the case.
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Buyer]
        required :buyer, -> { WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Buyer }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Outcome, nil]
        required :outcome,
                 enum: -> { WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Outcome },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Reason]
        required :reason, enum: -> { WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Reason }
        ...
        #   recorded.
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Refund, nil]
        required :refund,
                 enum: -> {
        ...
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Status }
        ...
        #
        #   @param account [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Account, nil] The account the case was filed against.
        #
        #   @param amount [Float] The amount in question, in whole units of `currency`.
        #
        #   @param available_actions [Array<Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::AvailableAction>]
        #
        #   @param buyer [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Buyer] The customer who opened the case.
        #
        ...
        #
        #   @param payment [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Payment] The payment the case was opened against.
        #
        ...
        #
        #   @param reason [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Reason] What the customer says went wrong. Shares the `/disputes` vocabulary, so a case
        #
        #   @param refund [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Refund, nil] Whether money moved and off whose balance: `none`, `merchant`, or `platform` (Wh
        #
        #   @param response_due_at [String, nil] When the next response is due, as an ISO 8601 timestamp.
        #
        #   @param status [Symbol, WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Status] Who the case is waiting on. `awaiting_merchant` and `awaiting_customer` name the
        #
        #   @param updated_at [String] When the case was last changed, as an ISO 8601 timestamp.

        # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data#account
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data#buyer
        class Buyer < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::Buyer} for more
          #   details.
          #
          #   The customer who opened the case.
          #
        ...
        class LineItem < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::LineItem::Subtotal, nil]
          required :subtotal,
                   -> { WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::LineItem::Subtotal },
                   nil?: true
          ...
          #
          #   @param subtotal [WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::LineItem::Subtotal, nil] The recorded amount for this item's full quantity, before discounts, tax, and fe

          # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::LineItem#subtotal
          class Subtotal < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data::LineItem::Subtotal}
            #   for more details.
            #
            #   The recorded amount for this item's full quantity, before discounts, tax, and
            #   fees, in its purchase currency. This is not the amount being contested. Returns
        ...
        # whether any money actually moved.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data#outcome
        module Outcome
          extend WhopSDK::Internal::Type::Enum
        ...
        # that later becomes a chargeback reports the same complaint.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data#reason
        module Reason
          extend WhopSDK::Internal::Type::Enum
        ...
        # recorded.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data#refund
        module Refund
          extend WhopSDK::Internal::Type::Enum
        ...
        # means it is settled — read `outcome` for how.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseCreatedWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
