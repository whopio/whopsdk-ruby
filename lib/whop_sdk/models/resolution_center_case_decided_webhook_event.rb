...
module WhopSDK
  module Models
    class ResolutionCenterCaseDecidedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"resolution_center_case.decided")
      ...
      #
      #   @param data [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data] A resolution center case is a dispute or support case between a user and a compa
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   exists.
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::Company, nil]
        required :company, -> { WhopSDK::ResolutionCenterCaseDecidedWebhookEvent::Data::Company }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::Member, nil]
        required :member, -> { WhopSDK::ResolutionCenterCaseDecidedWebhookEvent::Data::Member }, nil?: true
        ...
        #
        #   @return [Array<WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent>]
        required :resolution_events,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent] }
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::User]
        required :user, -> { WhopSDK::ResolutionCenterCaseDecidedWebhookEvent::Data::User }
        ...
        #
        #   @param company [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::Company, nil] The company involved in this resolution case. Null if the company no longer exis
        #
        ...
        #
        #   @param member [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::Member, nil] The membership record associated with the disputed payment. Null if the membersh
        #
        ...
        #
        #   @param payment [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::Payment] The payment record that is the subject of this resolution case.
        #
        ...
        #
        #   @param resolution_events [Array<WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent>] The most recent 50 messages, actions, and status changes that have occurred duri
        #
        ...
        #
        #   @param user [WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::User] The customer (buyer) who filed this resolution case.

        # @see WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data#company
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data#member
        ...
        class Payment < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::Payment} for
          #   more details.
          #
          #   The payment record that is the subject of this resolution case.
          #
        ...
        class ResolutionEvent < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent::Action]
          required :action,
          ...
          #
          #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent::ReporterType]
          ...
          #
          #   @param action [Symbol, WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent::Action] The type of action recorded in this event.
          #
          ...
          #
          #   @param reporter_type [Symbol, WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent::ReporterType] The party who performed this action.

          # The type of action recorded in this event.
          #
          # @see WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent#action
          module Action
          ...
          # The party who performed this action.
          #
          # @see WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data::ResolutionEvent#reporter_type
          module ReporterType
            extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseDecidedWebhookEvent::Data#user
