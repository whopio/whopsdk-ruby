  ...
  module Models
    ...
    class ResolutionCenterCaseListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      class LineItem < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem::Subtotal, nil]
        required :subtotal,
                 -> { WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem::Subtotal },
                 nil?: true
        ...
        #
        #   @param subtotal [WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem::Subtotal, nil] The recorded amount for this item's full quantity, before discounts, tax, and fe

        # @see WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem#subtotal
        class Subtotal < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem::Subtotal} for more
          #   details.
          #
          #   The recorded amount for this item's full quantity, before discounts, tax, and
          #   fees, in its purchase currency. This is not the amount being contested. Returns
