...
module WhopSDK
  module Models
    class ResolutionCenterCaseUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"resolution_center_case.updated")
      ...
      #
      #   @param data [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data] A resolution center case is a dispute or support case between a user and a compa
      #
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   exists.
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Company, nil]
        required :company, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Company }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Member, nil]
        required :member, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Member }, nil?: true
        ...
        #
        #   @return [Array<WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent>]
        required :resolution_events,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent] }
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::User]
        required :user, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::User }
        ...
        #
        #   @param company [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Company, nil] The company involved in this resolution case. Null if the company no longer exis
        #
        ...
        #
        #   @param member [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Member, nil] The membership record associated with the disputed payment. Null if the membersh
        #
        ...
        #
        #   @param payment [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Payment] The payment record that is the subject of this resolution case.
        #
        ...
        #
        #   @param resolution_events [Array<WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent>] The most recent 50 messages, actions, and status changes that have occurred duri
        #
        ...
        #
        #   @param user [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::User] The customer (buyer) who filed this resolution case.

        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#company
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#member
        ...
        class Payment < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Payment} for
          #   more details.
          #
          #   The payment record that is the subject of this resolution case.
          #
        ...
        class ResolutionEvent < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent::Action]
          required :action,
                   enum: -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent::Action }
          ...
          #
          #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent::ReporterType]
          required :reporter_type,
                   enum: -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent::ReporterType }

          # @!method initialize(id:, action:, created_at:, details:, reporter_type:)
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent}
          #   for more details.
          #
          ...
          #
          #   @param action [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent::Action] The type of action recorded in this event.
          #
          ...
          #
          #   @param reporter_type [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent::ReporterType] The party who performed this action.

          # The type of action recorded in this event.
          #
          # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent#action
          module Action
          ...
          # The party who performed this action.
          #
          # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::ResolutionEvent#reporter_type
          module ReporterType
            extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#user
