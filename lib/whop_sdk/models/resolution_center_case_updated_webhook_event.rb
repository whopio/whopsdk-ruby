...
module WhopSDK
  module Models
    class ResolutionCenterCaseUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!attribute data
      #
      #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data]
      required :data, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"resolution_center_case.updated"]
      required :type, const: :"resolution_center_case.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"resolution_center_case.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param api_version_date [String, nil] The dated API version (Api-Version-Date) the payload is serialized to
      #
      #   @param data [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data]
      #
      ...
      #
      #   @param type [Symbol, :"resolution_center_case.updated"] The webhook event type

      # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Account, nil]
        required :account, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Account }, nil?: true
        ...
        #
        #   @return [Array<Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::AvailableAction>]
        required :available_actions,
                 -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::AvailableAction] }

        # @!attribute buyer
        #   The customer who opened the case.
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer]
        required :buyer, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer }
        ...
        #
        #   @return [Array<WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::LineItem>]
        required :line_items,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::LineItem] }

        # @!attribute outcome
        #   Who prevailed on the claim. `null` until the case closes. Read `refund` for
        #   whether any money actually moved.
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Outcome, nil]
        required :outcome,
                 enum: -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Outcome },
                 nil?: true

        # @!attribute payment
        #   The payment the case was opened against.
        #
        #   @return [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Payment]
        required :payment, -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Payment }
        ...
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Reason]
        required :reason, enum: -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Reason }
        ...
        #   recorded.
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Refund, nil]
        required :refund,
                 enum: -> {
                   WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Refund
                 },
                 nil?: true
        ...
        #
        #   @return [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Status }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data} for more
        #   details.
        #
        #   @param id [String] Resolution center case ID, prefixed `reso_`.
        #
        #   @param account [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Account, nil] The account the case was filed against.
        #
        #   @param amount [Float] The amount in question, in whole units of `currency`.
        #
        #   @param available_actions [Array<Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::AvailableAction>]
        #
        #   @param buyer [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer] The customer who opened the case.
        #
        ...
        #
        #   @param line_items [Array<WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::LineItem>]
        #
        #   @param outcome [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Outcome, nil] Who prevailed on the claim. `null` until the case closes. Read `refund` for whet
        #
        #   @param payment [WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Payment] The payment the case was opened against.
        #
        ...
        #
        #   @param reason [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Reason] What the customer says went wrong. Shares the `/disputes` vocabulary, so a case
        #
        #   @param refund [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Refund, nil] Whether money moved and off whose balance: `none`, `merchant`, or `platform` (Wh
        #
        #   @param response_due_at [String, nil] When the next response is due, as an ISO 8601 timestamp.
        #
        #   @param status [Symbol, WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Status] Who the case is waiting on. `awaiting_merchant` and `awaiting_customer` name the
        #
        #   @param updated_at [String] When the case was last changed, as an ISO 8601 timestamp.

        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#account
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#buyer
        class Buyer < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer} for more
          #   details.
          #
          #   The customer who opened the case.
          #
        ...
        # whether any money actually moved.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#outcome
        module Outcome
          extend WhopSDK::Internal::Type::Enum
        ...
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#payment
        ...
        # that later becomes a chargeback reports the same complaint.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#reason
        module Reason
          extend WhopSDK::Internal::Type::Enum
        ...
        # recorded.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#refund
        module Refund
          extend WhopSDK::Internal::Type::Enum
        ...
        # means it is settled — read `outcome` for how.
        #
        # @see WhopSDK::Models::ResolutionCenterCaseUpdatedWebhookEvent::Data#status
        module Status
          extend WhopSDK::Internal::Type::Enum
