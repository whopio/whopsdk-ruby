...
module WhopSDK
  module Models
    class SetupIntentCanceledWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data]
      required :data, -> { WhopSDK::SetupIntentCanceledWebhookEvent::Data }
      ...
      #
      #   @param data [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data] An object representing a setup intent, which is a flow for allowing a customer t
      #
      ...
      # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::CheckoutConfiguration, nil]
        ...
        #
        #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Company, nil]
        required :company, -> { WhopSDK::SetupIntentCanceledWebhookEvent::Data::Company }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Member, nil]
        required :member, -> { WhopSDK::SetupIntentCanceledWebhookEvent::Data::Member }, nil?: true
        ...
        #
        #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::PaymentToken, nil]
        ...
        #
        #   @return [Symbol, WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Status]
        required :status, enum: -> { WhopSDK::SetupIntentCanceledWebhookEvent::Data::Status }
        ...
        #
        #   @param checkout_configuration [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::CheckoutConfiguration, nil] The checkout configuration associated with the setup intent
        #
        #   @param company [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Company, nil] The company of the setup intent
        #
        #   @param created_at [Time] The datetime the payment was created
        #
        #   @param error_message [String, nil] The error message, if any.
        #
        #   @param member [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Member, nil] The member connected to the setup intent
        #
        #   @param metadata [Hash{Symbol=>Object}, nil] The metadata associated with the setup intent
        #
        #   @param payment_token [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::PaymentToken, nil] The payment token created during the setup, if available.
        #
        #   @param status [Symbol, WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Status] The status of the setup intent

        # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data#checkout_configuration
        ...
        # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data#company
        ...
        # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data#member
        class Member < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Member::User, nil]
          required :user, -> { WhopSDK::SetupIntentCanceledWebhookEvent::Data::Member::User }, nil?: true
          ...
          #
          #   @param user [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Member::User, nil] The user for this member, if any.

          # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::Member#user
        ...
        # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data#payment_token
        class PaymentToken < WhopSDK::Internal::Type::BaseModel
          ...
          #   token.
          #
          #   @return [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::PaymentToken::Card, nil]
          required :card,
                   -> {
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::PaymentToken} for more
          #   details.
          #
          #   The payment token created during the setup, if available.
          #
          ...
          #
          #   @param card [WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::PaymentToken::Card, nil] The card data associated with the payment token, if its a debit or credit card t
          #
          ...
          # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data::PaymentToken#card
        ...
        # The status of the setup intent
        #
        # @see WhopSDK::Models::SetupIntentCanceledWebhookEvent::Data#status
        module Status
