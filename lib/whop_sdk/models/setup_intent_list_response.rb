  ...
  module Models
    ...
    class SetupIntentListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      class PaymentMethod < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::SetupIntentListResponse::PaymentMethod::MailingAddress, nil]
        ...
        #
        #   @param mailing_address [WhopSDK::Models::SetupIntentListResponse::PaymentMethod::MailingAddress, nil] The mailing address associated with the payment method's user
        #
        ...
        # @see WhopSDK::Models::SetupIntentListResponse::PaymentMethod#mailing_address
