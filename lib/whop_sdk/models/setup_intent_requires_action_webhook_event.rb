...
module WhopSDK
  module Models
    class SetupIntentRequiresActionWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"setup_intent.requires_action")
      ...
      #
      #   @param data [WhopSDK::Models::SetupIntent] A setup intent allows a user to save a payment method for future use without mak
      #
