...
module WhopSDK
  module Models
    ...
    class ShipmentListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #   {WhopSDK::Models::ShipmentListResponse} for more details.
      #
      ...
      #
      #   @param payment [WhopSDK::Models::ShipmentListResponse::Payment, nil] The payment associated with this shipment. Null if the payment has been deleted
      #
