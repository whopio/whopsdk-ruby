...
module WhopSDK
  module Models
    class ShipmentUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, :"shipment.updated"]
      required :type, const: :"shipment.updated"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"shipment.updated")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::ShipmentUpdatedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"shipment.updated"] The webhook event type
    end
  end
end
