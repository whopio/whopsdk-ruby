...
module WhopSDK
  module Models
    ...
    class StatQueryRawParams < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(resource:, company_id: nil, cursor: nil, from: nil, limit: nil, sort: nil, sort_direction: nil, to: nil, user_id: nil, request_options: {})
