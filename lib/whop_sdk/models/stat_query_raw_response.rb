...
module WhopSDK
  module Models
    # @see WhopSDK::Resources::Stats#query_raw
    class StatQueryRawResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::StatQueryRawResponse::Debug, nil]
      required :debug, -> { WhopSDK::Models::StatQueryRawResponse::Debug }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::StatQueryRawResponse::Pagination, nil]
      required :pagination, -> { WhopSDK::Models::StatQueryRawResponse::Pagination }, nil?: true

      # @!method initialize(columns:, data:, debug:, node:, pagination:)
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::StatQueryRawResponse} for more details.
      #
      ...
      #
      #   @param debug [WhopSDK::Models::StatQueryRawResponse::Debug, nil] Debug information including engine and SQL.
      #
      #   @param node [String, nil] The node path that was queried.
      #
      #   @param pagination [WhopSDK::Models::StatQueryRawResponse::Pagination, nil] Pagination information.

      # @see WhopSDK::Models::StatQueryRawResponse#debug
      ...
      # @see WhopSDK::Models::StatQueryRawResponse#pagination
