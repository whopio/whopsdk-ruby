...
module WhopSDK
  module Models
    ...
    class StatRunSqlResponse < WhopSDK::Internal::Type::BaseModel
      # @!attribute columns
      ...
      #
      #   @return [WhopSDK::Models::StatRunSqlResponse::Debug, nil]
      required :debug, -> { WhopSDK::Models::StatRunSqlResponse::Debug }, nil?: true
      ...
      #
      #   @return [WhopSDK::Models::StatRunSqlResponse::Pagination, nil]
      required :pagination, -> { WhopSDK::Models::StatRunSqlResponse::Pagination }, nil?: true
      ...
      #   {WhopSDK::Models::StatRunSqlResponse} for more details.
      #
      ...
      #
      #   @param debug [WhopSDK::Models::StatRunSqlResponse::Debug, nil] Debug information including engine and SQL.
      #
      #   @param node [String, nil] The node path that was queried.
      #
      #   @param pagination [WhopSDK::Models::StatRunSqlResponse::Pagination, nil] Pagination information.
      #
      #   @param typename [Symbol, :Result] The typename of this object

      # @see WhopSDK::Models::StatRunSqlResponse#debug
      ...
      # @see WhopSDK::Models::StatRunSqlResponse#pagination
