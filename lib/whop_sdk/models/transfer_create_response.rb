  ...
  module Models
    ...
    module TransferCreateResponse
      ...
      class Transfer < WhopSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, amount:, created_at:, currency:, destination:, destination_ledger_account_id:, origin:, origin_ledger_account_id:, fee_amount: nil, metadata: nil, notes: nil)
        #   A transfer of credit between two ledger accounts.
        #
