...
module WhopSDK
  module Models
    module UnwrapWebhookEvent
      ...
      variant :"verification.rfi_created", -> { WhopSDK::VerificationRfiCreatedWebhookEvent }
