...
module WhopSDK
  module Models
    module UnwrapWebhookEvent
      ...
      variant :"account.financing_approved", -> { WhopSDK::AccountFinancingApprovedWebhookEvent }

      variant :"account.financing_denied", -> { WhopSDK::AccountFinancingDeniedWebhookEvent }

      variant :"account.updated", -> { WhopSDK::AccountUpdatedWebhookEvent }

      variant :"ad.updated", -> { WhopSDK::AdUpdatedWebhookEvent }

      variant :"ad_campaign.payment_failed", -> { WhopSDK::AdCampaignPaymentFailedWebhookEvent }

      variant :"ad_campaign.updated", -> { WhopSDK::AdCampaignUpdatedWebhookEvent }
      ...
      variant :"financial_activity.funds_available", -> { WhopSDK::FinancialActivityFundsAvailableWebhookEvent }
      ...
      variant :"member.updated", -> { WhopSDK::MemberUpdatedWebhookEvent }
      ...
      variant :"payment.requires_action", -> { WhopSDK::PaymentRequiresActionWebhookEvent }
