...
module WhopSDK
  module Models
    ...
    class VerificationCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::VerificationCreateResponse::Address, nil]
      optional :address, -> { WhopSDK::Models::VerificationCreateResponse::Address }, nil?: true
      ...
      # @!attribute kind
      #
      #   @return [Symbol, WhopSDK::Models::VerificationCreateResponse::Kind, nil]
      optional :kind, enum: -> { WhopSDK::Models::VerificationCreateResponse::Kind }
      ...
      #
      #   @return [Array<WhopSDK::Models::VerificationCreateResponse::RequestedInformation>, nil]
      optional :requested_information,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::VerificationCreateResponse::RequestedInformation] }
      ...
      #   call.
      #
      #   @return [Array<WhopSDK::Models::VerificationCreateResponse::RequiredDocument>, nil]
      optional :required_documents,
               -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::VerificationCreateResponse::RequiredDocument] }
      ...
      #
      #   @return [Symbol, WhopSDK::Models::VerificationCreateResponse::Status, nil]
      optional :status, enum: -> { WhopSDK::Models::VerificationCreateResponse::Status }
      ...
      #   {WhopSDK::Models::VerificationCreateResponse} for more details.
      #
      #   @param id [String] Verification profile ID, prefixed `idpf_`.
      #
      #   @param address [WhopSDK::Models::VerificationCreateResponse::Address, nil] Address on the verification profile. `null` when no address is set.
      #
      ...
      #
      #   @param requested_information [Array<WhopSDK::Models::VerificationCreateResponse::RequestedInformation>] Fields or documents Whop still needs before review can continue. Submit answers
      #
      #   @param required_documents [Array<WhopSDK::Models::VerificationCreateResponse::RequiredDocument>] Documents for a document-upload verification and their progress. Present only on
      #
      #   @param session_url [String, nil] Hosted verification session URL for the user to complete identity checks. Expire
      #
      #   @param status [Symbol, WhopSDK::Models::VerificationCreateResponse::Status] Current verification state. `not_started` before any session has been created; `
      #
      #   @param updated_at [String] When the verification profile was last updated, as an ISO 8601 timestamp.

      # @see WhopSDK::Models::VerificationCreateResponse#address
      ...
      class RequestedInformation < WhopSDK::Internal::Type::BaseModel
        ...
        #   the answer.
        #
        #   @return [Array<WhopSDK::Models::VerificationCreateResponse::RequestedInformation::RequestedFile>, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::VerificationCreateResponse::RequestedInformation} for more
        #   details.
        #
        ...
        #
        #   @param requested_files [Array<WhopSDK::Models::VerificationCreateResponse::RequestedInformation::RequestedFile>] Document upload slots for this item. Present when `type` is `files`; upload one
        #
        ...
        class RequestedFile < WhopSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::VerificationCreateResponse::RequestedInformation::RequestedFile}
          #   for more details.
          #
      ...
      class RequiredDocument < WhopSDK::Internal::Type::BaseModel
        ...
        #   afterwards.
        #
        #   @return [Symbol, WhopSDK::Models::VerificationCreateResponse::RequiredDocument::Status, nil]
        optional :status, enum: -> { WhopSDK::Models::VerificationCreateResponse::RequiredDocument::Status }

        # @!method initialize(document: nil, rejection_reason: nil, status: nil)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::VerificationCreateResponse::RequiredDocument} for more
        #   details.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::VerificationCreateResponse::RequiredDocument::Status] `pending_upload` until the document has been relayed for review; `submitted` aft

        # `pending_upload` until the document has been relayed for review; `submitted`
        # afterwards.
        #
        # @see WhopSDK::Models::VerificationCreateResponse::RequiredDocument#status
        module Status
          extend WhopSDK::Internal::Type::Enum
