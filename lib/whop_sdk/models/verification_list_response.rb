    ...
    class VerificationListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        class RequestedInformation < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::ResponseType, nil]
          optional :response_type,
                   enum: -> { WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::ResponseType }

          # @!attribute selection_mode
          #   Whether a question with `options` accepts one value or multiple values.
          #
          #   @return [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SelectionMode, nil]
          optional :selection_mode,
                   enum: -> { WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SelectionMode }

          # @!attribute supporting_documents
          #   Documents supplied with the requirement for context.
          #
          #   @return [Array<WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument>, nil]
          optional :supporting_documents,
                   -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument] }
          ...
          #
          #   @param response_type [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::ResponseType] Optional native input format for a text response.
          #
          #   @param selection_mode [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SelectionMode] Whether a question with `options` accepts one value or multiple values.
          #
          #   @param supporting_documents [Array<WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument>] Documents supplied with the requirement for context.
          #
          ...
          # Optional native input format for a text response.
          #
          # @see WhopSDK::Models::VerificationListResponse::Data::RequestedInformation#response_type
          module ResponseType
            extend WhopSDK::Internal::Type::Enum
          ...
          # Whether a question with `options` accepts one value or multiple values.
          #
          # @see WhopSDK::Models::VerificationListResponse::Data::RequestedInformation#selection_mode
          ...
          class SupportingDocument < WhopSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::UploadStatus]
            required :upload_status,
                     enum: -> { WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::UploadStatus }
            ...
            #   expiring URL.
            #
            #   @return [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::Visibility]
            required :visibility,
                     enum: -> { WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::Visibility }
            ...
            #
            #   @return [Array<WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::MultipartUploadURL>, nil]
            ...
            #
            #   @param upload_status [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::UploadStatus] Where the file is in its upload lifecycle.
            #
            #   @param url [String, nil] A URL to download the file: a permanent CDN URL for public files, a signed expir
            #
            #   @param visibility [Symbol, WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::Visibility] `public` files are served via an unsigned CDN URL; `private` files via a signed,
            #
            ...
            #
            #   @param multipart_upload_urls [Array<WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument::MultipartUploadURL>, nil]
            #
            ...
            # Where the file is in its upload lifecycle.
            #
            # @see WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument#upload_status
            module UploadStatus
              extend WhopSDK::Internal::Type::Enum
            ...
            # expiring URL.
            #
            # @see WhopSDK::Models::VerificationListResponse::Data::RequestedInformation::SupportingDocument#visibility
            module Visibility
              extend WhopSDK::Internal::Type::Enum
