...
module WhopSDK
  module Models
    ...
    class VerificationRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @param requested_information [Array<WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation>] Fields or documents Whop still needs before review can continue. Submit answers
      #
      ...
      #
      #   @param status [Symbol, WhopSDK::Models::VerificationRetrieveResponse::Status] Current verification state. `not_started` before any session has been created; `
      #
      ...
      class RequestedInformation < WhopSDK::Internal::Type::BaseModel
        ...
        #   the answer.
        #
        #   @return [Array<WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::RequestedFile>, nil]
        optional :requested_files,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::RequestedFile] }
        ...
        #
        #   @param requested_files [Array<WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::RequestedFile>] Document upload slots for this item. Present when `type` is `files`; upload one
        #
