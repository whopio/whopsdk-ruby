...
module WhopSDK
  module Models
    class VerificationRfiCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::VerificationRfiCreatedWebhookEvent::Data]
      required :data, -> { WhopSDK::VerificationRfiCreatedWebhookEvent::Data }
      ...
      #
      #   @return [Symbol, :"verification.rfi_created"]
      required :type, const: :"verification.rfi_created"
      ...
      # @!method initialize(id:, data:, timestamp:, company_id: nil, api_version: :v1, type: :"verification.rfi_created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::VerificationRfiCreatedWebhookEvent} for more details.
      #
      #   @param id [String] A unique ID for every single webhook request
      #
      #   @param data [WhopSDK::Models::VerificationRfiCreatedWebhookEvent::Data] An identity verification session used to confirm a person or entity's identity f
      #
      ...
      #
      #   @param type [Symbol, :"verification.rfi_created"] The webhook event type

      # @see WhopSDK::Models::VerificationRfiCreatedWebhookEvent#data
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::VerificationRfiCreatedWebhookEvent::Data} for more details.
        #
        #   An identity verification session used to confirm a person or entity's identity
        #   for payout account eligibility.
        #
