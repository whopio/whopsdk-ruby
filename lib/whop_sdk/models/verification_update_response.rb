...
module WhopSDK
  module Models
    ...
    class VerificationUpdateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      # @!attribute rfis
      #
      #   @return [Array<WhopSDK::Models::VerificationUpdateResponse::Rfi>, nil]
      optional :rfis, -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::VerificationUpdateResponse::Rfi] }
