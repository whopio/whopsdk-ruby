...
module WhopSDK
  module Models
    ...
    class VerificationUpdateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [WhopSDK::Models::VerificationUpdateResponse::Address, nil]
      ...
      # @!attribute kind
      #
      #   @return [Symbol, WhopSDK::Models::VerificationUpdateResponse::Kind, nil]
      ...
      #
      #   @return [Array<WhopSDK::Models::VerificationUpdateResponse::RequestedInformation>, nil]
      ...
      #   call.
      #
      #   @return [Array<WhopSDK::Models::VerificationUpdateResponse::RequiredDocument>, nil]
      ...
      #
      #   @return [Symbol, WhopSDK::Models::VerificationUpdateResponse::Status, nil]
      ...
      #   {WhopSDK::Models::VerificationUpdateResponse} for more details.
      #
      #   @param id [String] Verification profile ID, prefixed `idpf_`.
      #
      #   @param address [WhopSDK::Models::VerificationUpdateResponse::Address, nil] Address on the verification profile. `null` when no address is set.
      #
      ...
      #
      #   @param requested_information [Array<WhopSDK::Models::VerificationUpdateResponse::RequestedInformation>] Fields or documents Whop still needs before review can continue. Submit answers
      #
      #   @param required_documents [Array<WhopSDK::Models::VerificationUpdateResponse::RequiredDocument>] Documents for a document-upload verification and their progress. Present only on
      #
      #   @param session_url [String, nil] Hosted verification session URL for the user to complete identity checks. Expire
      #
      #   @param status [Symbol, WhopSDK::Models::VerificationUpdateResponse::Status] Current verification state. `not_started` before any session has been created; `
      #
      #   @param updated_at [String] When the verification profile was last updated, as an ISO 8601 timestamp.

      # @see WhopSDK::Models::VerificationUpdateResponse#address
      ...
      class RequestedInformation < WhopSDK::Internal::Type::BaseModel
        ...
        #   the answer.
        #
        #   @return [Array<WhopSDK::Models::VerificationUpdateResponse::RequestedInformation::RequestedFile>, nil]
        optional :requested_files,
                 -> { WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::VerificationUpdateResponse::RequestedInformation::RequestedFile] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::VerificationUpdateResponse::RequestedInformation} for more
        #   details.
        #
        ...
        #
        #   @param requested_files [Array<WhopSDK::Models::VerificationUpdateResponse::RequestedInformation::RequestedFile>] Document upload slots for this item. Present when `type` is `files`; upload one
        #
      ...
      class RequiredDocument < WhopSDK::Internal::Type::BaseModel
        ...
        #   afterwards.
        #
        #   @return [Symbol, WhopSDK::Models::VerificationUpdateResponse::RequiredDocument::Status, nil]
        optional :status, enum: -> { WhopSDK::Models::VerificationUpdateResponse::RequiredDocument::Status }

        # @!method initialize(document: nil, rejection_reason: nil, status: nil)
        #   Some parameter documentations has been truncated, see
        #   {WhopSDK::Models::VerificationUpdateResponse::RequiredDocument} for more
        #   details.
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::VerificationUpdateResponse::RequiredDocument::Status] `pending_upload` until the document has been relayed for review; `submitted` aft

        # `pending_upload` until the document has been relayed for review; `submitted`
        # afterwards.
        #
        # @see WhopSDK::Models::VerificationUpdateResponse::RequiredDocument#status
        module Status
          extend WhopSDK::Internal::Type::Enum
