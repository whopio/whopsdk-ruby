...
module WhopSDK
  module Models
    ...
    class Webhook < WhopSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, WhopSDK::Models::Webhook::APIVersion]
      required :api_version, enum: -> { WhopSDK::Webhook::APIVersion }
      ...
      #
      #   @return [Symbol, WhopSDK::Models::Webhook::DisabledReason, nil]
      required :disabled_reason, enum: -> { WhopSDK::Webhook::DisabledReason }, nil?: true
      ...
      # @!attribute events
      #
      #   @return [Array<Symbol, WhopSDK::Models::Webhook::Event>]
      required :events, -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::Webhook::Event] }
      ...
      #
      #   @return [Array<Symbol, WhopSDK::Models::Webhook::TestableEvent>]
      required :testable_events, -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::Webhook::TestableEvent] }
      ...
      # @!method initialize(id:, api_version:, api_version_date:, child_resource_events:, consecutive_failures:, created_at:, disabled_at:, disabled_reason:, enabled:, events:, failing_since:, last_failure_at:, resource_id:, testable_events:, url:, webhook_secret:)
      #   Some parameter documentations has been truncated, see {WhopSDK::Models::Webhook}
      #   for more details.
      #
      #   @param id [String] Webhook ID, prefixed `hook_`.
      #
      #   @param api_version [Symbol, WhopSDK::Models::Webhook::APIVersion] The API version used to format payloads sent to this webhook endpoint.
      #
      ...
      #
      #   @param disabled_reason [Symbol, WhopSDK::Models::Webhook::DisabledReason, nil] Why Whop disabled this webhook. `delivery_failures` means every delivery failed
      #
      #   @param enabled [Boolean] Whether this webhook endpoint is currently active and receiving events.
      #
      #   @param events [Array<Symbol, WhopSDK::Models::Webhook::Event>]
      #
      ...
      #
      #   @param testable_events [Array<Symbol, WhopSDK::Models::Webhook::TestableEvent>]
      #
      ...
      # The API version used to format payloads sent to this webhook endpoint.
      #
      # @see WhopSDK::Models::Webhook#api_version
      module APIVersion
      ...
      # for 3 days straight. `null` when `disabled_at` is `null`.
      #
      # @see WhopSDK::Models::Webhook#disabled_reason
