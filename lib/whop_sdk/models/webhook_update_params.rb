...
module WhopSDK
  module Models
    ...
    class WebhookUpdateParams < WhopSDK::Internal::Type::BaseModel
      ...
      optional :events, -> { WhopSDK::Internal::Type::ArrayOf[enum: WhopSDK::WebhookUpdateParams::Event] }
      ...
      # @!method initialize(id:, body_api_version_date: nil, child_resource_events: nil, enabled: nil, events: nil, url: nil, header_api_version_date: nil, request_options: {})
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::WebhookUpdateParams} for more details.
      #
      #   @param id [String]
      #
      #   @param body_api_version_date [String, nil] The dated API version (Api-Version-Date) to pin this webhook's payloads to. Only
      #
      #   @param child_resource_events [Boolean] Whether or not to send events for child resources.
      #
      #   @param enabled [Boolean] Whether or not the webhook is enabled.
      #
      #   @param events [Array<Symbol, WhopSDK::Models::WebhookUpdateParams::Event>] The events to send the webhook for, in dot form (for example `payment.succeeded`
      #
