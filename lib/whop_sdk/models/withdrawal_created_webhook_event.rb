...
module WhopSDK
  module Models
    class WithdrawalCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, company_id: nil, previous_attributes: nil, api_version: :v1, type: :"withdrawal.created")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::WithdrawalCreatedWebhookEvent} for more details.
      #
