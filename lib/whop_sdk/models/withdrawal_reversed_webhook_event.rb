...
module WhopSDK
  module Models
    class WithdrawalReversedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, :"withdrawal.reversed"]
      required :type, const: :"withdrawal.reversed"
      ...
      # @!method initialize(id:, api_version_date:, data:, timestamp:, account_id: nil, previous_attributes: nil, api_version: :v1, type: :"withdrawal.reversed")
      #   Some parameter documentations has been truncated, see
      #   {WhopSDK::Models::WithdrawalReversedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, :"withdrawal.reversed"] The webhook event type
    end
  end
end
