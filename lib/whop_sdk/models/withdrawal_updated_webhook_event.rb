  ...
  module Models
    class WithdrawalUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout, nil]
        required :latest_payout, -> { WhopSDK::WithdrawalUpdatedWebhookEvent::Data::LatestPayout }, nil?: true
        ...
        #
        #   @param latest_payout [WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout, nil] The latest payout associated with this withdrawal, if any.
        #
        ...
        # @see WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data#latest_payout
        class LatestPayout < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout::ErrorCode, nil]
          required :error_code,
                   enum: -> { WhopSDK::WithdrawalUpdatedWebhookEvent::Data::LatestPayout::ErrorCode },
                   nil?: true
          ...
          #
          #   @return [Symbol, WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout::Status]
          required :status, enum: -> { WhopSDK::WithdrawalUpdatedWebhookEvent::Data::LatestPayout::Status }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout} for more
          #   details.
          #
          #   The latest payout associated with this withdrawal, if any.
          #
          ...
          #
          #   @param error_code [Symbol, WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout::ErrorCode, nil] The different error codes a payout can be in.
          #
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout::Status] The status of the payout.
          #
          #   @param trace_code [String, nil] The trace code for the payout, if applicable. Provided on ACH transactions when

          # The different error codes a payout can be in.
          #
          # @see WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout#error_code
          module ErrorCode
          ...
          # The status of the payout.
          #
          # @see WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::LatestPayout#status
          module Status
            extend WhopSDK::Internal::Type::Enum
        ...
        class PayoutToken < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::PayoutToken::Status]
          required :status, enum: -> { WhopSDK::WithdrawalUpdatedWebhookEvent::Data::PayoutToken::Status }
          ...
          #
          #   @param status [Symbol, WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::PayoutToken::Status] The status of the payout token.

          # The status of the payout token.
          #
          # @see WhopSDK::Models::WithdrawalUpdatedWebhookEvent::Data::PayoutToken#status
          module Status
            extend WhopSDK::Internal::Type::Enum
