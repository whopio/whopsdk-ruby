...
module WhopSDK
  module Models
    module Workforce
      ...
      class WorkforceBountyListItem < WhopSDK::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Workforce::WorkforceBountyListItem::BusinessGoalType, nil]
        ...
        #
        #   @return [WhopSDK::Models::Workforce::WorkforceBountyListItem::FundingAccount, nil]
        ...
        #
        #   @return [WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster]
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Workforce::WorkforceBountyListItem::ScheduledFrequency, nil]
        ...
        #
        #   @return [Symbol, WhopSDK::Models::Workforce::WorkforceBountyListItem::Status]
        ...
        #   {WhopSDK::Models::Workforce::WorkforceBountyListItem} for more details.
        #
        ...
        #
        #   @param business_goal_type [Symbol, WhopSDK::Models::Workforce::WorkforceBountyListItem::BusinessGoalType, nil] What the poster wants the work to achieve.
        #
        ...
        #
        #   @param funding_account [WhopSDK::Models::Workforce::WorkforceBountyListItem::FundingAccount, nil] The account whose balance funds the bounty pool, or `null` when a user funds it
        #
        ...
        #
        #   @param poster [WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster] The user who posted the bounty.
        #
        #   @param scheduled_frequency [Symbol, WhopSDK::Models::Workforce::WorkforceBountyListItem::ScheduledFrequency, nil] How often the schedule creates a new bounty. Each occurrence is a separate bount
        #
        ...
        #
        #   @param status [Symbol, WhopSDK::Models::Workforce::WorkforceBountyListItem::Status] Lifecycle state. `scheduled` bounties are unpublished drafts, visible to their p
        #
        ...
        # What the poster wants the work to achieve.
        #
        # @see WhopSDK::Models::Workforce::WorkforceBountyListItem#business_goal_type
        ...
        # @see WhopSDK::Models::Workforce::WorkforceBountyListItem#funding_account
        ...
        # @see WhopSDK::Models::Workforce::WorkforceBountyListItem#poster
        class Poster < WhopSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster::ProfilePicture]
          required :profile_picture, -> { WhopSDK::Workforce::WorkforceBountyListItem::Poster::ProfilePicture }
          ...
          #   Some parameter documentations has been truncated, see
          #   {WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster} for more details.
          #
          #   The user who posted the bounty.
          #
          ...
          #
          #   @param profile_picture [WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster::ProfilePicture] Avatar wrapper; its `url` is always present, using a generated placeholder when
          #
          #   @param username [String] Public username.

          # @see WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster#profile_picture
          class ProfilePicture < WhopSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {WhopSDK::Models::Workforce::WorkforceBountyListItem::Poster::ProfilePicture}
            #   for more details.
            #
            #   Avatar wrapper; its `url` is always present, using a generated placeholder when
            #   the user set no picture.
        ...
        # bounty; the original is not republished.
        #
        # @see WhopSDK::Models::Workforce::WorkforceBountyListItem#scheduled_frequency
        ...
        # before filling their slots.
        #
        # @see WhopSDK::Models::Workforce::WorkforceBountyListItem#status
        module Status
          extend WhopSDK::Internal::Type::Enum
    ...
    WorkforceBountyListItem = Workforce::WorkforceBountyListItem
  end
end
