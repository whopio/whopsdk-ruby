...
module Whop_sdk
  module Partners
    module Types
      ...
      class LeaderboardPartnersResponseMe < Internal::Types::Model
        ...
        field :user, -> { Whop_sdk::Partners::Types::LeaderboardPartnersResponseMeUser }, optional: false, nullable: true
      end
    end
  end
end
