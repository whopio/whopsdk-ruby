...
module Whop_sdk
  module PayoutMethods
    class Client
      ...
      #   )
      #
      # @return [Whop_sdk::PayoutMethods::Types::ListPayoutMethodResponse]
      def list_payout_method(request_options: {}, **params)
      ...
      #
      # @return [Whop_sdk::Types::PayoutMethod]
      def retrieve_payout_method(request_options: {}, **params)
        params = Whop_sdk::Internal::Types::Utils.normalize_keys(params)
        request = Whop_sdk::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "payout_methods/#{URI.encode_uri_component(params[:id].to_s)}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
