...
module Whop_sdk
  module Payouts
    module Methods
      module Types
        class CreateMethodsResponse < Internal::Types::Model
          field :account_reference, -> { String }, optional: false, nullable: true

          field :bank_verification_state, -> { Whop_sdk::Payouts::Methods::Types::CreateMethodsResponseBankVerificationState }, optional: true, nullable: false
          ...
          field :is_clone, -> { Internal::Types::Boolean }, optional: true, nullable: false
          ...
          field :linked_via_plaid, -> { Internal::Types::Boolean }, optional: true, nullable: false

          field :needs_plaid_reconnect, -> { Internal::Types::Boolean }, optional: true, nullable: false

          field :nickname, -> { String }, optional: false, nullable: true

          field :object, -> { Whop_sdk::Payouts::Methods::Types::CreateMethodsResponseObject }, optional: false, nullable: false
          ...
          field :supported_payout_method, -> { Whop_sdk::Payouts::Methods::Types::CreateMethodsResponseSupportedPayoutMethod }, optional: false, nullable: true

          field :unavailable_reason, -> { Whop_sdk::Payouts::Methods::Types::CreateMethodsResponseUnavailableReason }, optional: false, nullable: true
        end
      end
    end
  end
