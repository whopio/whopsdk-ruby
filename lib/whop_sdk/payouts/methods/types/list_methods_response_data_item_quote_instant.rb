...
module Whop_sdk
  module Payouts
    module Methods
      module Types
        # Instant-delivery estimate. Null if the method does not support instant delivery, instant delivery is
        # unavailable for the account, or the amount does not cover the fee.
        class ListMethodsResponseDataItemQuoteInstant < Internal::Types::Model
