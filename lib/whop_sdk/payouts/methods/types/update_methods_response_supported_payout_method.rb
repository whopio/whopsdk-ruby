...
module Whop_sdk
  module Payouts
    module Methods
      module Types
        class UpdateMethodsResponseSupportedPayoutMethod < Internal::Types::Model
          field :country_code, -> { String }, optional: false, nullable: true

          field :delivery_type, -> { Whop_sdk::Payouts::Methods::Types::UpdateMethodsResponseSupportedPayoutMethodDeliveryType }, optional: false, nullable: false
