...
module Whop_sdk
  module Payouts
    module SupportedMethods
      module Types
        # Instant-delivery estimate. Null if unsupported, unavailable for the account, or the amount does not cover the
        # fee.
        class ListSupportedMethodsResponseDataItemQuotesItemInstant < Internal::Types::Model
