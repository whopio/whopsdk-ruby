...
module Whop_sdk
  module Payouts
    module Types
      class CreatePayoutsResponse < Internal::Types::Model
        ...
        field :failure, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponseFailure }, optional: false, nullable: true

        field :fee_amount, -> { String }, optional: false, nullable: false

        field :fee_paid_by, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponseFeePaidBy }, optional: false, nullable: false
        ...
        field :object, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponseObject }, optional: false, nullable: false

        field :payer_name, -> { String }, optional: false, nullable: true

        field :payout_method, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponsePayoutMethod }, optional: false, nullable: true

        field :payout_request_id, -> { String }, optional: false, nullable: true

        field :source, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponseSource }, optional: false, nullable: true

        field :speed, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponseSpeed }, optional: false, nullable: false

        field :statement_descriptor, -> { String }, optional: false, nullable: true

        field :status, -> { Whop_sdk::Payouts::Types::CreatePayoutsResponseStatus }, optional: false, nullable: false
