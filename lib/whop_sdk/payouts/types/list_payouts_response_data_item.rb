...
module Whop_sdk
  module Payouts
    module Types
      class ListPayoutsResponseDataItem < Internal::Types::Model
        ...
        field :failure, -> { Whop_sdk::Payouts::Types::ListPayoutsResponseDataItemFailure }, optional: false, nullable: true

        field :fee_amount, -> { String }, optional: false, nullable: false

        field :fee_paid_by, -> { Whop_sdk::Payouts::Types::ListPayoutsResponseDataItemFeePaidBy }, optional: false, nullable: false
        ...
        field :object, -> { Whop_sdk::Payouts::Types::ListPayoutsResponseDataItemObject }, optional: false, nullable: false

        field :payer_name, -> { String }, optional: false, nullable: true

        field :payout_method, -> { Whop_sdk::Payouts::Types::ListPayoutsResponseDataItemPayoutMethod }, optional: false, nullable: true

        field :payout_request_id, -> { String }, optional: false, nullable: true

        field :source, -> { Whop_sdk::Payouts::Types::ListPayoutsResponseDataItemSource }, optional: false, nullable: true
