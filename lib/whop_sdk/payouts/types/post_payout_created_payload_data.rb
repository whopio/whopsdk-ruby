...
module Whop_sdk
  module Payouts
    module Types
      class PostPayoutCreatedPayloadData < Internal::Types::Model
        ...
        field :failure, -> { Whop_sdk::Payouts::Types::PostPayoutCreatedPayloadDataFailure }, optional: false, nullable: true

        field :fee_amount, -> { String }, optional: false, nullable: false

        field :fee_paid_by, -> { Whop_sdk::Payouts::Types::PostPayoutCreatedPayloadDataFeePaidBy }, optional: false, nullable: false
        ...
        field :object, -> { Whop_sdk::Payouts::Types::PostPayoutCreatedPayloadDataObject }, optional: false, nullable: false
        ...
        field :speed, -> { Whop_sdk::Payouts::Types::PostPayoutCreatedPayloadDataSpeed }, optional: false, nullable: false

        field :status, -> { Whop_sdk::Payouts::Types::PostPayoutCreatedPayloadDataStatus }, optional: false, nullable: false
