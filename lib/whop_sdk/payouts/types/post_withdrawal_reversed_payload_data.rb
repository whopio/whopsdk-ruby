...
module Whop_sdk
  module Payouts
    module Types
      class PostWithdrawalReversedPayloadData < Internal::Types::Model
        ...
        field :fee_paid_by, -> { Whop_sdk::Payouts::Types::PostWithdrawalReversedPayloadDataFeePaidBy }, optional: false, nullable: false
        ...
        field :object, -> { Whop_sdk::Payouts::Types::PostWithdrawalReversedPayloadDataObject }, optional: false, nullable: false

        field :payer_name, -> { String }, optional: false, nullable: true

        field :payout_method, -> { Whop_sdk::Payouts::Types::PostWithdrawalReversedPayloadDataPayoutMethod }, optional: false, nullable: true

        field :payout_request_id, -> { String }, optional: false, nullable: true

        field :source, -> { Whop_sdk::Payouts::Types::PostWithdrawalReversedPayloadDataSource }, optional: false, nullable: true

        field :speed, -> { Whop_sdk::Payouts::Types::PostWithdrawalReversedPayloadDataSpeed }, optional: false, nullable: false

        field :status, -> { Whop_sdk::Payouts::Types::PostWithdrawalReversedPayloadDataStatus }, optional: false, nullable: false
