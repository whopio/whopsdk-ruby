...
module Whop_sdk
  module PromoCodes
    class Client
      ...
      # @option params [Whop_sdk::PromoCodes::Types::ListPromoCodesRequestStatus, nil] :status
      ...
      # @option params [Whop_sdk::PromoCodes::Types::ListPromoCodesRequestOrder, nil] :order
      # @option params [Whop_sdk::PromoCodes::Types::ListPromoCodesRequestDirection, nil] :direction
      ...
      #   )
      #
      # @return [Whop_sdk::PromoCodes::Types::ListPromoCodesResponse]
      ...
      #   )
      #
      # @return [Whop_sdk::Types::PromoCode]
      ...
      #
      # @return [Whop_sdk::PromoCodes::Types::DeletePromoCodesResponse]
