...
module WhopSDK
  module Resources
    class Cards
      ...
      #
      # @overload create_dispute(id, dispute_type:, text_evidence:, transaction_id:, dispute_amount_cents: nil, request_options: {})
      #
      # @param id [String]
      #
      ...
      # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [WhopSDK::Models::CardDispute]
      #
      # @see WhopSDK::Models::CardCreateDisputeParams
      def create_dispute(id, params)
        parsed, options = WhopSDK::CardCreateDisputeParams.dump_request(params)
        @client.request(
          method: :post,
          path: ["cards/%1$s/disputes", id],
          body: parsed,
          model: WhopSDK::CardDispute,
          options: options
        )
      end
      ...
      #
      # @overload create_dispute_attachment(dispute_id, id:, attachment:, request_options: {})
      #
      # @param dispute_id [String] Path param
      #
      # @param id [String] Path param
      #
      # @param attachment [WhopSDK::Models::CardCreateDisputeAttachmentParams::Attachment] Body param
      #
      # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [WhopSDK::Models::CardDispute]
      #
      # @see WhopSDK::Models::CardCreateDisputeAttachmentParams
      def create_dispute_attachment(dispute_id, params)
        parsed, options = WhopSDK::CardCreateDisputeAttachmentParams.dump_request(params)
        id =
          parsed.delete(:id) do
        ...
        @client.request(
          method: :post,
          path: ["cards/%1$s/disputes/%2$s/attachments", id, dispute_id],
          body: parsed,
          model: WhopSDK::CardDispute,
          options: options
        )
      ...
      #
      # @overload pin(id, request_options: {})
      #
      # @param id [String]
      # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [WhopSDK::Models::CardPin]
      #
      # @see WhopSDK::Models::CardPinParams
      def pin(id, params = {})
        @client.request(
          method: :get,
          path: ["cards/%1$s/pin", id],
          model: WhopSDK::CardPin,
          options: params[:request_options]
        )
      end
      ...
      #
      # @overload secrets(id, request_options: {})
      #
      # @param id [String]
      # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [WhopSDK::Models::CardSecrets]
      #
      # @see WhopSDK::Models::CardSecretsParams
      def secrets(id, params = {})
        @client.request(
          method: :post,
          path: ["cards/%1$s/secrets", id],
          model: WhopSDK::CardSecrets,
          options: params[:request_options]
        )
      end
      ...
      #
      # @overload update_pin(id, pin:, request_options: {})
      #
      # @param id [String]
      #
      ...
      # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [WhopSDK::Models::CardUpdatePinResponse]
      #
      # @see WhopSDK::Models::CardUpdatePinParams
      def update_pin(id, params)
        parsed, options = WhopSDK::CardUpdatePinParams.dump_request(params)
        @client.request(
          method: :put,
          path: ["cards/%1$s/pin", id],
          body: parsed,
          model: WhopSDK::Models::CardUpdatePinResponse,
          options: options
        )
      end
