...
module WhopSDK
  module Resources
    ...
    class Disputes
      ...
      #
      # @param created_after [Time] Only return disputes created after this timestamp.
      #
      # @param created_before [Time] Only return disputes created before this timestamp.
      #
