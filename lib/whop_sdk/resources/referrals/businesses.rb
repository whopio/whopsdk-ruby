  ...
  module Resources
    class Referrals
      ...
      class Businesses
        ...
        # Use it to enroll as a Whop partner, list the users you referred, list your
        # referred businesses and review their earnings, and see the partner leaderboard.
        # @return [WhopSDK::Resources::Referrals::Businesses::Earnings]
        ...
        #
        # @return [WhopSDK::Models::Referrals::BusinessRetrieveResponse]
        #
        # @see WhopSDK::Models::Referrals::BusinessRetrieveParams
        ...
        # {WhopSDK::Models::Referrals::BusinessListParams} for more details.
        #
        ...
        #
        # @param created_after [String] Only return business referrals created after this timestamp.
        #
        # @param created_before [String] Only return business referrals created before this timestamp.
        #
        # @param direction [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Direction] Sort direction.
        #
        # @param first [Integer] Number of business referrals to return from the start of the window.
        #
        # @param has_earnings [Boolean] When true, only businesses with pending or completed earnings paid to the caller
        #
        # @param last [Integer] Number of business referrals to return from the end of the window.
        #
        # @param order [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Order] The field to sort business referrals by.
        #
        ...
        #
        # @param status [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Status] Filter by referral status.
        #
        # @param tier [Symbol, WhopSDK::Models::Referrals::BusinessListParams::Tier] Filter to only first-tier referrals or only second-tier referrals.
        #
        # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [WhopSDK::Internal::CursorPage<WhopSDK::Models::Referrals::BusinessListResponse>]
        #
        # @see WhopSDK::Models::Referrals::BusinessListParams
        def list(params = {})
        ...
        # Some parameter documentations has been truncated, see
        # {WhopSDK::Models::Referrals::BusinessLeaderboardParams} for more details.
        #
        ...
        #
        # @param period [Symbol, WhopSDK::Models::Referrals::BusinessLeaderboardParams::Period] Time window for the rankings. `day`, `month`, and `year` count earnings since th
        #
        # @param request_options [WhopSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [WhopSDK::Models::Referrals::BusinessLeaderboardResponse]
        #
        # @see WhopSDK::Models::Referrals::BusinessLeaderboardParams
