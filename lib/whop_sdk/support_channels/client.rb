...
module Whop_sdk
  module SupportChannels
    class Client
      ...
      def list(request_options: {}, **params)
        ...
        Whop_sdk::Internal::CursorItemIterator.new(
          ...
          if code.between?(200, 299)
            parsed_response = Whop_sdk::SupportChannels::Types::ListSupportChannelsResponse.load(response.body)
      ...
      #
      # @param request_options [Hash]
      # @param params [Whop_sdk::SupportChannels::Types::CreateSupportChannelsRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [Whop_sdk::Types::SupportChannel]
      def create(request_options: {}, **params)
        ...
        request = Whop_sdk::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "support_channels",
          body: Whop_sdk::SupportChannels::Types::CreateSupportChannelsRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Whop_sdk::Types::SupportChannel.load(response.body)
        else
          error_class = Whop_sdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def retrieve(request_options: {}, **params)
        ...
        request = Whop_sdk::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "support_channels/#{URI.encode_uri_component(params[:id].to_s)}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
