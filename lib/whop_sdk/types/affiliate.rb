...
module Whop_sdk
  module Types
    ...
    class Affiliate < Internal::Types::Model
      field :active_members_count, -> { Integer }, optional: false, nullable: false

      field :company, -> { Whop_sdk::Types::AffiliateCompany }, optional: false, nullable: false
      ...
      field :user, -> { Whop_sdk::Types::AffiliateUser }, optional: false, nullable: false
    end
  end
end
