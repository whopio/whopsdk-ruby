...
module Whop_sdk
  module Types
    ...
    class CourseStudent < Internal::Types::Model
      ...
      field :course, -> { Whop_sdk::Types::CourseStudentCourse }, optional: false, nullable: false
      ...
      field :user, -> { Whop_sdk::Types::CourseStudentUser }, optional: false, nullable: false
    end
  end
end
