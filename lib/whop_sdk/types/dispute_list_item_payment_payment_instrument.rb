...
module Whop_sdk
  module Types
    ...
    class DisputeListItemPaymentPaymentInstrument < Internal::Types::Model
      field :display_name, -> { String }, optional: false, nullable: false

      field :icons, -> { Whop_sdk::Types::DisputeListItemPaymentPaymentInstrumentIcons }, optional: false, nullable: false
