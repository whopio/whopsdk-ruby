...
module Whop_sdk
  module Types
    ...
    # spending history.
    class MemberLegacy < Internal::Types::Model
      field :access_level, -> { Whop_sdk::Types::AccessLevel }, optional: false, nullable: false

      field :company, -> { Whop_sdk::Types::MemberLegacyCompany }, optional: false, nullable: false
      ...
      field :user, -> { Whop_sdk::Types::MemberLegacyUser }, optional: false, nullable: true
    end
  end
end
