...
module Whop_sdk
  module Types
    ...
    class PaymentLegacyPaymentInstrument < Internal::Types::Model
      field :card, -> { Whop_sdk::Types::PaymentLegacyPaymentInstrumentCard }, optional: false, nullable: true

      field :display_name, -> { String }, optional: false, nullable: false

      field :icons, -> { Whop_sdk::Types::PaymentLegacyPaymentInstrumentIcons }, optional: false, nullable: false
