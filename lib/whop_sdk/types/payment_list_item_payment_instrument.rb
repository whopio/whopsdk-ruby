...
module Whop_sdk
  module Types
    ...
    class PaymentListItemPaymentInstrument < Internal::Types::Model
      field :card, -> { Whop_sdk::Types::PaymentListItemPaymentInstrumentCard }, optional: false, nullable: true

      field :display_name, -> { String }, optional: false, nullable: false

      field :icons, -> { Whop_sdk::Types::PaymentListItemPaymentInstrumentIcons }, optional: false, nullable: false
