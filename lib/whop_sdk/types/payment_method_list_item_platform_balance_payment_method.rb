...
module Whop_sdk
  module Types
    ...
    class PaymentMethodListItemPlatformBalancePaymentMethod < Internal::Types::Model
      field :created_at, -> { String }, optional: false, nullable: false

      field :icons, -> { Whop_sdk::Types::PaymentMethodListItemPlatformBalancePaymentMethodIcons }, optional: false, nullable: false

      field :id, -> { String }, optional: false, nullable: false

      field :payment_method_type, -> { Whop_sdk::Types::PaymentMethodTypes }, optional: false, nullable: false

      field :platform_balance, -> { Whop_sdk::Types::PaymentMethodListItemPlatformBalancePaymentMethodPlatformBalance }, optional: false, nullable: false
    end
  end
end
