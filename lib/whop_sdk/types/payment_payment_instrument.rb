...
module Whop_sdk
  module Types
    ...
    class PaymentPaymentInstrument < Internal::Types::Model
      field :card, -> { Whop_sdk::Types::PaymentPaymentInstrumentCard }, optional: false, nullable: true

      field :display_name, -> { String }, optional: false, nullable: false

      field :icons, -> { Whop_sdk::Types::PaymentPaymentInstrumentIcons }, optional: false, nullable: false
