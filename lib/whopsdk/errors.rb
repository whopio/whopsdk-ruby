  ...
  module Errors
    ...
    class APIStatusError < Whopsdk::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Whopsdk::Errors::BadRequestError.new(**kwargs)
        in 401
          Whopsdk::Errors::AuthenticationError.new(**kwargs)
        in 403
          Whopsdk::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Whopsdk::Errors::NotFoundError.new(**kwargs)
        in 409
          Whopsdk::Errors::ConflictError.new(**kwargs)
        in 422
          Whopsdk::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Whopsdk::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Whopsdk::Errors::InternalServerError.new(**kwargs)
        else
          Whopsdk::Errors::APIStatusError.new(**kwargs)
        end
      end
