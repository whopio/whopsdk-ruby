...
module Whopsdk
  module Models
    # @see Whopsdk::Resources::AccessPasses#retrieve
    class AccessPassRetrieveResponse < Whopsdk::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Whopsdk::Models::AccessPassRetrieveResponse::BusinessType, nil]
      required :business_type,
               enum: -> { Whopsdk::Models::AccessPassRetrieveResponse::BusinessType },
               nil?: true
      ...
      #
      #   @return [Symbol, Whopsdk::Models::AccessPassRetrieveResponse::IndustryType, nil]
      required :industry_type,
               enum: -> { Whopsdk::Models::AccessPassRetrieveResponse::IndustryType },
               nil?: true
      ...
      #
      #   @return [Whopsdk::Models::AccessPassRetrieveResponse::OwnerUser]
      required :owner_user, -> { Whopsdk::Models::AccessPassRetrieveResponse::OwnerUser }
      ...
      #
      #   @param business_type [Symbol, Whopsdk::Models::AccessPassRetrieveResponse::BusinessType, nil] The type of business the company is.
      #
      #   @param created_at [Integer] When the access pass was created.
      #
      #   @param industry_type [Symbol, Whopsdk::Models::AccessPassRetrieveResponse::IndustryType, nil] The specific industry the company operates in.
      #
      #   @param member_count [Integer] The number of active users for this access pass.
      #
      #   @param owner_user [Whopsdk::Models::AccessPassRetrieveResponse::OwnerUser] The user that owns the access pass (company owner).
      #
      ...
      # The type of business the company is.
      #
      # @see Whopsdk::Models::AccessPassRetrieveResponse#business_type
      module BusinessType
      ...
      # The specific industry the company operates in.
      #
      # @see Whopsdk::Models::AccessPassRetrieveResponse#industry_type
      module IndustryType
        extend Whopsdk::Internal::Type::Enum
      ...
      # @see Whopsdk::Models::AccessPassRetrieveResponse#owner_user
