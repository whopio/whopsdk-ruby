...
module Whopsdk
  module Models
    ...
    class InvoiceCreateParams < Whopsdk::Internal::Type::BaseModel
      ...
      # @!attribute input
      #
      #   @return [Whopsdk::Models::InvoiceCreateParams::Input]
      required :input, -> { Whopsdk::InvoiceCreateParams::Input }
      ...
      class Input < Whopsdk::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::CollectionMethod]
        required :collection_method, enum: -> { Whopsdk::InvoiceCreateParams::Input::CollectionMethod }
        ...
        # @!attribute plan
        #
        #   @return [Whopsdk::Models::InvoiceCreateParams::Input::Plan]
        required :plan, -> { Whopsdk::InvoiceCreateParams::Input::Plan }

        # @!attribute access_pass
        #
        #   @return [Whopsdk::Models::InvoiceCreateParams::Input::AccessPass, nil]
        optional :access_pass, -> { Whopsdk::InvoiceCreateParams::Input::AccessPass }, nil?: true
        ...
        # @!method initialize(collection_method:, due_date:, plan:, access_pass: nil, access_pass_id: nil, charge_buyer_fee: nil, client_mutation_id: nil, customer_name: nil, email_address: nil, member_id: nil, payment_token_id: nil)
        #   @param collection_method [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::CollectionMethod]
        #   @param due_date [Integer]
        #   @param plan [Whopsdk::Models::InvoiceCreateParams::Input::Plan]
        #   @param access_pass [Whopsdk::Models::InvoiceCreateParams::Input::AccessPass, nil]
        ...
        # @see Whopsdk::Models::InvoiceCreateParams::Input#collection_method
        ...
        # @see Whopsdk::Models::InvoiceCreateParams::Input#plan
        class Plan < Whopsdk::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::BaseCurrency, nil]
          ...
          #
          #   @return [Array<Whopsdk::Models::InvoiceCreateParams::Input::Plan::CustomField>, nil]
          optional :custom_fields,
                   -> {
                     Whopsdk::Internal::Type::ArrayOf[Whopsdk::InvoiceCreateParams::Input::Plan::CustomField]
                   },
                   nil?: true
          ...
          #
          #   @return [Object, nil]
          optional :initial_price, Whopsdk::Internal::Type::Unknown
          ...
          # @!attribute plan_type
          #
          #   @return [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::PlanType, nil]
          optional :plan_type, enum: -> { Whopsdk::InvoiceCreateParams::Input::Plan::PlanType }, nil?: true
          ...
          #
          #   @return [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::ReleaseMethod, nil]
          optional :release_method,
                   enum: -> { Whopsdk::InvoiceCreateParams::Input::Plan::ReleaseMethod },
                   nil?: true

          # @!attribute release_method_settings
          #
          #   @return [Whopsdk::Models::InvoiceCreateParams::Input::Plan::ReleaseMethodSettings, nil]
          ...
          #
          #   @return [Object, nil]
          optional :renewal_price, Whopsdk::Internal::Type::Unknown

          # @!attribute requirements
          #
          #   @return [Object, nil]
          optional :requirements, Whopsdk::Internal::Type::Unknown
          ...
          #
          #   @return [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::Visibility, nil]
          optional :visibility, enum: -> { Whopsdk::InvoiceCreateParams::Input::Plan::Visibility }, nil?: true
          ...
          #   @param base_currency [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::BaseCurrency, nil]
          #   @param billing_period [Integer, nil]
          #   @param card_payments [Boolean, nil]
          #   @param coinbase_commerce_accepted [Boolean, nil]
          #   @param custom_fields [Array<Whopsdk::Models::InvoiceCreateParams::Input::Plan::CustomField>, nil]
          #   @param description [String, nil]
          #   @param expiration_days [Integer, nil]
          #   @param initial_price [Object]
          #   @param internal_notes [String, nil]
          #   @param offer_cancel_discount [Boolean, nil]
          #   @param paypal_accepted [Boolean, nil]
          #   @param plan_type [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::PlanType, nil]
          #   @param platform_balance_accepted [Boolean, nil]
          #   @param redirect_url [String, nil]
          #   @param release_method [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::ReleaseMethod, nil]
          #   @param release_method_settings [Whopsdk::Models::InvoiceCreateParams::Input::Plan::ReleaseMethodSettings, nil]
          #   @param renewal_price [Object]
          ...
          #   @param visibility [Symbol, Whopsdk::Models::InvoiceCreateParams::Input::Plan::Visibility, nil]

          # @see Whopsdk::Models::InvoiceCreateParams::Input::Plan#base_currency
          module BaseCurrency
            extend Whopsdk::Internal::Type::Enum
          ...
          # @see Whopsdk::Models::InvoiceCreateParams::Input::Plan#plan_type
          module PlanType
            extend Whopsdk::Internal::Type::Enum
          ...
          # @see Whopsdk::Models::InvoiceCreateParams::Input::Plan#release_method
          ...
          # @see Whopsdk::Models::InvoiceCreateParams::Input::Plan#release_method_settings
          ...
          # @see Whopsdk::Models::InvoiceCreateParams::Input::Plan#visibility
          module Visibility
            extend Whopsdk::Internal::Type::Enum
        ...
        # @see Whopsdk::Models::InvoiceCreateParams::Input#access_pass
