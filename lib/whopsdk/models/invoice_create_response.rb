...
module Whopsdk
  module Models
    ...
    class InvoiceCreateResponse < Whopsdk::Internal::Type::BaseModel
      ...
      #   {Whopsdk::Models::InvoiceCreateResponse} for more details.
      #
      #   Autogenerated return type of CreateInvoice.
      #
      #   @param checkout_job_id [String, nil] Represents a unique identifier that is Base64 obfuscated. It is often used to re
      #
      ...
      class Invoice < Whopsdk::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Whopsdk::Models::InvoiceCreateResponse::Invoice} for more details.
        #
        #   A statement that defines an amount due by a customer.
        #
        ...
        #
        #   @param current_plan [Whopsdk::Models::InvoiceCreateResponse::Invoice::CurrentPlan] A plan for an access pass.
        #
        ...
        #
        #   @param member [Whopsdk::Models::InvoiceCreateResponse::Invoice::Member, nil] A user of the site.
        #
        #   @param number [String] Represents textual data as UTF-8 character sequences. This type is most often us
        #
        #   @param status [Symbol, Whopsdk::Models::InvoiceCreateResponse::Invoice::Status] The different statuses an invoice can be in
        ...
        class CurrentPlan < Whopsdk::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Whopsdk::Models::InvoiceCreateResponse::Invoice::CurrentPlan} for more details.
          #
          #   A plan for an access pass.
          #
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
          #
          #   @param base_currency [Symbol, Whopsdk::Models::InvoiceCreateResponse::Invoice::CurrentPlan::BaseCurrency] The available currencies on the platform
          #
        ...
        class Member < Whopsdk::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Whopsdk::Models::InvoiceCreateResponse::Invoice::Member} for more details.
          #
          #   A user of the site.
          #
          #   @param id [String] Represents a unique identifier that is Base64 obfuscated. It is often used to re
