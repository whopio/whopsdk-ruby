...
module Whopsdk
  module Models
    class InvoicePastDueWebhookEvent < Whopsdk::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Whopsdk::Models::InvoicePastDueWebhookEvent::APIVersion, nil]
      optional :api_version, enum: -> { Whopsdk::InvoicePastDueWebhookEvent::APIVersion }
      ...
      #
      #   @return [Symbol, Whopsdk::Models::InvoicePastDueWebhookEvent::Type, nil]
      optional :type, enum: -> { Whopsdk::InvoicePastDueWebhookEvent::Type }
      ...
      #
      #   @param api_version [Symbol, Whopsdk::Models::InvoicePastDueWebhookEvent::APIVersion] The API version for this webhook
      #
      ...
      # The API version for this webhook
      #
      # @see Whopsdk::Models::InvoicePastDueWebhookEvent#api_version
      module APIVersion
      ...
      # The webhook event type
      #
      # @see Whopsdk::Models::InvoicePastDueWebhookEvent#type
      module Type
        extend Whopsdk::Internal::Type::Enum
