    ...
    module Type
      class BaseModel
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  WhopSDK::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  WhopSDK::Internal::Type::BaseModel::KnownField,
                  { type: WhopSDK::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: WhopSDK::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(WhopSDK::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(WhopSDK::Internal::AnyHash) }
        def to_h
        end
