      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            cancellation_policy:
              T.nilable(
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            shipping_policy:
              T.nilable(
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::OrHash
              )
          ).void
        end
        ...
        class CancellationPolicy < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::UploadStatus::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::Visibility::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              upload_status:
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::UploadStatus::OrSymbol,
              url: T.nilable(String),
              visibility:
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::Visibility::OrSymbol,
              multipart_chunk_size: T.nilable(Integer),
              multipart_upload_id: T.nilable(String),
              multipart_upload_urls:
                T.nilable(
                  T::Array[
                    WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::MultipartUploadURL::OrHash
                  ]
                ),
          ...
          module UploadStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::UploadStatus
                )
              end
          ...
          module Visibility
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AccountFinancingApprovedWebhookEvent::Data::CancellationPolicy::Visibility
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class ShippingPolicy < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::UploadStatus::TaggedSymbol
            )
          end
          attr_accessor :upload_status
          ...
          sig do
            returns(
              WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::Visibility::TaggedSymbol
            )
          end
          attr_accessor :visibility
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              size: T.nilable(Integer),
              upload_status:
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::UploadStatus::OrSymbol,
              url: T.nilable(String),
              visibility:
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::Visibility::OrSymbol,
              multipart_chunk_size: T.nilable(Integer),
              multipart_upload_id: T.nilable(String),
              multipart_upload_urls:
                T.nilable(
                  T::Array[
                    WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::MultipartUploadURL::OrHash
                  ]
                ),
              upload_headers: T.anything,
              upload_url: T.nilable(String)
          ...
          module UploadStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::UploadStatus
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Visibility
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AccountFinancingApprovedWebhookEvent::Data::ShippingPolicy::Visibility
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Partner < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::AccountFinancingApprovedWebhookEvent::Data::Partner::ProfilePicture::OrHash
            ).void
          end
          attr_writer :profile_picture
