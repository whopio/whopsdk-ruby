  ...
  module Models
    class AccountUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        # other responses.
        sig do
          returns(T.nilable(WhopSDK::AccountUpdatedWebhookEvent::Data::Partner))
        end
        attr_reader :partner
        ...
        sig do
          params(
            partner:
              T.nilable(
                WhopSDK::AccountUpdatedWebhookEvent::Data::Partner::OrHash
              )
          ).void
        end
        attr_writer :partner
        ...
        sig do
          returns(
            T.nilable(
              T::Array[WhopSDK::AccountUpdatedWebhookEvent::Data::Reward]
            )
          )
        end
        attr_reader :rewards
        ...
        sig do
          params(
            rewards:
              T::Array[
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::OrHash
              ]
          ).void
        end
        attr_writer :rewards
          ...
          override.returns(
            {
              ...
              website: T.nilable(String),
              partner:
                T.nilable(WhopSDK::AccountUpdatedWebhookEvent::Data::Partner),
              rewards:
                T::Array[WhopSDK::AccountUpdatedWebhookEvent::Data::Reward]
            }
          )
        ...
        class Partner < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AccountUpdatedWebhookEvent::Data::Partner,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              WhopSDK::AccountUpdatedWebhookEvent::Data::Partner::ProfilePicture
            )
          end
          attr_reader :profile_picture
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Partner::ProfilePicture::OrHash
            ).void
          end
          attr_writer :profile_picture
        ...
        class Reward < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              qualification_amount:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::QualificationAmount::OrHash
            ).void
          end
          ...
          sig do
            params(
              qualification_progress:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::QualificationProgress::OrHash
            ).void
          end
          ...
          sig do
            returns(
              WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::QualificationType::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::RewardAmount
            )
          end
          ...
          sig do
            params(
              reward_amount:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::RewardAmount::OrHash
            ).void
          end
          ...
          sig do
            returns(
              WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              qualification_progress:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::QualificationProgress::OrHash,
              qualification_type:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::QualificationType::OrSymbol,
              reward_amount:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::RewardAmount::OrHash,
              status:
                WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::Status::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # Reward definition ID, prefixed `prwd_`. Progress and status apply to the
          ...
          module QualificationType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::QualificationType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AccountUpdatedWebhookEvent::Data::Reward::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
