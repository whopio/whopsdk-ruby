      ...
      class PreferenceUpdateResponse < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            ads_payment_methods:
              T.nilable(
                WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::OrHash
              )
          ).void
        end
        ...
        class AdsPaymentMethods < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              backup:
                T.nilable(
                  WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Backup::OrHash
                )
            ).void
          end
          attr_writer :backup
          ...
          sig do
            params(
              primary:
                T.nilable(
                  WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Primary::OrHash
                )
            ).void
          end
          attr_writer :primary
          ...
          class Backup < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Backup::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                id: String,
                type:
                  WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Backup::Type::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # The funding source ID: a Whop balance (`ldgr_`) for `platform_balance`, or a
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Backup::Type
                  )
                end
          ...
          class Primary < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Primary::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                id: String,
                type:
                  WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Primary::Type::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # The funding source ID: a Whop balance (`ldgr_`) for `platform_balance`, or a
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::Models::Accounts::PreferenceUpdateResponse::AdsPaymentMethods::Primary::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
