  ...
  module Models
    class Ad < WhopSDK::Internal::Type::BaseModel
      ...
      class Issue < WhopSDK::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(WhopSDK::Ad::Issue::Category::TaggedSymbol)) }
        ...
        sig do
          params(
            category: T.nilable(WhopSDK::Ad::Issue::Category::OrSymbol),
            created_at: Time,
        ...
        sig do
          override.returns(
            {
              category: T.nilable(WhopSDK::Ad::Issue::Category::TaggedSymbol),
              created_at: Time,
              resolution_status:
        ...
        module Category
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, WhopSDK::Ad::Issue::Category) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          POLICY_REJECTION =
            T.let(:policy_rejection, WhopSDK::Ad::Issue::Category::TaggedSymbol)
          CREATIVE_MEDIA =
            T.let(:creative_media, WhopSDK::Ad::Issue::Category::TaggedSymbol)
          AUDIENCE_TARGETING =
            T.let(
              :audience_targeting,
              WhopSDK::Ad::Issue::Category::TaggedSymbol
            )
          AD_VOLUME_LIMIT =
            T.let(:ad_volume_limit, WhopSDK::Ad::Issue::Category::TaggedSymbol)

          sig do
            override.returns(
              T::Array[WhopSDK::Ad::Issue::Category::TaggedSymbol]
            )
          end
          def self.values
          end
