  ...
  module Models
    class AdCampaign < WhopSDK::Internal::Type::BaseModel
      ...
      class Issue < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(WhopSDK::AdCampaign::Issue::Category::TaggedSymbol))
        end
        ...
        sig do
          params(
            category: T.nilable(WhopSDK::AdCampaign::Issue::Category::OrSymbol),
            created_at: Time,
            resolution_status:
        ...
        sig do
          override.returns(
            {
              category:
                T.nilable(WhopSDK::AdCampaign::Issue::Category::TaggedSymbol),
              created_at: Time,
              resolution_status:
        ...
        module Category
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, WhopSDK::AdCampaign::Issue::Category) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          POLICY_REJECTION =
            T.let(
              :policy_rejection,
              WhopSDK::AdCampaign::Issue::Category::TaggedSymbol
            )
          CREATIVE_MEDIA =
            T.let(
              :creative_media,
          ...
          sig do
            override.returns(
              T::Array[WhopSDK::AdCampaign::Issue::Category::TaggedSymbol]
            )
          end
          def self.values
          end
