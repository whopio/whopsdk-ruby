  ...
  module Models
    class AdCampaignCreateResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::AdCampaignCreateResponse,
      ...
      sig do
        params(
          billing_ledger_account:
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::BillingLedgerAccount::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignCreateResponse::Config))
      end
      attr_reader :config
      ...
      sig do
        params(
          config:
            T.nilable(WhopSDK::Models::AdCampaignCreateResponse::Config::OrHash)
        ).void
      end
      attr_writer :config
      ...
      sig { returns(WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser) }
      attr_reader :created_by_user

      sig do
        params(
          created_by_user:
            WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::Variants
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignCreateResponse::Platform::TaggedSymbol
          )
        )
      end
      ...
      # product.
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignCreateResponse::Product))
      end
      attr_reader :product
      ...
      sig do
        params(
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Product::OrHash
            )
        ).void
      end
      attr_writer :product
      ...
      sig do
        returns(WhopSDK::Models::AdCampaignCreateResponse::Status::TaggedSymbol)
      end
      ...
      sig do
        params(
          ...
          config:
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Config::OrHash
            ),
          created_at: Time,
          created_by_user:
            WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser::OrHash,
          ...
          payment_method:
            T.nilable(
              T.any(
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::BasePaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod::OrHash
              )
            ),
          platform:
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Platform::OrSymbol
            ),
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Product::OrHash
          ...
          revenue: Float,
          status: WhopSDK::Models::AdCampaignCreateResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            clicks_count: Integer,
            config:
              T.nilable(WhopSDK::Models::AdCampaignCreateResponse::Config),
            created_at: Time,
            created_by_user:
              WhopSDK::Models::AdCampaignCreateResponse::CreatedByUser,
            daily_budget: T.nilable(Float),
            impressions_count: Integer,
            paused_until: T.nilable(Time),
            payment_method:
            ...
            product:
              T.nilable(WhopSDK::Models::AdCampaignCreateResponse::Product),
            purchases_count: Integer,
            remaining_balance: Float,
            return_on_ad_spend: Float,
            revenue: Float,
            status:
              WhopSDK::Models::AdCampaignCreateResponse::Status::TaggedSymbol,
            target_country_codes: T::Array[String],
            title: String,
            todays_spend: Float,
            total_credits: Float,
      ...
      class Config < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignCreateResponse::Config,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Config::BidStrategy::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Config::Objective::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignCreateResponse::Config::Status::TaggedSymbol
            )
          )
        end
        attr_accessor :status
        ...
        sig do
          params(
            ...
            bid_strategy:
              T.nilable(
                WhopSDK::Models::AdCampaignCreateResponse::Config::BidStrategy::OrSymbol
              ),
            budget_optimization: T.nilable(T::Boolean),
            end_time: T.nilable(String),
            objective:
              T.nilable(
                WhopSDK::Models::AdCampaignCreateResponse::Config::Objective::OrSymbol
              ),
            special_categories: T.nilable(T::Array[String]),
            start_time: T.nilable(String),
            status:
              T.nilable(
                WhopSDK::Models::AdCampaignCreateResponse::Config::Status::OrSymbol
              )
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module BidStrategy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignCreateResponse::Config::BidStrategy
              )
            end
        ...
        module Objective
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignCreateResponse::Config::Objective
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignCreateResponse::Config::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module PaymentMethod
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              card:
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CardPaymentMethod::Card::OrHash
            ).void
          end
          attr_writer :card
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              us_bank_account:
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount::OrHash
            ).void
          end
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              cashapp:
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::CashappPaymentMethod::Cashapp::OrHash
            ).void
          end
          attr_writer :cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              ideal:
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::IdealPaymentMethod::Ideal::OrHash
            ).void
          end
          attr_writer :ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              sepa_debit:
                WhopSDK::Models::AdCampaignCreateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit::OrHash
            ).void
          end
      ...
      module Platform
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignCreateResponse::Platform)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Product < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignCreateResponse::Product,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignCreateResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
