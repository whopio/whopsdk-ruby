...
module WhopSDK
  module Models
    class AdCampaignPauseResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        params(
          billing_ledger_account:
            T.nilable(
              WhopSDK::Models::AdCampaignPauseResponse::BillingLedgerAccount::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignPauseResponse::Config))
      end
      attr_reader :config
      ...
      sig do
        params(
          config:
            T.nilable(WhopSDK::Models::AdCampaignPauseResponse::Config::OrHash)
        ).void
      end
      attr_writer :config
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::Variants
          )
        )
      end
      ...
      # product.
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignPauseResponse::Product))
      end
      attr_reader :product
      ...
      sig do
        params(
          product:
            T.nilable(WhopSDK::Models::AdCampaignPauseResponse::Product::OrHash)
        ).void
      end
      attr_writer :product
      ...
      sig do
        params(
          ...
          payment_method:
            T.nilable(
              T.any(
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::BasePaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod::OrHash
              )
            ),
          platform:
            T.nilable(
          ...
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignPauseResponse::Product::OrHash
            ),
        ...
        override.returns(
          {
            ...
            clicks_count: Integer,
            config: T.nilable(WhopSDK::Models::AdCampaignPauseResponse::Config),
            created_at: Time,
            created_by_user:
            ...
            product:
              T.nilable(WhopSDK::Models::AdCampaignPauseResponse::Product),
            purchases_count: Integer,
            remaining_balance: Float,
            return_on_ad_spend: Float,
            revenue: Float,
      ...
      class Config < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignPauseResponse::Config,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignPauseResponse::Config::BidStrategy::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignPauseResponse::Config::Objective::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignPauseResponse::Config::Status::TaggedSymbol
            )
          )
        end
        attr_accessor :status
        ...
        sig do
          params(
            ...
            bid_strategy:
              T.nilable(
                WhopSDK::Models::AdCampaignPauseResponse::Config::BidStrategy::OrSymbol
              ),
            budget_optimization: T.nilable(T::Boolean),
            end_time: T.nilable(String),
            objective:
              T.nilable(
                WhopSDK::Models::AdCampaignPauseResponse::Config::Objective::OrSymbol
              ),
            special_categories: T.nilable(T::Array[String]),
            start_time: T.nilable(String),
            status:
              T.nilable(
                WhopSDK::Models::AdCampaignPauseResponse::Config::Status::OrSymbol
              )
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module BidStrategy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignPauseResponse::Config::BidStrategy
              )
            end
        ...
        module Objective
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignPauseResponse::Config::Objective
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignPauseResponse::Config::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module PaymentMethod
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              card:
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CardPaymentMethod::Card::OrHash
            ).void
          end
          attr_writer :card
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              us_bank_account:
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount::OrHash
            ).void
          end
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              cashapp:
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::CashappPaymentMethod::Cashapp::OrHash
            ).void
          end
          attr_writer :cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              ideal:
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::IdealPaymentMethod::Ideal::OrHash
            ).void
          end
          attr_writer :ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              sepa_debit:
                WhopSDK::Models::AdCampaignPauseResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit::OrHash
            ).void
          end
      ...
      class Product < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignPauseResponse::Product,
              WhopSDK::Internal::AnyHash
            )
          end
