  ...
  module Models
    class AdCampaignUnpauseResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::AdCampaignUnpauseResponse,
      ...
      sig do
        params(
          billing_ledger_account:
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::BillingLedgerAccount::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignUnpauseResponse::Config))
      end
      attr_reader :config
      ...
      sig do
        params(
          config:
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Config::OrHash
            )
        ).void
      end
      attr_writer :config
      ...
      sig { returns(WhopSDK::Models::AdCampaignUnpauseResponse::CreatedByUser) }
      attr_reader :created_by_user

      sig do
        params(
          created_by_user:
            WhopSDK::Models::AdCampaignUnpauseResponse::CreatedByUser::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::Variants
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignUnpauseResponse::Platform::TaggedSymbol
          )
        )
      end
      ...
      # product.
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignUnpauseResponse::Product))
      end
      attr_reader :product
      ...
      sig do
        params(
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Product::OrHash
            )
        ).void
      end
      attr_writer :product
      ...
      sig do
        returns(
          WhopSDK::Models::AdCampaignUnpauseResponse::Status::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          payment_method:
            T.nilable(
              T.any(
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::BasePaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::CardPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::UsBankAccountPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::CashappPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::IdealPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::SepaDebitPaymentMethod::OrHash
              )
            ),
          platform:
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Platform::OrSymbol
            ),
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Product::OrHash
          ...
          revenue: Float,
          status: WhopSDK::Models::AdCampaignUnpauseResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            clicks_count: Integer,
            config:
              T.nilable(WhopSDK::Models::AdCampaignUnpauseResponse::Config),
            created_at: Time,
            created_by_user:
              WhopSDK::Models::AdCampaignUnpauseResponse::CreatedByUser,
            daily_budget: T.nilable(Float),
            impressions_count: Integer,
            paused_until: T.nilable(Time),
            payment_method:
            ...
            product:
              T.nilable(WhopSDK::Models::AdCampaignUnpauseResponse::Product),
            purchases_count: Integer,
            remaining_balance: Float,
            return_on_ad_spend: Float,
            revenue: Float,
      ...
      class Config < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignUnpauseResponse::Config,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Config::BidStrategy::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Config::Objective::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUnpauseResponse::Config::Status::TaggedSymbol
            )
          )
        end
        attr_accessor :status
        ...
        sig do
          params(
            ...
            bid_strategy:
              T.nilable(
                WhopSDK::Models::AdCampaignUnpauseResponse::Config::BidStrategy::OrSymbol
              ),
            budget_optimization: T.nilable(T::Boolean),
            end_time: T.nilable(String),
            objective:
              T.nilable(
                WhopSDK::Models::AdCampaignUnpauseResponse::Config::Objective::OrSymbol
              ),
            special_categories: T.nilable(T::Array[String]),
            start_time: T.nilable(String),
            status:
              T.nilable(
                WhopSDK::Models::AdCampaignUnpauseResponse::Config::Status::OrSymbol
              )
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module BidStrategy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUnpauseResponse::Config::BidStrategy
              )
            end
        ...
        module Objective
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUnpauseResponse::Config::Objective
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUnpauseResponse::Config::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module PaymentMethod
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              card:
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::CardPaymentMethod::Card::OrHash
            ).void
          end
          attr_writer :card
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              us_bank_account:
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount::OrHash
            ).void
          end
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              cashapp:
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::CashappPaymentMethod::Cashapp::OrHash
            ).void
          end
          attr_writer :cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              ideal:
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::IdealPaymentMethod::Ideal::OrHash
            ).void
          end
          attr_writer :ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              sepa_debit:
                WhopSDK::Models::AdCampaignUnpauseResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit::OrHash
            ).void
          end
      ...
      module Platform
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::Platform)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Product < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignUnpauseResponse::Product,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignUnpauseResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
