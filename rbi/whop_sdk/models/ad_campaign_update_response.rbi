  ...
  module Models
    class AdCampaignUpdateResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::AdCampaignUpdateResponse,
      ...
      sig do
        params(
          billing_ledger_account:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::BillingLedgerAccount::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignUpdateResponse::Config))
      end
      attr_reader :config
      ...
      sig do
        params(
          config:
            T.nilable(WhopSDK::Models::AdCampaignUpdateResponse::Config::OrHash)
        ).void
      end
      attr_writer :config
      ...
      sig { returns(WhopSDK::Models::AdCampaignUpdateResponse::CreatedByUser) }
      attr_reader :created_by_user

      sig do
        params(
          created_by_user:
            WhopSDK::Models::AdCampaignUpdateResponse::CreatedByUser::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::Variants
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignUpdateResponse::Platform::TaggedSymbol
          )
        )
      end
      ...
      # product.
      sig do
        returns(T.nilable(WhopSDK::Models::AdCampaignUpdateResponse::Product))
      end
      attr_reader :product
      ...
      sig do
        params(
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Product::OrHash
            )
        ).void
      end
      attr_writer :product
      ...
      sig do
        returns(WhopSDK::Models::AdCampaignUpdateResponse::Status::TaggedSymbol)
      end
      ...
      sig do
        params(
          ...
          config:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Config::OrHash
            ),
          created_at: Time,
          created_by_user:
            WhopSDK::Models::AdCampaignUpdateResponse::CreatedByUser::OrHash,
          ...
          payment_method:
            T.nilable(
              T.any(
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::BasePaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod::OrHash,
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod::OrHash
              )
            ),
          platform:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Platform::OrSymbol
            ),
          product:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Product::OrHash
          ...
          revenue: Float,
          status: WhopSDK::Models::AdCampaignUpdateResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            clicks_count: Integer,
            config:
              T.nilable(WhopSDK::Models::AdCampaignUpdateResponse::Config),
            created_at: Time,
            created_by_user:
              WhopSDK::Models::AdCampaignUpdateResponse::CreatedByUser,
            daily_budget: T.nilable(Float),
            impressions_count: Integer,
            paused_until: T.nilable(Time),
            payment_method:
            ...
            product:
              T.nilable(WhopSDK::Models::AdCampaignUpdateResponse::Product),
            purchases_count: Integer,
            remaining_balance: Float,
            return_on_ad_spend: Float,
            revenue: Float,
      ...
      class Config < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignUpdateResponse::Config,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Config::BidStrategy::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Config::Objective::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::Config::Status::TaggedSymbol
            )
          )
        end
        attr_accessor :status
        ...
        sig do
          params(
            ...
            bid_strategy:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::Config::BidStrategy::OrSymbol
              ),
            budget_optimization: T.nilable(T::Boolean),
            end_time: T.nilable(String),
            objective:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::Config::Objective::OrSymbol
              ),
            special_categories: T.nilable(T::Array[String]),
            start_time: T.nilable(String),
            status:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::Config::Status::OrSymbol
              )
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module BidStrategy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::Config::BidStrategy
              )
            end
        ...
        module Objective
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::Config::Objective
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::Config::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module PaymentMethod
        ...
        class CardPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              card:
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CardPaymentMethod::Card::OrHash
            ).void
          end
          attr_writer :card
        ...
        class UsBankAccountPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              us_bank_account:
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::UsBankAccountPaymentMethod::UsBankAccount::OrHash
            ).void
          end
        ...
        class CashappPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              cashapp:
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::CashappPaymentMethod::Cashapp::OrHash
            ).void
          end
          attr_writer :cashapp
        ...
        class IdealPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              ideal:
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::IdealPaymentMethod::Ideal::OrHash
            ).void
          end
          attr_writer :ideal
        ...
        class SepaDebitPaymentMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              sepa_debit:
                WhopSDK::Models::AdCampaignUpdateResponse::PaymentMethod::SepaDebitPaymentMethod::SepaDebit::OrHash
            ).void
          end
      ...
      module Platform
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Platform)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Product < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignUpdateResponse::Product,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignUpdateResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
