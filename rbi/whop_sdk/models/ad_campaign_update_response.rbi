  ...
  module Models
    class AdCampaignUpdateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::AdCampaignUpdateResponse::BudgetType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig)
        )
      end
      ...
      sig do
        params(
          meta_config:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::OrHash
            )
        ).void
      end
      ...
      sig do
        params(
          ...
          budget_type:
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::BudgetType::OrSymbol
            ),
          created_at: Time,
          created_by_user:
            WhopSDK::Models::AdCampaignUpdateResponse::CreatedByUser::OrHash,
      ...
      module BudgetType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::AdCampaignUpdateResponse::BudgetType)
          end
      ...
      class MetaConfig < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::BidStrategy::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::EffectiveStatus::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::Objective::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::Status::TaggedSymbol
            )
          )
        end
        attr_accessor :status
        ...
        sig do
          params(
            ...
            bid_strategy:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::BidStrategy::OrSymbol
              ),
            budget_optimization: T.nilable(T::Boolean),
            effective_status:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::EffectiveStatus::OrSymbol
              ),
            end_time: T.nilable(String),
            objective:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::Objective::OrSymbol
              ),
            special_categories: T.nilable(T::Array[String]),
            start_time: T.nilable(String),
            status:
              T.nilable(
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::Status::OrSymbol
              )
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module BidStrategy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::BidStrategy
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module EffectiveStatus
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::EffectiveStatus
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Objective
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::Objective
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::AdCampaignUpdateResponse::MetaConfig::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
