...
module WhopSDK
  module Models
    class AdGroupCreateParams < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(WhopSDK::AdGroupCreateParams::Config)) }
      attr_reader :config
      ...
      sig { returns(T.nilable(WhopSDK::AdGroupCreateParams::PlatformConfig)) }
        ...
        override.returns(
          {
            ...
            budget_type:
              T.nilable(WhopSDK::AdGroupCreateParams::BudgetType::OrSymbol),
            config: T.nilable(WhopSDK::AdGroupCreateParams::Config),
            daily_budget: T.nilable(Float),
            name: T.nilable(String),
            platform_config:
              T.nilable(WhopSDK::AdGroupCreateParams::PlatformConfig),
            status: T.nilable(WhopSDK::AdGroupCreateParams::Status::OrSymbol),
      ...
      class Config < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::AdGroupCreateParams::Config,
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::AdGroupCreateParams::Config::BidStrategy::OrSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::AdGroupCreateParams::Config::BillingEvent::OrSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::AdGroupCreateParams::Config::OptimizationGoal::OrSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(WhopSDK::AdGroupCreateParams::Config::Pacing::OrSymbol)
          )
        end
        ...
        sig do
          returns(T.nilable(WhopSDK::AdGroupCreateParams::Config::Targeting))
        end
        ...
        sig do
          params(
            targeting:
              T.nilable(WhopSDK::AdGroupCreateParams::Config::Targeting::OrHash)
          ).void
        end
          ...
          override.returns(
            {
              ...
              pacing:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::Config::Pacing::OrSymbol
                ),
              start_time: T.nilable(String),
              targeting:
                T.nilable(WhopSDK::AdGroupCreateParams::Config::Targeting)
            }
          )
        end
        def to_hash
        ...
        module BidStrategy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::AdGroupCreateParams::Config::BidStrategy)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          LOWEST_COST =
            T.let(
              :lowest_cost,
              WhopSDK::AdGroupCreateParams::Config::BidStrategy::TaggedSymbol
            )
          BID_CAP =
            T.let(
              :bid_cap,
        ...
        module BillingEvent
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::AdGroupCreateParams::Config::BillingEvent)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module OptimizationGoal
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::AdGroupCreateParams::Config::OptimizationGoal
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          CONVERSIONS =
            T.let(
              :conversions,
              WhopSDK::AdGroupCreateParams::Config::OptimizationGoal::TaggedSymbol
            )
          LINK_CLICKS =
            T.let(
              :link_clicks,
        ...
        module Pacing
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::AdGroupCreateParams::Config::Pacing)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          STANDARD =
            T.let(
              :standard,
              WhopSDK::AdGroupCreateParams::Config::Pacing::TaggedSymbol
            )
          ACCELERATED =
            T.let(
              :accelerated,
        ...
        class Targeting < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdGroupCreateParams::Config::Targeting,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::Config::Targeting::DevicePlatform::OrSymbol
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::Config::Targeting::Gender::OrSymbol
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::Config::Targeting::PlacementType::OrSymbol
              )
            )
          end
          ...
          module DevicePlatform
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::Config::Targeting::DevicePlatform
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            MOBILE =
              T.let(
                :mobile,
                WhopSDK::AdGroupCreateParams::Config::Targeting::DevicePlatform::TaggedSymbol
              )
            DESKTOP =
              T.let(
                :desktop,
          ...
          module Gender
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::Config::Targeting::Gender
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            MALE =
              T.let(
                :male,
                WhopSDK::AdGroupCreateParams::Config::Targeting::Gender::TaggedSymbol
              )
            FEMALE =
              T.let(
                :female,
          ...
          module PlacementType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::Config::Targeting::PlacementType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            AUTOMATIC =
              T.let(
                :automatic,
                WhopSDK::AdGroupCreateParams::Config::Targeting::PlacementType::TaggedSymbol
              )
            MANUAL =
              T.let(
                :manual,
      ...
      class PlatformConfig < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::AdGroupCreateParams::PlatformConfig,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(T.nilable(WhopSDK::AdGroupCreateParams::PlatformConfig::Meta))
        end
        attr_reader :meta
        ...
        sig do
          params(
            meta:
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::OrHash
              )
          ).void
        end
        attr_writer :meta
        ...
        sig do
          returns(
            T.nilable(WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok)
          )
        end
        attr_reader :tiktok
        ...
        sig do
          params(
            tiktok:
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OrHash
              )
          ).void
        end
        attr_writer :tiktok
        ...
        sig do
          override.returns(
            {
              meta:
                T.nilable(WhopSDK::AdGroupCreateParams::PlatformConfig::Meta),
              tiktok:
                T.nilable(WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok)
            }
          )
        ...
        class Meta < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::AttributionSpec
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BidStrategy::OrSymbol
              )
            )
          end
          attr_accessor :bid_strategy
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BillingEvent::OrSymbol
              )
            )
          end
          attr_accessor :billing_event
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::DestinationType::OrSymbol
              )
            )
          end
          ...
          sig do
            params(
              excluded_geo_locations:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoCity
                ]
              )
            )
          end
          ...
          sig do
            params(
              geo_locations:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoRegion
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadConversionLocation::OrSymbol
              )
            )
          end
          ...
          sig do
            params(
              lead_form_config:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::OptimizationGoal::OrSymbol
              )
            )
          end
          attr_accessor :optimization_goal
          ...
          sig do
            params(
              promoted_object:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::PromotedObject::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::Status::OrSymbol
              )
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              targeting_automation:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::TargetingAutomation::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              ...
              attribution_spec:
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::AttributionSpec::OrHash
                  ]
                ),
              ...
              geo_cities:
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoCity::OrHash
                  ]
                ),
              geo_locations:
                T.nilable(
              ...
              geo_regions:
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoRegion::OrHash
                  ]
                ),
          ...
          module BidStrategy
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BidStrategy
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            LOWEST_COST_WITHOUT_CAP =
              T.let(
                :LOWEST_COST_WITHOUT_CAP,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BidStrategy::TaggedSymbol
              )
          ...
          module BillingEvent
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::BillingEvent
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module DestinationType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::DestinationType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class ExcludedGeoLocations < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::City
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Region
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Zip
                  ]
                )
              )
            end
            ...
            sig do
              params(
                cities:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::City::OrHash
                    ]
                  ),
                countries: T.nilable(T::Array[String]),
                location_types: T.nilable(T::Array[String]),
                regions:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Region::OrHash
                    ]
                  ),
                zips:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::ExcludedGeoLocations::Zip::OrHash
                    ]
                  )
              ).returns(T.attached_class)
            end
          ...
          class GeoLocations < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::City
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Region
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Zip
                  ]
                )
              )
            end
            ...
            sig do
              params(
                cities:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::City::OrHash
                    ]
                  ),
                countries: T.nilable(T::Array[String]),
                location_types: T.nilable(T::Array[String]),
                regions:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Region::OrHash
                    ]
                  ),
                zips:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::GeoLocations::Zip::OrHash
                    ]
                  )
              ).returns(T.attached_class)
            end
          ...
          module LeadConversionLocation
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadConversionLocation
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            WEBSITE =
              T.let(
                :website,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadConversionLocation::TaggedSymbol
              )
            INSTANT_FORMS =
              T.let(
                :instant_forms,
          ...
          class LeadFormConfig < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question
                ]
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::CustomDisclaimerCheckbox
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::ThankYouPage
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                questions:
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::OrHash
                  ],
                ...
                custom_disclaimer_checkboxes:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::CustomDisclaimerCheckbox::OrHash
                    ]
                  ),
                ...
                thank_you_pages:
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::ThankYouPage::OrHash
                    ]
                  )
              ).returns(T.attached_class)
            end
            ...
            class Question < WhopSDK::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion
                    ]
                  )
                )
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  ...
                  dependent_conditional_questions:
                    T.nilable(
                      T::Array[
                        WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::OrHash
                      ]
                    ),
                  ...
                  options:
                    T.nilable(
                      T::Array[
                        WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option::OrHash
                      ]
                    ),
                ...
                sig do
                  params(
                    ...
                    options:
                      T.nilable(
                        T::Array[
                          WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option::OrHash
                        ]
                      )
                  ).returns(T.attached_class)
                end
                ...
                class Option < WhopSDK::Internal::Type::BaseModel
                  ...
                  sig do
                    params(
                      logic:
                        T.nilable(
                          WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::DependentConditionalQuestion::Option::Logic::OrHash
                        )
                    ).void
                  end
                  attr_writer :logic
              ...
              class Option < WhopSDK::Internal::Type::BaseModel
                ...
                sig do
                  params(
                    logic:
                      T.nilable(
                        WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::LeadFormConfig::Question::Option::Logic::OrHash
                      )
                  ).void
                end
                attr_writer :logic
          ...
          module OptimizationGoal
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::OptimizationGoal
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NONE =
              T.let(
                :NONE,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::OptimizationGoal::TaggedSymbol
              )
            APP_INSTALLS =
              T.let(
                :APP_INSTALLS,
          ...
          module Status
            ...
            ACTIVE =
              T.let(
                :ACTIVE,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Meta::Status::TaggedSymbol
              )
            PAUSED =
              T.let(
                :PAUSED,
        ...
        class Tiktok < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AgeGroup::OrSymbol
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AttributionEventCount::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AudienceType::OrSymbol
              )
            )
          end
          attr_accessor :audience_type
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BidType::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BillingEvent::OrSymbol
              )
            )
          end
          attr_accessor :billing_event
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BrandSafetyType::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BudgetMode::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ClickAttributionWindow::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::DeepFunnelOptimizationStatus::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::EngagedViewAttributionWindow::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Gender::OrSymbol
              )
            )
          end
          ...
          sig do
            params(
              instant_form_config:
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Ios14Targeting::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperatingSystem::OrSymbol
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperationStatus::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OptimizationGoal::OrSymbol
              )
            )
          end
          attr_accessor :optimization_goal
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Pacing::OrSymbol
              )
            )
          end
          attr_accessor :pacing
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::PlacementType::OrSymbol
              )
            )
          end
          attr_accessor :placement_type
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ProductSource::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ScheduleType::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ShoppingAdsRetargetingType::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::SpendingPower::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ViewAttributionWindow::OrSymbol
              )
            )
          end
          ...
          sig do
            params(
              actions:
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::OrHash
                  ]
                ),
              age_groups:
                T.nilable(
          ...
          class Action < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::ActionScene::OrSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::VideoUserAction::OrSymbol
                  ]
                )
              )
            end
            ...
            module ActionScene
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::ActionScene
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              VIDEO_RELATED =
                T.let(
                  :VIDEO_RELATED,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::ActionScene::TaggedSymbol
                )
              CREATOR_RELATED =
                T.let(
                  :CREATOR_RELATED,
            ...
            module VideoUserAction
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::VideoUserAction
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              WATCHED_TO_END =
                T.let(
                  :WATCHED_TO_END,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Action::VideoUserAction::TaggedSymbol
                )
              LIKED =
                T.let(
                  :LIKED,
          ...
          module AgeGroup
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AgeGroup
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            AGE_13_17 =
              T.let(
                :AGE_13_17,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AgeGroup::TaggedSymbol
              )
            AGE_18_24 =
              T.let(
                :AGE_18_24,
          ...
          module AttributionEventCount
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AttributionEventCount
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            UNSET =
              T.let(
                :UNSET,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AttributionEventCount::TaggedSymbol
              )
            EVERY =
              T.let(
                :EVERY,
          ...
          module AudienceType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AudienceType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NORMAL =
              T.let(
                :NORMAL,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::AudienceType::TaggedSymbol
              )
          ...
          module BidType
            ...
            BID_TYPE_NO_BID =
              T.let(
                :BID_TYPE_NO_BID,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BidType::TaggedSymbol
              )
            BID_TYPE_CUSTOM =
              T.let(
                :BID_TYPE_CUSTOM,
          ...
          module BillingEvent
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BillingEvent
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            CPC =
              T.let(
                :CPC,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BillingEvent::TaggedSymbol
              )
            CPM =
              T.let(
                :CPM,
          ...
          module BrandSafetyType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BrandSafetyType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NO_BRAND_SAFETY =
              T.let(
                :NO_BRAND_SAFETY,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BrandSafetyType::TaggedSymbol
              )
            STANDARD_INVENTORY =
              T.let(
                :STANDARD_INVENTORY,
          ...
          module BudgetMode
            ...
            BUDGET_MODE_DAY =
              T.let(
                :BUDGET_MODE_DAY,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::BudgetMode::TaggedSymbol
              )
            BUDGET_MODE_TOTAL =
              T.let(
                :BUDGET_MODE_TOTAL,
          ...
          module ClickAttributionWindow
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ClickAttributionWindow
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            OFF =
              T.let(
                :OFF,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ClickAttributionWindow::TaggedSymbol
              )
            ONE_DAY =
              T.let(
                :ONE_DAY,
          ...
          module DeepFunnelOptimizationStatus
            ...
            ON =
              T.let(
                :ON,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::DeepFunnelOptimizationStatus::TaggedSymbol
              )
            OFF =
              T.let(
                :OFF,
          ...
          module EngagedViewAttributionWindow
            ...
            OFF =
              T.let(
                :OFF,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::EngagedViewAttributionWindow::TaggedSymbol
              )
            ONE_DAY =
              T.let(
                :ONE_DAY,
          ...
          module Gender
            ...
            GENDER_UNLIMITED =
              T.let(
                :GENDER_UNLIMITED,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Gender::TaggedSymbol
              )
            GENDER_MALE =
              T.let(
                :GENDER_MALE,
          ...
          class InstantFormConfig < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig::Question
                ]
              )
            end
            attr_accessor :questions
            ...
            sig do
              params(
                ...
                questions:
                  T::Array[
                    WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::InstantFormConfig::Question::OrHash
                  ],
                button_text: T.nilable(String),
          ...
          module Ios14Targeting
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Ios14Targeting
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            UNSET =
              T.let(
                :UNSET,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Ios14Targeting::TaggedSymbol
              )
            IOS14_MINUS =
              T.let(
                :IOS14_MINUS,
          ...
          module OperatingSystem
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperatingSystem
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ANDROID =
              T.let(
                :ANDROID,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperatingSystem::TaggedSymbol
              )
            IOS =
              T.let(
                :IOS,
          ...
          module OperationStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperationStatus
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ENABLE =
              T.let(
                :ENABLE,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OperationStatus::TaggedSymbol
              )
            DISABLE =
              T.let(
                :DISABLE,
          ...
          module OptimizationGoal
            ...
            CLICK =
              T.let(
                :CLICK,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::OptimizationGoal::TaggedSymbol
              )
            CONVERT =
              T.let(
                :CONVERT,
          ...
          module Pacing
            ...
            PACING_MODE_SMOOTH =
              T.let(
                :PACING_MODE_SMOOTH,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::Pacing::TaggedSymbol
              )
            PACING_MODE_FAST =
              T.let(
                :PACING_MODE_FAST,
          ...
          module PlacementType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::PlacementType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            PLACEMENT_TYPE_AUTOMATIC =
              T.let(
                :PLACEMENT_TYPE_AUTOMATIC,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::PlacementType::TaggedSymbol
              )
          ...
          module ProductSource
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ProductSource
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            CATALOG =
              T.let(
                :CATALOG,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ProductSource::TaggedSymbol
              )
            STORE =
              T.let(
                :STORE,
          ...
          module ScheduleType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ScheduleType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            SCHEDULE_START_END =
              T.let(
                :SCHEDULE_START_END,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ScheduleType::TaggedSymbol
              )
            SCHEDULE_FROM_NOW =
              T.let(
                :SCHEDULE_FROM_NOW,
          ...
          module ShoppingAdsRetargetingType
            ...
            OFF =
              T.let(
                :OFF,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ShoppingAdsRetargetingType::TaggedSymbol
              )
            LAB1 =
              T.let(
                :LAB1,
          ...
          module SpendingPower
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::SpendingPower
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ALL =
              T.let(
                :ALL,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::SpendingPower::TaggedSymbol
              )
            HIGH =
              T.let(
                :HIGH,
          ...
          module ViewAttributionWindow
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ViewAttributionWindow
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            OFF =
              T.let(
                :OFF,
                WhopSDK::AdGroupCreateParams::PlatformConfig::Tiktok::ViewAttributionWindow::TaggedSymbol
              )
            ONE_DAY =
              T.let(
                :ONE_DAY,
      ...
      module Status
        ...
        INACTIVE =
          T.let(:inactive, WhopSDK::AdGroupCreateParams::Status::TaggedSymbol)
        IN_REVIEW =
          T.let(:in_review, WhopSDK::AdGroupCreateParams::Status::TaggedSymbol)
        REJECTED =
          T.let(:rejected, WhopSDK::AdGroupCreateParams::Status::TaggedSymbol)
        FLAGGED =
          T.let(:flagged, WhopSDK::AdGroupCreateParams::Status::TaggedSymbol)
