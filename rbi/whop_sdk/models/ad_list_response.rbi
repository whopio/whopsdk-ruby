    ...
    class AdListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      class Issue < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::AdListResponse::Issue::Category::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            category:
              T.nilable(
                WhopSDK::Models::AdListResponse::Issue::Category::OrSymbol
              ),
            created_at: Time,
            resolution_status:
        ...
        module Category
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::Models::AdListResponse::Issue::Category)
            end
