...
module WhopSDK
  module Models
    class AdRetrieveParams < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(WhopSDK::AdRetrieveParams::AttributionModel::OrSymbol)
        )
      end
      ...
      module AttributionModel
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::AdRetrieveParams::AttributionModel)
          end
        ...
        LAST_TOUCH =
          T.let(
            :last_touch,
            WhopSDK::AdRetrieveParams::AttributionModel::TaggedSymbol
          )
        FIRST_TOUCH =
          T.let(
            :first_touch,
        ...
        sig do
          override.returns(
            T::Array[WhopSDK::AdRetrieveParams::AttributionModel::TaggedSymbol]
          )
        end
        def self.values
        end
