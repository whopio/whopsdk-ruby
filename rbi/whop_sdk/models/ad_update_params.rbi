...
module WhopSDK
  module Models
    class AdUpdateParams < WhopSDK::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(WhopSDK::AdUpdateParams, WhopSDK::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(WhopSDK::AdUpdateParams::CallToAction::OrSymbol))
      end
      ...
      # platform.
      sig { returns(T.nilable(T::Array[WhopSDK::AdUpdateParams::Creative])) }
      ...
      # lead_form_id.
      sig { returns(T.nilable(WhopSDK::AdUpdateParams::LeadForm)) }
      attr_reader :lead_form

      sig { params(lead_form: WhopSDK::AdUpdateParams::LeadForm::OrHash).void }
      ...
      # (keyword).
      sig { returns(T.nilable(WhopSDK::AdUpdateParams::MessagingConfig)) }
      ...
      sig { returns(T.nilable(WhopSDK::AdUpdateParams::PostSource::OrSymbol)) }
      attr_reader :post_source

      sig do
        params(post_source: WhopSDK::AdUpdateParams::PostSource::OrSymbol).void
      end
      ...
      sig do
        returns(T.nilable(T::Array[WhopSDK::AdUpdateParams::SocialAccount]))
      end
        ...
        override.returns(
          {
            id: String,
            call_to_action: WhopSDK::AdUpdateParams::CallToAction::OrSymbol,
            creatives: T::Array[WhopSDK::AdUpdateParams::Creative],
            descriptions: T::Array[String],
            headlines: T::Array[String],
            lead_form: WhopSDK::AdUpdateParams::LeadForm,
            lead_form_id: String,
            messaging_config: WhopSDK::AdUpdateParams::MessagingConfig,
            multi_advertiser_ads: T::Boolean,
            post_id: String,
            post_source: WhopSDK::AdUpdateParams::PostSource::OrSymbol,
            primary_texts: T::Array[String],
            social_accounts: T::Array[WhopSDK::AdUpdateParams::SocialAccount],
            title: String,
            url: String,
            url_parameters: T.anything,
      ...
      module CallToAction
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, WhopSDK::AdUpdateParams::CallToAction) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        APPLY_NOW =
          T.let(:apply_now, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        BOOK_NOW =
          T.let(:book_now, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        CALL_NOW =
          T.let(:call_now, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        CONTACT_US =
          T.let(
            :contact_us,
            WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol
          )
        DOWNLOAD =
          T.let(:download, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        GET_DIRECTIONS =
          T.let(
            :get_directions,
            WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol
        ...
        GET_OFFER =
          T.let(:get_offer, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        GET_QUOTE =
          T.let(:get_quote, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        LEARN_MORE =
          T.let(
            :learn_more,
            WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol
        ...
        NO_BUTTON =
          T.let(:no_button, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        OPEN_LINK =
          T.let(:open_link, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        ORDER_NOW =
          T.let(:order_now, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        REQUEST_TIME =
          T.let(
            :request_time,
            WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol
        ...
        SEE_MENU =
          T.let(:see_menu, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        SEND_UPDATES =
          T.let(
            :send_updates,
            WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol
        ...
        SHOP_NOW =
          T.let(:shop_now, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        SIGN_UP =
          T.let(:sign_up, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        SUBSCRIBE =
          T.let(:subscribe, WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol)
        WATCH_MORE =
          T.let(
            :watch_more,
            WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[WhopSDK::AdUpdateParams::CallToAction::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class Creative < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(WhopSDK::AdUpdateParams::Creative, WhopSDK::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(WhopSDK::AdUpdateParams::Creative::Crop)) }
        attr_reader :crop

        sig do
          params(crop: WhopSDK::AdUpdateParams::Creative::Crop::OrHash).void
        end
        attr_writer :crop

        sig do
          returns(
            T.nilable(WhopSDK::AdUpdateParams::Creative::Format::OrSymbol)
          )
        end
        attr_reader :format_
        ...
        sig do
          params(
            format_: WhopSDK::AdUpdateParams::Creative::Format::OrSymbol
          ).void
        end
        attr_writer :format_
        ...
        sig do
          params(
            id: String,
            crop: WhopSDK::AdUpdateParams::Creative::Crop::OrHash,
            format_: WhopSDK::AdUpdateParams::Creative::Format::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        sig do
          override.returns(
            {
              id: String,
              crop: WhopSDK::AdUpdateParams::Creative::Crop,
              format_: WhopSDK::AdUpdateParams::Creative::Format::OrSymbol
            }
          )
        end
        ...
        class Crop < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdUpdateParams::Creative::Crop,
        ...
        module Format
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::AdUpdateParams::Creative::Format)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          SQUARE =
            T.let(
              :square,
              WhopSDK::AdUpdateParams::Creative::Format::TaggedSymbol
            )
          VERTICAL =
            T.let(
              :vertical,
          ...
          sig do
            override.returns(
              T::Array[WhopSDK::AdUpdateParams::Creative::Format::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      class LeadForm < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(WhopSDK::AdUpdateParams::LeadForm, WhopSDK::Internal::AnyHash)
          end

        # Optional completion screen shown after submission; url sets the follow-up
        # website button.
        sig do
          returns(T.nilable(WhopSDK::AdUpdateParams::LeadForm::Completion))
        end
        attr_reader :completion

        sig do
          params(
            completion: WhopSDK::AdUpdateParams::LeadForm::Completion::OrHash
          ).void
        end
        ...
        sig do
          returns(T.nilable(WhopSDK::AdUpdateParams::LeadForm::Disclaimer))
        end
        attr_reader :disclaimer

        sig do
          params(
            disclaimer: WhopSDK::AdUpdateParams::LeadForm::Disclaimer::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(WhopSDK::AdUpdateParams::LeadForm::FormType::OrSymbol)
          )
        end
        ...
        sig do
          params(
            form_type: WhopSDK::AdUpdateParams::LeadForm::FormType::OrSymbol
          ).void
        end
        attr_writer :form_type

        # Optional intro screen shown before the questions.
        sig { returns(T.nilable(WhopSDK::AdUpdateParams::LeadForm::Intro)) }
        attr_reader :intro

        sig do
          params(intro: WhopSDK::AdUpdateParams::LeadForm::Intro::OrHash).void
        end
        attr_writer :intro
        ...
        sig do
          returns(T.nilable(WhopSDK::AdUpdateParams::LeadForm::PrivacyPolicy))
        end
        ...
        sig do
          params(
            privacy_policy:
              WhopSDK::AdUpdateParams::LeadForm::PrivacyPolicy::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[WhopSDK::AdUpdateParams::LeadForm::Question])
          )
        end
        ...
        sig do
          params(
            questions:
              T::Array[WhopSDK::AdUpdateParams::LeadForm::Question::OrHash]
          ).void
        end
        ...
        sig do
          params(
            ...
            disclaimer: WhopSDK::AdUpdateParams::LeadForm::Disclaimer::OrHash,
            form_type: WhopSDK::AdUpdateParams::LeadForm::FormType::OrSymbol,
            intro: WhopSDK::AdUpdateParams::LeadForm::Intro::OrHash,
            name: String,
        ...
        sig do
          override.returns(
            {
              completion: WhopSDK::AdUpdateParams::LeadForm::Completion,
              disclaimer: WhopSDK::AdUpdateParams::LeadForm::Disclaimer,
              form_type: WhopSDK::AdUpdateParams::LeadForm::FormType::OrSymbol,
              intro: WhopSDK::AdUpdateParams::LeadForm::Intro,
              name: String,
              phone_verification: T::Boolean,
              privacy_policy: WhopSDK::AdUpdateParams::LeadForm::PrivacyPolicy,
              questions: T::Array[WhopSDK::AdUpdateParams::LeadForm::Question]
            }
          )
        end
        def to_hash
        ...
        class Completion < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdUpdateParams::LeadForm::Completion,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        class Disclaimer < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdUpdateParams::LeadForm::Disclaimer,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  WhopSDK::AdUpdateParams::LeadForm::Disclaimer::Checkbox
                ]
              )
            )
          end
          ...
          sig do
            params(
              checkboxes:
                T::Array[
                  WhopSDK::AdUpdateParams::LeadForm::Disclaimer::Checkbox::OrHash
                ]
            ).void
          end
        ...
        module FormType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::AdUpdateParams::LeadForm::FormType)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          MORE_VOLUME =
            T.let(
              :more_volume,
              WhopSDK::AdUpdateParams::LeadForm::FormType::TaggedSymbol
            )
          HIGHER_INTENT =
            T.let(
              :higher_intent,
        ...
        class Intro < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdUpdateParams::LeadForm::Intro,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        class PrivacyPolicy < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdUpdateParams::LeadForm::PrivacyPolicy,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        class Question < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::AdUpdateParams::LeadForm::Question,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdUpdateParams::LeadForm::Question::Format::OrSymbol
              )
            )
          end
          attr_reader :format_
          ...
          sig do
            returns(
              T.nilable(
                T::Array[WhopSDK::AdUpdateParams::LeadForm::Question::Option]
              )
            )
          end
          attr_reader :options
          ...
          sig do
            params(
              options:
                T::Array[
                  WhopSDK::AdUpdateParams::LeadForm::Question::Option::OrHash
                ]
            ).void
          end
          attr_writer :options
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::AdUpdateParams::LeadForm::Question::Type::OrSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type: WhopSDK::AdUpdateParams::LeadForm::Question::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Format
            ...
            SHORT_ANSWER =
              T.let(
                :short_answer,
                WhopSDK::AdUpdateParams::LeadForm::Question::Format::TaggedSymbol
              )
            MULTIPLE_CHOICE =
              T.let(
                :multiple_choice,
          ...
          class Option < WhopSDK::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  WhopSDK::AdUpdateParams::LeadForm::Question::Option,
                  WhopSDK::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T.nilable(
                  WhopSDK::AdUpdateParams::LeadForm::Question::Option::Logic
                )
              )
            end
            attr_reader :logic
            ...
            sig do
              params(
                logic:
                  WhopSDK::AdUpdateParams::LeadForm::Question::Option::Logic::OrHash
              ).void
            end
            attr_writer :logic
            ...
            class Logic < WhopSDK::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    WhopSDK::AdUpdateParams::LeadForm::Question::Option::Logic::Action::OrSymbol
                  )
                )
              end
              attr_reader :action
              ...
              module Action
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      WhopSDK::AdUpdateParams::LeadForm::Question::Option::Logic::Action
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                GO_TO_QUESTION =
                  T.let(
                    :go_to_question,
                    WhopSDK::AdUpdateParams::LeadForm::Question::Option::Logic::Action::TaggedSymbol
                  )
                SUBMIT_FORM =
                  T.let(
                    :submit_form,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, WhopSDK::AdUpdateParams::LeadForm::Question::Type)
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            EMAIL =
              T.let(
                :email,
                WhopSDK::AdUpdateParams::LeadForm::Question::Type::TaggedSymbol
              )
            PHONE =
              T.let(
                :phone,
      ...
      class MessagingConfig < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::AdUpdateParams::MessagingConfig,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      module PostSource
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, WhopSDK::AdUpdateParams::PostSource) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        FACEBOOK =
          T.let(:facebook, WhopSDK::AdUpdateParams::PostSource::TaggedSymbol)
        INSTAGRAM =
          T.let(:instagram, WhopSDK::AdUpdateParams::PostSource::TaggedSymbol)

        sig do
          override.returns(
            T::Array[WhopSDK::AdUpdateParams::PostSource::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class SocialAccount < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::AdUpdateParams::SocialAccount,
              WhopSDK::Internal::AnyHash
            )
          end
