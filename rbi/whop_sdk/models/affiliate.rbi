...
module WhopSDK
  module Models
    class Affiliate < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(WhopSDK::Affiliate, WhopSDK::Internal::AnyHash) }
      ...
      sig { returns(WhopSDK::Affiliate::Company) }
      attr_reader :company

      sig { params(company: WhopSDK::Affiliate::Company::OrHash).void }
      attr_writer :company
      ...
      sig { returns(WhopSDK::Affiliate::User) }
      attr_reader :user

      sig { params(user: WhopSDK::Affiliate::User::OrHash).void }
      attr_writer :user
      ...
      sig do
        params(
          ...
          company: WhopSDK::Affiliate::Company::OrHash,
          created_at: Time,
          ...
          updated_at: Time,
          user: WhopSDK::Affiliate::User::OrHash
      ...
      class Company < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(WhopSDK::Affiliate::Company, WhopSDK::Internal::AnyHash)
          end
      ...
      class User < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(WhopSDK::Affiliate::User, WhopSDK::Internal::AnyHash)
          end
