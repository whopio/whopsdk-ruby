  ...
  module Models
    class BountyRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T::Array[
            WhopSDK::Models::BountyRetrieveResponse::AcceptedDeliverableType::TaggedSymbol
          ]
        )
      end
      ...
      sig do
        returns(
          T::Array[
            WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed
          ]
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::BountyRetrieveResponse::BusinessGoalType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::BountyRetrieveResponse::CaptureSpec))
      end
      ...
      sig do
        params(
          capture_spec:
            T.nilable(
              WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(WhopSDK::Models::BountyRetrieveResponse::Currency::TaggedSymbol)
      end
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::BountyRetrieveResponse::FundingAccount)
        )
      end
      ...
      sig do
        params(
          funding_account:
            T.nilable(
              WhopSDK::Models::BountyRetrieveResponse::FundingAccount::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::BountyRetrieveResponse::HostingAccount)
        )
      end
      ...
      sig do
        params(
          hosting_account:
            T.nilable(
              WhopSDK::Models::BountyRetrieveResponse::HostingAccount::OrHash
            )
        ).void
      end
      ...
      # key.
      sig { returns(WhopSDK::Models::BountyRetrieveResponse::Poster) }
      attr_reader :poster

      sig do
        params(
          poster: WhopSDK::Models::BountyRetrieveResponse::Poster::OrHash
        ).void
      end
      attr_writer :poster
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::BountyRetrieveResponse::ScheduledFrequency::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          ...
          accepted_deliverable_types:
            T::Array[
              WhopSDK::Models::BountyRetrieveResponse::AcceptedDeliverableType::OrSymbol
            ],
          ...
          active_proof_livestream_feeds:
            T::Array[
              WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::OrHash
            ],
          ...
          business_goal_type:
            T.nilable(
              WhopSDK::Models::BountyRetrieveResponse::BusinessGoalType::OrSymbol
            ),
          ...
          created_at: String,
          currency: WhopSDK::Models::BountyRetrieveResponse::Currency::OrSymbol,
          ...
          scheduled_frequency:
            T.nilable(
              WhopSDK::Models::BountyRetrieveResponse::ScheduledFrequency::OrSymbol
            ),
        ...
        override.returns(
          {
            ...
            cancel_requested_at: T.nilable(String),
            capture_spec:
              T.nilable(WhopSDK::Models::BountyRetrieveResponse::CaptureSpec),
            created_at: String,
            currency:
              WhopSDK::Models::BountyRetrieveResponse::Currency::TaggedSymbol,
            denied_submissions_count: Integer,
            description: String,
            discussion_experience_id: T.nilable(String),
            discussion_feed_id: T.nilable(String),
            ...
            funding_account:
              T.nilable(
                WhopSDK::Models::BountyRetrieveResponse::FundingAccount
              ),
            gross_paid_out_amount: Float,
            gross_reward_amount: Float,
            hosting_account:
              T.nilable(
                WhopSDK::Models::BountyRetrieveResponse::HostingAccount
              ),
            min_total_verified_duration_seconds: T.nilable(Integer),
            net_reward_amount: Float,
      ...
      module AcceptedDeliverableType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::BountyRetrieveResponse::AcceptedDeliverableType
            )
          end
      ...
      class ActiveProofLivestreamFeed < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            host:
              T.nilable(
                WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host::OrHash
              )
          ).void
        end
        attr_writer :host
        ...
        class Host < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::Models::BountyRetrieveResponse::ActiveProofLivestreamFeed::Host::ProfilePicture::OrHash
            ).void
          end
      ...
      module BusinessGoalType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::BountyRetrieveResponse::BusinessGoalType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class CaptureSpec < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::BountyRetrieveResponse::CaptureSpec,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu)
        end
        attr_reader :imu
        ...
        sig do
          params(
            imu:
              WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu::OrHash
          ).void
        end
        attr_writer :imu
        ...
        sig do
          returns(WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video)
        end
        attr_reader :video
        ...
        sig do
          params(
            video:
              WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::OrHash
          ).void
        end
        attr_writer :video
        ...
        sig do
          override.returns(
            {
              filename_pattern: String,
              imu: WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu,
              manifest_schema_version: Integer,
              min_clip_duration_seconds: Integer,
              min_total_verified_duration_seconds: Integer,
              required_metadata_fields: T::Array[String],
              single_continuous_take: T::Boolean,
              video: WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video
            }
          )
        end
        def to_hash
        ...
        class Imu < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Imu,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        class Video < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::StabilizationMode::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              stabilization_mode:
                WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::StabilizationMode::OrSymbol,
          ...
          module StabilizationMode
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::Models::BountyRetrieveResponse::CaptureSpec::Video::StabilizationMode
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Currency
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::BountyRetrieveResponse::Currency)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Poster < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::BountyRetrieveResponse::Poster,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            WhopSDK::Models::BountyRetrieveResponse::Poster::ProfilePicture
          )
        end
        attr_reader :profile_picture
        ...
        sig do
          params(
            profile_picture:
              WhopSDK::Models::BountyRetrieveResponse::Poster::ProfilePicture::OrHash
          ).void
        end
        attr_writer :profile_picture
      ...
      module ScheduledFrequency
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::BountyRetrieveResponse::ScheduledFrequency
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
