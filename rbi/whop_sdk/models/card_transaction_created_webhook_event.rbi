...
module WhopSDK
  module Models
    class CardTransactionCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(WhopSDK::CardTransactionCreatedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: WhopSDK::CardTransactionCreatedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            ...
            api_version: Symbol,
            api_version_date: T.nilable(String),
            data: WhopSDK::CardTransactionCreatedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            account_id: T.nilable(String),
            previous_attributes: T.anything
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::CardTransactionCreatedWebhookEvent::Data,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            WhopSDK::CardTransactionCreatedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::CardTransactionCreatedWebhookEvent::Data::TransactionType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              WhopSDK::CardTransactionCreatedWebhookEvent::Data::Status::OrSymbol,
            transaction_type:
              WhopSDK::CardTransactionCreatedWebhookEvent::Data::TransactionType::OrSymbol,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::CardTransactionCreatedWebhookEvent::Data::Status
              )
            end
        ...
        module TransactionType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::CardTransactionCreatedWebhookEvent::Data::TransactionType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
