...
module WhopSDK
  module Models
    class CardTransactionDeclinedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(WhopSDK::CardTransactionDeclinedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: WhopSDK::CardTransactionDeclinedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            ...
            api_version: Symbol,
            api_version_date: T.nilable(String),
            data: WhopSDK::CardTransactionDeclinedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            account_id: T.nilable(String),
            previous_attributes: T.anything
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::CardTransactionDeclinedWebhookEvent::Data,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            WhopSDK::CardTransactionDeclinedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::CardTransactionDeclinedWebhookEvent::Data::TransactionType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              WhopSDK::CardTransactionDeclinedWebhookEvent::Data::Status::OrSymbol,
            transaction_type:
              WhopSDK::CardTransactionDeclinedWebhookEvent::Data::TransactionType::OrSymbol,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::CardTransactionDeclinedWebhookEvent::Data::Status
              )
            end
        ...
        module TransactionType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::CardTransactionDeclinedWebhookEvent::Data::TransactionType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
