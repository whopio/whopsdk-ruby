...
module WhopSDK
  module Models
    class CardTransactionUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(WhopSDK::CardTransactionUpdatedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: WhopSDK::CardTransactionUpdatedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            ...
            api_version: Symbol,
            api_version_date: T.nilable(String),
            data: WhopSDK::CardTransactionUpdatedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            account_id: T.nilable(String),
            previous_attributes: T.anything
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::CardTransactionUpdatedWebhookEvent::Data,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            WhopSDK::CardTransactionUpdatedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::CardTransactionUpdatedWebhookEvent::Data::TransactionType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              WhopSDK::CardTransactionUpdatedWebhookEvent::Data::Status::OrSymbol,
            transaction_type:
              WhopSDK::CardTransactionUpdatedWebhookEvent::Data::TransactionType::OrSymbol,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::CardTransactionUpdatedWebhookEvent::Data::Status
              )
            end
        ...
        module TransactionType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::CardTransactionUpdatedWebhookEvent::Data::TransactionType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
