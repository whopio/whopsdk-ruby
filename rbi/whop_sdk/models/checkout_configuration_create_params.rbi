      ...
      module Body
        ...
        class CreateCheckoutSessionInputModeSetup < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::CheckoutConfigurationCreateParams::Body::CreateCheckoutSessionInputModeSetup::ThreeDSLevel::OrSymbol
              )
            )
          end
          ...
          module ThreeDSLevel
            ...
            MANDATE_CHALLENGE =
              T.let(
                :mandate_challenge,
                WhopSDK::CheckoutConfigurationCreateParams::Body::CreateCheckoutSessionInputModeSetup::ThreeDSLevel::TaggedSymbol
              )
            FRICTIONLESS =
              T.let(
                :frictionless,
