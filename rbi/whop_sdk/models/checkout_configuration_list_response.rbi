  ...
  module Models
    class CheckoutConfigurationListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        params(
          effective_payment_method_configuration:
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationListResponse::EffectivePaymentMethodConfiguration::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::CheckoutConfigurationListResponse::ThreeDSLevel::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          ...
          three_ds_level:
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationListResponse::ThreeDSLevel::OrSymbol
            )
      ...
      class Plan < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            WhopSDK::Models::CheckoutConfigurationListResponse::Plan::PlanType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::Models::CheckoutConfigurationListResponse::Plan::ReleaseMethod::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::Models::CheckoutConfigurationListResponse::Plan::Visibility::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            initial_price: Float,
            plan_type:
              WhopSDK::Models::CheckoutConfigurationListResponse::Plan::PlanType::OrSymbol,
            release_method:
              WhopSDK::Models::CheckoutConfigurationListResponse::Plan::ReleaseMethod::OrSymbol,
            renewal_price: Float,
            three_ds_level:
              T.nilable(
            ...
            visibility:
              WhopSDK::Models::CheckoutConfigurationListResponse::Plan::Visibility::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # Plan ID, prefixed `plan_`.
        ...
        module PlanType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationListResponse::Plan::PlanType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module ReleaseMethod
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationListResponse::Plan::ReleaseMethod
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Visibility
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationListResponse::Plan::Visibility
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module ThreeDSLevel
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::CheckoutConfigurationListResponse::ThreeDSLevel
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
