  ...
  module Models
    class CheckoutConfigurationRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse,
      ...
      sig do
        returns(
          WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Mode::TaggedSymbol
        )
      end
      attr_accessor :mode
      ...
      sig do
        params(
          effective_payment_method_configuration:
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::EffectivePaymentMethodConfiguration::OrHash
            )
        ).void
      end
      ...
      sig do
        params(
          payment_method_configuration:
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::PaymentMethodConfiguration::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan
          )
        )
      end
      attr_reader :plan
      ...
      sig do
        params(
          plan:
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::OrHash
            )
        ).void
      end
      attr_writer :plan
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse::ThreeDSLevel::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          ...
          created_at: String,
          mode:
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Mode::OrSymbol,
          updated_at: String,
          ...
          three_ds_level:
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::ThreeDSLevel::OrSymbol
            )
      ...
      module Mode
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Mode
            )
          end
      ...
      class Plan < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::PlanType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::ReleaseMethod::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::ThreeDSLevel::TaggedSymbol
            )
          )
        end
        attr_accessor :three_ds_level
        ...
        sig do
          returns(
            WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::Visibility::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            initial_price: Float,
            plan_type:
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::PlanType::OrSymbol,
            release_method:
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::ReleaseMethod::OrSymbol,
            renewal_price: Float,
            three_ds_level:
              T.nilable(
                WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::ThreeDSLevel::OrSymbol
              ),
            trial_period_days: T.nilable(Integer),
            visibility:
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::Visibility::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # Plan ID, prefixed `plan_`.
        ...
        module PlanType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::PlanType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module ReleaseMethod
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::ReleaseMethod
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module ThreeDSLevel
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::ThreeDSLevel
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Visibility
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::CheckoutConfigurationRetrieveResponse::Plan::Visibility
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module ThreeDSLevel
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::CheckoutConfigurationRetrieveResponse::ThreeDSLevel
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
