  ...
  module Models
    class DisputeSubmitEvidenceResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::DisputeSubmitEvidenceResponse,
      ...
      sig do
        params(
          cancellation_policy_attachment:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::CancellationPolicyAttachment::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::DisputeSubmitEvidenceResponse::Company)
        )
      end
      attr_reader :company
      ...
      sig do
        params(
          company:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Company::OrHash
            )
        ).void
      end
      attr_writer :company
      ...
      sig do
        params(
          customer_communication_attachment:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::CustomerCommunicationAttachment::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment)
        )
      end
      attr_reader :payment
      ...
      sig do
        params(
          payment:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::OrHash
            )
        ).void
      end
      attr_writer :payment
      ...
      # to a specific plan.
      sig do
        returns(T.nilable(WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan))
      end
      attr_reader :plan
      ...
      sig do
        params(
          plan:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan::OrHash
            )
        ).void
      end
      attr_writer :plan
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::DisputeSubmitEvidenceResponse::Product)
        )
      end
      attr_reader :product
      ...
      sig do
        params(
          product:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Product::OrHash
            )
        ).void
      end
      attr_writer :product
      ...
      sig do
        params(
          refund_policy_attachment:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::RefundPolicyAttachment::OrHash
            )
        ).void
      end
      ...
      sig do
        params(
          uncategorized_attachment:
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::UncategorizedAttachment::OrHash
            )
        ).void
      end
        ...
        override.returns(
          {
            ...
            company:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Company
              ),
            created_at: T.nilable(Time),
            ...
            payment:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment
              ),
            plan:
              T.nilable(WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan),
            product:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Product
              ),
            product_description: T.nilable(String),
            reason: T.nilable(String),
            reason_code: T.nilable(String),
      ...
      class Payment < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Member
            )
          )
        end
        attr_reader :member
        ...
        sig do
          params(
            member:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Member::OrHash
              )
          ).void
        end
        attr_writer :member
        ...
        sig do
          params(
            membership:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::Membership::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            payment_instrument:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::User
            )
          )
        end
        attr_reader :user
        ...
        sig do
          params(
            user:
              T.nilable(
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::User::OrHash
              )
          ).void
        end
        attr_writer :user
        ...
        class PaymentInstrument < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons
            )
          end
          attr_reader :icons
          ...
          sig do
            params(
              icons:
                WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::OrHash
            ).void
          end
          attr_writer :icons
          ...
          class Icons < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                square:
                  WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::OrHash
              ).void
            end
            attr_writer :square
            ...
            class Square < WhopSDK::Internal::Type::BaseModel
              ...
              sig do
                params(
                  dark:
                    WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Dark::OrHash
                ).void
              end
              attr_writer :dark
              ...
              sig do
                params(
                  light:
                    WhopSDK::Models::DisputeSubmitEvidenceResponse::Payment::PaymentInstrument::Icons::Square::Light::OrHash
                ).void
              end
              attr_writer :light
      ...
      class Plan < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::DisputeSubmitEvidenceResponse::Plan,
              WhopSDK::Internal::AnyHash
            )
          end
