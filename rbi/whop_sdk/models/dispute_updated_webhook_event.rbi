...
module WhopSDK
  module Models
    class DisputeUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(WhopSDK::DisputeUpdatedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(data: WhopSDK::DisputeUpdatedWebhookEvent::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          id: String,
          data: WhopSDK::DisputeUpdatedWebhookEvent::Data::OrHash,
          timestamp: Time,
          api_version: Symbol,
          type: Symbol
        ...
        override.returns(
          {
            id: String,
            api_version: Symbol,
            data: WhopSDK::DisputeUpdatedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol
          }
        )
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::DisputeUpdatedWebhookEvent::Data,
        ...
        sig do
          params(
            cancellation_policy_attachment:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::CancellationPolicyAttachment::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Company))
        end
        attr_reader :company
        ...
        sig do
          params(
            company:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Company::OrHash
              )
          ).void
        end
        attr_writer :company
        ...
        sig do
          params(
            customer_communication_attachment:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::CustomerCommunicationAttachment::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment))
        end
        attr_reader :payment
        ...
        sig do
          params(
            payment:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::OrHash
              )
          ).void
        end
        attr_writer :payment
        ...
        sig do
          returns(T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Plan))
        end
        attr_reader :plan
        ...
        sig do
          params(
            plan:
              T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Plan::OrHash)
          ).void
        end
        attr_writer :plan
        ...
        sig do
          returns(T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Product))
        end
        attr_reader :product
        ...
        sig do
          params(
            product:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Product::OrHash
              )
          ).void
        end
        attr_writer :product
        ...
        sig do
          params(
            refund_policy_attachment:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::RefundPolicyAttachment::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            WhopSDK::DisputeUpdatedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            uncategorized_attachment:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::UncategorizedAttachment::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            ...
            plan:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Plan::OrHash
              ),
            product:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Product::OrHash
            ...
            status: WhopSDK::DisputeUpdatedWebhookEvent::Data::Status::OrSymbol,
            uncategorized_attachment:
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::UncategorizedAttachment::OrHash
              ),
          ...
          override.returns(
            {
              ...
              cancellation_policy_disclosure: T.nilable(String),
              company:
                T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Company),
              created_at: T.nilable(Time),
              ...
              notes: T.nilable(String),
              payment:
                T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment),
              plan: T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Plan),
              product:
                T.nilable(WhopSDK::DisputeUpdatedWebhookEvent::Data::Product),
              product_description: T.nilable(String),
              reason: T.nilable(String),
              refund_policy_attachment:
                T.nilable(
        ...
        class Company < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Company,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        class Payment < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::Member
              )
            )
          end
          attr_reader :member
          ...
          sig do
            params(
              member:
                T.nilable(
                  WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::Member::OrHash
                )
            ).void
          end
          attr_writer :member
          ...
          sig do
            params(
              membership:
                T.nilable(
                  WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::Membership::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::User
              )
            )
          end
          attr_reader :user
          ...
          sig do
            params(
              user:
                T.nilable(
                  WhopSDK::DisputeUpdatedWebhookEvent::Data::Payment::User::OrHash
                )
            ).void
          end
          attr_writer :user
        ...
        class Plan < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Plan,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        class Product < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::DisputeUpdatedWebhookEvent::Data::Product,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::DisputeUpdatedWebhookEvent::Data::Status)
            end
