...
module WhopSDK
  module Models
    class ForumPost < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(T::Array[WhopSDK::ForumPost::Attachment]) }
      ...
      sig do
        params(
          id: String,
          attachments: T::Array[WhopSDK::ForumPost::Attachment::OrHash],
      ...
      sig do
        override.returns(
          {
            id: String,
            attachments: T::Array[WhopSDK::ForumPost::Attachment],
            comment_count: Integer,
            content: T.nilable(String),
            created_at: Time,
            is_edited: T::Boolean,
      ...
      class Attachment < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(WhopSDK::ForumPost::Attachment, WhopSDK::Internal::AnyHash)
          end
