...
module WhopSDK
  module Models
    class IdentityProfile < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::IdentityProfile, WhopSDK::Internal::AnyHash)
        end
      ...
      # `business` profiles.
      sig { returns(T.nilable(WhopSDK::IdentityProfile::BusinessAddress)) }
      attr_reader :business_address

      sig do
        params(
          business_address:
            T.nilable(WhopSDK::IdentityProfile::BusinessAddress::OrHash)
        ).void
      end
      ...
      sig { returns(T::Array[WhopSDK::IdentityProfile::LinkedCompany]) }
      attr_accessor :linked_companies

      # Residential address reported by the identity provider. Present on `individual`
      # profiles.
      sig { returns(T.nilable(WhopSDK::IdentityProfile::PersonalAddress)) }
      attr_reader :personal_address

      sig do
        params(
          personal_address:
            T.nilable(WhopSDK::IdentityProfile::PersonalAddress::OrHash)
        ).void
      end
      ...
      sig { returns(WhopSDK::IdentityProfileStatus::TaggedSymbol) }
      ...
      # first.
      sig { returns(T::Array[WhopSDK::IdentityProfile::Verification]) }
      ...
      sig do
        params(
          ...
          linked_companies:
            T::Array[WhopSDK::IdentityProfile::LinkedCompany::OrHash],
          personal_address:
            T.nilable(WhopSDK::IdentityProfile::PersonalAddress::OrHash),
          phone: T.nilable(String),
          profile_type: String,
          status: WhopSDK::IdentityProfileStatus::OrSymbol,
          updated_at: Time,
          verifications:
            T::Array[WhopSDK::IdentityProfile::Verification::OrHash]
        ...
        override.returns(
          {
            id: String,
            business_address:
              T.nilable(WhopSDK::IdentityProfile::BusinessAddress),
            business_name: T.nilable(String),
            business_structure: T.nilable(String),
            country: T.nilable(String),
            created_at: Time,
            ...
            first_name: T.nilable(String),
            last_name: T.nilable(String),
            linked_companies: T::Array[WhopSDK::IdentityProfile::LinkedCompany],
            personal_address:
              T.nilable(WhopSDK::IdentityProfile::PersonalAddress),
            phone: T.nilable(String),
            profile_type: String,
            status: WhopSDK::IdentityProfileStatus::TaggedSymbol,
            updated_at: Time,
            verifications: T::Array[WhopSDK::IdentityProfile::Verification]
          }
        )
      end
      def to_hash
      ...
      class BusinessAddress < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::IdentityProfile::BusinessAddress,
      ...
      class LinkedCompany < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::IdentityProfile::LinkedCompany,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class PersonalAddress < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::IdentityProfile::PersonalAddress,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Verification < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::IdentityProfile::Verification,
              WhopSDK::Internal::AnyHash
            )
          end
