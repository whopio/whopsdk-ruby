...
module WhopSDK
  module Models
    class IdentityProfileApprovedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # data.
      sig { returns(WhopSDK::IdentityProfileApprovedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: WhopSDK::IdentityProfileApprovedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            id: String,
            api_version: Symbol,
            data: WhopSDK::IdentityProfileApprovedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            company_id: T.nilable(String)
          }
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::IdentityProfileApprovedWebhookEvent::Data,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            business_address:
              T.nilable(
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::BusinessAddress::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T::Array[
              WhopSDK::IdentityProfileApprovedWebhookEvent::Data::LinkedCompany
            ]
          )
        end
        ...
        sig do
          params(
            personal_address:
              T.nilable(
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::PersonalAddress::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T::Array[
              WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification
            ]
          )
        end
        ...
        sig do
          params(
            ...
            linked_companies:
              T::Array[
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::LinkedCompany::OrHash
              ],
            personal_address:
              T.nilable(
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::PersonalAddress::OrHash
            ...
            profile_type: String,
            status:
              WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Status::OrSymbol,
            updated_at: Time,
            verifications:
              T::Array[
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Status
              )
            end
        ...
        class Verification < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::LastErrorCode::TaggedSymbol
              )
            )
          end
          ...
          sig do
            returns(
              WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              last_error_code:
                T.nilable(
                  WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::LastErrorCode::OrSymbol
                ),
              last_error_reason: T.nilable(String),
              session_url: T.nilable(String),
              status:
                WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::Status::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # The numeric id of the verification record.
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::IdentityProfileApprovedWebhookEvent::Data::Verification::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
