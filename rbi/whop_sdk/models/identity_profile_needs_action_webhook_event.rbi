...
module WhopSDK
  module Models
    class IdentityProfileNeedsActionWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      # data.
      sig { returns(WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            id: String,
            api_version: Symbol,
            data: WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            company_id: T.nilable(String)
          }
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            business_address:
              T.nilable(
                WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::BusinessAddress::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T::Array[
              WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification
            ]
          )
        end
        ...
        sig do
          params(
            ...
            profile_type: String,
            status:
              WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Status::OrSymbol,
            updated_at: Time,
            verifications:
              T::Array[
                WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Status
              )
            end
        ...
        class Verification < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification::LastErrorCode::TaggedSymbol
              )
            )
          end
          ...
          sig do
            returns(
              WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              last_error_code:
                T.nilable(
                  WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification::LastErrorCode::OrSymbol
                ),
              last_error_reason: T.nilable(String),
              session_url: T.nilable(String),
              status:
                WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification::Status::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # The numeric id of the verification record.
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::IdentityProfileNeedsActionWebhookEvent::Data::Verification::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
