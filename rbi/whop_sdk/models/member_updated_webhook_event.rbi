...
module WhopSDK
  module Models
    class MemberUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::MemberUpdatedWebhookEvent, WhopSDK::Internal::AnyHash)
        end
      ...
      sig { returns(WhopSDK::MemberUpdatedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(data: WhopSDK::MemberUpdatedWebhookEvent::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          ...
          data: WhopSDK::MemberUpdatedWebhookEvent::Data::OrHash,
          timestamp: Time,
        ...
        override.returns(
          {
            ...
            api_version: Symbol,
            api_version_date: T.nilable(String),
            data: WhopSDK::MemberUpdatedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            account_id: T.nilable(String),
            previous_attributes: T.anything
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::MemberUpdatedWebhookEvent::Data,
        ...
        sig do
          returns(
            WhopSDK::MemberUpdatedWebhookEvent::Data::AccessLevel::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::MemberUpdatedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        # than a person.
        sig do
          returns(T.nilable(WhopSDK::MemberUpdatedWebhookEvent::Data::User))
        end
        attr_reader :user
        ...
        sig do
          params(
            user:
              T.nilable(WhopSDK::MemberUpdatedWebhookEvent::Data::User::OrHash)
          ).void
        end
        attr_writer :user
        ...
        sig do
          params(
            id: String,
            access_level:
              WhopSDK::MemberUpdatedWebhookEvent::Data::AccessLevel::OrSymbol,
            account_id: String,
            created_at: String,
            joined_at: String,
            last_accessed_at: T.nilable(String),
            phone_number: T.nilable(String),
            status: WhopSDK::MemberUpdatedWebhookEvent::Data::Status::OrSymbol,
            token_balance: Float,
            user:
              T.nilable(WhopSDK::MemberUpdatedWebhookEvent::Data::User::OrHash)
          ).returns(T.attached_class)
          ...
          override.returns(
            {
              ...
              status:
                WhopSDK::MemberUpdatedWebhookEvent::Data::Status::TaggedSymbol,
              token_balance: Float,
              user: T.nilable(WhopSDK::MemberUpdatedWebhookEvent::Data::User)
            }
          )
        end
        def to_hash
        ...
        module AccessLevel
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::MemberUpdatedWebhookEvent::Data::AccessLevel
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::MemberUpdatedWebhookEvent::Data::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class User < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::MemberUpdatedWebhookEvent::Data::User,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              WhopSDK::MemberUpdatedWebhookEvent::Data::User::ProfilePicture
            )
          end
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::MemberUpdatedWebhookEvent::Data::User::ProfilePicture::OrHash
            ).void
          end
