  ...
  module Models
    class MembershipAddFreeDaysResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::MembershipAddFreeDaysResponse,
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::MembershipAddFreeDaysResponse::CancelationStatus::TaggedSymbol
          )
        )
      end
      ...
      sig { returns(WhopSDK::Models::MembershipAddFreeDaysResponse::Company) }
      attr_reader :company

      sig do
        params(
          company:
            WhopSDK::Models::MembershipAddFreeDaysResponse::Company::OrHash
        ).void
      end
      attr_writer :company
      ...
      sig do
        returns(
          T::Array[
            WhopSDK::Models::MembershipAddFreeDaysResponse::CustomFieldResponse
          ]
        )
      end
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::MembershipAddFreeDaysResponse::Member)
        )
      end
      attr_reader :member
      ...
      sig do
        params(
          member:
            T.nilable(
              WhopSDK::Models::MembershipAddFreeDaysResponse::Member::OrHash
            )
        ).void
      end
      attr_writer :member
      ...
      sig { returns(WhopSDK::Models::MembershipAddFreeDaysResponse::Plan) }
      attr_reader :plan

      sig do
        params(
          plan: WhopSDK::Models::MembershipAddFreeDaysResponse::Plan::OrHash
        ).void
      end
      attr_writer :plan

      # The product this membership grants access to.
      sig { returns(WhopSDK::Models::MembershipAddFreeDaysResponse::Product) }
      attr_reader :product

      sig do
        params(
          product:
            WhopSDK::Models::MembershipAddFreeDaysResponse::Product::OrHash
        ).void
      end
      attr_writer :product
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::MembershipAddFreeDaysResponse::PromoCode)
        )
      end
      ...
      sig do
        params(
          promo_code:
            T.nilable(
              WhopSDK::Models::MembershipAddFreeDaysResponse::PromoCode::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::MembershipAddFreeDaysResponse::User))
      end
      attr_reader :user
      ...
      sig do
        params(
          user:
            T.nilable(
              WhopSDK::Models::MembershipAddFreeDaysResponse::User::OrHash
            )
        ).void
      end
      attr_writer :user
      ...
      sig do
        params(
          ...
          cancelation_status:
            T.nilable(
              WhopSDK::Models::MembershipAddFreeDaysResponse::CancelationStatus::OrSymbol
            ),
          ...
          custom_field_responses:
            T::Array[
              WhopSDK::Models::MembershipAddFreeDaysResponse::CustomFieldResponse::OrHash
            ],
        ...
        override.returns(
          {
            ...
            promo_code:
              T.nilable(
                WhopSDK::Models::MembershipAddFreeDaysResponse::PromoCode
              ),
            renewal_period_end: T.nilable(Time),
            renewal_period_start: T.nilable(Time),
            ...
            updated_at: Time,
            user:
              T.nilable(WhopSDK::Models::MembershipAddFreeDaysResponse::User)
          }
        )
      end
      def to_hash
      ...
      module CancelationStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::MembershipAddFreeDaysResponse::CancelationStatus
            )
          end
      ...
      class Company < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipAddFreeDaysResponse::Company,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Member < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipAddFreeDaysResponse::Member,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Plan < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipAddFreeDaysResponse::Plan,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Product < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipAddFreeDaysResponse::Product,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class User < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipAddFreeDaysResponse::User,
              WhopSDK::Internal::AnyHash
            )
          end
