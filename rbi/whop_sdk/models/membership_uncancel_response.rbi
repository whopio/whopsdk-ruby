  ...
  module Models
    class MembershipUncancelResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::MembershipUncancelResponse,
      ...
      sig do
        returns(
          T.nilable(
            WhopSDK::Models::MembershipUncancelResponse::CancelationStatus::TaggedSymbol
          )
        )
      end
      ...
      sig { returns(WhopSDK::Models::MembershipUncancelResponse::Company) }
      attr_reader :company

      sig do
        params(
          company: WhopSDK::Models::MembershipUncancelResponse::Company::OrHash
        ).void
      end
      attr_writer :company
      ...
      sig do
        returns(
          T::Array[
            WhopSDK::Models::MembershipUncancelResponse::CustomFieldResponse
          ]
        )
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::MembershipUncancelResponse::Member))
      end
      attr_reader :member
      ...
      sig do
        params(
          member:
            T.nilable(
              WhopSDK::Models::MembershipUncancelResponse::Member::OrHash
            )
        ).void
      end
      attr_writer :member
      ...
      sig { returns(WhopSDK::Models::MembershipUncancelResponse::Plan) }
      attr_reader :plan

      sig do
        params(
          plan: WhopSDK::Models::MembershipUncancelResponse::Plan::OrHash
        ).void
      end
      attr_writer :plan

      # The product this membership grants access to.
      sig { returns(WhopSDK::Models::MembershipUncancelResponse::Product) }
      attr_reader :product

      sig do
        params(
          product: WhopSDK::Models::MembershipUncancelResponse::Product::OrHash
        ).void
      end
      attr_writer :product
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::MembershipUncancelResponse::PromoCode)
        )
      end
      ...
      sig do
        params(
          promo_code:
            T.nilable(
              WhopSDK::Models::MembershipUncancelResponse::PromoCode::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::MembershipUncancelResponse::User))
      end
      attr_reader :user
      ...
      sig do
        params(
          user:
            T.nilable(WhopSDK::Models::MembershipUncancelResponse::User::OrHash)
        ).void
      end
      attr_writer :user
      ...
      sig do
        params(
          ...
          cancelation_status:
            T.nilable(
              WhopSDK::Models::MembershipUncancelResponse::CancelationStatus::OrSymbol
            ),
          ...
          custom_field_responses:
            T::Array[
              WhopSDK::Models::MembershipUncancelResponse::CustomFieldResponse::OrHash
            ],
        ...
        override.returns(
          {
            ...
            manage_url: T.nilable(String),
            member:
              T.nilable(WhopSDK::Models::MembershipUncancelResponse::Member),
            metadata: T.nilable(T::Hash[Symbol, T.anything]),
            payment_collection_paused: T::Boolean,
            ...
            updated_at: Time,
            user: T.nilable(WhopSDK::Models::MembershipUncancelResponse::User)
          }
        )
      end
      def to_hash
      ...
      module CancelationStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              WhopSDK::Models::MembershipUncancelResponse::CancelationStatus
            )
          end
      ...
      class Company < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipUncancelResponse::Company,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Member < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipUncancelResponse::Member,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Plan < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipUncancelResponse::Plan,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class Product < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipUncancelResponse::Product,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class PromoCode < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipUncancelResponse::PromoCode,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class User < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::MembershipUncancelResponse::User,
              WhopSDK::Internal::AnyHash
            )
          end
