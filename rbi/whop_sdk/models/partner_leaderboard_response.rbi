  ...
  module Models
    class PartnerLeaderboardResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::PartnerLeaderboardResponse,
      ...
      sig do
        returns(T::Array[WhopSDK::Models::PartnerLeaderboardResponse::Leader])
      end
      attr_accessor :leaders

      # The caller's own standing; null when the caller has no referral earnings.
      sig do
        returns(T.nilable(WhopSDK::Models::PartnerLeaderboardResponse::Me))
      end
      attr_reader :me

      sig do
        params(
          me: T.nilable(WhopSDK::Models::PartnerLeaderboardResponse::Me::OrHash)
        ).void
      end
      attr_writer :me
      ...
      sig do
        params(
          leaders:
            T::Array[
              WhopSDK::Models::PartnerLeaderboardResponse::Leader::OrHash
            ],
          me: T.nilable(WhopSDK::Models::PartnerLeaderboardResponse::Me::OrHash)
      ...
      sig do
        override.returns(
          {
            leaders:
              T::Array[WhopSDK::Models::PartnerLeaderboardResponse::Leader],
            me: T.nilable(WhopSDK::Models::PartnerLeaderboardResponse::Me)
          }
        )
      end
      def to_hash
      ...
      class Leader < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(WhopSDK::Models::PartnerLeaderboardResponse::Leader::User)
          )
        end
        attr_reader :user
        ...
        sig do
          params(
            user:
              T.nilable(
                WhopSDK::Models::PartnerLeaderboardResponse::Leader::User::OrHash
              )
          ).void
        end
        attr_writer :user
          ...
          override.returns(
            {
              ...
              user:
                T.nilable(
                  WhopSDK::Models::PartnerLeaderboardResponse::Leader::User
                )
            }
          )
        end
        ...
        class User < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::Models::PartnerLeaderboardResponse::Leader::User::ProfilePicture::OrHash
            ).void
          end
      ...
      class Me < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::PartnerLeaderboardResponse::Me,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(WhopSDK::Models::PartnerLeaderboardResponse::Me::User)
          )
        end
        attr_reader :user
        ...
        sig do
          params(
            user:
              T.nilable(
                WhopSDK::Models::PartnerLeaderboardResponse::Me::User::OrHash
              )
          ).void
        end
        attr_writer :user
        ...
        class User < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::Models::PartnerLeaderboardResponse::Me::User,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::Models::PartnerLeaderboardResponse::Me::User::ProfilePicture::OrHash
            ).void
          end
          attr_writer :profile_picture
