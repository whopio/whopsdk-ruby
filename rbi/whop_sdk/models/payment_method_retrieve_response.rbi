        ...
        class PlatformBalance < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              account:
                T.nilable(
                  WhopSDK::Models::PaymentMethodRetrieveResponse::PlatformBalancePaymentMethod::PlatformBalance::Account::OrHash
                )
            ).void
          end
          attr_writer :account
          ...
          class Account < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                logo:
                  T.nilable(
                    WhopSDK::Models::PaymentMethodRetrieveResponse::PlatformBalancePaymentMethod::PlatformBalance::Account::Logo::OrHash
                  )
              ).void
            end
            attr_writer :logo
