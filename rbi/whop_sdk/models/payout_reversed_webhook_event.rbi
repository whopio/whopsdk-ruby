...
module WhopSDK
  module Models
    class PayoutReversedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::PayoutReversedWebhookEvent, WhopSDK::Internal::AnyHash)
        end
      ...
      sig { returns(WhopSDK::PayoutReversedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(data: WhopSDK::PayoutReversedWebhookEvent::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          ...
          data: WhopSDK::PayoutReversedWebhookEvent::Data::OrHash,
          timestamp: Time,
        ...
        override.returns(
          {
            ...
            api_version: Symbol,
            api_version_date: T.nilable(String),
            data: WhopSDK::PayoutReversedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            account_id: T.nilable(String),
            previous_attributes: T.anything
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::PayoutReversedWebhookEvent::Data,
        ...
        sig do
          returns(T.nilable(WhopSDK::PayoutReversedWebhookEvent::Data::Failure))
        end
        attr_reader :failure
        ...
        sig do
          params(
            failure:
              T.nilable(
                WhopSDK::PayoutReversedWebhookEvent::Data::Failure::OrHash
              )
          ).void
        end
        attr_writer :failure
        ...
        sig do
          returns(
            WhopSDK::PayoutReversedWebhookEvent::Data::FeePaidBy::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::PayoutReversedWebhookEvent::Data::Object::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod)
          )
        end
        ...
        sig do
          params(
            payout_method:
              T.nilable(
                WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::PayoutReversedWebhookEvent::Data::Source::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            WhopSDK::PayoutReversedWebhookEvent::Data::Speed::TaggedSymbol
          )
        end
        attr_accessor :speed
        ...
        sig do
          returns(
            WhopSDK::PayoutReversedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            fee_amount: String,
            fee_paid_by:
              WhopSDK::PayoutReversedWebhookEvent::Data::FeePaidBy::OrSymbol,
            markup_fee: String,
            metadata: T::Hash[Symbol, String],
            net_amount: String,
            notes: T.nilable(String),
            object: WhopSDK::PayoutReversedWebhookEvent::Data::Object::OrSymbol,
            ...
            source:
              T.nilable(
                WhopSDK::PayoutReversedWebhookEvent::Data::Source::OrSymbol
              ),
            speed: WhopSDK::PayoutReversedWebhookEvent::Data::Speed::OrSymbol,
            status: WhopSDK::PayoutReversedWebhookEvent::Data::Status::OrSymbol,
          ...
          override.returns(
            {
              ...
              exchange_rate: T.nilable(Float),
              failure:
                T.nilable(WhopSDK::PayoutReversedWebhookEvent::Data::Failure),
              fee_amount: String,
              fee_paid_by:
                WhopSDK::PayoutReversedWebhookEvent::Data::FeePaidBy::TaggedSymbol,
              markup_fee: String,
              ...
              payout_method:
                T.nilable(
                  WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod
                ),
              payout_request_id: T.nilable(String),
              source:
                T.nilable(
        ...
        class Failure < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::PayoutReversedWebhookEvent::Data::Failure,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        module FeePaidBy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::PayoutReversedWebhookEvent::Data::FeePaidBy
              )
            end
        ...
        module Object
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutReversedWebhookEvent::Data::Object)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class PayoutMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              supported_payout_method:
                T.nilable(
                  WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::OrHash
                )
            ).void
          end
          ...
          class SupportedPayoutMethod < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                delivery_type:
                  WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType::OrSymbol,
            ...
            module DeliveryType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::PayoutReversedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Source
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutReversedWebhookEvent::Data::Source)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Speed
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutReversedWebhookEvent::Data::Speed)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutReversedWebhookEvent::Data::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
