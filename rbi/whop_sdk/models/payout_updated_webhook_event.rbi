...
module WhopSDK
  module Models
    class PayoutUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::PayoutUpdatedWebhookEvent, WhopSDK::Internal::AnyHash)
        end
      ...
      sig { returns(WhopSDK::PayoutUpdatedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(data: WhopSDK::PayoutUpdatedWebhookEvent::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          ...
          data: WhopSDK::PayoutUpdatedWebhookEvent::Data::OrHash,
          timestamp: Time,
        ...
        override.returns(
          {
            ...
            api_version: Symbol,
            api_version_date: T.nilable(String),
            data: WhopSDK::PayoutUpdatedWebhookEvent::Data,
            timestamp: Time,
            type: Symbol,
            account_id: T.nilable(String),
            previous_attributes: T.anything
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::PayoutUpdatedWebhookEvent::Data,
        ...
        sig do
          returns(T.nilable(WhopSDK::PayoutUpdatedWebhookEvent::Data::Failure))
        end
        attr_reader :failure
        ...
        sig do
          params(
            failure:
              T.nilable(
                WhopSDK::PayoutUpdatedWebhookEvent::Data::Failure::OrHash
              )
          ).void
        end
        attr_writer :failure
        ...
        sig do
          returns(
            WhopSDK::PayoutUpdatedWebhookEvent::Data::FeePaidBy::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            WhopSDK::PayoutUpdatedWebhookEvent::Data::Object::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod)
          )
        end
        ...
        sig do
          params(
            payout_method:
              T.nilable(
                WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::PayoutUpdatedWebhookEvent::Data::Source::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(WhopSDK::PayoutUpdatedWebhookEvent::Data::Speed::TaggedSymbol)
        end
        attr_accessor :speed
        ...
        sig do
          params(
            ...
            fee_amount: String,
            fee_paid_by:
              WhopSDK::PayoutUpdatedWebhookEvent::Data::FeePaidBy::OrSymbol,
            markup_fee: String,
            metadata: T::Hash[Symbol, String],
            net_amount: String,
            notes: T.nilable(String),
            object: WhopSDK::PayoutUpdatedWebhookEvent::Data::Object::OrSymbol,
          ...
          override.returns(
            {
              ...
              exchange_rate: T.nilable(Float),
              failure:
                T.nilable(WhopSDK::PayoutUpdatedWebhookEvent::Data::Failure),
              fee_amount: String,
              fee_paid_by:
                WhopSDK::PayoutUpdatedWebhookEvent::Data::FeePaidBy::TaggedSymbol,
              markup_fee: String,
              ...
              payout_method:
                T.nilable(
                  WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod
                ),
              payout_request_id: T.nilable(String),
              source:
                T.nilable(
        ...
        class Failure < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::PayoutUpdatedWebhookEvent::Data::Failure,
                WhopSDK::Internal::AnyHash
              )
            end
        ...
        module FeePaidBy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutUpdatedWebhookEvent::Data::FeePaidBy)
            end
        ...
        module Object
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutUpdatedWebhookEvent::Data::Object)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class PayoutMethod < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              supported_payout_method:
                T.nilable(
                  WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::OrHash
                )
            ).void
          end
          ...
          class SupportedPayoutMethod < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                delivery_type:
                  WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType::OrSymbol,
            ...
            module DeliveryType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::PayoutUpdatedWebhookEvent::Data::PayoutMethod::SupportedPayoutMethod::DeliveryType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Source
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutUpdatedWebhookEvent::Data::Source)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Speed
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutUpdatedWebhookEvent::Data::Speed)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::PayoutUpdatedWebhookEvent::Data::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
