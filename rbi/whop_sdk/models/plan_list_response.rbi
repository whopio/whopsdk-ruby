...
module WhopSDK
  module Models
    class PlanListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(WhopSDK::Models::PlanListResponse::InitialPriceDue) }
      attr_reader :initial_price_due

      sig do
        params(
          initial_price_due:
            WhopSDK::Models::PlanListResponse::InitialPriceDue::OrHash
        ).void
      end
        ...
        override.returns(
          {
            ...
            initial_price: Float,
            initial_price_due:
              WhopSDK::Models::PlanListResponse::InitialPriceDue,
            internal_notes: T.nilable(String),
            invoice: T.nilable(T.anything),
            member_count: T.nilable(Float),
            metadata: T.nilable(T.anything),
