...
module WhopSDK
  module Models
    class PlanUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::PlanUpdatedWebhookEvent, WhopSDK::Internal::AnyHash)
        end
      ...
      sig { returns(WhopSDK::Plan) }
      attr_reader :data

      sig { params(data: WhopSDK::Plan::OrHash).void }
      attr_writer :data
