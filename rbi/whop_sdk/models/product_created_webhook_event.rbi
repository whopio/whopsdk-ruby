...
module WhopSDK
  module Models
    class ProductCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::ProductCreatedWebhookEvent, WhopSDK::Internal::AnyHash)
        end
      ...
      sig { params(data: WhopSDK::Product::OrHash).void }
      attr_writer :data
