        ...
        class EarningListResponse < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              account:
                T.nilable(
                  WhopSDK::Models::Referrals::Businesses::EarningListResponse::Account::OrHash
                )
            ).void
          end
          attr_writer :account
          ...
          sig do
            returns(
              WhopSDK::Models::Referrals::Businesses::EarningListResponse::Object::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                WhopSDK::Models::Referrals::Businesses::EarningListResponse::Product
              )
            )
          end
          attr_reader :product
          ...
          sig do
            params(
              product:
                T.nilable(
                  WhopSDK::Models::Referrals::Businesses::EarningListResponse::Product::OrHash
                )
            ).void
          end
          attr_writer :product
          ...
          sig do
            params(
              resource:
                T.nilable(
                  WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              WhopSDK::Models::Referrals::Businesses::EarningListResponse::Status::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              financial_activity:
                T.nilable(
                  T::Array[
                    WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity::OrHash
                  ]
                ),
              object:
                WhopSDK::Models::Referrals::Businesses::EarningListResponse::Object::OrSymbol,
              ...
              status:
                WhopSDK::Models::Referrals::Businesses::EarningListResponse::Status::OrSymbol,
          ...
          class FinancialActivity < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                ...
                currency: String,
                type:
                  WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity::Type::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # Line amount in its native currency.
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::Models::Referrals::Businesses::EarningListResponse::FinancialActivity::Type
                  )
                end
          ...
          module Object
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::Models::Referrals::Businesses::EarningListResponse::Object
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Resource < WhopSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                alternative_payment_method:
                  T.nilable(
                    WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::AlternativePaymentMethod::OrHash
                  )
              ).void
            end
            ...
            sig do
              returns(
                WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::Object::TaggedSymbol
              )
            end
            attr_accessor :object
            ...
            sig do
              params(
                ...
                object:
                  WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::Object::OrSymbol,
            ...
            module Object
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    WhopSDK::Models::Referrals::Businesses::EarningListResponse::Resource::Object
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
