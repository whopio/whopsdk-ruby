  ...
  module Models
    class RefundUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            WhopSDK::RefundUpdatedWebhookEvent::Data::Provider::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::RefundUpdatedWebhookEvent::Data::ReferenceStatus::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::RefundUpdatedWebhookEvent::Data::ReferenceType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            WhopSDK::RefundUpdatedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            provider:
              WhopSDK::RefundUpdatedWebhookEvent::Data::Provider::OrSymbol,
            provider_created_at: T.nilable(Time),
            reference_status:
              T.nilable(
                WhopSDK::RefundUpdatedWebhookEvent::Data::ReferenceStatus::OrSymbol
              ),
            reference_type:
              T.nilable(
                WhopSDK::RefundUpdatedWebhookEvent::Data::ReferenceType::OrSymbol
              ),
            reference_value: T.nilable(String),
            status: WhopSDK::RefundUpdatedWebhookEvent::Data::Status::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # The ID of the refund.
        ...
        module Provider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::RefundUpdatedWebhookEvent::Data::Provider)
            end
        ...
        module ReferenceStatus
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::RefundUpdatedWebhookEvent::Data::ReferenceStatus
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::RefundUpdatedWebhookEvent::Data::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
