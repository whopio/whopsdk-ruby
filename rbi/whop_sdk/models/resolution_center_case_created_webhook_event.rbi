    ...
    class ResolutionCenterCaseCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Company
            )
          )
        end
        attr_reader :company
        ...
        sig do
          params(
            company:
              T.nilable(
                WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Company::OrHash
              )
          ).void
        end
        attr_writer :company
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Member
            )
          )
        end
        attr_reader :member
        ...
        sig do
          params(
            member:
              T.nilable(
                WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::Member::OrHash
              )
          ).void
        end
        attr_writer :member
        ...
        sig do
          returns(
            T::Array[
              WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent
            ]
          )
        end
        ...
        sig do
          returns(WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::User)
        end
        attr_reader :user
        ...
        sig do
          params(
            user:
              WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::User::OrHash
          ).void
        end
        attr_writer :user
        ...
        sig do
          params(
            ...
            resolution_events:
              T::Array[
                WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::OrHash
              ],
          ...
          override.returns(
            {
              ...
              updated_at: Time,
              user: WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::User
            }
          )
        end
        def to_hash
        ...
        class ResolutionEvent < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::Action::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::ReporterType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              id: String,
              action:
                WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::Action::OrSymbol,
              created_at: Time,
              details: T.nilable(String),
              reporter_type:
                WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::ReporterType::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # The unique identifier for the resolution event.
          ...
          module Action
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::Action
                )
              end
          ...
          module ReporterType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::ResolutionEvent::ReporterType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class User < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::ResolutionCenterCaseCreatedWebhookEvent::Data::User,
                WhopSDK::Internal::AnyHash
              )
            end
