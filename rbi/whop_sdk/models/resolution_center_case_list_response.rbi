...
module WhopSDK
  module Models
    class ResolutionCenterCaseListResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T::Array[WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem]
        )
      end
      ...
      sig do
        params(
          ...
          line_items:
            T::Array[
              WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem::OrHash
            ],
          outcome:
            T.nilable(
        ...
        override.returns(
          {
            ...
            line_items:
              T::Array[
                WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem
              ],
            outcome:
              T.nilable(
                WhopSDK::Models::ResolutionCenterCaseListResponse::Outcome::TaggedSymbol
      ...
      class LineItem < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            subtotal:
              T.nilable(
                WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem::Subtotal::OrHash
              )
          ).void
        end
