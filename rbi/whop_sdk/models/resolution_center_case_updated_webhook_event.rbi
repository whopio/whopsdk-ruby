    ...
    class ResolutionCenterCaseUpdatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            T::Array[
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::AvailableAction::TaggedSymbol
            ]
          )
        end
        ...
        sig do
          returns(WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer)
        end
        attr_reader :buyer
        ...
        sig do
          params(
            buyer:
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer::OrHash
          ).void
        end
        attr_writer :buyer
        ...
        sig do
          returns(
            T::Array[
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::LineItem
            ]
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Outcome::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Reason::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Refund::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            available_actions:
              T::Array[
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::AvailableAction::OrSymbol
              ],
            buyer:
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer::OrHash,
            created_at: String,
            ...
            line_items:
              T::Array[
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::LineItem::OrHash
              ],
            outcome:
              T.nilable(
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Outcome::OrSymbol
              ),
            payment:
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Payment::OrHash,
            ...
            reason:
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Reason::OrSymbol,
            refund:
              T.nilable(
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Refund::OrSymbol
              ),
            response_due_at: T.nilable(String),
            status:
              WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Status::OrSymbol,
            updated_at: String
          ).returns(T.attached_class)
        end
        def self.new(
          ...
          override.returns(
            {
              ...
              buyer:
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Buyer,
              created_at: String,
              currency: T.nilable(String),
              customer_appealed: T::Boolean,
              escalated: T::Boolean,
        ...
        module AvailableAction
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::AvailableAction
              )
            end
        ...
        module Outcome
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Outcome
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Reason
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Reason
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::ResolutionCenterCaseUpdatedWebhookEvent::Data::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
