  ...
  module Models
    class SetupIntent < WhopSDK::Internal::Type::BaseModel
      ...
      class PaymentMethod < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(WhopSDK::SetupIntent::PaymentMethod::MailingAddress)
          )
        end
        ...
        sig do
          params(
            mailing_address:
              T.nilable(
                WhopSDK::SetupIntent::PaymentMethod::MailingAddress::OrHash
              )
          ).void
        end
        ...
        class MailingAddress < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::SetupIntent::PaymentMethod::MailingAddress,
                WhopSDK::Internal::AnyHash
              )
            end
