...
module WhopSDK
  module Models
    class StatRunSqlResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(WhopSDK::Models::StatRunSqlResponse, WhopSDK::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(WhopSDK::Models::StatRunSqlResponse::Debug)) }
      attr_reader :debug

      sig do
        params(
          debug: T.nilable(WhopSDK::Models::StatRunSqlResponse::Debug::OrHash)
        ).void
      end
      attr_writer :debug
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::StatRunSqlResponse::Pagination))
      end
      ...
      sig do
        params(
          pagination:
            T.nilable(WhopSDK::Models::StatRunSqlResponse::Pagination::OrHash)
        ).void
      end
        ...
        override.returns(
          {
            columns: T.nilable(T::Array[String]),
            data: T.nilable(T::Array[T::Hash[Symbol, T.anything]]),
            debug: T.nilable(WhopSDK::Models::StatRunSqlResponse::Debug),
            node: T.nilable(String),
            pagination:
              T.nilable(WhopSDK::Models::StatRunSqlResponse::Pagination),
            typename: Symbol
          }
        )
      end
      ...
      class Pagination < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::StatRunSqlResponse::Pagination,
              WhopSDK::Internal::AnyHash
            )
          end
