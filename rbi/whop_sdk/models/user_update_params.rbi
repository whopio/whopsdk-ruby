...
module WhopSDK
  module Models
    class UserUpdateParams < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(WhopSDK::UserUpdateParams::Banner)) }
      attr_reader :banner
        ...
        override.returns(
          {
            id: String,
            account_id: String,
            banner: T.nilable(WhopSDK::UserUpdateParams::Banner),
            bio: String,
            name: String,
      ...
      class Banner < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(WhopSDK::UserUpdateParams::Banner, WhopSDK::Internal::AnyHash)
          end
