...
module WhopSDK
  module Models
    class VerificationCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(WhopSDK::Models::VerificationCreateResponse::Address))
      end
      attr_reader :address
      ...
      sig do
        params(
          address:
            T.nilable(
              WhopSDK::Models::VerificationCreateResponse::Address::OrHash
            )
        ).void
      end
      attr_writer :address
      ...
      sig do
        params(
          requested_information:
            T::Array[
              WhopSDK::Models::VerificationCreateResponse::RequestedInformation::OrHash
            ]
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              WhopSDK::Models::VerificationCreateResponse::RequiredDocument
            ]
          )
        )
      end
      ...
      sig do
        params(
          required_documents:
            T::Array[
              WhopSDK::Models::VerificationCreateResponse::RequiredDocument::OrHash
            ]
        ).void
      end
        ...
        override.returns(
          {
            id: String,
            address:
              T.nilable(WhopSDK::Models::VerificationCreateResponse::Address),
            business_name: T.nilable(String),
            business_structure: T.nilable(String),
            country: T.nilable(String),
            created_at: String,
      ...
      class Address < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::VerificationCreateResponse::Address,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class RequestedInformation < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            requested_files:
              T::Array[
                WhopSDK::Models::VerificationCreateResponse::RequestedInformation::RequestedFile::OrHash
              ]
          ).void
        end
      ...
      class RequiredDocument < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::VerificationCreateResponse::RequiredDocument::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              WhopSDK::Models::VerificationCreateResponse::RequiredDocument::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::VerificationCreateResponse::RequiredDocument::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
