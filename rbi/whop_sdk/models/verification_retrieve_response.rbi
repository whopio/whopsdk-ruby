      ...
      class RequestedInformation < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::RequestedFile
              ]
            )
          )
        end
        ...
        sig do
          params(
            requested_files:
              T::Array[
                WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::RequestedFile::OrHash
              ]
          ).void
        end
