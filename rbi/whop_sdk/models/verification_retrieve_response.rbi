...
module WhopSDK
  module Models
    class VerificationRetrieveResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(WhopSDK::Models::VerificationRetrieveResponse::Address)
        )
      end
      attr_reader :address
      ...
      sig do
        params(
          address:
            T.nilable(
              WhopSDK::Models::VerificationRetrieveResponse::Address::OrHash
            )
        ).void
      end
      attr_writer :address
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation
            ]
          )
        )
      end
      ...
      sig do
        params(
          requested_information:
            T::Array[
              WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::OrHash
            ]
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              WhopSDK::Models::VerificationRetrieveResponse::RequiredDocument
            ]
          )
        )
      end
      ...
      sig do
        params(
          required_documents:
            T::Array[
              WhopSDK::Models::VerificationRetrieveResponse::RequiredDocument::OrHash
            ]
        ).void
      end
      ...
      class Address < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::Models::VerificationRetrieveResponse::Address,
              WhopSDK::Internal::AnyHash
            )
          end
      ...
      class RequestedInformation < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            supporting_documents:
              T::Array[
                WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::OrHash
              ]
          ).void
        end
        ...
        class Error < WhopSDK::Internal::Type::BaseModel
          ...
          sig { params(code: String, reason: String).returns(T.attached_class) }
          def self.new(
            # Stable error code.
            code: nil,
            # Why it was rejected.
        ...
        class SupportingDocument < WhopSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::UploadStatus::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::Visibility::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              upload_status:
                WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::UploadStatus::OrSymbol,
              url: T.nilable(String),
              visibility:
                WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::Visibility::OrSymbol,
              multipart_chunk_size: T.nilable(Integer),
              multipart_upload_id: T.nilable(String),
              multipart_upload_urls:
                T.nilable(
                  T::Array[
                    WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::MultipartUploadURL::OrHash
                  ]
                ),
          ...
          module UploadStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::UploadStatus
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Visibility
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  WhopSDK::Models::VerificationRetrieveResponse::RequestedInformation::SupportingDocument::Visibility
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class RequiredDocument < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Models::VerificationRetrieveResponse::RequiredDocument::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              WhopSDK::Models::VerificationRetrieveResponse::RequiredDocument::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Models::VerificationRetrieveResponse::RequiredDocument::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
