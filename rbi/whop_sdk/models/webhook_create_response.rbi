...
module WhopSDK
  module Models
    class WebhookCreateResponse < WhopSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          WhopSDK::Models::WebhookCreateResponse::APIVersion::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T::Array[WhopSDK::Models::WebhookCreateResponse::Event::TaggedSymbol]
        )
      end
      ...
      sig do
        returns(
          T::Array[
            WhopSDK::Models::WebhookCreateResponse::TestableEvent::TaggedSymbol
          ]
        )
      end
      ...
      sig do
        params(
          id: String,
          api_version:
            WhopSDK::Models::WebhookCreateResponse::APIVersion::OrSymbol,
          child_resource_events: T::Boolean,
          created_at: Time,
          enabled: T::Boolean,
          events:
            T::Array[WhopSDK::Models::WebhookCreateResponse::Event::OrSymbol],
          resource_id: String,
          testable_events:
            T::Array[
              WhopSDK::Models::WebhookCreateResponse::TestableEvent::OrSymbol
            ],
          url: String,
        ...
        override.returns(
          {
            ...
            events:
              T::Array[
                WhopSDK::Models::WebhookCreateResponse::Event::TaggedSymbol
              ],
            resource_id: String,
            testable_events:
              T::Array[
      ...
      module APIVersion
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::WebhookCreateResponse::APIVersion)
          end
      ...
      module Event
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::WebhookCreateResponse::Event)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module TestableEvent
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::WebhookCreateResponse::TestableEvent)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
