...
module WhopSDK
  module Models
    ...
    module WebhookEvent
      ...
      PAYOUT_CREATED =
        T.let(:"payout.created", WhopSDK::WebhookEvent::TaggedSymbol)
      PAYOUT_UPDATED =
        T.let(:"payout.updated", WhopSDK::WebhookEvent::TaggedSymbol)
      PAYOUT_REVERSED =
        T.let(:"payout.reversed", WhopSDK::WebhookEvent::TaggedSymbol)
      ...
      AD_CAMPAIGN_UPDATED =
        T.let(:"ad_campaign.updated", WhopSDK::WebhookEvent::TaggedSymbol)
      AD_UPDATED = T.let(:"ad.updated", WhopSDK::WebhookEvent::TaggedSymbol)
