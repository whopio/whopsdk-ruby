  ...
  module Models
    class WebhookUpdateResponse < WhopSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            WhopSDK::Models::WebhookUpdateResponse,
      ...
      sig do
        returns(
          WhopSDK::Models::WebhookUpdateResponse::APIVersion::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T::Array[WhopSDK::Models::WebhookUpdateResponse::Event::TaggedSymbol]
        )
      end
      ...
      sig do
        returns(
          T::Array[
            WhopSDK::Models::WebhookUpdateResponse::TestableEvent::TaggedSymbol
          ]
        )
      end
      ...
      sig do
        params(
          id: String,
          api_version:
            WhopSDK::Models::WebhookUpdateResponse::APIVersion::OrSymbol,
          child_resource_events: T::Boolean,
          created_at: Time,
          enabled: T::Boolean,
          events:
            T::Array[WhopSDK::Models::WebhookUpdateResponse::Event::OrSymbol],
          resource_id: String,
          testable_events:
            T::Array[
              WhopSDK::Models::WebhookUpdateResponse::TestableEvent::OrSymbol
            ],
          url: String
        ...
        override.returns(
          {
            ...
            events:
              T::Array[
                WhopSDK::Models::WebhookUpdateResponse::Event::TaggedSymbol
              ],
            resource_id: String,
            testable_events:
              T::Array[
      ...
      module APIVersion
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::WebhookUpdateResponse::APIVersion)
          end
      ...
      module Event
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::WebhookUpdateResponse::Event)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module TestableEvent
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, WhopSDK::Models::WebhookUpdateResponse::TestableEvent)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
