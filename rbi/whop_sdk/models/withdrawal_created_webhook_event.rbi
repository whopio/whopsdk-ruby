...
module WhopSDK
  module Models
    class WithdrawalCreatedWebhookEvent < WhopSDK::Internal::Type::BaseModel
      ...
      sig { returns(WhopSDK::WithdrawalCreatedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(data: WhopSDK::WithdrawalCreatedWebhookEvent::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          id: String,
          data: WhopSDK::WithdrawalCreatedWebhookEvent::Data::OrHash,
          timestamp: Time,
      ...
      class Data < WhopSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              WhopSDK::WithdrawalCreatedWebhookEvent::Data,
              WhopSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(WhopSDK::WithdrawalCreatedWebhookEvent::Data::PayoutToken)
          )
        end
