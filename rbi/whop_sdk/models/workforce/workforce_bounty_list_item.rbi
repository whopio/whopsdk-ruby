    ...
    module Workforce
      class WorkforceBountyListItem < WhopSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Workforce::WorkforceBountyListItem::BusinessGoalType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            funding_account:
              T.nilable(
                WhopSDK::Workforce::WorkforceBountyListItem::FundingAccount::OrHash
              )
          ).void
        end
        ...
        sig { returns(WhopSDK::Workforce::WorkforceBountyListItem::Poster) }
        attr_reader :poster

        sig do
          params(
            poster: WhopSDK::Workforce::WorkforceBountyListItem::Poster::OrHash
          ).void
        end
        attr_writer :poster
        ...
        sig do
          returns(
            T.nilable(
              WhopSDK::Workforce::WorkforceBountyListItem::ScheduledFrequency::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            WhopSDK::Workforce::WorkforceBountyListItem::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            business_goal_type:
              T.nilable(
                WhopSDK::Workforce::WorkforceBountyListItem::BusinessGoalType::OrSymbol
              ),
            created_at: String,
            currency: String,
            ...
            scheduled_frequency:
              T.nilable(
                WhopSDK::Workforce::WorkforceBountyListItem::ScheduledFrequency::OrSymbol
              ),
            scheduled_publish_at: T.nilable(String),
            spots_remaining: Integer,
            status:
              WhopSDK::Workforce::WorkforceBountyListItem::Status::OrSymbol,
        ...
        module BusinessGoalType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Workforce::WorkforceBountyListItem::BusinessGoalType
              )
            end
        ...
        class Poster < WhopSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                WhopSDK::Workforce::WorkforceBountyListItem::Poster,
                WhopSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              WhopSDK::Workforce::WorkforceBountyListItem::Poster::ProfilePicture
            )
          end
          ...
          sig do
            params(
              profile_picture:
                WhopSDK::Workforce::WorkforceBountyListItem::Poster::ProfilePicture::OrHash
            ).void
          end
        ...
        module ScheduledFrequency
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                WhopSDK::Workforce::WorkforceBountyListItem::ScheduledFrequency
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, WhopSDK::Workforce::WorkforceBountyListItem::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
