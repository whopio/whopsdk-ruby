    ...
    class Cards
      ...
      sig do
        params(
          id: String,
          request_options: WhopSDK::RequestOptions::OrHash
        ).returns(WhopSDK::CardPin)
      end
      def pin(id, request_options: {})
      end
      ...
      sig do
        params(
          id: String,
          request_options: WhopSDK::RequestOptions::OrHash
        ).returns(WhopSDK::CardSecrets)
      end
      def secrets(id, request_options: {})
      end
      ...
      sig do
        params(
          ...
          pin: String,
          request_options: WhopSDK::RequestOptions::OrHash
        ).returns(WhopSDK::Models::CardUpdatePinResponse)
      end
      def update_pin(
        id,
        # The new 4-digit PIN.
