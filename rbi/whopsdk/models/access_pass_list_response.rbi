...
module Whopsdk
  module Models
    class AccessPassListResponse < Whopsdk::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[T.nilable(Whopsdk::Models::AccessPassListItem)])
        )
      end
      attr_accessor :data
      ...
      sig do
        params(
          data:
            T.nilable(
              T::Array[T.nilable(Whopsdk::Models::AccessPassListItem::OrHash)]
            ),
        ...
        override.returns(
          {
            data:
              T.nilable(
                T::Array[T.nilable(Whopsdk::Models::AccessPassListItem)]
              ),
