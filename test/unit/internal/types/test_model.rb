...
describe Whop_sdk::Internal::Types::Model do
  ...
  class ExampleModel < Whop_sdk::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Whop_sdk::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Whop_sdk::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Whop_sdk::Internal::Types::Model
