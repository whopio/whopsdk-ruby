...
describe Whop_sdk::Internal::Types::Union do
  class Rectangle < Whop_sdk::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Whop_sdk::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Whop_sdk::Internal::Types::Model
