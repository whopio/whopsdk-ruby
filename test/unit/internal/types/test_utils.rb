...
describe Whop_sdk::Internal::Types::Utils do
  Utils = Whop_sdk::Internal::Types::Utils

  module TestUtils
    class M < Whop_sdk::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Whop_sdk::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Whop_sdk::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Whop_sdk::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Whop_sdk::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Whop_sdk::Internal::Types::Array[String]
      ModelArray = -> { Whop_sdk::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Whop_sdk::Internal::Types::Array[TestUtils::U] }
