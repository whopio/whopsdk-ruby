...
class WhopSDK::Test::PrimitiveModelTest < Minitest::Test
  A = WhopSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = WhopSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < WhopSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      WhopSDK::Internal::Type::Unknown,
      WhopSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => WhopSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [WhopSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [WhopSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [WhopSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = WhopSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        WhopSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [WhopSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [WhopSDK::Internal::Type::Boolean, true] => true,
      [WhopSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => WhopSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        WhopSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = WhopSDK::Internal::Type::Converter.new_coerce_state
      WhopSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        WhopSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class WhopSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include WhopSDK::Internal::Type::Enum
...
class WhopSDK::Test::CollectionModelTest < Minitest::Test
  A1 = WhopSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = WhopSDK::Internal::Type::HashOf[Integer]

  A2 = WhopSDK::Internal::Type::ArrayOf[H1]
  H2 = WhopSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = WhopSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = WhopSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class WhopSDK::Test::BaseModelTest < Minitest::Test
  class M1 < WhopSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < WhopSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < WhopSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, WhopSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = WhopSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = WhopSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(WhopSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue WhopSDK::Errors::ConversionError => e
...
class WhopSDK::Test::UnionTest < Minitest::Test
  class U0
    include WhopSDK::Internal::Type::Union
  ...
  class M2 < WhopSDK::Internal::Type::BaseModel
  ...
  class M4 < WhopSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, WhopSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < WhopSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, WhopSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class WhopSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include WhopSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [WhopSDK::Internal::Type::Unknown, WhopSDK::Internal::Type::Unknown] => true,
      [WhopSDK::Internal::Type::Boolean, WhopSDK::Internal::Type::Boolean] => true,
      [WhopSDK::Internal::Type::Unknown, WhopSDK::Internal::Type::Boolean] => false,
...
class WhopSDK::Test::MetaInfoTest < Minitest::Test
  A1 = WhopSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = WhopSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
