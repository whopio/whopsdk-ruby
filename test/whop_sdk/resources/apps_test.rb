  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        domain_id: String,
        domains: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::App::Domain]) | nil,
        ...
        previous_hosted_urls: ^(WhopSDK::Internal::Type::ArrayOf[String]),
  ...
  def test_list
    ...
    assert_pattern do
      row => {
        ...
        discover_path: String | nil,
        domain_id: String,
        domains: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::AppListResponse::Domain]) | nil,
        experience_path: String | nil,
        hosted_url: String | nil,
