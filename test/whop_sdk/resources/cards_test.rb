...
class WhopSDK::Test::Resources::CardsTest < WhopSDK::Test::ResourceTest
  ...
  def test_pin
    ...
    response = @whop.cards.pin("id")

    assert_pattern do
      response => WhopSDK::CardPin
    end

    assert_pattern do
      response => {
        object: WhopSDK::CardPin::Object,
        pin: String
      }
    end
  end
  ...
  def test_secrets
    ...
    response = @whop.cards.secrets("id")

    assert_pattern do
      response => WhopSDK::CardSecrets
    end

    assert_pattern do
      response => {
        cvc: String,
        object: WhopSDK::CardSecrets::Object,
        pan: String,
        name_on_card: String | nil
      }
    end
  end
  ...
  def test_update_pin_required_params
    ...
    response = @whop.cards.update_pin("id", pin: "pin")

    assert_pattern do
      response => WhopSDK::Models::CardUpdatePinResponse
    end
