  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        billing_reason: WhopSDK::Payment::BillingReason | nil,
        card_brand: WhopSDK::Payment::CardBrand | nil,
        ...
        paid_at: Time | nil,
        payment_method_type: WhopSDK::Payment::PaymentMethodType | nil,
  ...
  def test_list_required_params
    ...
    assert_pattern do
      row => {
        ...
        billing_reason: WhopSDK::Models::PaymentListResponse::BillingReason | nil,
        card_brand: WhopSDK::Models::PaymentListResponse::CardBrand | nil,
        card_last4: String | nil,
        ...
        paid_at: Time | nil,
        payment_method_type: WhopSDK::Models::PaymentListResponse::PaymentMethodType | nil,
