...
class WhopSDK::Test::Resources::PaymentsTest < WhopSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @whop.payments.create(account_id: "biz_xxxxxxxxxxxxxx")
    ...
    assert_pattern do
      response => {
        ...
        holds: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::Payment::Hold]),
        last_payment_attempt_at: String | nil,
        line_items: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::Payment::LineItem]),
        ...
        payment_rule_matches: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::Payment::PaymentRuleMatch]),
        payments_failed: Float,
        plan_id: String | nil,
        presentment_total: WhopSDK::Payment::PresentmentTotal | nil,
        product_id: String | nil,
        promo_code_id: String | nil,
        recovery_url: String | nil,
