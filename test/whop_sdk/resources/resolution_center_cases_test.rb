  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        line_items: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::ResolutionCenterCaseRetrieveResponse::LineItem]),
  ...
  def test_list
    ...
    assert_pattern do
      row => {
        ...
        customer_appealed: WhopSDK::Internal::Type::Boolean,
        escalated: WhopSDK::Internal::Type::Boolean,
        line_items: ^(WhopSDK::Internal::Type::ArrayOf[WhopSDK::Models::ResolutionCenterCaseListResponse::LineItem]),
